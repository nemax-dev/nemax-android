...
.method public constructor <init>(ILandroid/content/Context;Lru/ok/messages/media/trim/rangeSeekBar/RangeSeekBarView;)V
    ...
    iput-object p3, p0, Lq7b;->l:Lru/ok/messages/media/trim/rangeSeekBar/RangeSeekBarView;
    ...
    iput-object v3, p0, Lq7b;->c:Landroid/graphics/Paint;
    ...
    iput-object v3, p0, Lq7b;->d:Landroid/graphics/Paint;

    new-instance v3, Landroid/graphics/Paint;

    invoke-direct {v3}, Landroid/graphics/Paint;-><init>()V

    iput-object v3, p0, Lq7b;->e:Landroid/graphics/Paint;

    iget p2, p2, Llqe;->m:I

    const v6, 0x3f19999a    # 0.6f

    invoke-static {p2, v6}, Lpo9;->X(IF)I
    ...
    iput-object p2, p0, Lq7b;->g:Landroid/graphics/RectF;
    ...
    iput-object p3, p0, Lq7b;->i:Landroid/graphics/RectF;
    ...
    iput-object p2, p0, Lq7b;->j:Landroid/graphics/RectF;
    ...
    iput-object p2, p0, Lq7b;->k:Landroid/graphics/RectF;
...
.method public final a()F
    ...
    iget-object v0, p0, Lq7b;->i:Landroid/graphics/RectF;

    invoke-virtual {v0}, Landroid/graphics/RectF;->centerX()F

    move-result v0

    iget-object p0, p0, Lq7b;->l:Lru/ok/messages/media/trim/rangeSeekBar/RangeSeekBarView;
...
.method public final b(Landroid/view/MotionEvent;)V
    ...
    iget-object v1, p0, Lq7b;->l:Lru/ok/messages/media/trim/rangeSeekBar/RangeSeekBarView;
    ...
    invoke-virtual {p0, p1}, Lq7b;->c(F)V

    return-void

    :cond_1
    invoke-virtual {p0}, Lq7b;->a()F
...
.method public final c(F)V
    ...
    iget-object v0, p0, Lq7b;->l:Lru/ok/messages/media/trim/rangeSeekBar/RangeSeekBarView;

    invoke-virtual {v0, p1}, Lru/ok/messages/media/trim/rangeSeekBar/RangeSeekBarView;->b(F)F

    move-result p1

    iget-object v0, p0, Lq7b;->g:Landroid/graphics/RectF;
    ...
    iget-object v2, p0, Lq7b;->j:Landroid/graphics/RectF;

    invoke-virtual {v2, p1, v1}, Landroid/graphics/RectF;->offsetTo(FF)V

    iget-object p0, p0, Lq7b;->k:Landroid/graphics/RectF;
