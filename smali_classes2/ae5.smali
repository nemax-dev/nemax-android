...
.field public r0:Landroid/text/SpannableString;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    :cond_0
    iput-object p1, p0, Lae5;->b:Ljava/lang/CharSequence;

    sget-object p1, Lbmf;->I:Ls3f;

    new-instance v0, Lzj;

    const/16 v1, 0x8

    invoke-direct {v0, v1, p0, p1}, Lzj;-><init>(ILandroid/view/View;Ljava/lang/Object;)V

    iput-object v0, p0, Lae5;->c:Lzj;
    ...
    invoke-virtual {p0}, Lae5;->getTypography()Ls3f;
    ...
    iput-object p1, p0, Lae5;->o:Landroid/text/TextPaint;

    const p1, 0x7fffffff

    iput p1, p0, Lae5;->s0:I

    invoke-virtual {v0, p0}, Lrx9;->n(Landroid/view/View;)Lvra;

    move-result-object p1

    invoke-virtual {p0, p1}, Lae5;->onThemeChanged(Lvra;)V
...
.method public final a(ILjava/lang/CharSequence;)Landroid/text/Layout;
    ...
    invoke-static {p2}, Lhi9;->d(Ljava/lang/CharSequence;)Lj8e;
    ...
    iget-object v1, p0, Lae5;->a:Lsl7;

    iget-object v3, p0, Lae5;->o:Landroid/text/TextPaint;
...
.method public final b(I)V
    ...
    iget-object v0, p0, Lae5;->r0:Landroid/text/SpannableString;
    ...
    :cond_0
    invoke-virtual {p0, p1, v0}, Lae5;->a(ILjava/lang/CharSequence;)Landroid/text/Layout;

    move-result-object v1

    iput-object v1, p0, Lae5;->v0:Landroid/text/Layout;

    invoke-virtual {v1}, Landroid/text/Layout;->getLineCount()I

    move-result v1

    iget v2, p0, Lae5;->s0:I

    if-gt v1, v2, :cond_1

    iget-object p1, p0, Lae5;->v0:Landroid/text/Layout;
    ...
    iget-object v3, p0, Lae5;->b:Ljava/lang/CharSequence;
    ...
    iget-object v4, p0, Lae5;->o:Landroid/text/TextPaint;
    ...
    :cond_6
    invoke-static {v7, v0}, Lcne;->H0(ILjava/lang/CharSequence;)Ljava/lang/CharSequence;
    ...
    invoke-direct {v1, v4, p0}, Lk97;-><init>(ILjava/lang/Object;)V

    new-instance v4, Landroid/text/SpannableStringBuilder;

    invoke-static {v0}, Ll54;->C(Ljava/lang/CharSequence;)Ljava/lang/CharSequence;
    ...
    :goto_5
    iput-object p1, p0, Lae5;->u0:Landroid/text/Layout;

    iget-boolean v0, p0, Lae5;->y0:Z
    ...
    :cond_8
    iput-object p1, p0, Lae5;->t0:Landroid/text/Layout;
...
.method public final c()V
    ...
    invoke-virtual {p0, v0}, Lae5;->b(I)V

    const/4 v0, 0x1

    iput-boolean v0, p0, Lae5;->w0:Z
    ...
    :cond_0
    iget-object v0, p0, Lae5;->A0:Lrp0;
    ...
    invoke-direct {v0, v1, p0}, Lrp0;-><init>(ILjava/lang/Object;)V

    iput-object v0, p0, Lae5;->A0:Lrp0;

    invoke-virtual {p0}, Landroid/view/View;->getViewTreeObserver()Landroid/view/ViewTreeObserver;

    move-result-object v0

    iget-object p0, p0, Lae5;->A0:Lrp0;
...
.method public final getText()Landroid/text/SpannableString;
    ...
    iget-object p0, p0, Lae5;->r0:Landroid/text/SpannableString;
...
.method public final getTextLayout()Landroid/text/Layout;
    ...
    iget-object p0, p0, Lae5;->t0:Landroid/text/Layout;

    return-object p0
.end method

.method public final getTypography()Ls3f;
    .locals 2

    sget-object v0, Lae5;->B0:[Lqj7;

    const/4 v1, 0x0

    aget-object v0, v0, v1

    iget-object p0, p0, Lae5;->c:Lzj;
...
.method public final onMeasure(II)V
    ...
    iget-object p2, p0, Lae5;->z0:Ljava/lang/Integer;
    ...
    :cond_0
    iget-object p2, p0, Lae5;->t0:Landroid/text/Layout;
...
.method public final onThemeChanged(Lvra;)V
    ...
    iget-object v0, p0, Lae5;->o:Landroid/text/TextPaint;

    invoke-virtual {v0, p1}, Landroid/graphics/Paint;->setColor(I)V

    iget-object p1, p0, Lae5;->r0:Landroid/text/SpannableString;
...
.method public final onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    :cond_0
    iget-object v0, p0, Lae5;->t0:Landroid/text/Layout;
    ...
    :cond_1
    iget-object v1, p0, Lae5;->t0:Landroid/text/Layout;
    ...
    invoke-static {v2, v5, v1}, Lzq3;->b(FFI)I
...
.method public final setText(Landroid/text/SpannableString;)V
    ...
    .line 1
    iput-object p1, p0, Lae5;->r0:Landroid/text/SpannableString;
...
.method public final setText(Ljava/lang/CharSequence;)V
    ...
    invoke-static {p1, v0, v1}, Lhi9;->g(Ljava/lang/CharSequence;II)Landroid/text/Spannable;
    ...
    .line 4
    invoke-static {p1}, Lhi9;->d(Ljava/lang/CharSequence;)Lj8e;
    ...
    .line 6
    iput-boolean p1, p0, Lae5;->y0:Z

    .line 7
    iput-boolean p1, p0, Lae5;->w0:Z
