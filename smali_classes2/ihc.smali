...
.field public final I0:Lhi;


# direct methods
.method public constructor <init>(Landroid/content/Context;Ljhc;)V
    .locals 7
    ...
    iput-object p2, p0, Lihc;->E0:Ljhc;
    ...
    iput-object v1, p0, Lihc;->F0:Landroid/graphics/drawable/GradientDrawable;
    ...
    invoke-static {v3, v4}, Ll54;->K(IF)I
    ...
    invoke-static {v5, v2, v2}, Lys9;->x(Ljava/lang/Integer;Ljava/lang/Integer;Ljava/lang/Integer;)Landroid/graphics/drawable/GradientDrawable;
    ...
    iput-object v6, p0, Lihc;->G0:Landroid/graphics/drawable/RippleDrawable;
    ...
    invoke-static {p1, v4}, Ll54;->K(IF)I
    ...
    iput-object v1, p0, Lihc;->H0:Landroid/graphics/drawable/RippleDrawable;
    ...
    iput-object p1, p0, Lihc;->I0:Lhi;

    new-instance p1, Ldpc;

    invoke-virtual {p2}, Ljhc;->a()I
    ...
    invoke-direct {p1, v1, p2}, Ldpc;-><init>(II)V
...
# virtual methods
.method public final F(Lhhc;)V
    .locals 4

    iget-boolean v0, p1, Lhhc;->o:Z

    if-eqz v0, :cond_1

    iget-object v1, p0, Lihc;->E0:Ljhc;

    invoke-virtual {v1}, Ljhc;->a()I

    move-result v2

    iget-object v1, v1, Ljhc;->a:Landroid/content/Context;

    invoke-static {v1}, Lulf;->v(Landroid/content/Context;)I
    ...
    iget-object p0, p0, Lihc;->G0:Landroid/graphics/drawable/RippleDrawable;

    goto :goto_2

    :cond_2
    iget-object p0, p0, Lihc;->H0:Landroid/graphics/drawable/RippleDrawable;

    :goto_2
    invoke-virtual {v2, p0}, Landroid/view/View;->setBackground(Landroid/graphics/drawable/Drawable;)V

    iget-object p0, p1, Lhhc;->c:Landroid/graphics/drawable/Drawable;
...
.method public final onThemeChanged(Lvra;)V
    ...
    invoke-static {v0, v1}, Ll54;->K(IF)I
    ...
    iget-object v2, p0, Lihc;->G0:Landroid/graphics/drawable/RippleDrawable;
    ...
    iget-object v2, p0, Lihc;->F0:Landroid/graphics/drawable/GradientDrawable;
    ...
    invoke-static {p1, v1}, Ll54;->K(IF)I
...
.method public final bridge synthetic y(Ljt7;)V
    ...
    invoke-virtual {p0, p1}, Lihc;->F(Lhhc;)V
