...
# static fields
.field public static final c:Lxuc;
...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0, v1}, Lxuc;-><init>(I)V

    sput-object v0, Lhh;->c:Lxuc;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object p1, p0, Lhh;->b:Landroid/content/res/Resources;
...
.method public final a(Landroid/content/res/XmlResourceParser;Landroid/animation/AnimatorSet;I)Landroid/animation/Animator;
    ...
    invoke-static {v1}, Lsya;->c(Landroid/content/res/XmlResourceParser;)Ljava/util/LinkedHashMap;
    ...
    invoke-static {v7}, Ljne;->Q(Ljava/lang/String;)Ljava/lang/Integer;
    ...
    :cond_4
    invoke-virtual {v0, v1, v3, v9}, Lhh;->a(Landroid/content/res/XmlResourceParser;Landroid/animation/AnimatorSet;I)Landroid/animation/Animator;
    ...
    invoke-virtual {v0, v3, v1}, Lhh;->b(Landroid/animation/ValueAnimator;Landroid/content/res/XmlResourceParser;)V
    ...
    invoke-direct {v3, v1}, Ltx0;-><init>(Landroid/content/res/XmlResourceParser;)V

    new-instance v7, Landroid/animation/ObjectAnimator;

    invoke-direct {v7}, Landroid/animation/ObjectAnimator;-><init>()V

    invoke-virtual {v0, v7, v3}, Lhh;->b(Landroid/animation/ValueAnimator;Landroid/content/res/XmlResourceParser;)V

    sget-object v11, Lxg;->Y:Lxg;

    iget-object v12, v0, Lhh;->a:Landroid/content/Context;

    invoke-virtual {v11, v12, v3}, Lmye;->B(Landroid/content/Context;Landroid/content/res/XmlResourceParser;)Ljava/lang/Object;
    ...
    sget-object v13, Lxg;->r0:Lxg;

    invoke-virtual {v13, v12, v3}, Lmye;->B(Landroid/content/Context;Landroid/content/res/XmlResourceParser;)Ljava/lang/Object;

    move-result-object v13

    check-cast v13, Ljava/lang/String;

    sget-object v14, Lxg;->s0:Lxg;

    invoke-virtual {v14, v12, v3}, Lmye;->B(Landroid/content/Context;Landroid/content/res/XmlResourceParser;)Ljava/lang/Object;

    move-result-object v14

    check-cast v14, Ljava/lang/String;

    sget-object v15, Lxg;->w0:Lxg;

    invoke-virtual {v15, v12, v3}, Lmye;->B(Landroid/content/Context;Landroid/content/res/XmlResourceParser;)Ljava/lang/Object;

    move-result-object v3

    check-cast v3, Lnh;

    instance-of v12, v3, Llh;

    if-nez v12, :cond_6

    instance-of v3, v3, Lmh;
    ...
    :cond_8
    :goto_3
    invoke-static {v11}, Lmu0;->h(Ljava/lang/String;)Landroid/graphics/Path;
    ...
    invoke-virtual {v0, v12, v3}, Lmye;->B(Landroid/content/Context;Landroid/content/res/XmlResourceParser;)Ljava/lang/Object;
...
.method public final b(Landroid/animation/ValueAnimator;Landroid/content/res/XmlResourceParser;)V
    ...
    sget-object v0, Lyg;->o:Lyg;

    iget-object p0, p0, Lhh;->a:Landroid/content/Context;

    invoke-virtual {v0, p0, p2}, Lmye;->B(Landroid/content/Context;Landroid/content/res/XmlResourceParser;)Ljava/lang/Object;
    ...
    sget-object v1, Lah;->o:Lah;

    invoke-virtual {v1, p0, p2}, Lmye;->B(Landroid/content/Context;Landroid/content/res/XmlResourceParser;)Ljava/lang/Object;

    move-result-object v1

    check-cast v1, Lnh;

    sget-object v2, Lah;->X:Lah;

    invoke-virtual {v2, p0, p2}, Lmye;->B(Landroid/content/Context;Landroid/content/res/XmlResourceParser;)Ljava/lang/Object;
    ...
    invoke-virtual {v3, p0, p2}, Lmye;->B(Landroid/content/Context;Landroid/content/res/XmlResourceParser;)Ljava/lang/Object;

    move-result-object p0

    check-cast p0, Lnh;

    instance-of p2, v1, Lih;
    ...
    :cond_0
    instance-of p2, p0, Lmh;

    if-eqz p2, :cond_2

    new-instance p0, Ljh;

    invoke-direct {p0, v4}, Ljh;-><init>(F)V
    ...
    invoke-direct {p0, v3}, Lih;-><init>(I)V

    :cond_2
    :goto_1
    instance-of p2, p0, Ljh;

    instance-of v5, p0, Llh;

    const/4 v6, 0x0

    if-eqz v5, :cond_11

    instance-of p0, v1, Llh;
    ...
    iget-object p2, p2, Llh;->a:Ljava/lang/String;
    ...
    :cond_4
    invoke-static {p2}, Lmu0;->g(Ljava/lang/String;)[Ls0b;
    ...
    iget-object v4, v4, Llh;->a:Ljava/lang/String;
    ...
    :cond_7
    invoke-static {v4}, Lmu0;->g(Ljava/lang/String;)[Ls0b;
    ...
    invoke-direct {v5}, Lmyb;-><init>()V

    if-eqz v4, :cond_f

    invoke-static {p2, v4}, Lmu0;->b([Ls0b;[Ls0b;)Z
    ...
    iget-object p0, v1, Llh;->a:Ljava/lang/String;
    ...
    iget-object v6, v2, Llh;->a:Ljava/lang/String;
    ...
    invoke-static {p2, p0, v0, v6}, Lme5;->k(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
