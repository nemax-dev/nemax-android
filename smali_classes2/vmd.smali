...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    invoke-direct {v3, v1}, Ld7a;-><init>(Landroid/content/Context;)V
    ...
    invoke-virtual {v3, v4}, Ld7a;->setAvatarShape(Lx6a;)V

    iput-object v3, v0, Lvmd;->a:Ld7a;
    ...
    sget-object v8, Lxbf;->b:Leue;

    invoke-static {v8, v4}, Leue;->d(Leue;Landroid/widget/TextView;)V

    sget-object v8, Lzs4;->p0:Lqs9;

    invoke-virtual {v8, v4}, Lqs9;->e(Landroid/view/View;)Lnma;
    ...
    iput-object v4, v0, Lvmd;->b:Landroidx/appcompat/widget/AppCompatTextView;
    ...
    sget-object v12, Lxbf;->o:Leue;

    invoke-static {v12, v11}, Leue;->d(Leue;Landroid/widget/TextView;)V

    invoke-virtual {v8, v11}, Lqs9;->e(Landroid/view/View;)Lnma;
    ...
    iget v13, v13, Lqse;->j:I

    invoke-virtual {v11, v13}, Landroid/widget/TextView;->setTextColor(I)V

    iput-object v11, v0, Lvmd;->c:Landroidx/appcompat/widget/AppCompatTextView;
    ...
    invoke-static {v12, v13}, Leue;->d(Leue;Landroid/widget/TextView;)V

    invoke-virtual {v8, v13}, Lqs9;->e(Landroid/view/View;)Lnma;
    ...
    iput-object v13, v0, Lvmd;->o:Landroidx/appcompat/widget/AppCompatTextView;
    ...
    invoke-direct {v2, v7, v7}, Lc73;-><init>(II)V

    invoke-virtual {v9, v2}, Landroid/view/View;->setLayoutParams(Landroid/view/ViewGroup$LayoutParams;)V

    invoke-virtual {v9, v5}, Landroid/widget/TextView;->setGravity(I)V

    invoke-static {v12, v9}, Leue;->d(Leue;Landroid/widget/TextView;)V

    invoke-virtual {v8, v9}, Lqs9;->e(Landroid/view/View;)Lnma;
    ...
    iput-object v9, v0, Lvmd;->n0:Landroidx/appcompat/widget/AppCompatTextView;
    ...
    invoke-direct {v1, v7, v7}, Lc73;-><init>(II)V
    ...
    iput-object v2, v0, Lvmd;->o0:Landroid/widget/LinearLayout;
    ...
    invoke-direct {v6, v8, v7}, Lc73;-><init>(II)V
...
.method private final setDivider(Z)V
    ...
    :goto_0
    iget-object p0, p0, Lvmd;->o:Landroidx/appcompat/widget/AppCompatTextView;
...
.method private final setNickname(Ljava/lang/String;)V
    ...
    :goto_2
    iget-object p0, p0, Lvmd;->n0:Landroidx/appcompat/widget/AppCompatTextView;
...
.method private final setPhoneNumber(Ljava/lang/String;)V
    ...
    :goto_2
    iget-object p0, p0, Lvmd;->c:Landroidx/appcompat/widget/AppCompatTextView;
...
.method public final onThemeChanged(Lnma;)V
    ...
    iget-object v1, p0, Lvmd;->b:Landroidx/appcompat/widget/AppCompatTextView;
    ...
    iget-object v1, p0, Lvmd;->c:Landroidx/appcompat/widget/AppCompatTextView;
    ...
    iget-object v1, p0, Lvmd;->n0:Landroidx/appcompat/widget/AppCompatTextView;
...
.method public setAlpha(F)V
    ...
    iget-object v0, p0, Lvmd;->o0:Landroid/widget/LinearLayout;

    invoke-virtual {v0, p1}, Landroid/view/View;->setAlpha(F)V

    iget-object p0, p0, Lvmd;->a:Ld7a;
...
.method public final setAvatarClickedListener(Ld96;)V
    .locals 2
...
.method public final setNicknameClickListener(Ld96;)V
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public final setTopBarContent(Lcmd;)V
    .locals 4

    iget-object v0, p1, Lcmd;->b:Ljava/lang/String;

    iget-wide v1, p1, Lcmd;->a:J

    invoke-static {v1, v2}, Ljava/lang/Long;->valueOf(J)Ljava/lang/Long;

    move-result-object v1

    iget-object v2, p1, Lcmd;->d:Ljava/lang/CharSequence;

    iget-object v3, p0, Lvmd;->a:Ld7a;

    invoke-static {v3, v0, v1, v2}, Ld7a;->m(Ld7a;Ljava/lang/String;Ljava/lang/Long;Ljava/lang/CharSequence;)V

    iget-object v0, p0, Lvmd;->b:Landroidx/appcompat/widget/AppCompatTextView;

    iget-object v1, p1, Lcmd;->c:Ljava/lang/String;

    invoke-virtual {v0, v1}, Landroid/widget/TextView;->setText(Ljava/lang/CharSequence;)V

    iget-object v0, p1, Lcmd;->e:Ljava/lang/String;

    invoke-direct {p0, v0}, Lvmd;->setPhoneNumber(Ljava/lang/String;)V

    iget-object p1, p1, Lcmd;->f:Ljava/lang/String;

    invoke-direct {p0, p1}, Lvmd;->setNickname(Ljava/lang/String;)V
    ...
    :goto_1
    invoke-direct {p0, p1}, Lvmd;->setDivider(Z)V

    return-void
.end method

.method public final setUserPhoneClickListener(Ld96;)V
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
