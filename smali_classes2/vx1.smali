...
# direct methods
.method public constructor <init>(Li0a;Lorg/webrtc/CameraVideoCapturer;Lxoe;Ljava/util/ArrayList;Ljava/util/ArrayList;ZLi7c;)V
    .locals 4
    ...
    iput-object v0, p0, Lvx1;->a:Ljava/util/ArrayList;

    new-instance v1, Ljava/util/ArrayList;

    invoke-direct {v1}, Ljava/util/ArrayList;-><init>()V

    iput-object v1, p0, Lvx1;->b:Ljava/util/ArrayList;

    new-instance v2, Ljava/util/concurrent/CopyOnWriteArraySet;

    invoke-direct {v2}, Ljava/util/concurrent/CopyOnWriteArraySet;-><init>()V

    iput-object v2, p0, Lvx1;->f:Ljava/util/concurrent/CopyOnWriteArraySet;

    new-instance v2, Ljava/lang/Object;

    invoke-direct {v2}, Ljava/lang/Object;-><init>()V

    iput-object v2, p0, Lvx1;->g:Ljava/lang/Object;

    const/4 v2, 0x0

    iput-object v2, p0, Lvx1;->h:Ljava/lang/String;

    iput-object p7, p0, Lvx1;->e:Li7c;

    check-cast p1, Ljc4;

    new-instance p7, Ljxg;

    new-instance v2, Lqta;

    new-instance v3, Lsz1;

    iget-object p1, p1, Ljc4;->a:Li7c;

    invoke-direct {v3, p1}, Lsz1;-><init>(Li7c;)V

    invoke-direct {v2, p2, v3, p1}, Lqta;-><init>(Lorg/webrtc/CameraVideoCapturer;Lsz1;Li7c;)V

    const/16 p1, 0x14

    invoke-direct {p7, p1, v2}, Ljxg;-><init>(ILjava/lang/Object;)V

    iput-object p7, p0, Lvx1;->c:Ljxg;

    iput-object p3, p0, Lvx1;->d:Lxoe;

    invoke-virtual {v0, p4}, Ljava/util/ArrayList;->addAll(Ljava/util/Collection;)Z

    invoke-virtual {v1, p5}, Ljava/util/ArrayList;->addAll(Ljava/util/Collection;)Z

    iput-boolean p6, p0, Lvx1;->i:Z
...
.method public final a()V
    ...
    :try_start_0
    iget-boolean v1, p0, Lvx1;->i:Z

    if-eqz v1, :cond_0

    iget-object v2, p0, Lvx1;->a:Ljava/util/ArrayList;
    ...
    :cond_0
    iget-object v2, p0, Lvx1;->b:Ljava/util/ArrayList;
    ...
    invoke-interface {v0, v3, v4}, Li7c;->log(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-direct {v0, v3}, Lp17;-><init>(I)V
    ...
    invoke-static {v6, v7, v8, v2, v9}, Lcx3;->o(Ljava/lang/StringBuilder;ILjava/lang/String;ILjava/lang/String;)V
    ...
    invoke-static {v7, v4, v3, v8}, Lcx3;->h(Ljava/lang/String;IILjava/lang/String;)Ljava/lang/String;

    move-result-object v4

    iget-object v7, p0, Lvx1;->e:Li7c;

    new-instance v8, Ljava/lang/IllegalArgumentException;

    invoke-direct {v8, v4}, Ljava/lang/IllegalArgumentException;-><init>(Ljava/lang/String;)V

    invoke-interface {v7, v6, v4, v8}, Li7c;->reportException(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V

    :cond_b
    iget-object v4, p0, Lvx1;->e:Li7c;

    const-string v7, "changeFormat, "

    const-string v8, "@"

    invoke-static {v7, v2, v5, v0, v8}, Lmh0;->j(Ljava/lang/String;ILjava/lang/String;ILjava/lang/String;)Ljava/lang/StringBuilder;
    ...
    invoke-interface {v4, v6, v7}, Li7c;->log(Ljava/lang/String;Ljava/lang/String;)V
    ...
    iget-object v4, p0, Lvx1;->f:Ljava/util/concurrent/CopyOnWriteArraySet;
    ...
    iget-object v8, v7, Lhu7;->r:Lvx1;

    if-eq p0, v8, :cond_d

    iget-object v8, v7, Lhu7;->n:Li7c;
    ...
    invoke-interface {v8, v10, v11, v9}, Li7c;->reportException(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V

    :cond_d
    iget-object v7, v7, Lhu7;->y:Lxuf;

    iget-object v8, v7, Lvl3;->c:Ljava/lang/Object;
    ...
    invoke-static {v10, v2, v0, v5}, Lcx3;->h(Ljava/lang/String;IILjava/lang/String;)Ljava/lang/String;

    move-result-object v10

    invoke-interface {v8, v9, v10}, Li7c;->log(Ljava/lang/String;Ljava/lang/String;)V

    iget-object v8, v7, Lxuf;->k:Lorg/webrtc/Size;
    ...
    invoke-virtual {v7}, Lxuf;->u()V

    goto :goto_6

    :cond_e
    iget-boolean v4, p0, Lvx1;->k:Z
    ...
    iget-object v4, p0, Lvx1;->c:Ljxg;

    iget-object v4, v4, Ljxg;->b:Ljava/lang/Object;

    check-cast v4, Lqta;

    invoke-virtual {v4, v2, v0, v3}, Lqta;->changeCaptureFormat(III)V
    ...
    invoke-virtual {v0, v3, v4, v5}, Lqta;->startCapture(III)V

    iput-boolean v1, p0, Lvx1;->k:Z
    :try_end_1
...
.method public final b()V
    ...
    invoke-virtual {v0}, Lqta;->stopCapture()V

    const/4 v0, 0x0

    iput-boolean v0, p0, Lvx1;->k:Z
    :try_end_0
