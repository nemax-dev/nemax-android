...
.method public synthetic constructor <init>(Ljava/lang/Object;ILjava/lang/Object;)V
    ...
    iput-object p3, p0, Lpua;->c:Ljava/lang/Object;
...
.method public final accept(Ljava/lang/Object;)V
    ...
    iget-object p0, p0, Lpua;->c:Ljava/lang/Object;

    check-cast p0, Lnud;

    check-cast p1, Lbs1;

    invoke-static {v0, p0, p1}, Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants;->d(Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants;Lnud;Lbs1;)V
    ...
    iget-object p0, p1, Lwua;->U:Lhu7;

    const/4 p1, 0x0

    invoke-virtual {p0, p1, p1}, Lhu7;->m(Ljava/lang/Float;Ljava/lang/Float;)V
    ...
    iget v0, p1, Lwua;->g0:F

    invoke-static {v0}, Ljava/lang/Float;->valueOf(F)Ljava/lang/Float;

    move-result-object v0

    iget p1, p1, Lwua;->h0:F

    invoke-static {p1}, Ljava/lang/Float;->valueOf(F)Ljava/lang/Float;

    move-result-object p1

    invoke-virtual {p0, v0, p1}, Lhu7;->m(Ljava/lang/Float;Ljava/lang/Float;)V
    ...
    invoke-virtual {v0, p0}, Lwua;->g(Ljava/util/List;)Lorg/webrtc/PeerConnection$RTCConfiguration;
    ...
    invoke-interface {p1, v2, v1}, Li7c;->log(Ljava/lang/String;Ljava/lang/String;)V

    iget-object p1, v0, Lwua;->r:Landroid/os/Handler;
    ...
    invoke-virtual {v0, p1, v1}, Lwua;->t(Lorg/webrtc/PeerConnection;Z)V

    goto :goto_1

    :cond_2
    invoke-virtual {v0, p1, v1}, Lwua;->k(Lorg/webrtc/PeerConnection;Z)V
    ...
    iget-object p1, v0, Lwua;->T:Ljava/util/ArrayList;
    ...
    iget-boolean p0, v0, Lwua;->V:Z

    if-eqz p0, :cond_7

    const/4 p0, 0x0

    iput-boolean p0, v0, Lwua;->V:Z
    ...
    invoke-virtual {p0, v1, p1, v0}, Ll7c;->log(Le4e;Ljava/lang/String;Ljava/lang/String;)V
