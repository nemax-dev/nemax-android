...
# direct methods
.method public constructor <init>(Lorg/webrtc/CameraVideoCapturer;Ld02;Lxec;)V
    .locals 0

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Li0b;->a:Lorg/webrtc/CameraVideoCapturer;

    iput-object p2, p0, Li0b;->b:Ld02;

    iput-object p3, p0, Li0b;->c:Lxec;
...
.method public final changeCaptureFormat(III)V
    ...
    iget-object p0, p0, Li0b;->a:Lorg/webrtc/CameraVideoCapturer;
...
.method public final initialize(Lorg/webrtc/SurfaceTextureHelper;Landroid/content/Context;Lorg/webrtc/CapturerObserver;)V
    ...
    iget-object v2, p0, Li0b;->c:Lxec;

    const-string v3, "PatchedVideoCapturer"

    invoke-interface {v2, v3, v1}, Lxec;->log(Ljava/lang/String;Ljava/lang/String;)V

    iget-object v1, p0, Li0b;->X:Lorg/webrtc/SurfaceTextureHelper;

    if-nez v1, :cond_0

    iput-object p1, p0, Li0b;->X:Lorg/webrtc/SurfaceTextureHelper;
    ...
    iput-object v1, p0, Li0b;->o:Lorg/webrtc/YuvConverter;
    :try_end_0
    ...
    :goto_0
    invoke-interface {v2, v3, v0, v1}, Lxec;->logException(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    invoke-direct {v0, p0, p3, v2, v1}, Lxwg;-><init>(Ljava/lang/Object;Ljava/lang/Object;ZI)V
