...
# direct methods
.method public constructor <init>(Lvl7;Lvl7;Lev0;Lvl7;Lxue;Lvl7;Lvl7;Ly95;)V
    .locals 1
    ...
    iput-object v0, p0, Le5b;->k:Ljava/util/HashMap;

    iput-object p1, p0, Le5b;->a:Lvl7;

    iput-object p2, p0, Le5b;->b:Lvl7;

    iput-object p3, p0, Le5b;->c:Lev0;

    iput-object p4, p0, Le5b;->d:Lvl7;

    iput-object p5, p0, Le5b;->e:Lxue;

    iput-object p6, p0, Le5b;->f:Lvl7;

    iput-object p7, p0, Le5b;->g:Lvl7;

    iput-object p8, p0, Le5b;->h:Ly95;
...
.method public final b(Ljava/util/List;Ljava/util/Map;Ljava/util/HashMap;)V
    ...
    iget-object v3, p0, Le5b;->f:Lvl7;

    if-lez v0, :cond_2

    iget-object v0, p0, Le5b;->d:Lvl7;
    ...
    invoke-direct {v5, v2}, Llo3;-><init>(I)V
    ...
    invoke-virtual {v0, v4}, Lxaa;->t(Ljava/util/List;)[J
    ...
    invoke-virtual {v0, p1}, Ljo3;->t(Ljava/util/List;)V
    ...
    iget-object v7, p0, Le5b;->k:Ljava/util/HashMap;
    ...
    iget-object v5, p0, Le5b;->h:Ly95;

    check-cast v5, Luha;

    invoke-virtual {v5, v4}, Luha;->c(Ljava/lang/Throwable;)V
    ...
    invoke-direct {v7, p2, v8, v4}, Lpxb;-><init>(Ljava/lang/Object;ILjava/lang/Object;)V

    invoke-virtual {v5, v7}, Lxxc;->p(Ljava/lang/Runnable;)V
    ...
    invoke-static {v1, v5, v4}, Lkug;->l(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    invoke-virtual {v1}, Lnyc;->c()Lk5b;

    move-result-object v1

    iget-object v1, v1, Lk5b;->a:Lxxc;
    ...
    invoke-virtual {v1, v4}, Lxxc;->d(Ljava/lang/String;)Lore;

    move-result-object v4

    int-to-long v7, v2

    invoke-interface {v4, v6, v7, v8}, Lmre;->k(IJ)V

    int-to-long v5, v0

    invoke-interface {v4, v2, v5, v6}, Lmre;->k(IJ)V
    ...
    invoke-interface {v4, v2}, Lmre;->Z(I)V

    goto :goto_4

    :cond_7
    invoke-interface {v4, v2, v5}, Lmre;->f(ILjava/lang/String;)V
    ...
    invoke-virtual {p1, p3}, Ljo3;->x(Ljava/util/List;)Ljava/util/Set;
    ...
    invoke-virtual {p2, p1}, Lsxe;->f(Ljava/util/Collection;)V
    ...
    iget-object p2, p0, Le5b;->c:Lev0;

    invoke-virtual {p2, p1}, Lev0;->c(Ljava/lang/Object;)V

    iget-object p1, p0, Le5b;->e:Lxue;
    ...
    invoke-direct {p2, p0, v0}, Ld5b;-><init>(Le5b;I)V

    const-wide/16 v0, 0x1

    sget-object p0, Ljava/util/concurrent/TimeUnit;->SECONDS:Ljava/util/concurrent/TimeUnit;

    invoke-virtual {p1, p2, v0, v1, p0}, Lo6d;->c(Ljava/lang/Runnable;JLjava/util/concurrent/TimeUnit;)Lvq4;
...
.method public final c()V
    ...
    iput-boolean v0, p0, Le5b;->j:Z

    iget-object v1, p0, Le5b;->e:Lxue;
    ...
    invoke-direct {v2, p0, v0}, Ld5b;-><init>(Le5b;I)V
...
.method public final d()V
    ...
    invoke-virtual {v5, v4, v7, v8}, Loyc;->k(IJ)V

    iget-object v3, v3, Lk5b;->a:Lxxc;

    invoke-virtual {v3}, Lxxc;->b()V

    invoke-virtual {v3, v5}, Lxxc;->n(Lnre;)Landroid/database/Cursor;
    ...
    invoke-static {v5}, Lqg9;->a(I)I

    move-result v30

    new-instance v17, Lq4b;

    invoke-direct/range {v17 .. v30}, Lq4b;-><init>(JJILjava/lang/String;JLjava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;I)V
    ...
    invoke-static {v6, v4}, Lb83;->P(Ljava/lang/Iterable;I)I
    ...
    invoke-static {v6}, Lnyc;->d(Lq4b;)Lp4b;
    ...
    iget-object v6, v5, Lp4b;->o:Ljava/lang/String;

    new-instance v7, Lws3;

    iget-object v8, v5, Lp4b;->Z:Ljava/lang/String;

    iget-object v5, v5, Lp4b;->r0:Ljava/lang/String;

    invoke-direct {v7, v8, v5}, Lws3;-><init>(Ljava/lang/String;Ljava/lang/String;)V
    ...
    iget-object v3, v0, Le5b;->k:Ljava/util/HashMap;
    ...
    invoke-direct {v3, v4, v5, v1, v6}, Ldq3;-><init>(JLjava/lang/Object;I)V

    invoke-static {v2, v3}, Lxaa;->u(Lxaa;Lql;)J

    move-result-wide v1

    iput-wide v1, v0, Le5b;->i:J
...
.method public onEvent(Lni0;)V
    ...
    .line 6
    iput-boolean p1, p0, Le5b;->j:Z

    :cond_0
    return-void
.end method

.method public onEvent(Lque;)V
    .locals 3
    .annotation runtime Lboe;
    .end annotation
