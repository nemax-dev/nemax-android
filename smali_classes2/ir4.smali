...
.method public constructor <init>()V
    ...
    sget-wide v0, Lir4;->i:J

    iput-wide v0, p0, Lir4;->a:J
    ...
    iput-object v2, p0, Lir4;->b:Ljava/lang/String;

    new-instance v2, Ljava/util/concurrent/locks/ReentrantLock;

    invoke-direct {v2}, Ljava/util/concurrent/locks/ReentrantLock;-><init>()V

    iput-object v2, p0, Lir4;->c:Ljava/util/concurrent/locks/ReentrantLock;

    const/4 v2, 0x1

    iput-boolean v2, p0, Lir4;->e:Z

    new-instance v2, Ljava/util/HashMap;

    invoke-direct {v2}, Ljava/util/HashMap;-><init>()V

    iput-object v2, p0, Lir4;->f:Ljava/util/HashMap;

    new-instance v2, Lr02;

    const/16 v3, 0x12

    invoke-direct {v2, v3}, Lr02;-><init>(I)V

    iput-object v2, p0, Lir4;->g:Lr02;

    new-instance v2, Ljava/util/ArrayList;

    invoke-direct {v2}, Ljava/util/ArrayList;-><init>()V

    iput-object v2, p0, Lir4;->h:Ljava/util/ArrayList;
    ...
    invoke-static {v0, v1, p0, v2}, Lbtf;->f(JLjava/lang/String;Ljava/lang/String;)Ljava/lang/String;
...
.method public final a()V
    ...
    iget-object v0, p0, Lir4;->b:Ljava/lang/String;
    ...
    iget-wide v5, p0, Lir4;->d:J

    sub-long/2addr v3, v5

    new-instance v5, Ljava/lang/StringBuilder;

    iget-wide v6, p0, Lir4;->a:J

    const-string v8, "Dns(ttl="

    const-string v9, "|elapsed="

    invoke-static {v6, v7, v8, v9}, Lmw1;->l(JLjava/lang/String;Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v6

    const-string v7, ") cache:"

    invoke-static {v6, v3, v4, v7}, Low7;->j(Ljava/lang/StringBuilder;JLjava/lang/String;)Ljava/lang/String;

    move-result-object v3

    invoke-direct {v5, v3}, Ljava/lang/StringBuilder;-><init>(Ljava/lang/String;)V

    iget-object p0, p0, Lir4;->f:Ljava/util/HashMap;
...
.method public final b()V
    ...
    iget-wide v2, p0, Lir4;->d:J

    sub-long/2addr v0, v2

    iget-wide v2, p0, Lir4;->a:J

    cmp-long v2, v0, v2

    if-lez v2, :cond_2

    iget-object v2, p0, Lir4;->f:Ljava/util/HashMap;
    ...
    iget-object v2, p0, Lir4;->b:Ljava/lang/String;
    ...
    iget-wide v5, p0, Lir4;->a:J

    const-string v7, "maybeResetIps, cache expired, elapsed="

    const-string v8, " ms, ttl="

    invoke-static {v0, v1, v7, v8}, Lmw1;->l(JLjava/lang/String;Ljava/lang/String;)Ljava/lang/StringBuilder;
    ...
    invoke-virtual {v3, v4, v2, v0, v1}, Leka;->b(Le08;Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method public final c()V
    ...
    iget-object v0, p0, Lir4;->f:Ljava/util/HashMap;
...
.method public final d(Ljava/lang/String;)Liya;
    .locals 7

    const-string v0, "could not get all ip addresses for "

    iget-object v1, p0, Lir4;->b:Ljava/lang/String;
    ...
    invoke-static {p0, p1, v4}, Lkug;->n(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method public final e(Ljava/lang/String;)Lie7;
    .locals 7
    ...
    invoke-static {p1, p0}, Le83;->R(Ljava/util/List;Ljava/util/Comparator;)V
...
.method public final f(Ljava/lang/String;[Ljava/net/InetAddress;)V
    ...
    :cond_1
    :goto_0
    iget-object v0, p0, Lir4;->h:Ljava/util/ArrayList;
    ...
    iget-object p1, p1, Lie7;->a:Ljava/net/InetAddress;
    ...
    invoke-direct {v1, p1}, Lie7;-><init>(Ljava/net/InetAddress;)V
...
.method public final g(Ljava/lang/String;[Ljava/net/InetAddress;)Lie7;
    .locals 5
    ...
    :cond_1
    :goto_0
    iget-object v0, p0, Lir4;->c:Ljava/util/concurrent/locks/ReentrantLock;
    ...
    :cond_2
    invoke-virtual {p0, p1, p2}, Lir4;->f(Ljava/lang/String;[Ljava/net/InetAddress;)V
    ...
    invoke-virtual {p0, p1}, Lir4;->e(Ljava/lang/String;)Lie7;
