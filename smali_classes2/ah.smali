...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object p1, p0, Lah;->b:Landroid/content/res/Resources;
...
.method public final a(Landroid/content/res/XmlResourceParser;Landroid/animation/AnimatorSet;I)Landroid/animation/Animator;
    ...
    invoke-static {v1}, Lyu0;->b(Landroid/content/res/XmlResourceParser;)Ljava/util/LinkedHashMap;
    ...
    invoke-static {v7}, Ldee;->f0(Ljava/lang/String;)Ljava/lang/Integer;
    ...
    :cond_4
    invoke-virtual {v0, v1, v3, v9}, Lah;->a(Landroid/content/res/XmlResourceParser;Landroid/animation/AnimatorSet;I)Landroid/animation/Animator;
    ...
    invoke-virtual {v0, v3, v1}, Lah;->b(Landroid/animation/ValueAnimator;Landroid/content/res/XmlResourceParser;)V
    ...
    invoke-virtual {v0, v7, v3}, Lah;->b(Landroid/animation/ValueAnimator;Landroid/content/res/XmlResourceParser;)V

    sget-object v11, Lqg;->Y:Lqg;

    iget-object v12, v0, Lah;->a:Landroid/content/Context;

    invoke-virtual {v11, v12, v3}, Lxoe;->A(Landroid/content/Context;Landroid/content/res/XmlResourceParser;)Ljava/lang/Object;
    ...
    sget-object v13, Lqg;->n0:Lqg;

    invoke-virtual {v13, v12, v3}, Lxoe;->A(Landroid/content/Context;Landroid/content/res/XmlResourceParser;)Ljava/lang/Object;

    move-result-object v13

    check-cast v13, Ljava/lang/String;

    sget-object v14, Lqg;->o0:Lqg;

    invoke-virtual {v14, v12, v3}, Lxoe;->A(Landroid/content/Context;Landroid/content/res/XmlResourceParser;)Ljava/lang/Object;

    move-result-object v14

    check-cast v14, Ljava/lang/String;

    sget-object v15, Lqg;->s0:Lqg;

    invoke-virtual {v15, v12, v3}, Lxoe;->A(Landroid/content/Context;Landroid/content/res/XmlResourceParser;)Ljava/lang/Object;

    move-result-object v3

    check-cast v3, Lgh;

    instance-of v12, v3, Leh;

    if-nez v12, :cond_6

    instance-of v3, v3, Lfh;
    ...
    :cond_8
    :goto_3
    invoke-static {v11}, Lis8;->o(Ljava/lang/String;)Landroid/graphics/Path;
    ...
    invoke-virtual {v0, v12, v3}, Lxoe;->A(Landroid/content/Context;Landroid/content/res/XmlResourceParser;)Ljava/lang/Object;
...
.method public final b(Landroid/animation/ValueAnimator;Landroid/content/res/XmlResourceParser;)V
    ...
    sget-object v0, Lrg;->o:Lrg;

    iget-object p0, p0, Lah;->a:Landroid/content/Context;

    invoke-virtual {v0, p0, p2}, Lxoe;->A(Landroid/content/Context;Landroid/content/res/XmlResourceParser;)Ljava/lang/Object;
    ...
    sget-object v1, Ltg;->o:Ltg;

    invoke-virtual {v1, p0, p2}, Lxoe;->A(Landroid/content/Context;Landroid/content/res/XmlResourceParser;)Ljava/lang/Object;

    move-result-object v1

    check-cast v1, Lgh;

    sget-object v2, Ltg;->X:Ltg;

    invoke-virtual {v2, p0, p2}, Lxoe;->A(Landroid/content/Context;Landroid/content/res/XmlResourceParser;)Ljava/lang/Object;

    move-result-object v2

    check-cast v2, Lgh;

    sget-object v3, Lqg;->s0:Lqg;

    invoke-virtual {v3, p0, p2}, Lxoe;->A(Landroid/content/Context;Landroid/content/res/XmlResourceParser;)Ljava/lang/Object;

    move-result-object p0

    check-cast p0, Lgh;

    instance-of p2, v1, Lbh;
    ...
    :cond_0
    instance-of p2, p0, Lfh;

    if-eqz p2, :cond_2

    new-instance p0, Lch;

    invoke-direct {p0, v4}, Lch;-><init>(F)V
    ...
    invoke-direct {p0, v3}, Lbh;-><init>(I)V

    :cond_2
    :goto_1
    instance-of p2, p0, Lch;

    instance-of v5, p0, Leh;

    const/4 v6, 0x0

    if-eqz v5, :cond_11

    instance-of p0, v1, Leh;
    ...
    iget-object p2, p2, Leh;->a:Ljava/lang/String;
    ...
    :cond_4
    invoke-static {p2}, Lis8;->n(Ljava/lang/String;)[Laua;
    ...
    :cond_7
    invoke-static {v4}, Lis8;->n(Ljava/lang/String;)[Laua;
    ...
    invoke-static {p2, v4}, Lis8;->c([Laua;[Laua;)Z
    ...
    iget-object p0, v1, Leh;->a:Ljava/lang/String;
    ...
    iget-object v6, v2, Leh;->a:Ljava/lang/String;
    ...
    invoke-static {p2, p0, v0, v6}, Ldl5;->j(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
