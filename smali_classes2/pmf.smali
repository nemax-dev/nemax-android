...
.field public final u:Lhtb;

.field public final v:Z

.field public final w:Lm;
...
# direct methods
.method public constructor <init>(Landroid/content/Context;Lo75;Ljava/lang/String;Ljava/lang/String;FFLhtb;ZLm;)V
    .locals 1
    ...
    iput-boolean v0, p0, Lpmf;->j:Z

    iput-boolean v0, p0, Lpmf;->k:Z

    iput-boolean v0, p0, Lpmf;->l:Z

    iput-boolean v0, p0, Lpmf;->m:Z

    iput-boolean v0, p0, Lpmf;->n:Z

    iput-object p1, p0, Lpmf;->o:Landroid/content/Context;

    iput-object p2, p0, Lpmf;->p:Lo75;

    iput-object p3, p0, Lpmf;->q:Ljava/lang/String;

    iput-object p4, p0, Lpmf;->r:Ljava/lang/String;

    iput p5, p0, Lpmf;->s:F

    iput p6, p0, Lpmf;->t:F

    iput-object p7, p0, Lpmf;->u:Lhtb;

    iput-boolean p8, p0, Lpmf;->v:Z

    iput-object p9, p0, Lpmf;->w:Lm;

    return-void
.end method

.method public static a(Landroid/content/Context;Lo75;Ljava/lang/String;Ljava/lang/String;FFLhtb;ZLm;)Z
    .locals 13
    ...
    invoke-direct/range {v1 .. v10}, Lpmf;-><init>(Landroid/content/Context;Lo75;Ljava/lang/String;Ljava/lang/String;FFLhtb;ZLm;)V
    ...
    invoke-static {p1, p2, p0}, Lz76;->m(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    :cond_1
    iget-object p0, v1, Lpmf;->b:Landroid/media/MediaExtractor;
    ...
    invoke-virtual {p0}, Lame;->x()V

    :cond_4
    iget-object p0, v1, Lpmf;->g:Lhqa;

    if-eqz p0, :cond_23

    iget-object p1, p0, Lhqa;->b:Landroid/view/Surface;
    ...
    iget-object v0, v1, Lpmf;->b:Landroid/media/MediaExtractor;
    ...
    iget-boolean v6, v1, Lpmf;->n:Z

    if-eqz v6, :cond_8

    iget-boolean v6, v1, Lpmf;->m:Z
    ...
    iget-object v0, v1, Lpmf;->f:Lkd;

    iget-object v2, v1, Lpmf;->b:Landroid/media/MediaExtractor;
    ...
    iget-wide v5, v1, Lpmf;->x:J

    cmp-long v0, v3, v5

    if-lez v0, :cond_e

    iget-object v0, v1, Lpmf;->a:Ljava/nio/ByteBuffer;
    ...
    iget-object v3, v1, Lpmf;->b:Landroid/media/MediaExtractor;

    iget-object v4, v1, Lpmf;->a:Ljava/nio/ByteBuffer;
    ...
    iget-object v3, v1, Lpmf;->c:Lml9;

    iget-object v4, v1, Lpmf;->a:Ljava/nio/ByteBuffer;

    iget-object v5, v3, Lml9;->f:Ljava/lang/Object;

    check-cast v5, Landroid/media/MediaMuxer;

    invoke-virtual {v3}, Lml9;->b()Z

    move-result v6

    if-eqz v6, :cond_c

    iget-boolean v6, v3, Lml9;->c:Z

    if-nez v6, :cond_b

    invoke-virtual {v5}, Landroid/media/MediaMuxer;->start()V

    iput-boolean v2, v3, Lml9;->c:Z

    :cond_b
    invoke-virtual {v3}, Lml9;->a()V
    ...
    :cond_c
    iget-object v5, v3, Lml9;->g:Ljava/lang/Object;
    ...
    invoke-direct {v6, v3, v4, v0}, Lll9;-><init>(ILjava/nio/ByteBuffer;Landroid/media/MediaCodec$BufferInfo;)V
    ...
    :cond_13
    :goto_5
    iget-boolean v0, v1, Lpmf;->k:Z

    if-nez v0, :cond_14

    iget-object v0, v1, Lpmf;->f:Lkd;

    invoke-virtual {v0}, Lkd;->m()V
    ...
    iget-object v0, v1, Lpmf;->h:Llwg;

    invoke-virtual {v0}, Llwg;->h()V
    :try_end_1
    ...
    iget-object p2, p0, Lhqa;->b:Landroid/view/Surface;
    ...
    :cond_1c
    invoke-static {p1, v3, p0}, Lz76;->p(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    invoke-static {p1, p0, v0}, Lz76;->p(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V

    iget-object p0, v1, Lpmf;->p:Lo75;
    ...
    :cond_26
    iget-object p1, v1, Lpmf;->b:Landroid/media/MediaExtractor;
    ...
    :cond_27
    iget-object p1, v1, Lpmf;->c:Lml9;

    if-eqz p1, :cond_28

    iget-object p1, p1, Lml9;->f:Ljava/lang/Object;
    ...
    :cond_28
    iget-object p1, v1, Lpmf;->i:Lame;

    if-eqz p1, :cond_29

    iget-object p2, p1, Lame;->X:Ljava/lang/Object;

    check-cast p2, Landroid/view/Surface;

    if-eqz p2, :cond_29

    invoke-virtual {p1}, Lame;->x()V

    :cond_29
    iget-object p1, v1, Lpmf;->g:Lhqa;

    if-eqz p1, :cond_2a

    iget-object p2, p1, Lhqa;->b:Landroid/view/Surface;

    if-eqz p2, :cond_2a

    invoke-virtual {p1}, Lhqa;->a()V
...
.method public final b()Z
    ...
    iput-object v0, v5, Lpmf;->a:Ljava/nio/ByteBuffer;

    new-instance v0, Landroid/media/MediaExtractor;

    invoke-direct {v0}, Landroid/media/MediaExtractor;-><init>()V

    iput-object v0, v5, Lpmf;->b:Landroid/media/MediaExtractor;

    iget-object v1, v5, Lpmf;->q:Ljava/lang/String;

    invoke-static {v1}, Landroid/net/Uri;->parse(Ljava/lang/String;)Landroid/net/Uri;

    move-result-object v1

    iget-object v2, v5, Lpmf;->o:Landroid/content/Context;
    ...
    iget-object v1, v5, Lpmf;->r:Ljava/lang/String;
    ...
    iput-boolean v7, v0, Lml9;->d:Z

    iput-boolean v7, v0, Lml9;->e:Z

    new-instance v2, Ljava/util/ArrayList;

    invoke-direct {v2}, Ljava/util/ArrayList;-><init>()V

    iput-object v2, v0, Lml9;->g:Ljava/lang/Object;

    new-instance v2, Landroid/media/MediaMuxer;

    invoke-direct {v2, v1, v7}, Landroid/media/MediaMuxer;-><init>(Ljava/lang/String;I)V

    iput-object v2, v0, Lml9;->f:Ljava/lang/Object;

    iput-object v0, v5, Lpmf;->c:Lml9;

    iget-object v0, v5, Lpmf;->b:Landroid/media/MediaExtractor;
    ...
    invoke-static {v0, v13}, Lz76;->n(Ljava/lang/String;Ljava/lang/String;)V
    ...
    iput-wide v0, v5, Lpmf;->y:J

    iget-object v0, v5, Lpmf;->u:Lhtb;
    ...
    invoke-direct/range {v0 .. v5}, Llwg;-><init>(IIIILpmf;)V

    iput-object v0, v5, Lpmf;->h:Llwg;
    ...
    invoke-direct {v1, v2, v7}, Lame;-><init>(IZ)V

    sget-object v2, Landroid/opengl/EGL14;->EGL_NO_DISPLAY:Landroid/opengl/EGLDisplay;

    iput-object v2, v1, Lame;->b:Ljava/lang/Object;

    sget-object v2, Landroid/opengl/EGL14;->EGL_NO_CONTEXT:Landroid/opengl/EGLContext;

    iput-object v2, v1, Lame;->c:Ljava/lang/Object;

    sget-object v2, Landroid/opengl/EGL14;->EGL_NO_SURFACE:Landroid/opengl/EGLSurface;

    iput-object v2, v1, Lame;->o:Ljava/lang/Object;

    invoke-virtual {v0}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    iput-object v0, v1, Lame;->X:Ljava/lang/Object;

    invoke-static {v7}, Landroid/opengl/EGL14;->eglGetDisplay(I)Landroid/opengl/EGLDisplay;

    move-result-object v0

    iput-object v0, v1, Lame;->b:Ljava/lang/Object;
    ...
    iget-object v14, v1, Lame;->b:Ljava/lang/Object;
    ...
    iget-object v2, v1, Lame;->b:Ljava/lang/Object;
    ...
    iput-object v0, v1, Lame;->c:Ljava/lang/Object;

    const-string v0, "eglCreateContext"

    invoke-static {v0}, Lame;->s(Ljava/lang/String;)V

    iget-object v0, v1, Lame;->c:Ljava/lang/Object;
    ...
    iget-object v4, v1, Lame;->X:Ljava/lang/Object;
    ...
    iput-object v0, v1, Lame;->o:Ljava/lang/Object;

    const-string v0, "eglCreateWindowSurface"

    invoke-static {v0}, Lame;->s(Ljava/lang/String;)V

    iget-object v0, v1, Lame;->o:Ljava/lang/Object;

    check-cast v0, Landroid/opengl/EGLSurface;

    if-eqz v0, :cond_3

    iput-object v1, v5, Lpmf;->i:Lame;

    iget-object v2, v1, Lame;->b:Ljava/lang/Object;

    check-cast v2, Landroid/opengl/EGLDisplay;

    iget-object v1, v1, Lame;->c:Ljava/lang/Object;
    ...
    iput-object v0, v5, Lpmf;->g:Lhqa;

    new-instance v0, Lkd;

    iget-object v1, v5, Lpmf;->g:Lhqa;

    invoke-direct {v0, v13, v12, v1, v5}, Lkd;-><init>(Ljava/lang/String;Landroid/media/MediaFormat;Lhqa;Lpmf;)V

    iput-object v0, v5, Lpmf;->f:Lkd;

    iget-object v0, v5, Lpmf;->c:Lml9;

    iput-boolean v11, v0, Lml9;->d:Z
    ...
    :cond_6
    iput-object v6, v1, Lame;->b:Ljava/lang/Object;
    ...
    iput v10, v5, Lpmf;->e:I

    iget-boolean v0, v5, Lpmf;->v:Z
