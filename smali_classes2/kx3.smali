...
.method public constructor <init>(Lone/me/sdk/contextmenu/popup/ContextMenuPopupWindow;Landroid/view/LayoutInflater;Landroid/content/Context;)V
    ...
    iput-object v1, v0, Lkx3;->a:Lone/me/sdk/contextmenu/popup/ContextMenuPopupWindow;
    ...
    invoke-direct {v3, v4, v1}, Lf5;-><init>(ILjava/lang/Object;)V

    invoke-static {v0, v3}, Lo58;->M(Landroid/view/View;Landroid/view/View$OnClickListener;)V

    sget-object v3, Lone/me/sdk/contextmenu/popup/ContextMenuPopupWindow;->u0:[Lqj7;
    ...
    invoke-virtual {v1}, Lone/me/sdk/contextmenu/popup/ContextMenuPopupWindow;->z0()Z

    move-result v5

    invoke-direct {v3, v4, v5}, Lfgb;-><init>(Landroid/content/Context;Z)V
    ...
    invoke-static {v4}, Lkug;->c(Landroid/os/Bundle;)Ljava/util/List;
    ...
    iget-object v8, v8, Lbx3;->d:Ljava/lang/Integer;
    ...
    const-class v10, Lr3f;

    invoke-static {v4, v8, v10}, Lw5h;->o(Landroid/os/Bundle;Ljava/lang/String;Ljava/lang/Class;)Ljava/lang/Object;
    ...
    invoke-direct {v12, v4, v1, v11}, Ljx3;-><init>(Lr3f;Lone/me/sdk/contextmenu/popup/ContextMenuPopupWindow;Landroid/content/Context;)V
    ...
    invoke-direct {v10, v7, v11}, Legb;-><init>(Landroid/content/Context;Z)V

    iget-object v12, v5, Lbx3;->b:Lr3f;

    iget-object v7, v5, Lbx3;->d:Ljava/lang/Integer;

    iget-object v13, v5, Lbx3;->c:Ljava/lang/Integer;
    ...
    invoke-virtual/range {v10 .. v15}, Legb;->c(Legb;Lr3f;Ljava/lang/Integer;ZZ)V

    iget-object v11, v5, Lbx3;->e:Ljava/lang/Integer;

    invoke-virtual {v10, v7, v11}, Legb;->b(Ljava/lang/Integer;Ljava/lang/Integer;)V

    new-instance v7, Lpb;

    const/16 v11, 0x19

    invoke-direct {v7, v1, v11, v5}, Lpb;-><init>(Ljava/lang/Object;ILjava/lang/Object;)V

    invoke-static {v10, v7}, Lo58;->M(Landroid/view/View;Landroid/view/View$OnClickListener;)V
    ...
    invoke-static {v1}, Lone/me/sdk/contextmenu/popup/ContextMenuPopupWindow;->y0(Lone/me/sdk/contextmenu/popup/ContextMenuPopupWindow;)Lvra;

    move-result-object v1

    invoke-virtual {v0, v1}, Lkx3;->onThemeChanged(Lvra;)V
...
.method public final onThemeChanged(Lvra;)V
    ...
    iget-object p1, p0, Lkx3;->a:Lone/me/sdk/contextmenu/popup/ContextMenuPopupWindow;

    invoke-virtual {p1}, Ley3;->getArgs()Landroid/os/Bundle;
