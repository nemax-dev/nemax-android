...
.method public constructor <init>(Lpld;)V
    ...
    iget-object v0, p1, Lpld;->g:Lxy7;

    iput-object v0, p0, Lqld;->t0:Lxy7;

    iget v1, p1, Lpld;->h:F

    iput v1, p0, Lqld;->u0:F

    iget-wide v1, p1, Lpld;->i:J

    iput-wide v1, p0, Lqld;->w0:J
    ...
    invoke-virtual {v0}, Lxy7;->a()Z

    move-result v0

    if-eqz v0, :cond_1

    iget-object p1, p1, Lpld;->g:Lxy7;

    iget-wide v0, p1, Lxy7;->a:D
...
.method public final x()Lj09;
    ...
    iget-object v8, p0, Lqld;->t0:Lxy7;

    iput-object v8, v7, Ln00;->a:Lxy7;

    iget v8, p0, Lqld;->u0:F
    ...
    invoke-virtual {v1}, Lpn4;->a()Ljava/lang/String;
...
.method public final y(Lu72;J)J
    ...
    :goto_1
    invoke-direct/range {v2 .. v7}, Ljld;-><init>(JJZ)V

    invoke-virtual {p1, v2}, Ltxg;->b(Lukd;)J
