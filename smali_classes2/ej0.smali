...
.method private final a(Ljava/lang/Object;)V
    ...
    invoke-virtual {p1, v6, v1}, Lm2c;->a(Ljava/lang/Class;Z)Z
    ...
    invoke-virtual {p1, v1, v6}, Lm2c;->a(Ljava/lang/Class;Z)Z
    ...
    invoke-virtual {p1, v6, v5}, Lm2c;->a(Ljava/lang/Class;Z)Z
    ...
    invoke-virtual {p1, v7, v6}, Lm2c;->a(Ljava/lang/Class;Z)Z
    ...
    invoke-virtual {p1, v9, v6}, Lm2c;->a(Ljava/lang/Class;Z)Z
    ...
    invoke-virtual {p1, v9, v3}, Lm2c;->a(Ljava/lang/Class;Z)Z
    ...
    invoke-virtual {p1, v8, v3}, Lm2c;->a(Ljava/lang/Class;Z)Z
    ...
    invoke-virtual {p1, v6, v3}, Lm2c;->a(Ljava/lang/Class;Z)Z
    ...
    invoke-virtual {p1, v3, v5}, Lm2c;->a(Ljava/lang/Class;Z)Z
    ...
    invoke-virtual {p1, v10, v6}, Lm2c;->a(Ljava/lang/Class;Z)Z
    ...
    invoke-virtual {p1, v3, v2}, Lm2c;->a(Ljava/lang/Class;Z)Z
    ...
    invoke-virtual {p1, v1, v4}, Lm2c;->a(Ljava/lang/Class;Z)Z
    ...
    :cond_2d
    invoke-direct {p0, v0}, Lmhd;-><init>(Ljava/util/List;)V

    sput-object p0, Lyn4;->a:Lmhd;

    sget-object p0, Lyn4;->a:Lmhd;
...
.method public final accept(Ljava/lang/Object;)V
    ...
    invoke-virtual {v1}, Lox7;->d()Z

    move-result v1

    if-nez v1, :cond_a

    iget-object v1, v0, Llq9;->u0:Lyc;

    const-string v2, "LOCAL_MEDIA_CROP"

    invoke-virtual {v1, v2}, Lyc;->f(Ljava/lang/String;)V

    iget-object v1, v0, Llq9;->w0:Lvn5;

    const-string v2, "jpg"

    invoke-interface {v1, v2}, Lvn5;->a(Ljava/lang/String;)Ljava/io/File;

    move-result-object v1

    iget-object v2, v0, Llq9;->X:Lox7;

    invoke-virtual {v2}, Lox7;->a()Ljava/lang/String;

    move-result-object v2

    iget-object v3, v0, Llq9;->t0:Ls5b;

    if-eqz v3, :cond_0

    iget-object v4, v3, Ls5b;->b:Landroid/net/Uri;
    ...
    iget-object v3, v3, Ls5b;->a:Landroid/net/Uri;
    ...
    invoke-static {v8, v3}, Lkug;->m(Ljava/lang/String;Ljava/lang/String;)V

    iget-object v3, v0, Llq9;->t0:Ls5b;

    if-eqz v3, :cond_8

    iget-object v9, v3, Ls5b;->X:Landroid/net/Uri;
    ...
    iget-object v3, v0, Llq9;->x0:Lgzc;
    ...
    invoke-direct {v2, v0, v3, v1}, Lwp8;-><init>(Ljava/lang/Object;ILjava/lang/Object;)V

    new-instance v1, Lhq9;

    invoke-direct {v1, v0, v11}, Lhq9;-><init>(Llq9;I)V

    new-instance v0, Lms1;

    invoke-direct {v0, v2, v10, v1}, Lms1;-><init>(Ljava/lang/Object;ILjava/lang/Object;)V

    :try_start_0
    new-instance v1, Li3e;

    invoke-direct {v1, v0}, Li3e;-><init>(Ly3e;)V

    invoke-interface {v0, v1}, Ly3e;->c(Lvq4;)V
    :try_end_0
    .catch Ljava/lang/NullPointerException; {:try_start_0 .. :try_end_0} :catch_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_1

    :try_start_1
    invoke-interface {v4, v1}, La4e;->g(Li3e;)V
    :try_end_1
    ...
    invoke-virtual {v0, v2, v1, v5}, Lru/ok/messages/media/mediabar/ActLocalMedias;->g0(Landroid/net/Uri;Ljava/io/File;Lb34;)V
    ...
    iget-object v1, v0, Llq9;->y0:Ly95;

    const-string v2, "onQualityButtonClicked"

    invoke-static {v8, v2}, Lkug;->m(Ljava/lang/String;Ljava/lang/String;)V
    ...
    :cond_c
    iget-object v2, v0, Llq9;->o:Ljy7;

    iget-boolean v2, v2, Ljy7;->a:Z
    ...
    :cond_d
    iget-object v2, v0, Llq9;->B0:Lms1;
    ...
    :cond_e
    iget-object v2, v0, Llq9;->s0:Lwwf;
    ...
    :cond_f
    iget-object v2, v0, Llq9;->Z:Ljava/util/ArrayList;
    ...
    iget-object v14, v4, Ly0c;->a:Lw0c;

    iget v15, v4, Ly0c;->b:I

    iget v5, v4, Ly0c;->c:I

    iget v6, v4, Ly0c;->d:I

    iget-wide v7, v4, Ly0c;->e:J
    ...
    invoke-direct/range {v13 .. v20}, Ly0c;-><init>(Lw0c;IIIJZ)V
    ...
    :cond_11
    iget-object v2, v0, Llq9;->c:Lru/ok/messages/media/mediabar/ActLocalMedias;

    iget-object v0, v0, Llq9;->s0:Lwwf;

    iget-object v0, v0, Lwwf;->a:Lw0c;

    invoke-static {v1, v0, v12}, Lru/ok/messages/views/dialogs/VideoQualityPickerDialog;->b1(Ljava/util/ArrayList;Lw0c;Z)Lru/ok/messages/views/dialogs/VideoQualityPickerDialog;

    move-result-object v0

    invoke-virtual {v2}, Landroidx/fragment/app/b;->C()Lt86;
    ...
    invoke-virtual {v1}, Landroidx/fragment/app/a;->a0()Lso7;
    ...
    invoke-direct {v2, v12}, Le3h;-><init>(I)V

    new-instance v4, Lq2d;

    const/16 v5, 0x16

    invoke-direct {v4, v2, v5, v3}, Lq2d;-><init>(Ljava/lang/Object;ILjava/lang/Object;)V

    const-string v2, "VideoQualityPickerDialog:result:request"

    invoke-virtual {v0, v2, v1, v4}, Landroidx/fragment/app/c;->e0(Ljava/lang/String;Lso7;Lw86;)V
    ...
    :catch_1
    iput-object v9, v1, Libb;->D0:Lcq9;
    ...
    invoke-virtual {v0, v4, v3}, Lm2c;->a(Ljava/lang/Class;Z)Z
    ...
    invoke-virtual {v0, v3, v11}, Lm2c;->a(Ljava/lang/Class;Z)Z
    ...
    :cond_18
    invoke-direct {v1, v2}, Lmhd;-><init>(Ljava/util/List;)V

    sput-object v1, Lxn4;->a:Lmhd;

    sget-object v0, Lxn4;->a:Lmhd;

    invoke-static {v0}, Lmhd;->u(Lmhd;)V
    ...
    invoke-virtual {v0, v6, v11}, Lm2c;->a(Ljava/lang/Class;Z)Z
    ...
    invoke-virtual {v0, v11, v8}, Lm2c;->a(Ljava/lang/Class;Z)Z
    ...
    invoke-virtual {v0, v8, v11}, Lm2c;->a(Ljava/lang/Class;Z)Z
    ...
    invoke-virtual {v0, v11, v4}, Lm2c;->a(Ljava/lang/Class;Z)Z
    ...
    invoke-virtual {v0, v12, v2}, Lm2c;->a(Ljava/lang/Class;Z)Z
    ...
    invoke-virtual {v0, v9, v2}, Lm2c;->a(Ljava/lang/Class;Z)Z
    ...
    invoke-virtual {v0, v2, v3}, Lm2c;->a(Ljava/lang/Class;Z)Z
    ...
    invoke-virtual {v0, v8, v2}, Lm2c;->a(Ljava/lang/Class;Z)Z
    ...
    invoke-virtual {v0, v2, v11}, Lm2c;->a(Ljava/lang/Class;Z)Z
    ...
    :cond_55
    invoke-direct {v1, v5}, Lmhd;-><init>(Ljava/util/List;)V

    sput-object v1, Lwn4;->a:Lmhd;

    sget-object v0, Lwn4;->a:Lmhd;
    ...
    invoke-virtual {v0, v7, v6}, Lm2c;->a(Ljava/lang/Class;Z)Z
    ...
    invoke-virtual {v0, v6, v7}, Lm2c;->a(Ljava/lang/Class;Z)Z
    ...
    invoke-virtual {v0, v9, v7}, Lm2c;->a(Ljava/lang/Class;Z)Z
    ...
    :cond_62
    invoke-direct {v1, v4}, Lmhd;-><init>(Ljava/util/List;)V

    sput-object v1, Lvn4;->a:Lmhd;
    ...
    iget-object v0, v0, Lsq9;->A0:Lru/ok/messages/location/FrgLocationMap;
    ...
    :cond_63
    invoke-virtual {v1}, Lyd3;->onBackPressed()V
    ...
    invoke-virtual {v0, v5}, Lsq9;->X0(I)V
    ...
    invoke-virtual {v0, v7}, Lsq9;->X0(I)V
    ...
    invoke-virtual {v0, v10}, Lsq9;->X0(I)V
    ...
    :cond_64
    iget-object v3, v0, Lsq9;->c:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    iget-object v2, v0, Lsq9;->A0:Lru/ok/messages/location/FrgLocationMap;
    ...
    iget-object v1, v0, Lsq9;->A0:Lru/ok/messages/location/FrgLocationMap;
    ...
    :cond_67
    iget-object v3, v0, Lsq9;->B0:Lbz7;

    iget-wide v3, v3, Lbz7;->o:J

    cmp-long v3, v3, v6

    if-eqz v3, :cond_69

    iget-object v3, v0, Lsq9;->o:Ljava/util/concurrent/ConcurrentHashMap;

    iget-wide v4, v2, Lp78;->c:J
    ...
    iget-wide v5, v4, Lp78;->j:J

    iget-object v7, v0, Lsq9;->B0:Lbz7;

    iget-wide v7, v7, Lbz7;->o:J

    cmp-long v5, v5, v7

    if-nez v5, :cond_68

    invoke-virtual {v1, v4}, Lru/ok/messages/location/FrgLocationMap;->e1(Lp78;)V

    goto :goto_26

    :cond_69
    invoke-virtual {v1, v2}, Lru/ok/messages/location/FrgLocationMap;->e1(Lp78;)V
    ...
    iget-object v1, v0, Lsq9;->C0:Lxy7;
    ...
    :cond_6c
    iget-object v1, v0, Lsq9;->c:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    iget-object v3, v3, Lbz7;->e:Laz7;

    iget-object v4, v2, Lru/ok/messages/location/FrgLocationMap;->F1:Lbz7;
    ...
    iget-object v4, v2, Lru/ok/messages/views/fragments/base/FrgBase;->p1:Lbbd;
    ...
    invoke-virtual {v4, v7, v5}, Lyc;->g(Ljava/lang/String;Ljava/lang/String;)V

    iget-wide v4, v2, Lru/ok/messages/location/FrgLocationMap;->G1:J

    new-instance v6, Lpld;

    invoke-direct {v6, v4, v5}, Ltld;-><init>(J)V

    iput-object v1, v6, Lpld;->g:Lxy7;

    iget-wide v3, v3, Laz7;->b:J

    iput-wide v3, v6, Lpld;->i:J
    ...
    invoke-direct {v1, v6}, Lqld;-><init>(Lpld;)V
    ...
    invoke-virtual {v3, v1}, Ltxg;->a(Lukd;)V
    ...
    invoke-static {v1, v2}, Ll54;->F(Landroid/content/Context;I)V
    ...
    invoke-virtual {v4, v7, v8}, Lyc;->g(Ljava/lang/String;Ljava/lang/String;)V

    invoke-virtual {v2}, Lru/ok/messages/views/fragments/base/FrgBase;->U0()Ls5;
    ...
    invoke-virtual {v2}, Ls5;->finish()V
    ...
    invoke-virtual {v0, v9}, Lsq9;->e1(Loq9;)V
    ...
    :cond_70
    iget-object v4, v0, Lsq9;->D0:Lp78;

    iget-object v4, v4, Lp78;->a:Lxy7;
    ...
    invoke-virtual {v1}, Lrr9;->E()[D

    move-result-object v1

    iget-object v4, v0, Lsq9;->D0:Lp78;

    invoke-virtual {v4}, Lp78;->a()Lo78;
    ...
    invoke-direct {v9, v10, v11, v12, v13}, Lxy7;-><init>(DD)V

    iput-object v9, v4, Lo78;->a:Lxy7;

    new-instance v1, Lp78;

    invoke-direct {v1, v4}, Lp78;-><init>(Lo78;)V

    iput-object v1, v0, Lsq9;->D0:Lp78;

    :cond_71
    iget-object v0, v0, Lsq9;->D0:Lp78;

    iget-object v0, v0, Lp78;->a:Lxy7;
    ...
    :cond_72
    iget-object v4, v2, Lru/ok/messages/location/FrgLocationMap;->A1:Ld96;
    ...
    iget-object v0, v2, Lru/ok/messages/location/FrgLocationMap;->A1:Ld96;

    iget v1, v2, Lru/ok/messages/location/FrgLocationMap;->H1:I

    invoke-interface {v0, v1, v5, v4}, Ld96;->a0(IILandroid/content/Intent;)V

    invoke-virtual {v3}, Ls5;->onBackPressed()V

    goto :goto_28

    :cond_73
    iget-object v4, v2, Lru/ok/messages/location/FrgLocationMap;->B1:Lsq9;

    iget-object v9, v4, Lsq9;->B0:Lbz7;
    ...
    invoke-virtual {v9}, Lrr9;->F()Ly58;

    iget-object v4, v4, Lsq9;->C0:Lxy7;

    iget-object v9, v2, Lru/ok/messages/location/FrgLocationMap;->D1:Lcye;

    iget-wide v10, v0, Lxy7;->a:D

    iget-wide v12, v0, Lxy7;->b:D

    iget-wide v14, v4, Lxy7;->a:D

    iget-wide v7, v4, Lxy7;->b:D

    move-wide/from16 v16, v7

    invoke-interface/range {v9 .. v17}, Lcye;->c(DDDD)Z
    ...
    invoke-virtual {v4, v7}, Lyc;->f(Ljava/lang/String;)V
    ...
    invoke-virtual {v3}, Ls5;->finish()V
    ...
    iget-object v2, v0, Lsq9;->x0:Lvxc;

    invoke-virtual {v2}, Lvxc;->v()V
    ...
    :goto_29
    iput-boolean v11, v0, Lsq9;->E0:Z

    iget-object v12, v0, Lsq9;->Z:Lcye;

    iget-object v2, v0, Lsq9;->D0:Lp78;

    iget-object v2, v2, Lp78;->a:Lxy7;

    iget-wide v13, v2, Lxy7;->a:D

    iget-wide v2, v2, Lxy7;->b:D

    iget-object v4, v0, Lsq9;->C0:Lxy7;

    iget-wide v5, v4, Lxy7;->a:D
    ...
    invoke-interface/range {v12 .. v20}, Lcye;->c(DDDD)Z
    ...
    iput-object v3, v0, Lsq9;->D0:Lp78;
    ...
    iget-object v0, v0, Lsq9;->C0:Lxy7;

    iget-wide v4, v0, Lxy7;->a:D

    iget-wide v6, v0, Lxy7;->b:D
    ...
    invoke-direct {v3, v4, v5, v6, v7}, Lxy7;-><init>(DD)V
