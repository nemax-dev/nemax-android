...
.method public synthetic constructor <init>(Lru/ok/tamtam/upload/workers/UploadDraftMediaWorker;I)V
    ...
    iput-object p1, p0, Lxef;->b:Lru/ok/tamtam/upload/workers/UploadDraftMediaWorker;
...
.method public final invoke()Ljava/lang/Object;
    ...
    iget-object p0, p0, Lxef;->b:Lru/ok/tamtam/upload/workers/UploadDraftMediaWorker;
    ...
    invoke-virtual {p0, v0, v2, v3}, Lz54;->d(Ljava/lang/String;J)J
    ...
    :cond_0
    invoke-direct {v1, v4, v5, v0}, Lns4;-><init>(JLjava/lang/String;)V
    ...
    invoke-virtual {p0, v4, v2, v3}, Lz54;->d(Ljava/lang/String;J)J
    ...
    :cond_2
    invoke-static {v2}, Llge;->E(Ljava/lang/String;)I

    move-result v5

    iget-object v2, p0, Lz54;->a:Ljava/util/HashMap;
    ...
    invoke-direct {v2, v7}, Lv10;-><init>(I)V

    const-string v7, "draft.videoConvertOptions.mute"

    const/4 v8, 0x0

    invoke-virtual {p0, v7, v8}, Lz54;->b(Ljava/lang/String;Z)Z

    move-result v7

    iput-boolean v7, v2, Lv10;->d:Z

    const-string v7, "draft.videoConvertOptions.quality"

    invoke-virtual {p0, v7}, Lz54;->e(Ljava/lang/String;)Ljava/lang/String;
    ...
    :goto_0
    invoke-static {v6}, Lgtb;->valueOf(Ljava/lang/String;)Lgtb;

    move-result-object v6

    iput-object v6, v2, Lv10;->c:Lgtb;

    const-string v6, "draft.videoConvertOptions.startTrimPosition"

    invoke-virtual {p0, v6}, Lz54;->c(Ljava/lang/String;)F
    ...
    invoke-direct {p0, v2}, Lkmf;-><init>(Lv10;)V
