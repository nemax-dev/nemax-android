...
# direct methods
.method public constructor <init>(Law5;Lic4;Lvh;Lorg/webrtc/EglBase;Lded;)V
    .locals 2

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p3, p0, Lji;->a:Lvh;
    ...
    iput-object p2, p0, Lji;->b:Landroid/os/HandlerThread;
    ...
    iput-object p3, p0, Lji;->d:Landroid/os/HandlerThread;

    new-instance p5, Ljava/util/HashMap;

    invoke-direct {p5}, Ljava/util/HashMap;-><init>()V

    iput-object p5, p0, Lji;->e:Ljava/util/HashMap;

    new-instance p5, Ljava/util/concurrent/ConcurrentHashMap;

    invoke-direct {p5}, Ljava/util/concurrent/ConcurrentHashMap;-><init>()V

    iput-object p5, p0, Lji;->f:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    iput-object p5, p0, Lji;->g:Ljava/util/LinkedHashSet;
    ...
    invoke-direct {p5, p1, p4, v0, v1}, Lef1;-><init>(Li7c;Lorg/webrtc/EglBase$Context;[ILjava/lang/String;)V

    iput-object p5, p0, Lji;->h:Lef1;
    ...
    iput-object p1, p0, Lji;->c:Landroid/os/Handler;
