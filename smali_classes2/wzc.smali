.class public interface abstract Lwzc;
...
.method public static q(Landroid/view/ViewGroup;Ljava/lang/String;Landroid/view/WindowInsets;I)Landroid/view/View;
    ...
    sget-object v0, Lvzc;->$EnumSwitchMapping$1:[I
    ...
    invoke-static {p2, v1}, Ldra;->A(Landroid/view/WindowInsets;I)Landroid/graphics/Insets;
...
.method public c(Landroid/view/Window;)V
    ...
    :cond_1
    invoke-interface {p0}, Lwzc;->R()Ljava/lang/Integer;

    move-result-object v0

    const/4 v1, 0x0

    invoke-interface {p0, p1, v1, v0, v2}, Lwzc;->t(Landroid/view/Window;Ljava/lang/Integer;Ljava/lang/Integer;Z)V
...
.method public m(Landroid/view/Window;)V
    ...
    invoke-interface {p0}, Lwzc;->getContext()Landroid/content/Context;
    ...
    invoke-virtual {v1, v3}, Lqs9;->c(Landroid/content/Context;)Lzs4;
    ...
    invoke-interface {p0, p1, v2, v2, v0}, Lwzc;->t(Landroid/view/Window;Ljava/lang/Integer;Ljava/lang/Integer;Z)V
...
.method public t(Landroid/view/Window;Ljava/lang/Integer;Ljava/lang/Integer;Z)V
    ...
    invoke-direct {v1, p2, v0, p3, p0}, Luzc;-><init>(Ljava/lang/Integer;Landroid/view/ViewGroup;Ljava/lang/Integer;Lwzc;)V
    ...
    invoke-direct {p3, p2}, Lyba;-><init>(Landroid/view/View;)V
    ...
    invoke-direct {v0, v1, p3}, Lrkg;-><init>(Landroid/view/WindowInsetsController;Lyba;)V
    ...
    invoke-direct {v0, p1, p3}, Lqkg;-><init>(Landroid/view/Window;Lyba;)V
    ...
    invoke-interface {p2}, Lnma;->h()Lu73;

    move-result-object p2

    sget-object p3, Lu73;->a:Lu73;
    ...
    invoke-virtual {v0, p2}, Lxwe;->z(Z)V
    ...
    :cond_6
    invoke-virtual {v0, p2}, Lxwe;->A(Z)V
