...
.method public final V0()Landroid/app/Dialog;
    ...
    invoke-direct {v5, p0, v4}, Lc88;-><init>(Landroid/content/Context;I)V

    iget-object v4, v5, Lqc;->a:Lmc;

    iput-boolean v1, v4, Lmc;->m:Z
    ...
    iput-object v2, v4, Lmc;->k:Ljava/lang/CharSequence;

    iput-object v1, v4, Lmc;->l:Landroid/content/DialogInterface$OnClickListener;

    invoke-static {p0, v0, v5, v3}, Lvzg;->B(Landroid/content/Context;Ljava/lang/String;Lc88;Z)V

    invoke-virtual {v5}, Lc88;->create()Lrc;
    ...
    invoke-direct {v2, p0, v4}, Lc88;-><init>(Landroid/content/Context;I)V

    iget-object v4, v2, Lqc;->a:Lmc;

    iput-boolean v1, v4, Lmc;->m:Z

    invoke-static {p0, v0, v2, v3}, Lvzg;->B(Landroid/content/Context;Ljava/lang/String;Lc88;Z)V

    invoke-virtual {v2}, Lc88;->create()Lrc;
...
.method public final onCancel(Landroid/content/DialogInterface;)V
    ...
    iget-object p0, p0, Lru/ok/messages/views/dialogs/ProgressDialog;->E1:Lixb;

    if-eqz p0, :cond_0

    invoke-interface {p0}, Lixb;->onCancel()V
