...
.method public static final b1(Ljava/util/ArrayList;Lw0c;Z)Lru/ok/messages/views/dialogs/VideoQualityPickerDialog;
    .locals 4
    ...
    sget-object v1, Ly0c;->g:Lrj4;

    invoke-static {p0, v1}, Le83;->R(Ljava/util/List;Ljava/util/Comparator;)V
    ...
    filled-new-array {p0, v1, p2}, [Liya;
...
.method public final V0()Landroid/app/Dialog;
    ...
    iget-object v6, v6, Lb1c;->a:Ly0c;

    iget-object v6, v6, Ly0c;->a:Lw0c;
    ...
    iget-object v7, v7, Lb1c;->a:Ly0c;

    iget-boolean v9, v7, Ly0c;->f:Z

    iget-object v10, v7, Ly0c;->a:Lw0c;

    iget-object v10, v10, Lw0c;->a:Ljava/lang/String;
    ...
    iget-wide v13, v7, Ly0c;->e:J

    const/4 v7, 0x0

    invoke-static {v13, v14, v8, v7}, Ll4f;->t(JZLandroid/content/Context;)Ljava/lang/String;
    ...
    invoke-virtual {v1, v2}, Lc88;->d(Ljava/lang/CharSequence;)Lc88;
    ...
    invoke-direct {v3, p0, v0, v4}, Lsb6;-><init>(Landroidx/fragment/app/a;Ljava/lang/Object;I)V

    iget-object v0, v1, Lqc;->a:Lmc;

    iput-object v2, v0, Lmc;->p:[Ljava/lang/CharSequence;

    iput-object v3, v0, Lmc;->r:Landroid/content/DialogInterface$OnClickListener;

    iput v5, v0, Lmc;->u:I

    iput-boolean v8, v0, Lmc;->t:Z
    ...
    iget-object p0, v1, Lqc;->a:Lmc;

    iput-object v0, p0, Lmc;->k:Ljava/lang/CharSequence;

    iput-object v2, p0, Lmc;->l:Landroid/content/DialogInterface$OnClickListener;

    invoke-virtual {v1}, Lqc;->a()Lrc;
