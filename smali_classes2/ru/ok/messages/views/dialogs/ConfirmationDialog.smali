...
.method public final V0()Landroid/app/Dialog;
    ...
    invoke-direct {v0, v5, v6}, Lc88;-><init>(Landroid/content/Context;I)V

    invoke-virtual {v0, v1}, Lc88;->d(Ljava/lang/CharSequence;)Lc88;

    move-result-object v0

    iget-object v1, v0, Lqc;->a:Lmc;

    iput-object v2, v1, Lmc;->f:Ljava/lang/CharSequence;

    new-instance v2, Lyj3;

    const/4 v5, 0x0

    invoke-direct {v2, p0, v5}, Lyj3;-><init>(Lru/ok/messages/views/dialogs/ConfirmationDialog;I)V

    iput-object v3, v1, Lmc;->g:Ljava/lang/CharSequence;

    iput-object v2, v1, Lmc;->h:Landroid/content/DialogInterface$OnClickListener;

    new-instance v2, Lyj3;

    const/4 v3, 0x1

    invoke-direct {v2, p0, v3}, Lyj3;-><init>(Lru/ok/messages/views/dialogs/ConfirmationDialog;I)V

    iput-object v4, v1, Lmc;->k:Ljava/lang/CharSequence;

    iput-object v2, v1, Lmc;->l:Landroid/content/DialogInterface$OnClickListener;
...
.method public final Z0()V
    ...
    invoke-virtual {v3, v0, v4, v5}, Ls5;->onActivityResult(IILandroid/content/Intent;)V
