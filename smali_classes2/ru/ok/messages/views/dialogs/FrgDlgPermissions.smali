...
.method public final V0()Landroid/app/Dialog;
    ...
    invoke-direct {v3, v4, v5}, Lmx3;-><init>(Landroid/content/Context;I)V

    new-instance v4, Lc88;

    const/4 v5, 0x0

    invoke-direct {v4, v3, v5}, Lc88;-><init>(Landroid/content/Context;I)V

    iget-object v3, v4, Lqc;->a:Lmc;

    iget-object v6, v3, Lmc;->a:Landroid/view/ContextThemeWrapper;
    ...
    iget-object v2, v3, Lmc;->a:Landroid/view/ContextThemeWrapper;

    invoke-virtual {v2, v1}, Landroid/content/Context;->getText(I)Ljava/lang/CharSequence;

    move-result-object v1

    iput-object v1, v3, Lmc;->f:Ljava/lang/CharSequence;

    new-instance v1, Ltb6;

    const/4 v2, 0x0

    invoke-direct {v1, p0, v2}, Ltb6;-><init>(Lru/ok/messages/views/dialogs/FrgDlgPermissions;I)V

    invoke-virtual {v4, v0, v1}, Lc88;->c(ILandroid/content/DialogInterface$OnClickListener;)Lc88;

    move-result-object v0

    iget-object v1, v0, Lqc;->a:Lmc;

    iput-boolean v5, v1, Lmc;->m:Z
    ...
    invoke-direct {v3, p0, v4}, Ltb6;-><init>(Lru/ok/messages/views/dialogs/FrgDlgPermissions;I)V

    iget-object p0, v1, Lmc;->a:Landroid/view/ContextThemeWrapper;

    invoke-virtual {p0, v2}, Landroid/content/Context;->getText(I)Ljava/lang/CharSequence;

    move-result-object p0

    iput-object p0, v1, Lmc;->k:Ljava/lang/CharSequence;

    iput-object v3, v1, Lmc;->l:Landroid/content/DialogInterface$OnClickListener;

    :cond_0
    invoke-virtual {v0}, Lc88;->create()Lrc;
...
.method public final onCancel(Landroid/content/DialogInterface;)V
    ...
    invoke-interface {p1}, Lub6;->b()V

    :cond_0
    iget-object p0, p0, Landroidx/fragment/app/a;->H0:Landroidx/fragment/app/a;

    instance-of p1, p0, Lub6;

    if-eqz p1, :cond_1

    check-cast p0, Lub6;

    invoke-interface {p0}, Lub6;->b()V
