...
.method public final V0()Landroid/app/Dialog;
    ...
    new-array v1, v0, [Ldwf;

    sget-object v2, Ldwf;->Y:Lg85;

    invoke-static {v2, v1}, Lye5;->Y(Ljava/util/Collection;[Ljava/lang/Object;)[Ljava/lang/Object;
    ...
    invoke-direct {v3, v4, v0}, Lc88;-><init>(Landroid/content/Context;I)V
    ...
    invoke-virtual {v3, v4}, Lc88;->d(Ljava/lang/CharSequence;)Lc88;
    ...
    invoke-direct {v2, p0, v1, v4}, Lsb6;-><init>(Landroidx/fragment/app/a;Ljava/lang/Object;I)V

    iget-object p0, v3, Lqc;->a:Lmc;

    iput-object v0, p0, Lmc;->p:[Ljava/lang/CharSequence;

    iput-object v2, p0, Lmc;->r:Landroid/content/DialogInterface$OnClickListener;

    invoke-virtual {v3}, Lqc;->a()Lrc;
