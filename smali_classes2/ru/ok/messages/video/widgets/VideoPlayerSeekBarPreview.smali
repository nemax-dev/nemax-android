...
.field public final o:Lw96;

.field public final r0:Lug;

.field public s0:Lr98;

.field public t0:Lhl7;

.field public u0:Llwf;

.field public v0:Lpm4;

.field public w0:Lpm4;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    sget p2, Lr9c;->view_video_player_seekbar_preview:I

    invoke-static {p1, p2, p0}, Landroid/view/View;->inflate(Landroid/content/Context;ILandroid/view/ViewGroup;)Landroid/view/View;

    move-result-object p1

    sget p2, Lt8c;->video_frame_preview:I
    ...
    sget p2, Lt8c;->video_player_seek_bar:I
    ...
    iget-object v2, p1, Lv96;->a:Lo27;

    iget-object p1, p1, Lv96;->c:Lvl7;
    ...
    invoke-direct {p2, v0, v1, v2, p1}, Lw96;-><init>(Lqye;Ly95;Lo27;Lsn4;)V

    iput-object p2, p0, Lru/ok/messages/video/widgets/VideoPlayerSeekBarPreview;->o:Lw96;
...
.method public final a()V
    ...
    iget-object v0, p0, Lru/ok/messages/video/widgets/VideoPlayerSeekBarPreview;->v0:Lpm4;
    ...
    iput-object v0, p0, Lru/ok/messages/video/widgets/VideoPlayerSeekBarPreview;->v0:Lpm4;
    ...
    iget-object v0, p0, Lru/ok/messages/video/widgets/VideoPlayerSeekBarPreview;->w0:Lpm4;
    ...
    invoke-direct {v1, p0, v2}, Lg5g;-><init>(Lru/ok/messages/video/widgets/VideoPlayerSeekBarPreview;I)V

    invoke-virtual {v0, v1}, Lpm4;->b0(Lys9;)V

    iput-object v0, p0, Lru/ok/messages/video/widgets/VideoPlayerSeekBarPreview;->w0:Lpm4;
...
.method public final onDetachedFromWindow()V
    ...
    iget-object v0, p0, Lru/ok/messages/video/widgets/VideoPlayerSeekBarPreview;->s0:Lr98;

    invoke-static {v0}, Ll2d;->b(Lvq4;)V

    iget-object v0, p0, Lru/ok/messages/video/widgets/VideoPlayerSeekBarPreview;->t0:Lhl7;
    ...
    :cond_1
    iget-object v0, p0, Lru/ok/messages/video/widgets/VideoPlayerSeekBarPreview;->o:Lw96;

    iget-object v1, v0, Lw96;->h:Lgx7;

    if-eqz v1, :cond_3

    iget-object v2, v1, Lgx7;->g:Lhl7;

    invoke-static {v2}, Ll2d;->b(Lvq4;)V

    :try_start_0
    iget-object v2, v1, Lgx7;->h:Landroid/media/MediaMetadataRetriever;
    ...
    iput-wide v2, v1, Lgx7;->j:J

    iget-object v1, v1, Lgx7;->f:Lnl0;
    ...
    :cond_3
    iget-object v0, v0, Lw96;->i:Lprc;

    if-eqz v0, :cond_5

    iget-object v1, v0, Lprc;->g:Lh0;
    ...
    iput-object v2, v0, Lprc;->g:Lh0;

    :cond_4
    iget-object v1, v0, Lprc;->h:Lh0;

    if-eqz v1, :cond_5

    invoke-virtual {v1}, Lh0;->a()Z

    iput-object v2, v0, Lprc;->h:Lh0;
...
.method public final onProgressChanged(Landroid/widget/SeekBar;IZ)V
    ...
    iget-object p1, p0, Lru/ok/messages/video/widgets/VideoPlayerSeekBarPreview;->u0:Llwf;
    ...
    iget-object p3, p0, Lru/ok/messages/video/widgets/VideoPlayerSeekBarPreview;->o:Lw96;
    ...
    iget-object v2, p0, Lru/ok/messages/video/widgets/VideoPlayerSeekBarPreview;->u0:Llwf;
    ...
    :cond_4
    iget-object v2, p0, Lru/ok/messages/video/widgets/VideoPlayerSeekBarPreview;->t0:Lhl7;
    ...
    invoke-static {v6, v7, v2, v5}, Lp5a;->r(JLjava/util/concurrent/TimeUnit;Lo6d;)Ls8a;
    ...
    invoke-direct {v5, p0, v3}, Lf5g;-><init>(Lru/ok/messages/video/widgets/VideoPlayerSeekBarPreview;I)V

    new-instance v6, Lcxf;

    const/4 v7, 0x3

    invoke-direct {v6, v7}, Lcxf;-><init>(I)V

    sget-object v7, Lvzg;->c:Lrd6;

    new-instance v8, Lhl7;

    invoke-direct {v8, v5, v6, v7}, Lhl7;-><init>(Lwm3;Lwm3;Lb6;)V

    invoke-virtual {v2, v8}, Lp5a;->a(Lu8a;)V

    iput-object v8, p0, Lru/ok/messages/video/widgets/VideoPlayerSeekBarPreview;->t0:Lhl7;

    :cond_5
    iget-object v2, p0, Lru/ok/messages/video/widgets/VideoPlayerSeekBarPreview;->s0:Lr98;

    invoke-static {v2}, Ll2d;->b(Lvq4;)V

    iget-object v2, p3, Lt96;->e:Llwf;
    ...
    invoke-static {p3, v2, v4}, Lkug;->n(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V

    sget-object p3, Lw98;->a:Lw98;
    ...
    :cond_7
    iget-object p3, p3, Lw96;->i:Lprc;

    iget-object v2, p3, Lprc;->h:Lh0;

    if-eqz v2, :cond_8

    invoke-virtual {v2}, Lh0;->a()Z

    iput-object v4, p3, Lprc;->h:Lh0;
    ...
    new-instance p3, Lv98;

    invoke-direct {p3, v2}, Lv98;-><init>(Lma8;)V

    goto :goto_3

    :cond_9
    :goto_2
    iget-object p3, p3, Lw96;->h:Lgx7;
    ...
    iget-object p3, p3, Lgx7;->f:Lnl0;

    new-instance v6, Lac4;

    const/4 v7, 0x4

    invoke-direct {v6, v2, v7}, Lac4;-><init>(II)V

    invoke-virtual {p3}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    new-instance v7, Ls5a;

    invoke-direct {v7, p3, v6, v5}, Ls5a;-><init>(Lp5a;Lygb;I)V

    new-instance p3, Lq6a;

    invoke-direct {p3, v7}, Lq6a;-><init>(Ls5a;)V
    ...
    invoke-direct {v2, p3, v6, v3}, Laa8;-><init>(Lq98;Ljava/lang/Object;I)V
    ...
    invoke-virtual {p3, v2}, Lq98;->f(Lo6d;)Lia8;

    move-result-object p3

    new-instance v2, Lf5g;

    invoke-direct {v2, p0, v5}, Lf5g;-><init>(Lru/ok/messages/video/widgets/VideoPlayerSeekBarPreview;I)V
    ...
    invoke-direct {v6, v7, p0}, Lh5;-><init>(ILjava/lang/Object;)V

    new-instance v7, Lr98;

    invoke-direct {v7, v2, v5, v6}, Lr98;-><init>(Lwm3;Lwm3;Lb6;)V

    invoke-virtual {p3, v7}, Lq98;->a(Lja8;)V

    iput-object v7, p0, Lru/ok/messages/video/widgets/VideoPlayerSeekBarPreview;->s0:Lr98;

    iput-wide p1, p0, Lru/ok/messages/video/widgets/VideoPlayerSeekBarPreview;->z0:J

    :cond_a
    iget-object p3, p0, Lru/ok/messages/video/widgets/VideoPlayerSeekBarPreview;->w0:Lpm4;

    if-eqz p3, :cond_b

    invoke-virtual {p3}, Lpm4;->B()V

    iput-object v4, p0, Lru/ok/messages/video/widgets/VideoPlayerSeekBarPreview;->w0:Lpm4;
    ...
    iget-object p3, p0, Lru/ok/messages/video/widgets/VideoPlayerSeekBarPreview;->v0:Lpm4;
    ...
    invoke-virtual {p3, v1}, Lug;->d(Landroid/view/View;)Lpm4;

    move-result-object p3

    new-instance v2, Lg5g;

    invoke-direct {v2, p0, v3}, Lg5g;-><init>(Lru/ok/messages/video/widgets/VideoPlayerSeekBarPreview;I)V

    invoke-virtual {p3, v2}, Lpm4;->b0(Lys9;)V

    iput-object p3, p0, Lru/ok/messages/video/widgets/VideoPlayerSeekBarPreview;->v0:Lpm4;
    ...
    invoke-static {p1, p2}, Le5h;->f(J)Ljava/lang/String;
...
.method public setVideoContent(Llwf;)V
    .locals 6

    iget-object v0, p0, Lru/ok/messages/video/widgets/VideoPlayerSeekBarPreview;->u0:Llwf;
    ...
    :cond_0
    iput-object p1, p0, Lru/ok/messages/video/widgets/VideoPlayerSeekBarPreview;->u0:Llwf;

    invoke-interface {p1}, Llwf;->getWidth()I

    move-result v0

    invoke-interface {p1}, Llwf;->getHeight()I
    ...
    invoke-static {v2, v2, v0, v1}, Ly30;->u(IIII)[I
    ...
    iget-object p0, p0, Lru/ok/messages/video/widgets/VideoPlayerSeekBarPreview;->o:Lw96;

    invoke-virtual {p0, p1, v2, v0}, Lw96;->a(Llwf;II)V
    ...
    invoke-interface {p1}, Llwf;->i()Landroid/net/Uri;
    ...
    iget-object v1, p0, Lprc;->f:Lo27;

    invoke-virtual {p1}, Lc37;->a()Lb37;

    move-result-object p1

    invoke-virtual {v1, p1, v0}, Lo27;->e(Lb37;Lyg9;)Lh0;

    move-result-object p1

    iput-object p1, p0, Lprc;->g:Lh0;
    ...
    iget-object p1, p0, Lt96;->a:Lqye;

    iget-object v2, p0, Lt96;->e:Llwf;
    ...
    invoke-direct {v1, v2, v0}, Lgd3;-><init>(ILjava/lang/Object;)V
    ...
    invoke-virtual {v1, v0}, Lp5a;->o(Lo6d;)Lf6a;
    ...
    invoke-virtual {v0, p1}, Lp5a;->k(Lo6d;)Ll7a;

    move-result-object p1

    iget-object v0, p0, Lgx7;->f:Lnl0;
    ...
    invoke-direct {v1, v2, v0}, Ljr5;-><init>(ILjava/lang/Object;)V

    new-instance v0, Lns7;

    const/4 v2, 0x3

    invoke-direct {v0, v2}, Lns7;-><init>(I)V

    sget-object v2, Lvzg;->c:Lrd6;

    new-instance v3, Lhl7;

    invoke-direct {v3, v1, v0, v2}, Lhl7;-><init>(Lwm3;Lwm3;Lb6;)V

    invoke-virtual {p1, v3}, Lp5a;->a(Lu8a;)V

    iput-object v3, p0, Lgx7;->g:Lhl7;
