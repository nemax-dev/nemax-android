...
.method public final m0(Landroid/view/LayoutInflater;Landroid/view/ViewGroup;Landroid/os/Bundle;)Landroid/view/View;
    ...
    invoke-virtual {p3, v0}, Lymd;->e(Ljava/lang/String;)V

    :cond_0
    sget p3, Lr9c;->frg_settings_base:I
    ...
    sget p2, Lt8c;->frg_settings__rv_content:I
    ...
    invoke-direct {p2, p3, v0, p0}, Lwqd;-><init>(Landroidx/fragment/app/b;Ljava/util/List;Lru/ok/messages/settings/FrgBaseSettings;)V

    iput-object p2, p0, Lru/ok/messages/settings/FrgBaseSettings;->B1:Lwqd;

    iget-object p0, p0, Lru/ok/messages/settings/FrgBaseSettings;->C1:Landroidx/recyclerview/widget/RecyclerView;

    invoke-virtual {p0, p2}, Landroidx/recyclerview/widget/RecyclerView;->setAdapter(Luoc;)V
