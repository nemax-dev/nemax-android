...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    invoke-virtual {p0, v2}, Lowd;->setValue(F)V
    ...
    sget v6, Lj6c;->Slider_tickColor:I
    ...
    sget v7, Lj6c;->Slider_tickColor:I

    goto :goto_0

    :cond_1
    sget v7, Lj6c;->Slider_tickColorInactive:I
    ...
    :cond_2
    sget v6, Lj6c;->Slider_tickColorActive:I
    ...
    sget-object v0, Ll6c;->SliderWithCustomTicks:[I

    invoke-virtual {p1, p2, v0, v1, v1}, Landroid/content/Context;->obtainStyledAttributes(Landroid/util/AttributeSet;[III)Landroid/content/res/TypedArray;

    move-result-object p1

    sget p2, Ll6c;->SliderWithCustomTicks_tickRadius:I
    ...
    sget p2, Ll6c;->SliderWithCustomTicks_normalValue:I
...
.method public final onDraw(Landroid/graphics/Canvas;)V
    ...
    :cond_0
    invoke-virtual {v0}, Lowd;->getStepSize()F
    ...
    :cond_1
    invoke-virtual {v0}, Lowd;->getValueTo()F

    move-result v2

    invoke-virtual {v0}, Lowd;->getValueFrom()F
    ...
    invoke-virtual {v0}, Lowd;->getTrackWidth()I

    move-result v6

    invoke-virtual {v0}, Lowd;->getTrackHeight()I
    ...
    invoke-virtual {v0}, Lowd;->getTrackSidePadding()I
    ...
    :cond_4
    invoke-virtual {v0}, Lowd;->getValue()F
    ...
    invoke-virtual {v0}, Lowd;->getThumbRadius()I
...
.method public setStepSize(F)V
    ...
    invoke-super {p0, p1}, Lowd;->setStepSize(F)V
...
.method public setValueFrom(F)V
    ...
    invoke-super {p0, p1}, Lowd;->setValueFrom(F)V
...
.method public setValueTo(F)V
    ...
    invoke-super {p0, p1}, Lowd;->setValueTo(F)V
