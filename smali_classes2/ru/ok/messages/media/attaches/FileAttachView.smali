...
.field public T0:Lhn9;

.field public final U0:Lzze;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    iput-object p1, p0, Lru/ok/messages/media/attaches/FileAttachView;->F0:Lye3;
    ...
    iput-object p1, p0, Lru/ok/messages/media/attaches/FileAttachView;->G0:Lyo4;

    iget-object p1, p0, Lru/ok/messages/media/attaches/FileAttachView;->F0:Lye3;
    ...
    iput-object p1, p0, Lru/ok/messages/media/attaches/FileAttachView;->U0:Lzze;
    ...
    sget p2, Lt8c;->view_file_attach__attachments:I
    ...
    sget p2, Lr9c;->ll_view_file_attach__message_attachments_layout_view:I
    ...
    iget-object v1, p0, Lru/ok/messages/media/attaches/FileAttachView;->G0:Lyo4;
    ...
    sget v3, Lt8c;->view_file_attach__sticker:I
    ...
    sget v3, Lr9c;->ll_view_file_attach__sticker_view:I
    ...
    sget v2, Lt8c;->view_file_attach__big_preview_barrier:I
    ...
    sget v2, Lt8c;->view_file_attach__attachments:I
    ...
    invoke-virtual {p1, v2}, Lyl3;->setReferencedIds([I)V
    ...
    iget-object v2, p0, Lru/ok/messages/media/attaches/FileAttachView;->G0:Lyo4;

    iget v2, v2, Lyo4;->u:I

    invoke-direct {p1, v2, v2}, Lam3;-><init>(II)V
    ...
    sget v3, Lt8c;->view_file_attach__iv_bg:I
    ...
    iget-object v3, p0, Lru/ok/messages/media/attaches/FileAttachView;->G0:Lyo4;
    ...
    invoke-direct {v4}, Lg0d;-><init>()V

    const/16 v5, 0x8

    new-array v6, v5, [F

    iput-object v6, v4, Lg0d;->c:[F
    ...
    iget-object v2, p0, Lru/ok/messages/media/attaches/FileAttachView;->U0:Lzze;
    ...
    invoke-direct {p1, v0, v0}, Lam3;-><init>(II)V

    sget v4, Lt8c;->view_file_attach__iv_bg:I
    ...
    invoke-static {v4, v6}, Lsw3;->b(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {p1, v4}, Lnh6;->h(Lc5d;)V
    ...
    iget-object v4, p0, Lru/ok/messages/media/attaches/FileAttachView;->G0:Lyo4;
    ...
    invoke-direct {v6}, Lg0d;-><init>()V

    new-array v7, v5, [F

    iput-object v7, v6, Lg0d;->c:[F

    invoke-static {v7, v4}, Ljava/util/Arrays;->fill([FF)V

    invoke-virtual {p1, v6}, Lnh6;->m(Lg0d;)V
    ...
    invoke-direct {v6, p0, v0}, Lnl5;-><init>(Lru/ok/messages/media/attaches/FileAttachView;I)V

    const-wide/16 v7, 0x320

    invoke-static {v4, v7, v8, v6}, Lo58;->L(Landroid/view/View;JLandroid/view/View$OnClickListener;)V
    ...
    sget v4, Lt8c;->view_file_attach__tv_title:I
    ...
    iget-object v6, p0, Lru/ok/messages/media/attaches/FileAttachView;->G0:Lyo4;
    ...
    invoke-direct {p1, v0, p2}, Lam3;-><init>(II)V

    sget v2, Lt8c;->view_file_attach__iv_bg:I

    iput v2, p1, Lam3;->i:I

    iput v2, p1, Lam3;->s:I

    sget v2, Lt8c;->view_file_attach__btn_load:I

    iput v2, p1, Lam3;->u:I

    sget v2, Lt8c;->view_file_attach__tv_subtitle:I
    ...
    sget v6, Lt8c;->view_file_attach__tv_subtitle:I
    ...
    iget-object v9, p0, Lru/ok/messages/media/attaches/FileAttachView;->U0:Lzze;
    ...
    sget v9, Lt8c;->view_file_attach__tv_title:I

    iput v9, p1, Lam3;->j:I

    sget v9, Lt8c;->view_file_attach__iv_bg:I

    iput v9, p1, Lam3;->s:I

    sget v9, Lt8c;->view_file_attach__btn_load:I

    iput v9, p1, Lam3;->u:I

    sget v9, Lt8c;->view_file_attach__tv_duration:I
    ...
    iget-object v9, p0, Lru/ok/messages/media/attaches/FileAttachView;->G0:Lyo4;
    ...
    iget-object v4, p0, Lru/ok/messages/media/attaches/FileAttachView;->U0:Lzze;
    ...
    sget p2, Lt8c;->view_file_attach__tv_subtitle:I

    iput p2, p1, Lam3;->j:I

    sget p2, Lt8c;->view_file_attach__iv_bg:I

    iput p2, p1, Lam3;->s:I

    sget v4, Lt8c;->view_file_attach__btn_load:I
    ...
    sget p2, Lt8c;->view_file_attach__btn_load:I
    ...
    invoke-interface {p2}, Lvra;->a()Lit2;

    move-result-object p2

    invoke-interface {p2}, Lit2;->j()Lms0;
    ...
    iget-object p2, p0, Lru/ok/messages/media/attaches/FileAttachView;->G0:Lyo4;

    iget p2, p2, Lyo4;->s:I

    invoke-direct {p1, p2, p2}, Lam3;-><init>(II)V

    sget p2, Lt8c;->view_file_attach__big_preview_barrier:I
    ...
    invoke-direct {v0, p0, v1}, Lnl5;-><init>(Lru/ok/messages/media/attaches/FileAttachView;I)V

    invoke-static {p2, v7, v8, v0}, Lo58;->L(Landroid/view/View;JLandroid/view/View$OnClickListener;)V
    ...
    invoke-static {p0, p1}, Lys9;->f(Landroid/view/View;Lb6;)Lhl7;

    return-void
.end method

.method private getMusicAttachViewController()Lhn9;
    .locals 1

    iget-object v0, p0, Lru/ok/messages/media/attaches/FileAttachView;->T0:Lhn9;
    ...
    invoke-direct {v0, p0}, Lhn9;-><init>(Lgn9;)V

    iput-object v0, p0, Lru/ok/messages/media/attaches/FileAttachView;->T0:Lhn9;

    :goto_0
    iget-object p0, p0, Lru/ok/messages/media/attaches/FileAttachView;->T0:Lhn9;
...
.method public static v(Lru/ok/messages/media/attaches/FileAttachView;)V
    ...
    invoke-direct {p0}, Lru/ok/messages/media/attaches/FileAttachView;->getMusicAttachViewController()Lhn9;
...
# virtual methods
.method public getMessageAttachmentsView()Lez8;
    .locals 1
    ...
    invoke-virtual {p0}, Lru/ok/messages/media/attaches/MessageAttachmentsLayout;->getView()Lez8;
...
.method public setListener(Lol5;)V
    .locals 0
...
.method public setPipRequestListener(Ldz8;)V
    ...
    invoke-virtual {p0}, Lru/ok/messages/media/attaches/FileAttachView;->getMessageAttachmentsView()Lez8;

    move-result-object p0

    invoke-virtual {p0, p1}, Lez8;->setPipRequestListener(Ldz8;)V
