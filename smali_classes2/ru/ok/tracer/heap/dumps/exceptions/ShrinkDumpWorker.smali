...
.method public final a()Lau7;
    ...
    invoke-virtual {v1, v2}, Lw64;->e(Ljava/lang/String;)Ljava/lang/String;
    ...
    :cond_1
    sget-object v4, Lmee;->b:Lvbf;

    invoke-static {v4}, Lx2a;->l(Lvbf;)Z
    ...
    invoke-static {v0, v4}, Lx2a;->j(Landroid/content/Context;Lvbf;)Ljava/io/File;
    ...
    new-instance v8, Liw6;

    invoke-direct {v8, v7}, Liw6;-><init>(Ljava/io/DataInputStream;)V
    :try_end_1
    ...
    :try_start_3
    invoke-static {v8, v7}, Lmq0;->m(Ljava/io/InputStream;Ljava/io/OutputStream;)J
    :try_end_3
    ...
    :try_start_5
    invoke-virtual {v8}, Liw6;->close()V
    :try_end_5
    ...
    invoke-static/range {v3 .. v9}, Lzs3;->m(Landroid/content/Context;Lvbf;Ljava/io/File;Ljava/lang/String;Ljava/lang/Long;Ljava/util/Map;I)V
