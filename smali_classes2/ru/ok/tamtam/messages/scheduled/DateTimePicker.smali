...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    sget p2, Lc4c;->date_picker_today_margin_top:I
    ...
    sget v0, Ls9c;->date_time_picker:I

    invoke-static {p1, v0, p0}, Landroid/view/View;->inflate(Landroid/content/Context;ILandroid/view/ViewGroup;)Landroid/view/View;

    sget v0, Lx8c;->days_recycler_view:I
    ...
    sget v1, Lx8c;->hours_recycler_view:I
    ...
    sget v2, Lx8c;->minutes_recycler_view:I
    ...
    sget v3, Lc4c;->date_picker_item_height:I
    ...
    sget-object v5, Lt84;->k:Lt84;

    invoke-direct {v4, v5}, Lbt7;-><init>(Lh5h;)V

    const/4 v5, 0x1

    invoke-virtual {v4, v5}, Luoc;->A(Z)V
    ...
    invoke-direct {v8, p0, v9, v4}, Lb9;-><init>(Ljava/lang/Object;ILjava/lang/Object;)V

    invoke-direct {v6, p1, v8}, Lru/ok/tamtam/messages/scheduled/SliderLayoutManager;-><init>(Landroid/content/Context;Lp5e;)V
    ...
    invoke-direct {v4, v3}, Lhxa;-><init>(I)V

    invoke-virtual {v0, v4}, Landroidx/recyclerview/widget/RecyclerView;->setEdgeEffectFactory(Lyoc;)V
    ...
    invoke-virtual {v1, v4}, Landroidx/recyclerview/widget/RecyclerView;->setItemAnimator(Lzoc;)V
    ...
    invoke-direct {v8, p0, v0, v9}, Ll84;-><init>(Lru/ok/tamtam/messages/scheduled/DateTimePicker;Lv6f;I)V
    ...
    invoke-direct {v0, v3}, Lhxa;-><init>(I)V

    invoke-virtual {v1, v0}, Landroidx/recyclerview/widget/RecyclerView;->setEdgeEffectFactory(Lyoc;)V

    new-instance v0, Lv6f;

    invoke-direct {v0}, Lv6f;-><init>()V

    invoke-virtual {v2, v0}, Landroidx/recyclerview/widget/RecyclerView;->setAdapter(Luoc;)V
    ...
    invoke-virtual {v2, v1}, Landroidx/recyclerview/widget/RecyclerView;->j(Lbpc;)V

    new-instance p2, Lru/ok/tamtam/messages/scheduled/SliderLayoutManager;

    new-instance v1, Ll84;

    invoke-direct {v1, p0, v0, v5}, Ll84;-><init>(Lru/ok/tamtam/messages/scheduled/DateTimePicker;Lv6f;I)V

    invoke-direct {p2, p1, v1}, Lru/ok/tamtam/messages/scheduled/SliderLayoutManager;-><init>(Landroid/content/Context;Lp5e;)V
    ...
    invoke-direct {p1, v3}, Lhxa;-><init>(I)V

    invoke-virtual {v2, p1}, Landroidx/recyclerview/widget/RecyclerView;->setEdgeEffectFactory(Lyoc;)V
    ...
    :goto_0
    invoke-virtual {p0, p1}, Lru/ok/tamtam/messages/scheduled/DateTimePicker;->s(Lzze;)V
...
.method public final setListener$scheduled_send_picker_dialog_release(Lo84;)V
    .locals 0

    iput-object p1, p0, Lru/ok/tamtam/messages/scheduled/DateTimePicker;->L0:Lo84;
