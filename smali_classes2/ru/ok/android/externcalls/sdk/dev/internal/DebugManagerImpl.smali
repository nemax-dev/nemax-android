...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "signalingProvider",
        "<init>",
        "(Lsy0;Lru/ok/android/externcalls/sdk/log/ExtLogger;Lrz3;Lxec;Lru/ok/android/externcalls/sdk/signaling/SignalingProvider;)V",
        "Lhde;",
        "operation",
        "",
        "param",
        ...
        "(Lpee;ILjava/util/concurrent/TimeUnit;)V",
        "removeStatListener",
        "(Lpee;)V",
        "Lsy0;",
        "getUnderlyingCall",
...
.field private final underlyingCall:Lsy0;
...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0, v1}, Lru/ok/android/externcalls/sdk/dev/internal/DebugManagerImpl$Companion;-><init>(Lsd4;)V
...
.method public constructor <init>(Lsy0;Lru/ok/android/externcalls/sdk/log/ExtLogger;Lrz3;Lxec;Lru/ok/android/externcalls/sdk/signaling/SignalingProvider;)V
    .locals 0

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Lru/ok/android/externcalls/sdk/dev/internal/DebugManagerImpl;->underlyingCall:Lsy0;
    ...
    iput-object p3, p0, Lru/ok/android/externcalls/sdk/dev/internal/DebugManagerImpl;->cidProvider:Lrz3;

    iput-object p4, p0, Lru/ok/android/externcalls/sdk/dev/internal/DebugManagerImpl;->log:Lxec;

    new-instance p1, Lru/ok/android/externcalls/sdk/dev/internal/MediaDumpManagerImpl;

    invoke-virtual {p0}, Lru/ok/android/externcalls/sdk/dev/internal/DebugManagerImpl;->getUnderlyingCall()Lsy0;

    move-result-object p2

    invoke-direct {p1, p2, p5}, Lru/ok/android/externcalls/sdk/dev/internal/MediaDumpManagerImpl;-><init>(Lsy0;Lru/ok/android/externcalls/sdk/signaling/SignalingProvider;)V
...
.method public enableFullAudioDump(Ljava/lang/String;)V
    ...
    :cond_0
    sget-object v1, Lsy0;->d1:Ljava/util/concurrent/ExecutorService;
...
.method public getUnderlyingCall()Lsy0;
    ...
    iget-object p0, p0, Lru/ok/android/externcalls/sdk/dev/internal/DebugManagerImpl;->underlyingCall:Lsy0;

    return-object p0
.end method

.method public registerStatListener(Lpee;ILjava/util/concurrent/TimeUnit;)V
    .locals 2
    ...
    iget-object p0, p0, Lsy0;->G0:Lkr8;

    int-to-long v0, p2

    invoke-virtual {p0, p1, v0, v1, p3}, Lkr8;->c(Lpee;JLjava/util/concurrent/TimeUnit;)V

    return-void
.end method

.method public removeStatListener(Lpee;)V
    .locals 0
...
.method public report(Lhde;Ljava/lang/String;)V
    .locals 1
    ...
    iget-object p0, p0, Lru/ok/android/externcalls/sdk/dev/internal/DebugManagerImpl;->cidProvider:Lrz3;

    check-cast p0, Lsz3;

    iget-object p0, p0, Lsz3;->a:Ljava/lang/String;

    invoke-virtual {v0, p1, p0, p2}, Lru/ok/android/externcalls/sdk/log/ExtLogger;->logSimple(Lhde;Ljava/lang/String;Ljava/lang/String;)V
...
.method public reportError(Ljava/lang/Throwable;)V
    ...
    iget-object p0, p0, Lru/ok/android/externcalls/sdk/dev/internal/DebugManagerImpl;->log:Lxec;
