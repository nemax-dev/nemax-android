...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "Lsaa;",
        "makeState",
        "(Lru/ok/android/externcalls/sdk/log/stat/item/StatItem;)Lsaa;",
        "Lraa;",
        "builder",
        "setStat",
        "(Lraa;Lru/ok/android/externcalls/sdk/log/stat/item/StatItem;)Lraa;",
        "",
        "",
        "custom",
        "setCustom",
        "(Lraa;Ljava/util/Map;)V",
        "calls-sdk_release"
    }
    k = 0x1
    mv = {
...
.method public makeState(Lru/ok/android/externcalls/sdk/log/stat/item/StatItem;)Lsaa;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(TS;)",
    ...
    invoke-virtual {p0, v0, p1}, Lru/ok/android/externcalls/sdk/log/stat/BaseStatisticsManagerImpl;->setStat(Lraa;Lru/ok/android/externcalls/sdk/log/stat/item/StatItem;)Lraa;

    move-result-object p0

    invoke-virtual {p0}, Lraa;->a()Lsaa;
...
.method public sendStat(Lru/ok/android/externcalls/sdk/log/stat/item/StatItem;)V
    ...
    invoke-virtual {p0, p1}, Lru/ok/android/externcalls/sdk/log/stat/BaseStatisticsManagerImpl;->makeState(Lru/ok/android/externcalls/sdk/log/stat/item/StatItem;)Lsaa;
...
.method public setCustom(Lraa;Ljava/util/Map;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public setStat(Lraa;Lru/ok/android/externcalls/sdk/log/stat/item/StatItem;)Lraa;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {p0, p1, v0}, Lru/ok/android/externcalls/sdk/log/stat/BaseStatisticsManagerImpl;->setCustom(Lraa;Ljava/util/Map;)V

    invoke-interface {p2}, Lru/ok/android/externcalls/sdk/log/stat/item/StatItem;->getCollector()Ljava/lang/String;

    move-result-object v0

    iput-object v0, p1, Lraa;->a:Ljava/lang/String;
    ...
    iput-object v0, p1, Lraa;->c:Ljava/lang/String;
    ...
    invoke-virtual {p1, v0, v1}, Lraa;->e(J)V
