...
.method private final getPosition(Ljava/lang/Long;)Loj9;
    .locals 4
    ...
    invoke-direct {p0, v0, v1}, Lmj9;-><init>(J)V

    return-object p0

    :cond_1
    :goto_0
    sget-object p0, Lnj9;->a:Lnj9;
...
.method private final updateState(Lvj9;)V
    .locals 12
    ...
    iget-object p1, p1, Lvj9;->a:Ljava/util/ArrayList;
    ...
    iget-object v3, v1, Luj9;->a:Ljr1;

    iget-object v3, v3, Ljr1;->b:Lqg1;
    ...
    iget-object v11, v3, Ljr1;->c:Llj9;
    ...
    sget-object v5, Lsj9;->$EnumSwitchMapping$1:[I
    ...
    :cond_3
    sget-object v3, Lrj9;->b:Lrj9;

    goto :goto_1

    :cond_4
    sget-object v3, Lrj9;->a:Lrj9;
    ...
    iget-object v9, v8, Lij9;->d:Lrj9;

    if-ne v9, v3, :cond_6

    iget-object v8, v8, Lij9;->a:Llj9;

    invoke-virtual {v8, v11}, Llj9;->equals(Ljava/lang/Object;)Z
    ...
    iget-object v2, v1, Luj9;->d:Ljava/lang/Long;

    invoke-direct {p0, v2}, Lru/ok/android/externcalls/sdk/watch_together/internal/listener/WatchTogetherListenerManagerImpl;->getPosition(Ljava/lang/Long;)Loj9;

    move-result-object v5

    iget-boolean v2, v1, Luj9;->c:Z

    xor-int/2addr v6, v2

    iget v7, v1, Luj9;->b:F

    invoke-static {v7}, Lzj9;->a(F)V

    iget-boolean v8, v1, Luj9;->e:Z

    const/4 v10, 0x0

    invoke-direct/range {v3 .. v10}, Lru/ok/android/externcalls/sdk/watch_together/listener/states/MovieState;-><init>(Lru/ok/android/externcalls/sdk/id/ParticipantId;Loj9;ZFZLij9;Lsd4;)V
    ...
    invoke-virtual {v2}, Lru/ok/android/externcalls/sdk/participant/collection/ParticipantStore;->getActiveRoomId()Lnnd;

    move-result-object v2

    invoke-direct {v1, v4, v2, v9}, Lru/ok/android/externcalls/sdk/watch_together/listener/states/MovieStartedData;-><init>(Lru/ok/android/externcalls/sdk/id/ParticipantId;Lnnd;Lij9;)V
...
.method public final onVideoStarted(Ltj9;)V
    .locals 12
    ...
    invoke-direct/range {v1 .. v8}, Lru/ok/android/externcalls/sdk/watch_together/listener/states/MovieState;-><init>(Lru/ok/android/externcalls/sdk/id/ParticipantId;Loj9;ZFZLij9;Lsd4;)V
    ...
    iget-object p1, p1, Ltj9;->b:Lnnd;

    invoke-direct {v1, v0, p1, v7}, Lru/ok/android/externcalls/sdk/watch_together/listener/states/MovieStartedData;-><init>(Lru/ok/android/externcalls/sdk/id/ParticipantId;Lnnd;Lij9;)V
...
.method public final onVideoStatesUpdatedChanged(Lvj9;)V
    .locals 0

    invoke-direct {p0, p1}, Lru/ok/android/externcalls/sdk/watch_together/internal/listener/WatchTogetherListenerManagerImpl;->updateState(Lvj9;)V
...
.method public final onVideoStopped(Lwj9;)V
    .locals 4
    ...
    iget-object v2, p1, Lwj9;->b:Lnnd;

    iget-object v3, p1, Lwj9;->c:Llj9;

    iget-object p1, p1, Lwj9;->d:Lrj9;

    invoke-direct {v1, v0, v2, v3, p1}, Lru/ok/android/externcalls/sdk/watch_together/listener/states/MovieStoppedData;-><init>(Lru/ok/android/externcalls/sdk/id/ParticipantId;Lnnd;Llj9;Lrj9;)V
