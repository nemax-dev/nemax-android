...
.method private final processFeedbackForResolvedInternalIds(Ljava/util/List;Ljava/util/List;)Ljava/util/List;
    ...
    invoke-virtual {v1}, Lru/ok/android/externcalls/sdk/feedback/internal/listeners/FeedbackListenerManagerImpl$CallParticipantFeedback;->getParticipantId()Lqg1;
    ...
    invoke-virtual {v2, v3}, Lru/ok/android/externcalls/sdk/id/IdMappingWrapper;->getByInternal(Lqg1;)Lru/ok/android/externcalls/sdk/id/ParticipantId;
    ...
    invoke-direct/range {v4 .. v11}, Lru/ok/android/externcalls/sdk/feedback/ParticipantFeedback;-><init>(Ljava/lang/String;JLru/ok/android/externcalls/sdk/id/ParticipantId;Lru/ok/android/externcalls/sdk/feedback/ParticipantFeedbackSource;ILsd4;)V
...
.method private final scheduleRemoving()V
    ...
    invoke-direct {v5, p0, v0, v1, v6}, Lo50;-><init>(Ljava/lang/Object;JI)V
...
.method private final unrollReceivedFeedback(Lj71;)Ljava/util/List;
    .locals 6
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iget-object p0, p1, Lj71;->b:Ljava/util/ArrayList;
    ...
    iget-object v1, v0, Li71;->b:Ljava/lang/Object;
    ...
    iget-object v4, v0, Li71;->a:Ljava/lang/String;
    ...
    invoke-direct {v5, v3, v4}, Lru/ok/android/externcalls/sdk/feedback/internal/listeners/FeedbackListenerManagerImpl$CallParticipantFeedback;-><init>(Lqg1;Ljava/lang/String;)V
    ...
    :cond_0
    invoke-static {p1, v2}, Lf83;->U(Ljava/util/Collection;Ljava/lang/Iterable;)V
...
.method public onFeedback(Lj71;)V
    .locals 5

    iget-object v0, p1, Lj71;->a:Lnnd;
    ...
    invoke-virtual {v1}, Lru/ok/android/externcalls/sdk/participant/collection/ParticipantStore;->getActiveRoomId()Lnnd;
    ...
    :cond_0
    invoke-direct {p0, p1}, Lru/ok/android/externcalls/sdk/feedback/internal/listeners/FeedbackListenerManagerImpl;->unrollReceivedFeedback(Lj71;)Ljava/util/List;
    ...
    invoke-virtual {v4}, Lru/ok/android/externcalls/sdk/feedback/internal/listeners/FeedbackListenerManagerImpl$CallParticipantFeedback;->getParticipantId()Lqg1;
    ...
    invoke-direct {v3, p0, p1, v0, v4}, Lg65;-><init>(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;I)V

    new-instance p1, Lpk4;

    const/16 v4, 0x18

    invoke-direct {p1, p0, v4, v0}, Lpk4;-><init>(Ljava/lang/Object;ILjava/lang/Object;)V
