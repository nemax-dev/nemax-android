...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "exception",
        "debugApiException",
        "(Lwk;Lgl;Lru/ok/android/api/core/ApiException;)V",
        "Ljava/io/IOException;",
        "debugIoException",
        "(Lwk;Lgl;Ljava/io/IOException;)V",
        "Lxec;",
...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0, v1}, Lru/ok/android/externcalls/sdk/api/log/LoggingApiRequestDebugger$Companion;-><init>(Lsd4;)V
...
.method public constructor <init>(Lxec;)V
    ...
    iput-object p1, p0, Lru/ok/android/externcalls/sdk/api/log/LoggingApiRequestDebugger;->log:Lxec;
...
.method private final eraseSecrets(Ljava/lang/String;)Ljava/lang/String;
    ...
    iget-object p0, p0, Lru/ok/android/externcalls/sdk/api/log/LoggingApiRequestDebugger;->log:Lxec;
...
.method private final getParams(Lgl;)Ljava/lang/String;
    .locals 0

    invoke-direct {p0, p1}, Lru/ok/android/externcalls/sdk/api/log/LoggingApiRequestDebugger;->getRawParams(Lgl;)Ljava/lang/String;
...
.method private final getRawParams(Lgl;)Ljava/lang/String;
    .locals 2
    ...
    invoke-direct {v1, v0}, Ljcb;-><init>(Ljava/io/Writer;)V

    :try_start_0
    invoke-virtual {v1}, Ljcb;->s()V

    invoke-interface {p1, v1}, Lgl;->writeParams(Lzi7;)V

    invoke-virtual {v1}, Ljcb;->q()V

    invoke-virtual {v1}, Ljcb;->flush()V
    :try_end_0
...
.method public debugApiException(Lwk;Lgl;Lru/ok/android/api/core/ApiException;)V
    ...
    invoke-interface {p0, p2, p1, p3}, Lxec;->logException(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method public debugApiRequest(Lwk;Lgl;Lxk;)V
    ...
    iget-object p1, p0, Lru/ok/android/externcalls/sdk/api/log/LoggingApiRequestDebugger;->log:Lxec;

    invoke-interface {p2}, Lgl;->getUri()Landroid/net/Uri;

    move-result-object p3

    invoke-direct {p0, p2}, Lru/ok/android/externcalls/sdk/api/log/LoggingApiRequestDebugger;->getParams(Lgl;)Ljava/lang/String;
...
.method public debugApiResponseFail(Lwk;Lgl;Lsi7;)Lsi7;
    ...
    invoke-interface {p3}, Lsi7;->Y()Ljava/lang/String;
    ...
    invoke-interface {p0, p3, p2}, Lxec;->log(Ljava/lang/String;Ljava/lang/String;)V

    invoke-static {p1}, Lti7;->d(Ljava/lang/String;)Lti7;
