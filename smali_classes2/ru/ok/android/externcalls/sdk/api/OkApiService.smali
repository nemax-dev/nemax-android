...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "(Ljava/lang/String;Ljava/lang/String;ZLru/ok/android/externcalls/sdk/ConversationParticipant;Ljava/util/List;Ljava/util/List;Lru/ok/android/externcalls/sdk/conversation/StartCallApiParams;)Le3e;",
        "peerId",
        "Lru/ok/android/externcalls/sdk/api/JoinByIdResponse;",
        "joinToConversation",
        "(Ljava/lang/String;JLru/ok/android/externcalls/sdk/conversation/StartCallApiParams;)Le3e;",
        "anonToken",
        ...
        "(Ljava/lang/String;Ljava/lang/String;JLru/ok/android/externcalls/sdk/conversation/StartCallApiParams;)Le3e;",
        "opponents",
        "startConversation",
        "(Ljava/lang/String;Ljava/lang/String;ZLru/ok/android/externcalls/sdk/ConversationParticipant;Ljava/util/List;Lru/ok/android/externcalls/sdk/conversation/StartCallApiParams;)Le3e;",
        "opponentIds",
        "startConversationWithExternalIds",
        "createJoinLink",
        "(Ljava/lang/String;)Le3e;",
        "Lsk0;",
        "joinReq",
        "Lxmf;",
...
# instance fields
.field private final rxApiClient:Ld2d;
...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0, v1}, Lru/ok/android/externcalls/sdk/api/OkApiService$Companion;-><init>(Lsd4;)V
...
.method public constructor <init>(Ld2d;)V
    ...
    iput-object p1, p0, Lru/ok/android/externcalls/sdk/api/OkApiService;->rxApiClient:Ld2d;

    return-void
.end method

.method public static synthetic getConversationParams$default(Lru/ok/android/externcalls/sdk/api/OkApiService;Ljava/lang/String;Ljava/lang/String;ILjava/lang/Object;)Le3e;
    .locals 1
    ...
    :cond_1
    invoke-virtual {p0, p1, p2}, Lru/ok/android/externcalls/sdk/api/OkApiService;->getConversationParams(Ljava/lang/String;Ljava/lang/String;)Le3e;
...
.method private final startConversationImpl(Ljava/lang/String;Ljava/lang/String;ZLru/ok/android/externcalls/sdk/ConversationParticipant;Ljava/util/List;Ljava/util/List;Lru/ok/android/externcalls/sdk/conversation/StartCallApiParams;)Le3e;
    .locals 4
    ...
    iget-object v0, p0, Lru/ok/android/externcalls/sdk/api/OkApiService;->rxApiClient:Ld2d;

    const-string v1, "vchat.startConversation"

    invoke-static {v1}, Lsec;->A(Ljava/lang/String;)Lsk0;

    move-result-object v1

    sget-object v2, Lml;->c:Lml;

    iput-object v2, v1, Lsk0;->b:Lml;
    ...
    invoke-direct {p1, v2, p2, p3}, Lra7;-><init>(Ljava/lang/String;J)V

    iget-object p2, v1, Lsk0;->c:Lfl;

    invoke-virtual {p2, p1}, Lfl;->a(Lel;)V
    ...
    sget-object p0, Lru/ok/android/externcalls/sdk/api/CallInfo;->PARSER:Loi7;

    invoke-virtual {v1, p0}, Lsk0;->a(Loi7;)Ltk0;

    move-result-object p0

    invoke-virtual {v0, p0}, Ld2d;->a(Lzk;)Lx3e;
...
.method public final createJoinLink(Ljava/lang/String;)Le3e;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iget-object p0, p0, Lru/ok/android/externcalls/sdk/api/OkApiService;->rxApiClient:Ld2d;
    ...
    invoke-direct {p1, v2, v1}, Lru/ok/android/externcalls/sdk/api/UnwrappingParser;-><init>(Ljava/lang/String;Loi7;)V

    invoke-virtual {v0, p1}, Lsk0;->a(Loi7;)Ltk0;

    move-result-object p1

    invoke-virtual {p0, p1}, Ld2d;->a(Lzk;)Lx3e;
...
.method public final getConversationParams(Ljava/lang/String;Ljava/lang/String;)Le3e;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    :cond_1
    sget-object p1, Lru/ok/android/externcalls/sdk/api/ConversationParams;->PARSER:Loi7;
...
.method public final getJoinConversationParamsExt(Ljava/lang/String;Ljava/lang/String;JLru/ok/android/externcalls/sdk/conversation/StartCallApiParams;)Le3e;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {p1, v1, p3, p4}, Lra7;-><init>(Ljava/lang/String;J)V

    iget-object p3, v0, Lsk0;->c:Lfl;

    invoke-virtual {p3, p1}, Lfl;->a(Lel;)V
    ...
    invoke-direct {p2, p4, p1}, Lane;-><init>(Ljava/lang/String;Ljava/lang/String;)V

    invoke-virtual {p3, p2}, Lfl;->a(Lel;)V
    ...
    invoke-direct {p1, p2, p4, p5}, Lra7;-><init>(Ljava/lang/String;J)V
    ...
    sget-object p1, Lru/ok/android/externcalls/sdk/api/JoinByLinkResponse;->PARSER:Loi7;
...
.method public final joinToConversation(Ljava/lang/String;JLru/ok/android/externcalls/sdk/conversation/StartCallApiParams;)Le3e;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {p1, v1, p2, p3}, Lra7;-><init>(Ljava/lang/String;J)V

    iget-object p2, v0, Lsk0;->c:Lfl;
    ...
    invoke-direct {p1, p3, v1, v2}, Lra7;-><init>(Ljava/lang/String;J)V
...
.method public final startConversation(Ljava/lang/String;Ljava/lang/String;ZLru/ok/android/externcalls/sdk/ConversationParticipant;Ljava/util/List;Lru/ok/android/externcalls/sdk/conversation/StartCallApiParams;)Le3e;
    .locals 8
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct/range {v0 .. v7}, Lru/ok/android/externcalls/sdk/api/OkApiService;->startConversationImpl(Ljava/lang/String;Ljava/lang/String;ZLru/ok/android/externcalls/sdk/ConversationParticipant;Ljava/util/List;Ljava/util/List;Lru/ok/android/externcalls/sdk/conversation/StartCallApiParams;)Le3e;
...
.method public final startConversationWithExternalIds(Ljava/lang/String;Ljava/lang/String;ZLru/ok/android/externcalls/sdk/ConversationParticipant;Ljava/util/List;Lru/ok/android/externcalls/sdk/conversation/StartCallApiParams;)Le3e;
    .locals 8
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
