...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "(Ljava/lang/String;Ljava/lang/String;ZLru/ok/android/externcalls/sdk/ConversationParticipant;Ljava/util/List;Ljava/util/List;Lru/ok/android/externcalls/sdk/conversation/StartCallApiParams;)Lfud;",
        "peerId",
        "Lru/ok/android/externcalls/sdk/api/JoinByIdResponse;",
        "joinToConversation",
        "(Ljava/lang/String;JLru/ok/android/externcalls/sdk/conversation/StartCallApiParams;)Lfud;",
        "anonToken",
        "Lru/ok/android/externcalls/sdk/api/ConversationParams;",
        "getConversationParams",
        "(Ljava/lang/String;Ljava/lang/String;)Lfud;",
        "initialJoinLink",
        "getJoinConversationParamsExt",
        "(Ljava/lang/String;Ljava/lang/String;JLru/ok/android/externcalls/sdk/conversation/StartCallApiParams;)Lfud;",
        "opponents",
        "startConversation",
        "(Ljava/lang/String;Ljava/lang/String;ZLru/ok/android/externcalls/sdk/ConversationParticipant;Ljava/util/List;Lru/ok/android/externcalls/sdk/conversation/StartCallApiParams;)Lfud;",
        "opponentIds",
        "startConversationWithExternalIds",
        "createJoinLink",
        "(Ljava/lang/String;)Lfud;",
        "Ljl0;",
        "joinReq",
        "Ltcf;",
...
# instance fields
.field private final rxApiClient:Litc;
...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0, v1}, Lru/ok/android/externcalls/sdk/api/OkApiService$Companion;-><init>(Luc4;)V
...
.method public constructor <init>(Litc;)V
    ...
    iput-object p1, p0, Lru/ok/android/externcalls/sdk/api/OkApiService;->rxApiClient:Litc;

    return-void
.end method

.method public static synthetic getConversationParams$default(Lru/ok/android/externcalls/sdk/api/OkApiService;Ljava/lang/String;Ljava/lang/String;ILjava/lang/Object;)Lfud;
    .locals 1
    ...
    :cond_1
    invoke-virtual {p0, p1, p2}, Lru/ok/android/externcalls/sdk/api/OkApiService;->getConversationParams(Ljava/lang/String;Ljava/lang/String;)Lfud;
...
.method private final startConversationImpl(Ljava/lang/String;Ljava/lang/String;ZLru/ok/android/externcalls/sdk/ConversationParticipant;Ljava/util/List;Ljava/util/List;Lru/ok/android/externcalls/sdk/conversation/StartCallApiParams;)Lfud;
    .locals 4
    ...
    iget-object v0, p0, Lru/ok/android/externcalls/sdk/api/OkApiService;->rxApiClient:Litc;

    const-string v1, "vchat.startConversation"

    invoke-static {v1}, Laug;->u(Ljava/lang/String;)Ljl0;

    move-result-object v1

    sget-object v2, Lel;->c:Lel;

    iput-object v2, v1, Ljl0;->b:Lel;
    ...
    invoke-direct {p1, v2, p2, p3}, Lq67;-><init>(Ljava/lang/String;J)V

    iget-object p2, v1, Ljl0;->c:Lyk;

    invoke-virtual {p2, p1}, Lyk;->a(Lxk;)V
    ...
    sget-object p0, Lru/ok/android/externcalls/sdk/api/CallInfo;->PARSER:Lle7;

    invoke-virtual {v1, p0}, Ljl0;->a(Lle7;)Lkl0;

    move-result-object p0

    invoke-virtual {v0, p0}, Litc;->a(Lsk;)Lyud;
...
.method public final createJoinLink(Ljava/lang/String;)Lfud;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iget-object p0, p0, Lru/ok/android/externcalls/sdk/api/OkApiService;->rxApiClient:Litc;
    ...
    invoke-direct {p1, v2, v1}, Lru/ok/android/externcalls/sdk/api/UnwrappingParser;-><init>(Ljava/lang/String;Lle7;)V

    invoke-virtual {v0, p1}, Ljl0;->a(Lle7;)Lkl0;

    move-result-object p1

    invoke-virtual {p0, p1}, Litc;->a(Lsk;)Lyud;
...
.method public final getConversationParams(Ljava/lang/String;Ljava/lang/String;)Lfud;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    :cond_1
    sget-object p1, Lru/ok/android/externcalls/sdk/api/ConversationParams;->PARSER:Lle7;
...
.method public final getJoinConversationParamsExt(Ljava/lang/String;Ljava/lang/String;JLru/ok/android/externcalls/sdk/conversation/StartCallApiParams;)Lfud;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {p1, v1, p3, p4}, Lq67;-><init>(Ljava/lang/String;J)V

    iget-object p3, v0, Ljl0;->c:Lyk;

    invoke-virtual {p3, p1}, Lyk;->a(Lxk;)V
    ...
    invoke-direct {p2, p4, p1}, Lude;-><init>(Ljava/lang/String;Ljava/lang/String;)V

    invoke-virtual {p3, p2}, Lyk;->a(Lxk;)V
    ...
    invoke-direct {p1, p2, p4, p5}, Lq67;-><init>(Ljava/lang/String;J)V
    ...
    sget-object p1, Lru/ok/android/externcalls/sdk/api/JoinByLinkResponse;->PARSER:Lle7;
...
.method public final joinToConversation(Ljava/lang/String;JLru/ok/android/externcalls/sdk/conversation/StartCallApiParams;)Lfud;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {p1, v1, p2, p3}, Lq67;-><init>(Ljava/lang/String;J)V

    iget-object p2, v0, Ljl0;->c:Lyk;
    ...
    invoke-direct {p1, p3, v1, v2}, Lq67;-><init>(Ljava/lang/String;J)V
...
.method public final startConversation(Ljava/lang/String;Ljava/lang/String;ZLru/ok/android/externcalls/sdk/ConversationParticipant;Ljava/util/List;Lru/ok/android/externcalls/sdk/conversation/StartCallApiParams;)Lfud;
    .locals 8
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct/range {v0 .. v7}, Lru/ok/android/externcalls/sdk/api/OkApiService;->startConversationImpl(Ljava/lang/String;Ljava/lang/String;ZLru/ok/android/externcalls/sdk/ConversationParticipant;Ljava/util/List;Ljava/util/List;Lru/ok/android/externcalls/sdk/conversation/StartCallApiParams;)Lfud;
...
.method public final startConversationWithExternalIds(Ljava/lang/String;Ljava/lang/String;ZLru/ok/android/externcalls/sdk/ConversationParticipant;Ljava/util/List;Lru/ok/android/externcalls/sdk/conversation/StartCallApiParams;)Lfud;
    .locals 8
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
