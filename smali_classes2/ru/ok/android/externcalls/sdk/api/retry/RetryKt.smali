...
.method private static final createFastBackoff()Lgf0;
    ...
    invoke-direct {v0, v1, v2, v3}, Lgf0;-><init>(Lee5;J)V
...
.method public static final retryApiCallForBackgroundWork(Le3e;ZLxec;)Le3e;
    .locals 0
    ...
    invoke-static {p0, p1, p2}, Lru/ok/android/externcalls/sdk/api/retry/RetryKt;->retryWithSlowBackoff(Le3e;ZLxec;)Le3e;
...
.method public static final retryApiCallForFastWorkRequired(Le3e;ZLxec;)Le3e;
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    invoke-static {p0, p1, p2}, Lru/ok/android/externcalls/sdk/api/retry/RetryKt;->retryWithFastBackoff(Le3e;ZLxec;)Le3e;
...
.method public static final retryApiCallForIncoming(Le3e;ZLxec;)Le3e;
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
...
.method public static final retryApiCallForJoining(Le3e;ZLxec;)Le3e;
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
...
.method public static final retryApiCallForOutgoing(Le3e;ZLxec;)Le3e;
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
...
.method private static final retryApiWithBackoff(Le3e;ZLxec;Lgf0;)Le3e;
    .locals 6
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    invoke-direct {v3, p2}, Lru/ok/android/externcalls/sdk/api/retry/RetryKt$retryApiWithBackoff$2;-><init>(Lxec;)V

    new-instance v5, Lru/ok/android/externcalls/sdk/api/retry/RetryKt$retryApiWithBackoff$3;

    invoke-direct {v5, p2}, Lru/ok/android/externcalls/sdk/api/retry/RetryKt$retryApiWithBackoff$3;-><init>(Lxec;)V
    ...
    invoke-direct/range {v0 .. v5}, Llwc;-><init>(Lmc6;Lgf0;Lad6;Lo6d;Lmc6;)V

    new-instance p1, Li6a;

    const/4 p2, 0x7

    invoke-direct {p1, p0, v0, p2}, Li6a;-><init>(Lp5a;Lbd6;I)V

    new-instance p0, Lj8a;

    const/4 p2, 0x0

    invoke-direct {p0, p2, p1}, Lj8a;-><init>(ILjava/lang/Object;)V
    ...
    invoke-interface {p2, p1, p3}, Lxec;->log(Ljava/lang/String;Ljava/lang/String;)V

    return-object p0
.end method

.method private static final retryWithFastBackoff(Le3e;ZLxec;)Le3e;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    invoke-static {p0, p1, p2, v0}, Lru/ok/android/externcalls/sdk/api/retry/RetryKt;->retryApiWithBackoff(Le3e;ZLxec;Lgf0;)Le3e;
...
.method private static final retryWithSlowBackoff(Le3e;ZLxec;)Le3e;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
