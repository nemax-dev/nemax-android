...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "store",
        "<init>",
        "(Lkc6;Lsy0;Lru/ok/android/externcalls/sdk/renderer/ConversationRenderers;Lru/ok/android/externcalls/sdk/participant/collection/ParticipantStore;)V",
        "Ljr1;",
        "key",
        "",
...
.field private final state:Lkc6;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lkc6;"
        }
...
# direct methods
.method public constructor <init>(Lkc6;Lsy0;Lru/ok/android/externcalls/sdk/renderer/ConversationRenderers;Lru/ok/android/externcalls/sdk/participant/collection/ParticipantStore;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p1, p0, Lru/ok/android/externcalls/sdk/video/internal/VideoRenderManagerImpl;->state:Lkc6;

    iput-object p2, p0, Lru/ok/android/externcalls/sdk/video/internal/VideoRenderManagerImpl;->call:Lsy0;
...
.method private final setRenderers(Ljr1;Ljava/util/List;)V
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method private final setRenderersForMe(Ljr1;Ljava/util/List;)V
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    :cond_1
    :goto_0
    invoke-direct {p0, p1, p2}, Lru/ok/android/externcalls/sdk/video/internal/VideoRenderManagerImpl;->setRenderers(Ljr1;Ljava/util/List;)V

    iget-object p0, p0, Lru/ok/android/externcalls/sdk/video/internal/VideoRenderManagerImpl;->call:Lsy0;
    ...
    invoke-virtual {v0, p1, p2}, Laq1;->R(Ljr1;Ljava/util/List;)V

    iget-object p0, p0, Lsy0;->t0:Lx06;
    ...
    iput-object p1, p2, Lcs8;->b:Ljava/lang/Object;

    sget-object p1, Lu6g;->c:Lu6g;

    iput-object p1, p2, Lcs8;->a:Ljava/lang/Object;

    invoke-virtual {p2}, Lcs8;->l()Ljr1;
    ...
    invoke-virtual {p0, p1}, Lfy7;->k(Lorg/webrtc/VideoSink;)V
...
.method private final setRenderersForOthers(Ljr1;Ljava/util/List;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public getCallRenderer()Lye1;
    ...
    iget-object v0, p0, Lru/ok/android/externcalls/sdk/video/internal/VideoRenderManagerImpl;->state:Lkc6;
...
.method public getEglBaseContext()Lorg/webrtc/EglBase$Context;
    ...
    iget-object v0, p0, Lru/ok/android/externcalls/sdk/video/internal/VideoRenderManagerImpl;->call:Lsy0;

    iget-object v0, v0, Lsy0;->m:Lorg/webrtc/EglBase;
    ...
    iget-object p0, p0, Lsy0;->m:Lorg/webrtc/EglBase;
...
.method public setRenderers(Lru/ok/android/externcalls/sdk/layout/ConversationVideoTrackParticipantKey;Ljava/util/List;)V
    ...
    .line 4
    invoke-virtual {p1}, Lru/ok/android/externcalls/sdk/layout/ConversationVideoTrackParticipantKey;->getType()Lu6g;

    move-result-object v2

    .line 5
    iput-object v2, v1, Lcs8;->a:Ljava/lang/Object;
    ...
    .line 8
    iput-object v2, v1, Lcs8;->b:Ljava/lang/Object;

    .line 9
    invoke-virtual {p1}, Lru/ok/android/externcalls/sdk/layout/ConversationVideoTrackParticipantKey;->getMovieId()Llj9;

    move-result-object v2

    .line 10
    iput-object v2, v1, Lcs8;->c:Ljava/lang/Object;

    .line 11
    invoke-virtual {v1}, Lcs8;->l()Ljr1;
    ...
    .line 14
    invoke-direct {p0, v1, p2}, Lru/ok/android/externcalls/sdk/video/internal/VideoRenderManagerImpl;->setRenderersForMe(Ljr1;Ljava/util/List;)V

    return-void

    .line 15
    :cond_1
    invoke-direct {p0, v1, p2}, Lru/ok/android/externcalls/sdk/video/internal/VideoRenderManagerImpl;->setRenderersForOthers(Ljr1;Ljava/util/List;)V
