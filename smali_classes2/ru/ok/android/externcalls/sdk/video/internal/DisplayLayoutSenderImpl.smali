...
.field private final sender:Lmc6;
...
.field private final store:Lmc6;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lmc6;"
        }
...
# direct methods
.method public constructor <init>(Lmc6;Lmc6;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p1, p0, Lru/ok/android/externcalls/sdk/video/internal/DisplayLayoutSenderImpl;->store:Lmc6;

    iput-object p2, p0, Lru/ok/android/externcalls/sdk/video/internal/DisplayLayoutSenderImpl;->sender:Lmc6;
...
.method public sendDisplayLayouts(Ljava/util/Collection;)V
    ...
    iget-object p0, p0, Lru/ok/android/externcalls/sdk/video/internal/DisplayLayoutSenderImpl;->sender:Lmc6;
    ...
    invoke-virtual {v2}, Lru/ok/android/externcalls/sdk/layout/ConversationVideoTrackParticipantKey;->getType()Lu6g;
    ...
    iget-object v4, p0, Lru/ok/android/externcalls/sdk/video/internal/DisplayLayoutSenderImpl;->store:Lmc6;

    invoke-interface {v4, v3}, Lmc6;->invoke(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    iput-object v3, v4, Lcs8;->b:Ljava/lang/Object;

    iput-object v2, v4, Lcs8;->a:Ljava/lang/Object;

    invoke-virtual {v1}, Lru/ok/android/externcalls/sdk/layout/ConversationDisplayLayoutItem;->getVideoTrackParticipantKey()Lru/ok/android/externcalls/sdk/layout/ConversationVideoTrackParticipantKey;

    move-result-object v2

    invoke-virtual {v2}, Lru/ok/android/externcalls/sdk/layout/ConversationVideoTrackParticipantKey;->getMovieId()Llj9;

    move-result-object v2

    iput-object v2, v4, Lcs8;->c:Ljava/lang/Object;
    ...
    invoke-virtual {v1}, Lru/ok/android/externcalls/sdk/layout/ConversationDisplayLayoutItem;->getLayout()Lgxf;

    move-result-object v1

    invoke-direct {v3, v2, v1}, Ld51;-><init>(Ljr1;Lgxf;)V
