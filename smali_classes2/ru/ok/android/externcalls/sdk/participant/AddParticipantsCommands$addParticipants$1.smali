...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Lru/ok/android/externcalls/sdk/participant/AddParticipantsCommands;->addParticipants(Ljava/util/Collection;Ljava/lang/Boolean;ZLmc6;Lmc6;)V
.end annotation
...
# direct methods
.method public constructor <init>(Ljava/util/Collection;Ljava/lang/Boolean;ZLmc6;Lru/ok/android/externcalls/sdk/participant/AddParticipantsCommands;Lmc6;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p4, p0, Lru/ok/android/externcalls/sdk/participant/AddParticipantsCommands$addParticipants$1;->$onError:Lmc6;
    ...
    iput-object p6, p0, Lru/ok/android/externcalls/sdk/participant/AddParticipantsCommands$addParticipants$1;->$onSuccess:Lmc6;
...
.method public static synthetic a(Lmc6;Lru/ok/android/externcalls/sdk/participant/AddParticipantsCommands;Lorg/json/JSONObject;)V
    .locals 0

    invoke-static {p0, p1, p2}, Lru/ok/android/externcalls/sdk/participant/AddParticipantsCommands$addParticipants$1;->invoke$lambda$5(Lmc6;Lru/ok/android/externcalls/sdk/participant/AddParticipantsCommands;Lorg/json/JSONObject;)V

    return-void
.end method

.method public static synthetic c(Lru/ok/android/externcalls/sdk/participant/AddParticipantsCommands;Lmc6;Lmc6;Lorg/json/JSONObject;)V
    .locals 0

    invoke-static {p0, p1, p2, p3}, Lru/ok/android/externcalls/sdk/participant/AddParticipantsCommands$addParticipants$1;->invoke$lambda$4(Lru/ok/android/externcalls/sdk/participant/AddParticipantsCommands;Lmc6;Lmc6;Lorg/json/JSONObject;)V

    return-void
.end method

.method private static final invoke$lambda$4(Lru/ok/android/externcalls/sdk/participant/AddParticipantsCommands;Lmc6;Lmc6;Lorg/json/JSONObject;)V
    .locals 8
    ...
    :cond_0
    invoke-static {v5}, Lcl7;->N(Lorg/json/JSONObject;)Lqg1;

    move-result-object v6

    invoke-static {p0}, Lru/ok/android/externcalls/sdk/participant/AddParticipantsCommands;->access$getCall$p(Lru/ok/android/externcalls/sdk/participant/AddParticipantsCommands;)Lsy0;

    move-result-object v7

    invoke-virtual {v7, v6, v5}, Lsy0;->y(Lqg1;Lorg/json/JSONObject;)I
    ...
    invoke-static {p3, v0}, Lcl7;->h0(Lorg/json/JSONObject;Ljava/lang/String;)Ljava/util/ArrayList;
    ...
    invoke-static {p3, v4}, Lcl7;->h0(Lorg/json/JSONObject;Ljava/lang/String;)Ljava/util/ArrayList;
    ...
    invoke-virtual {p3, v5}, Lru/ok/android/externcalls/sdk/id/IdMappingWrapper;->getByInternal(Lqg1;)Lru/ok/android/externcalls/sdk/id/ParticipantId;
    ...
    invoke-virtual {p0, v3}, Lru/ok/android/externcalls/sdk/id/IdMappingWrapper;->getByInternal(Lqg1;)Lru/ok/android/externcalls/sdk/id/ParticipantId;
...
.method private static final invoke$lambda$5(Lmc6;Lru/ok/android/externcalls/sdk/participant/AddParticipantsCommands;Lorg/json/JSONObject;)V
    .locals 0
...
.method public bridge synthetic invoke(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1}, Lru/ok/android/externcalls/sdk/participant/AddParticipantsCommands$addParticipants$1;->invoke(Ln1e;)V
...
.method public final invoke(Ln1e;)V
    .locals 6
    ...
    invoke-static {v0, v1, v2}, Lcl7;->p(Ljava/util/Collection;Ljava/lang/Boolean;Z)Lmh6;
    ...
    iget-object v2, p0, Lru/ok/android/externcalls/sdk/participant/AddParticipantsCommands$addParticipants$1;->$onSuccess:Lmc6;

    iget-object v3, p0, Lru/ok/android/externcalls/sdk/participant/AddParticipantsCommands$addParticipants$1;->$onError:Lmc6;

    new-instance v4, Lru/ok/android/externcalls/sdk/participant/c;

    invoke-direct {v4, v1, v2, v3}, Lru/ok/android/externcalls/sdk/participant/c;-><init>(Lru/ok/android/externcalls/sdk/participant/AddParticipantsCommands;Lmc6;Lmc6;)V
    ...
    .line 4
    invoke-virtual {p1, v0, v1, v4, v2}, Ln1e;->d(Lq1e;ZLm1e;Lm1e;)V
    :try_end_0
    .catch Lorg/json/JSONException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    .line 5
    iget-object p0, p0, Lru/ok/android/externcalls/sdk/participant/AddParticipantsCommands$addParticipants$1;->$onError:Lmc6;
