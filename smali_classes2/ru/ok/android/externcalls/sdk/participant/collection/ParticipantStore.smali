...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "sessionRoomId",
        "add",
        "(Lru/ok/android/externcalls/sdk/ConversationParticipant;Lnnd;)V",
        "Lqg1;",
        ...
        "getByInternal",
        "(Lqg1;)Lru/ok/android/externcalls/sdk/ConversationParticipant;",
        "removeByExternal",
        ...
        "(Lru/ok/android/externcalls/sdk/ConversationParticipant;)Lnnd;",
        "Lhnd;",
        "room",
...
.field private proposedRoom:Lhnd;

.field private proposedRoomId:Lnnd;
...
.method public constructor <init>(Lru/ok/android/externcalls/sdk/ConversationParticipant;Lru/ok/android/externcalls/sdk/id/local/LocalIdMappings;)V
    ...
    sget-object p2, Llnd;->a:Llnd;

    iput-object p2, p0, Lru/ok/android/externcalls/sdk/participant/collection/ParticipantStore;->activeRoomId:Lnnd;
...
.method private final getSessionRoomParticipantsMap(Lnnd;)Ljava/util/LinkedHashMap;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method private final onActiveRoomChanged(Lnnd;Lnnd;)V
    .locals 1
    ...
    invoke-virtual {p0, p1, p2}, Lru/ok/android/externcalls/sdk/participant/collection/ParticipantStore;->add(Lru/ok/android/externcalls/sdk/ConversationParticipant;Lnnd;)V
...
.method private final setActiveRoomId(Lnnd;)V
    .locals 1

    iget-object v0, p0, Lru/ok/android/externcalls/sdk/participant/collection/ParticipantStore;->activeRoomId:Lnnd;
    ...
    iput-object p1, p0, Lru/ok/android/externcalls/sdk/participant/collection/ParticipantStore;->activeRoomId:Lnnd;

    invoke-direct {p0, v0, p1}, Lru/ok/android/externcalls/sdk/participant/collection/ParticipantStore;->onActiveRoomChanged(Lnnd;Lnnd;)V
...
# virtual methods
.method public final add(Lru/ok/android/externcalls/sdk/ConversationParticipant;Lnnd;)V
    .locals 2
    ...
    .line 4
    invoke-direct {p0, p2}, Lru/ok/android/externcalls/sdk/participant/collection/ParticipantStore;->getSessionRoomParticipantsMap(Lnnd;)Ljava/util/LinkedHashMap;
...
.method public final addToActiveSessionRoom(Lru/ok/android/externcalls/sdk/ConversationParticipant;)V
    ...
    invoke-virtual {p0, p1, v0}, Lru/ok/android/externcalls/sdk/participant/collection/ParticipantStore;->add(Lru/ok/android/externcalls/sdk/ConversationParticipant;Lnnd;)V
...
.method public final containsByInternal(Lqg1;)Z
    .locals 0
...
.method public final getActiveRoom()Lhnd;
    .locals 0

    iget-object p0, p0, Lru/ok/android/externcalls/sdk/participant/collection/ParticipantStore;->activeRoom:Lhnd;

    return-object p0
.end method

.method public final getActiveRoomId()Lnnd;
    .locals 0

    iget-object p0, p0, Lru/ok/android/externcalls/sdk/participant/collection/ParticipantStore;->activeRoomId:Lnnd;
...
.method public getByInternal(Lqg1;)Lru/ok/android/externcalls/sdk/ConversationParticipant;
    .locals 1

    iget-object v0, p0, Lru/ok/android/externcalls/sdk/participant/collection/ParticipantStore;->localIdMappings:Lru/ok/android/externcalls/sdk/id/local/LocalIdMappings;

    invoke-virtual {v0, p1}, Lru/ok/android/externcalls/sdk/id/local/LocalIdMappings;->getLocalId(Lqg1;)Lru/ok/android/externcalls/sdk/id/local/LocalParticipantId;
...
.method public final getParticipantRoomId(Lru/ok/android/externcalls/sdk/ConversationParticipant;)Lnnd;
    .locals 0
...
.method public getParticipants()Ljava/util/Collection;
    ...
    invoke-virtual {p0, v0}, Lru/ok/android/externcalls/sdk/participant/collection/ParticipantStore;->getParticipants(Lnnd;)Ljava/util/Collection;
...
.method public final getParticipants(Lnnd;)Ljava/util/Collection;
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 2
    invoke-direct {p0, p1}, Lru/ok/android/externcalls/sdk/participant/collection/ParticipantStore;->getSessionRoomParticipantsMap(Lnnd;)Ljava/util/LinkedHashMap;
...
.method public final getProposedRoom()Lhnd;
    .locals 0

    iget-object p0, p0, Lru/ok/android/externcalls/sdk/participant/collection/ParticipantStore;->proposedRoom:Lhnd;

    return-object p0
.end method

.method public final getProposedRoomId()Lnnd;
    .locals 0

    iget-object p0, p0, Lru/ok/android/externcalls/sdk/participant/collection/ParticipantStore;->proposedRoomId:Lnnd;
...
.method public final maybeUpdateRoom(Lhnd;)V
    .locals 2

    iget-object v0, p0, Lru/ok/android/externcalls/sdk/participant/collection/ParticipantStore;->activeRoomId:Lnnd;

    iget-object v1, p1, Lhnd;->a:Lmnd;
    ...
    iput-object p1, p0, Lru/ok/android/externcalls/sdk/participant/collection/ParticipantStore;->activeRoom:Lhnd;

    :cond_0
    iget-object v0, p0, Lru/ok/android/externcalls/sdk/participant/collection/ParticipantStore;->proposedRoomId:Lnnd;
    ...
    iput-object p1, p0, Lru/ok/android/externcalls/sdk/participant/collection/ParticipantStore;->proposedRoom:Lhnd;
...
.method public final removeByInternal(Ljava/util/Collection;)V
    ...
    .line 4
    invoke-virtual {p0, v0}, Lru/ok/android/externcalls/sdk/participant/collection/ParticipantStore;->removeByInternal(Lqg1;)V
...
.method public final removeByInternal(Lqg1;)V
    .locals 1
...
.method public final setActiveSessionRoom(Lnnd;Lhnd;)V
    .locals 0

    invoke-direct {p0, p1}, Lru/ok/android/externcalls/sdk/participant/collection/ParticipantStore;->setActiveRoomId(Lnnd;)V

    iput-object p2, p0, Lru/ok/android/externcalls/sdk/participant/collection/ParticipantStore;->activeRoom:Lhnd;

    return-void
.end method

.method public final setProposedSessionRoom(Lnnd;Lhnd;)V
    .locals 0

    iput-object p1, p0, Lru/ok/android/externcalls/sdk/participant/collection/ParticipantStore;->proposedRoomId:Lnnd;

    iput-object p2, p0, Lru/ok/android/externcalls/sdk/participant/collection/ParticipantStore;->proposedRoom:Lhnd;
...
.method public toArray()[Ljava/lang/Object;
    ...
    .line 1
    invoke-static {p0}, Lye5;->X(Ljava/util/Collection;)[Ljava/lang/Object;
...
.method public toArray([Ljava/lang/Object;)[Ljava/lang/Object;
    ...
    .line 2
    invoke-static {p0, p1}, Lye5;->Y(Ljava/util/Collection;[Ljava/lang/Object;)[Ljava/lang/Object;
