...
.method private constructor <init>(Landroid/content/Context;Lxec;)V
    .locals 1
    ...
    iput-object p2, p0, Lru/ok/android/externcalls/sdk/id/IdMappingWrapper;->log:Lxec;
...
.method private declared-synchronized ensureMappingNotOutdated(Lqg1;)V
    .locals 1
...
.method public static get(Landroid/content/Context;Lxec;)Lru/ok/android/externcalls/sdk/id/IdMappingWrapper;
    .locals 2
    ...
    invoke-direct {v1, p0, p1}, Lru/ok/android/externcalls/sdk/id/IdMappingWrapper;-><init>(Landroid/content/Context;Lxec;)V
...
.method private getFile(Z)Ljava/io/File;
    ...
    iget-object p0, p0, Lru/ok/android/externcalls/sdk/id/IdMappingWrapper;->log:Lxec;
...
.method private declared-synchronized read()V
    ...
    :catch_0
    :try_start_4
    iget-object v3, p0, Lru/ok/android/externcalls/sdk/id/IdMappingWrapper;->log:Lxec;
    ...
    invoke-interface {v3, v4, v1}, Lxec;->log(Ljava/lang/String;Ljava/lang/String;)V
    ...
    iget-object v0, p0, Lru/ok/android/externcalls/sdk/id/IdMappingWrapper;->log:Lxec;
...
.method private declared-synchronized write()V
    ...
    invoke-virtual {v3}, Lqg1;->b()Ljava/lang/String;
...
# virtual methods
.method public declared-synchronized addMapping(Lru/ok/android/externcalls/sdk/id/ParticipantId;Lqg1;)V
    .locals 2
...
.method public declared-synchronized getByExternal(Lru/ok/android/externcalls/sdk/id/ParticipantId;)Lqg1;
    .locals 1
...
.method public declared-synchronized getByInternal(Lqg1;)Lru/ok/android/externcalls/sdk/id/ParticipantId;
    .locals 1
    ...
    :cond_0
    :try_start_1
    invoke-direct {p0, p1}, Lru/ok/android/externcalls/sdk/id/IdMappingWrapper;->ensureMappingNotOutdated(Lqg1;)V
...
.method public declared-synchronized readCacheFromDisk()V
    ...
    :try_start_1
    iget-object v1, p0, Lru/ok/android/externcalls/sdk/id/IdMappingWrapper;->log:Lxec;
...
.method public scheduleReadCacheFromDisk()V
    ...
    invoke-direct {v1, p0, v2}, Lp07;-><init>(Lru/ok/android/externcalls/sdk/id/IdMappingWrapper;I)V
