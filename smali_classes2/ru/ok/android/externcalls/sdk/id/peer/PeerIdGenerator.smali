...
.field private static final PEER_ID_RANGE:Le38;
...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0, v1}, Lru/ok/android/externcalls/sdk/id/peer/PeerIdGenerator$Companion;-><init>(Lsd4;)V
    ...
    invoke-direct {v0, v1, v2, v3, v4}, Le38;-><init>(JJ)V

    sput-object v0, Lru/ok/android/externcalls/sdk/id/peer/PeerIdGenerator;->PEER_ID_RANGE:Le38;
...
.method public final generatePeerId()J
    ...
    sget-object p0, Lru/ok/android/externcalls/sdk/id/peer/PeerIdGenerator;->PEER_ID_RANGE:Le38;

    sget-object v0, Ljfc;->a:Lifc;

    :try_start_0
    iget-wide v0, p0, Le38;->a:J

    invoke-virtual {p0}, Le38;->isEmpty()Z

    move-result v2

    if-nez v2, :cond_2

    iget-wide v2, p0, Le38;->b:J
    ...
    sget-object p0, Ljfc;->b:Lh3;

    invoke-virtual {p0, v0, v1, v2, v3}, Ljfc;->f(JJ)J
