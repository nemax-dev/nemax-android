...
.field private final okApi:Lh9a;

.field private final rtcLog:Lxec;
...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0, v1}, Lru/ok/android/externcalls/sdk/id/mapping/ExternalToInternalIdsMapper$Companion;-><init>(Lsd4;)V
...
.method public constructor <init>(Lh9a;Lpg1;Lxec;)V
    .locals 0

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Lru/ok/android/externcalls/sdk/id/mapping/ExternalToInternalIdsMapper;->okApi:Lh9a;

    iput-object p2, p0, Lru/ok/android/externcalls/sdk/id/mapping/ExternalToInternalIdsMapper;->callParams:Lpg1;

    iput-object p3, p0, Lru/ok/android/externcalls/sdk/id/mapping/ExternalToInternalIdsMapper;->rtcLog:Lxec;
...
.method private final filterEmptyParticipantIds(Ljava/util/Collection;)Ljava/util/List;
    ...
    iget-object v3, p0, Lru/ok/android/externcalls/sdk/id/mapping/ExternalToInternalIdsMapper;->rtcLog:Lxec;
    ...
    invoke-interface {v3, v6, v5, v4}, Lxec;->reportException(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method private final getBatchedResolveInternalIdsRequests(Ljava/util/Collection;)Ljava/util/List;
    ...
    invoke-direct {p0, v1}, Lru/ok/android/externcalls/sdk/id/mapping/ExternalToInternalIdsMapper;->getResolveInternalIdsRequestsForCandidates(Ljava/util/List;)Ltk0;
...
.method private final getResolveInternalIdsRequestsForCandidates(Ljava/util/List;)Ltk0;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v1, v2, p0}, Lane;-><init>(Ljava/lang/String;Ljava/lang/String;)V

    iget-object p0, v0, Lsk0;->c:Lfl;

    invoke-virtual {p0, v1}, Lfl;->a(Lel;)V

    sget-object p0, Lru/ok/android/externcalls/sdk/api/BatchInternalIdResponse;->PARSER:Loi7;

    invoke-virtual {v0, p0}, Lsk0;->a(Loi7;)Ltk0;
...
.method public map(Ljava/util/Collection;)Ljava/util/Map;
    ...
    invoke-direct {v3, v2, v2}, Ljl;-><init>(Ltk0;Lzk;)V
    ...
    :cond_1
    iget-object v1, p0, Lru/ok/android/externcalls/sdk/id/mapping/ExternalToInternalIdsMapper;->okApi:Lh9a;
    ...
    invoke-direct {v2, v0}, Lcl0;-><init>([Ljl;)V

    invoke-virtual {v1, v2}, Ld2d;->a(Lzk;)Lx3e;

    move-result-object v0

    iget-object v1, p0, Lru/ok/android/externcalls/sdk/id/mapping/ExternalToInternalIdsMapper;->callParams:Lpg1;

    iget-object v1, v1, Lpg1;->B:Lng1;

    iget-boolean v1, v1, Lng1;->h:Z

    iget-object v2, p0, Lru/ok/android/externcalls/sdk/id/mapping/ExternalToInternalIdsMapper;->rtcLog:Lxec;

    invoke-static {v0, v1, v2}, Lru/ok/android/externcalls/sdk/api/retry/RetryKt;->retryApiCallForFastWorkRequired(Le3e;ZLxec;)Le3e;
