...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "toRecordDescription",
        "(Lpi1;)Lru/ok/android/externcalls/sdk/record/RecordDescription;",
        ...
        "current",
        "setMyRecordHistory",
        "(Lru/ok/android/externcalls/sdk/id/ParticipantId;Lnnd;Lru/ok/android/externcalls/sdk/record/RecordDescription;)V",
        "reportStarted",
        "()V",
        "whoStoppedRecordId",
        "reportStopped",
        ...
        "onError",
        "startRecord",
        "(Lru/ok/android/externcalls/sdk/record/RecordManager$StartParams;Lkc6;Lmc6;)V",
        "Lru/ok/android/externcalls/sdk/record/RecordManager$StopParams;",
        "stopRecord",
        "(Lru/ok/android/externcalls/sdk/record/RecordManager$StopParams;Lkc6;Lmc6;)V",
...
# instance fields
.field private activeRoomId:Lnnd;

.field private final commandParamsCreator:Lglc;
...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0, v1}, Lru/ok/android/externcalls/sdk/record/internal/RecordManagerImpl$Companion;-><init>(Lsd4;)V
...
.method public constructor <init>(Lxec;Lru/ok/android/externcalls/sdk/participant/collection/ParticipantStore;Lru/ok/android/externcalls/sdk/id/mapping/IdMappingResolver;Lru/ok/android/externcalls/sdk/id/IdMappingWrapper;Lru/ok/android/externcalls/sdk/signaling/SignalingProvider;Lru/ok/android/externcalls/sdk/events/RecordEventListener;)V
    ...
    iput-object p1, p0, Lru/ok/android/externcalls/sdk/record/internal/RecordManagerImpl;->logger:Lxec;
    ...
    iput-object p1, p0, Lru/ok/android/externcalls/sdk/record/internal/RecordManagerImpl;->commandParamsCreator:Lglc;
    ...
    iput-object p1, p0, Lru/ok/android/externcalls/sdk/record/internal/RecordManagerImpl;->activeRoomId:Lnnd;

    return-void
.end method

.method public static synthetic a(Lru/ok/android/externcalls/sdk/record/internal/RecordManagerImpl;Lri1;)V
    .locals 0

    invoke-static {p0, p1}, Lru/ok/android/externcalls/sdk/record/internal/RecordManagerImpl;->onRecordStarted$lambda$4(Lru/ok/android/externcalls/sdk/record/internal/RecordManagerImpl;Lri1;)V

    return-void
.end method

.method private final applyRecordStarted(Lri1;)V
    .locals 2

    iget-object v0, p1, Lri1;->b:Lpi1;

    iget-object p1, p1, Lri1;->a:Lnnd;

    invoke-direct {p0, v0}, Lru/ok/android/externcalls/sdk/record/internal/RecordManagerImpl;->toRecordDescription(Lpi1;)Lru/ok/android/externcalls/sdk/record/RecordDescription;
    ...
    invoke-direct {p0, v1, p1, v0}, Lru/ok/android/externcalls/sdk/record/internal/RecordManagerImpl;->setMyRecordHistory(Lru/ok/android/externcalls/sdk/id/ParticipantId;Lnnd;Lru/ok/android/externcalls/sdk/record/RecordDescription;)V
    ...
    iget-object v0, p0, Lru/ok/android/externcalls/sdk/record/internal/RecordManagerImpl;->activeRoomId:Lnnd;
...
.method public static synthetic b(Lru/ok/android/externcalls/sdk/record/internal/RecordManagerImpl;Lru/ok/android/externcalls/sdk/record/RecordManager$StartParams;Lmc6;Lorg/json/JSONObject;)V
    .locals 0

    invoke-static {p0, p1, p2, p3}, Lru/ok/android/externcalls/sdk/record/internal/RecordManagerImpl;->startRecord$lambda$1(Lru/ok/android/externcalls/sdk/record/internal/RecordManagerImpl;Lru/ok/android/externcalls/sdk/record/RecordManager$StartParams;Lmc6;Lorg/json/JSONObject;)V

    return-void
.end method

.method public static synthetic c(Lru/ok/android/externcalls/sdk/record/RecordManager$StopParams;Lkc6;Lorg/json/JSONObject;)V
    .locals 0

    invoke-static {p0, p1, p2}, Lru/ok/android/externcalls/sdk/record/internal/RecordManagerImpl;->stopRecord$lambda$2(Lru/ok/android/externcalls/sdk/record/RecordManager$StopParams;Lkc6;Lorg/json/JSONObject;)V

    return-void
.end method

.method public static synthetic d(Lru/ok/android/externcalls/sdk/record/RecordManager$StartParams;Lkc6;Lorg/json/JSONObject;)V
    .locals 0

    invoke-static {p0, p1, p2}, Lru/ok/android/externcalls/sdk/record/internal/RecordManagerImpl;->startRecord$lambda$0(Lru/ok/android/externcalls/sdk/record/RecordManager$StartParams;Lkc6;Lorg/json/JSONObject;)V
...
.method public static synthetic f(Lru/ok/android/externcalls/sdk/record/internal/RecordManagerImpl;Lru/ok/android/externcalls/sdk/record/RecordManager$StopParams;Lmc6;Lorg/json/JSONObject;)V
    .locals 0

    invoke-static {p0, p1, p2, p3}, Lru/ok/android/externcalls/sdk/record/internal/RecordManagerImpl;->stopRecord$lambda$3(Lru/ok/android/externcalls/sdk/record/internal/RecordManagerImpl;Lru/ok/android/externcalls/sdk/record/RecordManager$StopParams;Lmc6;Lorg/json/JSONObject;)V

    return-void
.end method

.method private final notifyListenersWhenActiveRoomChanged(Lnnd;Lnnd;)V
    .locals 1
...
.method private static final onRecordStarted$lambda$4(Lru/ok/android/externcalls/sdk/record/internal/RecordManagerImpl;Lri1;)V
    .locals 0

    invoke-direct {p0, p1}, Lru/ok/android/externcalls/sdk/record/internal/RecordManagerImpl;->applyRecordStarted(Lri1;)V
...
.method private static final onRecordStarted$lambda$5(Lru/ok/android/externcalls/sdk/record/internal/RecordManagerImpl;)V
    ...
    iget-object p0, p0, Lru/ok/android/externcalls/sdk/record/internal/RecordManagerImpl;->logger:Lxec;
...
.method private final setMyRecordHistory(Lru/ok/android/externcalls/sdk/id/ParticipantId;Lnnd;Lru/ok/android/externcalls/sdk/record/RecordDescription;)V
    .locals 2
...
.method private static final startRecord$lambda$0(Lru/ok/android/externcalls/sdk/record/RecordManager$StartParams;Lkc6;Lorg/json/JSONObject;)V
    .locals 0

    invoke-virtual {p0}, Lru/ok/android/externcalls/sdk/record/RecordManager$StartParams;->getOnSuccess()Lmc6;
...
.method private static final startRecord$lambda$1(Lru/ok/android/externcalls/sdk/record/internal/RecordManagerImpl;Lru/ok/android/externcalls/sdk/record/RecordManager$StartParams;Lmc6;Lorg/json/JSONObject;)V
    .locals 2
    ...
    :cond_0
    invoke-virtual {p1}, Lru/ok/android/externcalls/sdk/record/RecordManager$StartParams;->getOnError()Lmc6;
...
.method private static final stopRecord$lambda$2(Lru/ok/android/externcalls/sdk/record/RecordManager$StopParams;Lkc6;Lorg/json/JSONObject;)V
    .locals 1

    invoke-virtual {p0}, Lru/ok/android/externcalls/sdk/record/RecordManager$StopParams;->getOnSuccess()Lmc6;
...
.method private static final stopRecord$lambda$3(Lru/ok/android/externcalls/sdk/record/internal/RecordManagerImpl;Lru/ok/android/externcalls/sdk/record/RecordManager$StopParams;Lmc6;Lorg/json/JSONObject;)V
    .locals 2
    ...
    :cond_0
    invoke-virtual {p1}, Lru/ok/android/externcalls/sdk/record/RecordManager$StopParams;->getOnError()Lmc6;
...
.method private final toRecordDescription(Lpi1;)Lru/ok/android/externcalls/sdk/record/RecordDescription;
    .locals 9

    iget-object v0, p0, Lru/ok/android/externcalls/sdk/record/internal/RecordManagerImpl;->participantStore:Lru/ok/android/externcalls/sdk/participant/collection/ParticipantStore;

    iget-object v1, p1, Lpi1;->c:Lqg1;

    invoke-virtual {v0, v1}, Lru/ok/android/externcalls/sdk/participant/collection/ParticipantStore;->getByInternal(Lqg1;)Lru/ok/android/externcalls/sdk/ConversationParticipant;
    ...
    iget-object v0, p1, Lpi1;->c:Lqg1;

    invoke-virtual {p0, v0}, Lru/ok/android/externcalls/sdk/id/IdMappingWrapper;->getByInternal(Lqg1;)Lru/ok/android/externcalls/sdk/id/ParticipantId;
    ...
    iget-object v2, p1, Lpi1;->b:Lcoc;

    iget-wide v3, p1, Lpi1;->d:J

    iget-wide v5, p1, Lpi1;->a:J

    iget-object v7, p1, Lpi1;->e:Ljava/lang/String;

    iget-object v8, p1, Lpi1;->f:Ljava/lang/String;

    invoke-direct/range {v0 .. v8}, Lru/ok/android/externcalls/sdk/record/RecordDescription;-><init>(Lru/ok/android/externcalls/sdk/id/ParticipantId;Lcoc;JJLjava/lang/String;Ljava/lang/String;)V
...
.method public final getRecordAdmin()Lru/ok/android/externcalls/sdk/id/ParticipantId;
    ...
    iget-object p0, p0, Lru/ok/android/externcalls/sdk/record/internal/RecordManagerImpl;->activeRoomId:Lnnd;
...
.method public onCurrentParticipantActiveRoomChanged(Lym1;)V
    ...
    invoke-direct {p0, v0, p1}, Lru/ok/android/externcalls/sdk/record/internal/RecordManagerImpl;->notifyListenersWhenActiveRoomChanged(Lnnd;Lnnd;)V

    return-void
.end method

.method public bridge synthetic onCurrentParticipantInvitedToRoom(Lzm1;)V
    .locals 0

    return-void
.end method

.method public onRecordError(Lqi1;)V
    .locals 0

    iget-object p1, p1, Lqi1;->a:Ljava/lang/String;
...
.method public onRecordStarted(Lri1;)V
    .locals 4

    iget-object v0, p0, Lru/ok/android/externcalls/sdk/record/internal/RecordManagerImpl;->participantStore:Lru/ok/android/externcalls/sdk/participant/collection/ParticipantStore;

    iget-object v1, p1, Lri1;->b:Lpi1;

    iget-object v1, v1, Lpi1;->c:Lqg1;
    ...
    invoke-direct {v2, p0, v3, p1}, Lpxb;-><init>(Ljava/lang/Object;ILjava/lang/Object;)V

    new-instance p1, Lk1b;

    const/16 v3, 0x9

    invoke-direct {p1, v3, p0}, Lk1b;-><init>(ILjava/lang/Object;)V
...
.method public onRecordStopped(Lsi1;)V
    .locals 3

    iget-object v0, p0, Lru/ok/android/externcalls/sdk/record/internal/RecordManagerImpl;->sessionRoomToRecordInfo:Ljava/util/HashMap;

    iget-object v1, p1, Lsi1;->a:Lnnd;
    ...
    :goto_0
    invoke-direct {p0, v0, v1, v2}, Lru/ok/android/externcalls/sdk/record/internal/RecordManagerImpl;->setMyRecordHistory(Lru/ok/android/externcalls/sdk/id/ParticipantId;Lnnd;Lru/ok/android/externcalls/sdk/record/RecordDescription;)V
...
.method public bridge synthetic onRoomRemoved(Lan1;)V
    .locals 0

    return-void
.end method

.method public bridge synthetic onRoomUpdated(Lbn1;)V
    .locals 0
...
.method public startRecord(Lru/ok/android/externcalls/sdk/record/RecordManager$StartParams;Lkc6;Lmc6;)V
    .locals 21
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-static {v3, v2}, Lru/ok/android/externcalls/sdk/signaling/SignalingProviderKt;->get(Lru/ok/android/externcalls/sdk/signaling/SignalingProvider;Lmc6;)Ln1e;
    ...
    :cond_0
    iget-object v4, v0, Lru/ok/android/externcalls/sdk/record/internal/RecordManagerImpl;->commandParamsCreator:Lglc;
    ...
    invoke-virtual {v1}, Lru/ok/android/externcalls/sdk/record/RecordManager$StartParams;->getSessionRoomId()Lnnd;

    move-result-object v7

    if-nez v7, :cond_1

    iget-object v7, v0, Lru/ok/android/externcalls/sdk/record/internal/RecordManagerImpl;->activeRoomId:Lnnd;
    ...
    invoke-static {v5, v4}, Lcl7;->b(Lorg/json/JSONObject;Ljava/lang/String;)Lmh6;

    move-result-object v4

    instance-of v5, v7, Lmnd;
    ...
    invoke-virtual {v4, v6, v5}, Lmh6;->b(ILjava/lang/String;)V
    :try_end_0
    ...
    invoke-direct {v5, v1, v7, v6}, Lboc;-><init>(Ljava/lang/Object;Lkc6;I)V

    new-instance v6, Lhy0;

    const/4 v7, 0x5

    invoke-direct {v6, v0, v1, v2, v7}, Lhy0;-><init>(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;I)V

    const/4 v0, 0x0

    invoke-virtual {v3, v4, v0, v5, v6}, Ln1e;->d(Lq1e;ZLm1e;Lm1e;)V
...
.method public stopRecord(Lru/ok/android/externcalls/sdk/record/RecordManager$StopParams;Lkc6;Lmc6;)V
    .locals 7
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-static {v0, p3}, Lru/ok/android/externcalls/sdk/signaling/SignalingProviderKt;->get(Lru/ok/android/externcalls/sdk/signaling/SignalingProvider;Lmc6;)Ln1e;
    ...
    :cond_0
    iget-object v1, p0, Lru/ok/android/externcalls/sdk/record/internal/RecordManagerImpl;->commandParamsCreator:Lglc;

    invoke-virtual {p1}, Lru/ok/android/externcalls/sdk/record/RecordManager$StopParams;->getSessionRoomId()Lnnd;

    move-result-object v2

    if-nez v2, :cond_1

    iget-object v2, p0, Lru/ok/android/externcalls/sdk/record/internal/RecordManagerImpl;->activeRoomId:Lnnd;
    ...
    invoke-static {v1, v4}, Lcl7;->b(Lorg/json/JSONObject;Ljava/lang/String;)Lmh6;

    move-result-object v1

    iget-object v5, v1, Lmh6;->a:Lorg/json/JSONObject;

    const-string v6, "command"

    invoke-virtual {v5, v6, v4}, Lorg/json/JSONObject;->put(Ljava/lang/String;Ljava/lang/Object;)Lorg/json/JSONObject;

    instance-of v4, v2, Lmnd;
    ...
    invoke-virtual {v1, v2, v4}, Lmh6;->b(ILjava/lang/String;)V
    ...
    invoke-direct {v2, p1, p2, v3}, Lboc;-><init>(Ljava/lang/Object;Lkc6;I)V

    new-instance p2, Lhy0;

    const/4 v3, 0x4

    invoke-direct {p2, p0, p1, p3, v3}, Lhy0;-><init>(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;I)V

    const/4 p0, 0x0

    invoke-virtual {v0, v1, p0, v2, p2}, Ln1e;->d(Lq1e;ZLm1e;Lm1e;)V
