...
# instance fields
.field private final callVideoDrawer:Lgr1;

.field private final drawerListener:Lfr1;
...
.method public constructor <init>(Ljava/lang/String;)V
    ...
    iput-object v0, p0, Lru/ok/android/externcalls/sdk/ui/internal/VoipVideoRenderer;->callVideoDrawer:Lgr1;
    ...
    invoke-direct {p1, p0}, Lwbg;-><init>(Lru/ok/android/externcalls/sdk/ui/internal/VoipVideoRenderer;)V

    iput-object p1, p0, Lru/ok/android/externcalls/sdk/ui/internal/VoipVideoRenderer;->drawerListener:Lfr1;
...
.method public clearImage()V
    ...
    iget-object p0, p0, Lru/ok/android/externcalls/sdk/ui/internal/VoipVideoRenderer;->callVideoDrawer:Lgr1;
    ...
    invoke-virtual {v1, v2}, Lwe1;->c(Lmc6;)Z
    :try_end_0
...
.method public createEglSurface(Landroid/view/Surface;)V
    ...
    iget-object v2, v1, Lye1;->a:Lxec;

    iget-object v3, p0, Lgr1;->j:Ljava/lang/String;
    ...
    invoke-direct {v2, p0, v3, p1}, Lr14;-><init>(Ljava/lang/Object;ILjava/lang/Object;)V
    ...
    :cond_0
    iput-object p1, p0, Lgr1;->i:Landroid/view/Surface;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public init(Lye1;Lorg/webrtc/RendererCommon$GlDrawer;)V
    ...
    iget-object v0, p0, Lru/ok/android/externcalls/sdk/ui/internal/VoipVideoRenderer;->callVideoDrawer:Lgr1;

    iget-object v1, v0, Lgr1;->h:Ljava/lang/Object;

    monitor-enter v1

    :try_start_0
    iget-object v2, v0, Lgr1;->g:Lye1;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    :cond_0
    :try_start_1
    iput-object p1, v0, Lgr1;->g:Lye1;

    iget-object v2, p1, Lye1;->e:Lwe1;

    new-instance v3, Li1h;

    invoke-direct {v3, v0, p2, p1}, Li1h;-><init>(Lxe1;Ljava/lang/Object;Lye1;)V

    invoke-virtual {v2, v3}, Lwe1;->c(Lmc6;)Z

    iget-object p2, v0, Lgr1;->i:Landroid/view/Surface;

    if-eqz p2, :cond_1

    iget-object v2, p1, Lye1;->a:Lxec;
    ...
    invoke-direct {v2, v0, v3, p2}, Lr14;-><init>(Ljava/lang/Object;ILjava/lang/Object;)V

    invoke-virtual {p1, v2}, Lwe1;->c(Lmc6;)Z
    ...
    iput-object p1, v0, Lgr1;->i:Landroid/view/Surface;
    :try_end_1
    ...
    :goto_1
    iget-object p1, p0, Lru/ok/android/externcalls/sdk/ui/internal/VoipVideoRenderer;->callVideoDrawer:Lgr1;

    iget-object p0, p0, Lru/ok/android/externcalls/sdk/ui/internal/VoipVideoRenderer;->drawerListener:Lfr1;

    iget-object p1, p1, Lgr1;->c:Ljava/util/concurrent/CopyOnWriteArrayList;
...
.method public onFrame(Lorg/webrtc/VideoFrame;)V
    ...
    iget-object v0, p0, Lgr1;->l:Lhr1;

    iget-object v0, v0, Lhr1;->c:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    :cond_0
    :try_start_1
    iget-object v2, p0, Lgr1;->d:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    iget-object v2, v1, Lye1;->e:Lwe1;

    new-instance v3, Lp1h;

    invoke-direct {v3, p0, v1}, Lp1h;-><init>(Lxe1;Lye1;)V
    ...
    :try_start_2
    iget-object v1, v2, Lwe1;->k:Lr0h;

    new-instance v4, Lve1;

    const/4 v5, 0x0

    invoke-direct {v4, v3, v2, v5}, Lve1;-><init>(Lmc6;Lwe1;I)V
    ...
    :try_start_3
    iget-object v3, v2, Lwe1;->a:Lxec;

    iget-object v2, v2, Lwe1;->j:Ljava/lang/String;

    const-string v4, "OpenGL tread died, is it fine?"

    invoke-interface {v3, v2, v4, v1}, Lxec;->reportException(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    :try_end_3
    ...
    iget-object p0, p0, Lgr1;->l:Lhr1;

    iget-object p0, p0, Lhr1;->d:Ljava/util/concurrent/atomic/AtomicInteger;
...
.method public release()V
    ...
    iget-object v1, p0, Lru/ok/android/externcalls/sdk/ui/internal/VoipVideoRenderer;->drawerListener:Lfr1;

    iget-object v0, v0, Lgr1;->c:Ljava/util/concurrent/CopyOnWriteArrayList;
    ...
    invoke-direct {v3, v1, p0}, Lp1h;-><init>(Lye1;Lxe1;)V
...
.method public releaseEglSurface(Lkc6;)V
    .locals 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    :try_start_0
    iput-object v1, p0, Lgr1;->i:Landroid/view/Surface;
    ...
    invoke-direct {v3, v1, p0, p1}, Li1h;-><init>(Lye1;Lxe1;Lkc6;)V
