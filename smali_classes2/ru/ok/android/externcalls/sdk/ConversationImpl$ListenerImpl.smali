...
.method private handleMuteParticipant(Ljp9;)V
    .locals 1

    iget-boolean v0, p1, Ljp9;->b:Z

    iget-object p1, p1, Ljp9;->a:Lip9;
    ...
    invoke-interface {v0, p1}, Lru/ok/android/externcalls/sdk/events/ConversationEventsListener;->onMuteChanged(Lip9;)V
    ...
    invoke-virtual {p0, p1}, Lru/ok/android/externcalls/sdk/media/mute/internal/listener/MediaMuteListenerManagerImpl;->onMuteChanged(Lip9;)V

    return-void
.end method

.method private handleRolesChanged(Lug1;)V
    .locals 2
    ...
    invoke-virtual {v1, v0}, Lru/ok/android/externcalls/sdk/participant/collection/ParticipantStore;->getByInternal(Lqg1;)Lru/ok/android/externcalls/sdk/ConversationParticipant;
    ...
    invoke-static {v1}, Lru/ok/android/externcalls/sdk/ConversationImpl;->Z(Lru/ok/android/externcalls/sdk/ConversationImpl;)Lpg1;

    move-result-object v1

    iget-object v1, v1, Lpg1;->B:Lng1;

    iget-boolean v1, v1, Lng1;->j:Z

    if-eqz v1, :cond_1

    iget-object v1, p1, Lug1;->p:Lw61;
    ...
    invoke-virtual {v0}, Lru/ok/android/externcalls/sdk/ConversationParticipant;->getCallParticipant()Lug1;
    ...
    invoke-virtual {v0, p1, v1}, Lru/ok/android/externcalls/sdk/ConversationParticipant;->setCallParticipant(Lug1;Lru/ok/android/externcalls/sdk/id/local/LocalIdMappings;)V
    ...
    invoke-static {p1}, Lru/ok/android/externcalls/sdk/ConversationImpl;->Z(Lru/ok/android/externcalls/sdk/ConversationImpl;)Lpg1;

    move-result-object p1

    iget-object p1, p1, Lpg1;->B:Lng1;

    iget-boolean p1, p1, Lng1;->j:Z
...
# virtual methods
.method public onCallParticipantFingerprint(Lug1;J)V
    .locals 3

    iget-object v0, p0, Lru/ok/android/externcalls/sdk/ConversationImpl$ListenerImpl;->this$0:Lru/ok/android/externcalls/sdk/ConversationImpl;

    invoke-static {v0}, Lru/ok/android/externcalls/sdk/ConversationImpl;->Y(Lru/ok/android/externcalls/sdk/ConversationImpl;)Lsy0;

    move-result-object v0

    iget-object v0, v0, Lsy0;->e0:Lzg1;

    invoke-virtual {v0}, Lzg1;->i()Ljava/util/Collection;
...
.method public onCallParticipantNetworkStatusChanged(Ljava/util/List;)V
    ...
    invoke-virtual {v3, v2}, Lru/ok/android/externcalls/sdk/participant/collection/ParticipantStore;->getByInternal(Lqg1;)Lru/ok/android/externcalls/sdk/ConversationParticipant;
    ...
    invoke-virtual {v2, v1, v3}, Lru/ok/android/externcalls/sdk/ConversationParticipant;->setCallParticipant(Lug1;Lru/ok/android/externcalls/sdk/id/local/LocalIdMappings;)V
    ...
    invoke-virtual {v1, v2}, Lru/ok/android/externcalls/sdk/participant/collection/ParticipantStore;->getParticipantRoomId(Lru/ok/android/externcalls/sdk/ConversationParticipant;)Lnnd;
    ...
    invoke-virtual {v3}, Lru/ok/android/externcalls/sdk/participant/collection/ParticipantStore;->getActiveRoomId()Lnnd;
...
.method public onCustomData(Lqg1;Lorg/json/JSONObject;)V
    .locals 0
...
.method public onEvent(Lsy0;Lf61;Ljava/lang/Object;)V
    .locals 6

    iget-object v0, p0, Lru/ok/android/externcalls/sdk/ConversationImpl$ListenerImpl;->this$0:Lru/ok/android/externcalls/sdk/ConversationImpl;

    invoke-static {v0}, Lru/ok/android/externcalls/sdk/ConversationImpl;->k0(Lru/ok/android/externcalls/sdk/ConversationImpl;)Lxec;
    ...
    invoke-virtual {p0, p3}, Lru/ok/android/externcalls/sdk/watch_together/internal/listener/WatchTogetherListenerManagerImpl;->onVideoStopped(Lwj9;)V

    return-void

    :pswitch_2
    instance-of p1, p3, Lvj9;
    ...
    invoke-virtual {p0, p3}, Lru/ok/android/externcalls/sdk/watch_together/internal/listener/WatchTogetherListenerManagerImpl;->onVideoStatesUpdatedChanged(Lvj9;)V

    return-void

    :pswitch_3
    instance-of p1, p3, Ltj9;
    ...
    invoke-virtual {p0, p3}, Lru/ok/android/externcalls/sdk/watch_together/internal/listener/WatchTogetherListenerManagerImpl;->onVideoStarted(Ltj9;)V
    ...
    invoke-interface {p1, p3}, Lru/ok/android/externcalls/sdk/events/ConversationEventsListener;->onMuteStateInitialized(Lip9;)V
    ...
    invoke-virtual {p0, p3}, Lru/ok/android/externcalls/sdk/media/mute/internal/listener/MediaMuteListenerManagerImpl;->onMuteStateInitialized(Lip9;)V
    ...
    sget-object p2, Lry0;->Y:Lry0;

    iget-object p1, p1, Lsy0;->o:Ljava/util/EnumSet;
    ...
    :pswitch_c
    instance-of p1, p3, Ljp9;

    if-eqz p1, :cond_8

    check-cast p3, Ljp9;

    invoke-direct {p0, p3}, Lru/ok/android/externcalls/sdk/ConversationImpl$ListenerImpl;->handleMuteParticipant(Ljp9;)V

    return-void

    :pswitch_d
    instance-of p1, p3, Lqg1;
    ...
    invoke-virtual {p1, p3}, Lru/ok/android/externcalls/sdk/participant/collection/ParticipantStore;->getByInternal(Lqg1;)Lru/ok/android/externcalls/sdk/ConversationParticipant;
    ...
    invoke-direct {p0, p2}, Lru/ok/android/externcalls/sdk/ConversationImpl$ListenerImpl;->handleRolesChanged(Lug1;)V

    goto :goto_1

    :pswitch_f
    instance-of p1, p3, Lug1;

    if-eqz p1, :cond_8

    check-cast p3, Lug1;

    invoke-direct {p0, p3}, Lru/ok/android/externcalls/sdk/ConversationImpl$ListenerImpl;->handleRolesChanged(Lug1;)V
    ...
    :pswitch_12
    invoke-virtual {p1, v1}, Lsy0;->E(Z)V
    ...
    :pswitch_13
    invoke-virtual {p1, v3}, Lsy0;->E(Z)V
    ...
    iget-object p1, p1, Lsy0;->Z0:Lehb;
    ...
    sget-object v0, Lyp6;->X:Lyp6;

    sget-object v1, Ljava/util/Collections;->EMPTY_SET:Ljava/util/Set;

    invoke-direct {p3, v0, v1, v2}, Lru/ok/android/externcalls/sdk/events/ConversationEventsListener$CallEndInfo;-><init>(Lyp6;Ljava/util/Set;Ljava/lang/String;)V
    ...
    iget-object p2, p1, Lsy0;->Z0:Lehb;
    ...
    invoke-virtual {p2, p3}, Lehb;->G(Lru/ok/android/externcalls/sdk/events/end/ConversationEndReason;)V
    ...
    iget-object v0, p1, Lsy0;->F:Lyp6;

    invoke-static {p2, v0, p3}, Lru/ok/android/externcalls/sdk/ConversationImpl;->u0(Lru/ok/android/externcalls/sdk/ConversationImpl;Lyp6;Ljava/lang/Object;)Lru/ok/android/externcalls/sdk/events/ConversationEventsListener$CallEndInfo;
    ...
    iget-object v1, p1, Lsy0;->Z:Lmyd;

    iget-object p0, v1, Lmyd;->a:Ljava/util/concurrent/ExecutorService;
...
.method public onStateChanged(Lqg1;Lsg1;)V
    .locals 2
    ...
    invoke-static {p1, v0}, Lru/ok/android/externcalls/sdk/ConversationParticipant;->fromInternal(Lqg1;Lru/ok/android/externcalls/sdk/id/IdMappingWrapper;)Lru/ok/android/externcalls/sdk/ConversationParticipant;
    ...
    invoke-interface {v1, v0, p2}, Lru/ok/android/externcalls/sdk/events/ConversationEventsListener;->onStateChanged(Lru/ok/android/externcalls/sdk/ConversationParticipant;Lsg1;)V
    ...
    invoke-virtual {p0, p1, p2}, Lru/ok/android/externcalls/sdk/participant/state/internal/ParticipantStatesManagerImpl;->onStateChanged(Lqg1;Lsg1;)V
