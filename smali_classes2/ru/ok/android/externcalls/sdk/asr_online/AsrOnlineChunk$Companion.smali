...
.method public final chunkFromPackage$calls_sdk_release(Lru/ok/android/externcalls/sdk/participant/collection/ParticipantStore;Lqs;)Lru/ok/android/externcalls/sdk/asr_online/AsrOnlineChunk;
    ...
    iget-object p0, p2, Lqs;->a:Lqg1;

    const/4 v0, 0x0

    if-eqz p0, :cond_0

    invoke-virtual {p1, p0}, Lru/ok/android/externcalls/sdk/participant/collection/ParticipantStore;->getByInternal(Lqg1;)Lru/ok/android/externcalls/sdk/ConversationParticipant;
