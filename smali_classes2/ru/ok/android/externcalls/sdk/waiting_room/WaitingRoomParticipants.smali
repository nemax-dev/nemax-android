...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "log",
        "<init>",
        "(Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants$Listener;Lru/ok/android/externcalls/sdk/id/IdMappingWrapper;Lru/ok/android/externcalls/sdk/id/mapping/IdMappingResolver;Lxec;)V",
        "Lsy0;",
        "call",
        "Lxmf;",
        "setCall",
        ...
        "(Lru/ok/android/externcalls/sdk/waiting_room/ConversationWaitingParticipantId;)Le3e;",
        "Lpr1;",
        "fromId",
        "Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants$WaitingParticipantsPage;",
        ...
        "internalId",
        "fromInternalLong",
        "(Lru/ok/android/externcalls/sdk/waiting_room/ConversationWaitingParticipantId;Lqg1;)Lpr1;",
        "",
        "Lor1;",
        "waitingParticipants",
        "Lkotlin/Function1;",
...
# instance fields
.field private volatile call:Lsy0;

.field private final compositeDisposable:Lge3;
...
.field private final loadEventSubject:Lb0c;
...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0, v1}, Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants$Companion;-><init>(Lsd4;)V
...
.method public constructor <init>(Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants$Listener;Lru/ok/android/externcalls/sdk/id/IdMappingWrapper;Lru/ok/android/externcalls/sdk/id/mapping/IdMappingResolver;Lxec;)V
    .locals 2
    ...
    iput-object p4, p0, Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants;->log:Lxec;

    new-instance p1, Lb0c;

    invoke-direct {p1}, Lb0c;-><init>()V

    iput-object p1, p0, Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants;->loadEventSubject:Lb0c;

    new-instance p2, Lge3;

    invoke-direct {p2}, Ljava/lang/Object;-><init>()V

    iput-object p2, p0, Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants;->compositeDisposable:Lge3;
    ...
    invoke-direct {p4, p1, v0, v1}, Lf6a;-><init>(Lb0c;Lo6d;I)V

    invoke-static {}, Lb7d;->b()Lo6d;

    move-result-object p1

    invoke-virtual {p4, p1}, Lp5a;->k(Lo6d;)Ll7a;
    ...
    invoke-direct {v0, p1, p4, v1}, Li6a;-><init>(Lp5a;Lbd6;I)V
    ...
    invoke-direct {p1, p3}, Ltd6;-><init>(Ljava/lang/Object;)V

    new-instance p3, Li6a;

    const/4 p4, 0x6

    invoke-direct {p3, v0, p1, p4}, Li6a;-><init>(Lp5a;Lbd6;I)V

    invoke-static {}, Lyd;->a()Lo6d;

    move-result-object p1

    invoke-virtual {p3, p1}, Lp5a;->k(Lo6d;)Ll7a;
    ...
    invoke-virtual {p1, p3}, Lp5a;->m(Lwm3;)Lhl7;
...
.method public static synthetic a(Lm3e;)V
    .locals 0

    invoke-static {p0}, Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants;->resolveInternalIdSingle$lambda$1$lambda$0(Lm3e;)V
...
.method public static synthetic b(Lsy0;Lpr1;Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants;Li3e;)V
    .locals 0

    invoke-static {p0, p1, p2, p3}, Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants;->loadWaitingParticipantIdsPageSingle$lambda$6(Lsy0;Lpr1;Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants;Lm3e;)V

    return-void
.end method

.method public static synthetic c(Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants;Lru/ok/android/externcalls/sdk/waiting_room/ConversationWaitingParticipantId;Li3e;)V
    .locals 0

    invoke-static {p0, p1, p2}, Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants;->resolveInternalIdSingle$lambda$1(Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants;Lru/ok/android/externcalls/sdk/waiting_room/ConversationWaitingParticipantId;Lm3e;)V

    return-void
.end method

.method public static synthetic d(Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants;Lm3e;Lhs1;)V
    .locals 0

    invoke-static {p0, p1, p2}, Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants;->loadWaitingParticipantIdsPageSingle$lambda$6$lambda$4(Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants;Lm3e;Lhs1;)V

    return-void
.end method

.method public static synthetic e(Lm3e;)V
    .locals 0

    invoke-static {p0}, Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants;->loadWaitingParticipantIdsPageSingle$lambda$6$lambda$5(Lm3e;)V

    return-void
.end method

.method private final fromInternalLong(Lru/ok/android/externcalls/sdk/waiting_room/ConversationWaitingParticipantId;Lqg1;)Lpr1;
    .locals 2
    ...
    invoke-direct {p0, p2, v0, v1}, Lpr1;-><init>(Lqg1;J)V
...
.method private final getInternalIdsToResolve(Ljava/util/List;)Ljava/util/List;
    ...
    iget-object v1, v1, Lor1;->a:Lpr1;

    iget-object v1, v1, Lpr1;->b:Lqg1;
    ...
    invoke-virtual {v2, v1}, Lru/ok/android/externcalls/sdk/id/IdMappingWrapper;->getByInternal(Lqg1;)Lru/ok/android/externcalls/sdk/id/ParticipantId;
...
.method private final getResolvedWaitingParticipantIds(Ljava/util/List;)Ljava/util/List;
    ...
    iget-object v2, v1, Lor1;->a:Lpr1;

    iget-object v2, v2, Lpr1;->b:Lqg1;
    ...
    invoke-virtual {v3, v2}, Lru/ok/android/externcalls/sdk/id/IdMappingWrapper;->getByInternal(Lqg1;)Lru/ok/android/externcalls/sdk/id/ParticipantId;
...
.method private final loadWaitingParticipantIds()Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipantsUpdate;
    ...
    iget-object v0, p0, Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants;->call:Lsy0;
    ...
    :try_start_0
    invoke-direct {p0, v3}, Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants;->resolveInternalIdSingle(Lru/ok/android/externcalls/sdk/waiting_room/ConversationWaitingParticipantId;)Le3e;

    move-result-object v6

    invoke-virtual {v6}, Le3e;->e()Ljava/lang/Object;

    move-result-object v6

    check-cast v6, Lqg1;

    invoke-direct {p0, v3, v6}, Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants;->fromInternalLong(Lru/ok/android/externcalls/sdk/waiting_room/ConversationWaitingParticipantId;Lqg1;)Lpr1;
    ...
    iget-object v2, p0, Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants;->log:Lxec;
    ...
    :goto_0
    :try_start_1
    invoke-direct {p0, v0, v6}, Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants;->loadWaitingParticipantIdsPageSingle(Lsy0;Lpr1;)Le3e;
...
.method private final loadWaitingParticipantIdsPageSingle(Lsy0;Lpr1;)Le3e;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v0, p1, p2, p0}, Lg2g;-><init>(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;)V
...
.method private static final loadWaitingParticipantIdsPageSingle$lambda$6(Lsy0;Lpr1;Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants;Lm3e;)V
    .locals 7
    ...
    invoke-direct {v0, p2, v1, p3}, Lj1b;-><init>(Ljava/lang/Object;ILjava/lang/Object;)V

    new-instance p2, Lpcg;

    const/4 v1, 0x0

    invoke-direct {p2, p3, v1}, Lpcg;-><init>(Lm3e;I)V

    iget-object p3, p0, Lsy0;->g:Ln1e;
    ...
    iget-object v5, p1, Lpr1;->b:Lqg1;

    invoke-virtual {v5}, Lqg1;->b()Ljava/lang/String;
    ...
    invoke-virtual {v1, v2, p1}, Lmh6;->b(ILjava/lang/String;)V
    :try_end_0
    ...
    invoke-direct {p1, p0, v0, p2, v2}, Lhy0;-><init>(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;I)V

    new-instance p0, Lmy0;

    const/4 v0, 0x0

    invoke-direct {p0, v0, p2}, Lmy0;-><init>(ILjava/lang/Object;)V

    invoke-virtual {p3, v1, v4, p1, p0}, Ln1e;->d(Lq1e;ZLm1e;Lm1e;)V
...
.method private static final loadWaitingParticipantIdsPageSingle$lambda$6$lambda$4(Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants;Lm3e;Lhs1;)V
    .locals 8

    iget-object v2, p2, Lhs1;->a:Ljava/util/ArrayList;
    ...
    invoke-direct/range {v0 .. v5}, Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants$loadWaitingParticipantIdsPageSingle$lambda$6$lambda$4$$inlined$resolveInternalIds$1;-><init>(Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants;Ljava/util/List;Lm3e;Lhs1;Lm3e;)V
    ...
    invoke-direct {p0, v3}, Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants$loadWaitingParticipantIdsPageSingle$lambda$6$lambda$4$$inlined$resolveInternalIds$2;-><init>(Lm3e;)V
...
.method private static final loadWaitingParticipantIdsPageSingle$lambda$6$lambda$5(Lm3e;)V
    .locals 2
    ...
    invoke-virtual {p0, v0}, Li3e;->d(Ljava/lang/Throwable;)Z
...
.method private final putIdMappingsToCache(Ljava/util/List;)V
    ...
    iget-object v1, v0, Lor1;->b:Lw61;

    invoke-static {v1}, Lru/ok/android/externcalls/sdk/id/CallExternalIdConverter;->convert(Lw61;)Lru/ok/android/externcalls/sdk/id/ParticipantId;
    ...
    iget-object v0, v0, Lpr1;->b:Lqg1;

    invoke-virtual {v2, v1, v0}, Lru/ok/android/externcalls/sdk/id/IdMappingWrapper;->addMapping(Lru/ok/android/externcalls/sdk/id/ParticipantId;Lqg1;)V
...
.method private final resolveInternalIdSingle(Lru/ok/android/externcalls/sdk/waiting_room/ConversationWaitingParticipantId;)Le3e;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method private static final resolveInternalIdSingle$lambda$1(Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants;Lru/ok/android/externcalls/sdk/waiting_room/ConversationWaitingParticipantId;Lm3e;)V
    .locals 3
    ...
    invoke-direct {v0, v1, p2}, Lum3;-><init>(ILjava/lang/Object;)V

    new-instance v1, Lpcg;

    const/4 v2, 0x1

    invoke-direct {v1, p2, v2}, Lpcg;-><init>(Lm3e;I)V

    invoke-interface {p0, p1, v0, v1}, Lru/ok/android/externcalls/sdk/id/mapping/IdMappingResolver;->withInternalId(Lru/ok/android/externcalls/sdk/id/ParticipantId;Lxm3;Ljava/lang/Runnable;)V

    return-void
.end method

.method private static final resolveInternalIdSingle$lambda$1$lambda$0(Lm3e;)V
    .locals 1
...
.method private final resolveInternalIds(Ljava/util/List;Lmc6;Lmc6;)V
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v2, p0, p1, p2, p3}, Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants$resolveInternalIds$1;-><init>(Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants;Ljava/util/List;Lmc6;Lmc6;)V

    new-instance p0, Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants$resolveInternalIds$2;

    invoke-direct {p0, p3}, Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants$resolveInternalIds$2;-><init>(Lmc6;)V
...
.method private final scheduleLoad()V
    ...
    iget-object p0, p0, Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants;->loadEventSubject:Lb0c;
...
.method public final release()V
    ...
    iget-object p0, p0, Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants;->compositeDisposable:Lge3;
...
.method public final setCall(Lsy0;)V
    .locals 0

    iput-object p1, p0, Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants;->call:Lsy0;
