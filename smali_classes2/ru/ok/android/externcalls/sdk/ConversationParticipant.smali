...
.method public static fromExternal(Lru/ok/android/externcalls/sdk/id/ParticipantId;Lru/ok/android/externcalls/sdk/id/IdMappingWrapper;)Lru/ok/android/externcalls/sdk/ConversationParticipant;
    ...
    invoke-virtual {p1, p0}, Lru/ok/android/externcalls/sdk/id/IdMappingWrapper;->getByExternal(Lru/ok/android/externcalls/sdk/id/ParticipantId;)Lqg1;

    move-result-object p0

    if-eqz p0, :cond_0

    invoke-virtual {v0, p0}, Lru/ok/android/externcalls/sdk/ConversationParticipant;->setInternalId(Lqg1;)V

    :cond_0
    return-object v0
.end method

.method public static fromInternal(Lqg1;Lru/ok/android/externcalls/sdk/id/IdMappingWrapper;)Lru/ok/android/externcalls/sdk/ConversationParticipant;
    .locals 1
    ...
    invoke-virtual {p1, p0}, Lru/ok/android/externcalls/sdk/id/IdMappingWrapper;->getByInternal(Lqg1;)Lru/ok/android/externcalls/sdk/id/ParticipantId;
...
# virtual methods
.method public deAnonymize(Lug1;Lru/ok/android/externcalls/sdk/id/ParticipantId;Lru/ok/android/externcalls/sdk/id/ParticipantId;Lru/ok/android/externcalls/sdk/id/local/LocalIdMappings;)V
    .locals 0
    ...
    iput-object p1, p0, Lru/ok/android/externcalls/sdk/ConversationParticipant;->callParticipant:Lug1;
...
.method public getAcceptCallEpochMs()J
    ...
    iget-object p0, p0, Lru/ok/android/externcalls/sdk/ConversationParticipant;->callParticipant:Lug1;

    if-eqz p0, :cond_0

    iget-wide v0, p0, Lug1;->m:J
...
.method public getAcceptedCallPlatform()Ljava/lang/String;
    ...
    :cond_0
    iget-object p0, p0, Lug1;->l:Ljava/lang/String;

    return-object p0
.end method

.method public getAudioOptionState()Lmk8;
    .locals 0
    ...
    iget-object p0, p0, Lug1;->b:Lro9;

    iget-object p0, p0, Lro9;->a:Lmk8;
...
.method public getCallParticipant()Lug1;
    .locals 0
...
.method public getInternalId()Lqg1;
    .locals 0

    iget-object p0, p0, Lru/ok/android/externcalls/sdk/ConversationParticipant;->internalId:Lqg1;
...
.method public getMovies()Ljava/util/List;
    ...
    :cond_0
    iget-object p0, p0, Lug1;->q:Ljava/util/List;

    return-object p0
.end method

.method public getNetworkStatus()Lqu9;
    .locals 0
    ...
    sget-object p0, Lqu9;->a:Lqu9;

    return-object p0

    :cond_0
    iget-object p0, p0, Lug1;->i:Lqu9;

    return-object p0
.end method

.method public getScreenshareOptionState()Lmk8;
    .locals 0
...
.method public getVideoOptionState()Lmk8;
    .locals 0
...
.method public getWatchTogetherOptionState()Lmk8;
    .locals 0
...
.method public hasRegisteredPeers()Z
    ...
    iget-object p0, p0, Lug1;->f:Ljava/util/HashMap;
...
.method public setCallParticipant(Lug1;Lru/ok/android/externcalls/sdk/id/local/LocalIdMappings;)V
    .locals 0
    ...
    iput-object p1, p0, Lru/ok/android/externcalls/sdk/ConversationParticipant;->internalId:Lqg1;
...
.method public setDeviceIndex(ILru/ok/android/externcalls/sdk/id/local/LocalIdMappings;)V
    ...
    invoke-static {p1, v0, v1}, Lme5;->l(ILjava/lang/String;Ljava/lang/String;)Ljava/lang/StringBuilder;
    ...
    :cond_0
    iget-object v0, p0, Lru/ok/android/externcalls/sdk/ConversationParticipant;->internalId:Lqg1;

    if-eqz v0, :cond_1

    new-instance v1, Lqg1;

    iget-wide v2, v0, Lqg1;->a:J

    iget v0, v0, Lqg1;->b:I

    invoke-direct {v1, v0, p1, v2, v3}, Lqg1;-><init>(IIJ)V

    iput-object v1, p0, Lru/ok/android/externcalls/sdk/ConversationParticipant;->internalId:Lqg1;

    :cond_1
    iget-object v0, p0, Lru/ok/android/externcalls/sdk/ConversationParticipant;->callParticipant:Lug1;
    ...
    iget-wide v3, v1, Lqg1;->a:J

    iget v1, v1, Lqg1;->b:I

    invoke-direct {v2, v1, p1, v3, v4}, Lqg1;-><init>(IIJ)V

    iput-object v2, v0, Lug1;->a:Lqg1;

    iget-object v1, v0, Lug1;->p:Lw61;

    if-eqz v1, :cond_3

    new-instance v2, Lw61;

    iget-object v3, v1, Lw61;->a:Ljava/lang/String;

    iget v1, v1, Lw61;->b:I

    invoke-direct {v2, v3, v1, p1}, Lw61;-><init>(Ljava/lang/String;II)V

    iput-object v2, v0, Lug1;->p:Lw61;
...
.method public setInternalId(Lqg1;)V
    .locals 0
...
.method public toString()Ljava/lang/String;
    ...
    iget-object v2, p0, Lru/ok/android/externcalls/sdk/ConversationParticipant;->internalId:Lqg1;
