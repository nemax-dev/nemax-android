...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "upload",
        "<init>",
        "(Lj4a;Lru/ok/android/externcalls/analytics/config/EventMetaParamsConfig;Lru/ok/android/externcalls/analytics/log/CallAnalyticsLogger;Lru/ok/android/externcalls/analytics/config/UploadConfig;)V",
        "Lj4a;",
        "getOkApi",
        "()Lj4a;",
        "Lru/ok/android/externcalls/analytics/config/EventMetaParamsConfig;",
...
.field private final okApi:Lj4a;

.field private final upload:Lru/ok/android/externcalls/analytics/config/UploadConfig;


# direct methods
.method public constructor <init>(Lj4a;Lru/ok/android/externcalls/analytics/config/EventMetaParamsConfig;Lru/ok/android/externcalls/analytics/log/CallAnalyticsLogger;Lru/ok/android/externcalls/analytics/config/UploadConfig;)V
    .locals 0
    ...
    .line 2
    iput-object p1, p0, Lru/ok/android/externcalls/analytics/config/CallAnalyticsConfig;->okApi:Lj4a;
...
.method public synthetic constructor <init>(Lj4a;Lru/ok/android/externcalls/analytics/config/EventMetaParamsConfig;Lru/ok/android/externcalls/analytics/log/CallAnalyticsLogger;Lru/ok/android/externcalls/analytics/config/UploadConfig;ILuc4;)V
    .locals 18
    ...
    invoke-direct {v0, v2, v1, v2}, Lru/ok/android/externcalls/analytics/config/EventMetaParamsConfig;-><init>(Ld96;ILuc4;)V
    ...
    invoke-direct/range {v3 .. v17}, Lru/ok/android/externcalls/analytics/config/UploadConfig;-><init>(ILjava/util/concurrent/Executor;JJLd96;Ld96;Ld96;Ld96;Ld96;Ld96;ILuc4;)V
    ...
    .line 9
    :goto_3
    invoke-direct {v2, v4, v0, v1, v3}, Lru/ok/android/externcalls/analytics/config/CallAnalyticsConfig;-><init>(Lj4a;Lru/ok/android/externcalls/analytics/config/EventMetaParamsConfig;Lru/ok/android/externcalls/analytics/log/CallAnalyticsLogger;Lru/ok/android/externcalls/analytics/config/UploadConfig;)V
...
.method public final getOkApi()Lj4a;
    .locals 0

    iget-object p0, p0, Lru/ok/android/externcalls/analytics/config/CallAnalyticsConfig;->okApi:Lj4a;
