...
.method public static synthetic a(Lru/ok/android/externcalls/analytics/internal/api/CallAnalyticsApiRequest;Lsi7;)Ljava/lang/Void;
    .locals 0

    invoke-direct {p0, p1}, Lru/ok/android/externcalls/analytics/internal/api/CallAnalyticsApiRequest;->lambda$getOkParser$0(Lsi7;)Ljava/lang/Void;
...
.method private synthetic lambda$getOkParser$0(Lsi7;)Ljava/lang/Void;
    .locals 2
...
.method private writeString(Lzi7;Ljava/lang/String;Ljava/lang/String;)V
    .locals 1
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    .line 1
    invoke-direct {p0, p1, p2, p3, v0}, Lru/ok/android/externcalls/analytics/internal/api/CallAnalyticsApiRequest;->writeString(Lzi7;Ljava/lang/String;Ljava/lang/String;Z)V

    return-void
.end method

.method private writeString(Lzi7;Ljava/lang/String;Ljava/lang/String;Z)V
    .locals 0
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    .line 3
    :cond_0
    invoke-interface {p1, p2}, Lzi7;->k0(Ljava/lang/String;)Lzi7;

    .line 4
    invoke-interface {p1, p3}, Lzi7;->h(Ljava/lang/String;)V
...
.method public writeParams(Lzi7;)V
    ...
    invoke-interface {p1, v0}, Lzi7;->k0(Ljava/lang/String;)Lzi7;

    invoke-interface {p1}, Lzi7;->s()V
    ...
    invoke-direct {p0, p1, v2, v0, v1}, Lru/ok/android/externcalls/analytics/internal/api/CallAnalyticsApiRequest;->writeString(Lzi7;Ljava/lang/String;Ljava/lang/String;Z)V
    ...
    invoke-direct {p0, p1, v0, v1}, Lru/ok/android/externcalls/analytics/internal/api/CallAnalyticsApiRequest;->writeString(Lzi7;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {p0, p1}, Lwr0;->write(Lzi7;)V

    invoke-interface {p1}, Lzi7;->q()V

    return-void
.end method

.method public bridge synthetic writeSupplyParams(Lzi7;)V
    .locals 0
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;,
