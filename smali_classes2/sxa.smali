...
# direct methods
.method public constructor <init>(Landroid/content/Context;Lth7;Lth7;Lth7;Lrv0;Lhoe;Lo75;)V
    .locals 0
    ...
    iput-object p7, p0, Lsxa;->c:Lo75;

    iput-object p2, p0, Lsxa;->o:Lth7;

    iput-object p3, p0, Lsxa;->X:Lth7;

    iput-object p4, p0, Lsxa;->Y:Lth7;
    ...
    iput-object p1, p0, Lsxa;->o0:Lq4e;

    check-cast p6, Loba;

    invoke-virtual {p6}, Loba;->d()Lyca;
    ...
    invoke-virtual {p2, p3, p4, p3, p3}, Lyca;->f(ILjava/lang/String;II)Ljava/util/concurrent/ExecutorService;

    move-result-object p2

    new-instance p4, Lz75;

    invoke-direct {p4, p2}, Lz75;-><init>(Ljava/util/concurrent/Executor;)V

    new-instance p2, Lkj;

    invoke-direct {p2, p0}, Lkj;-><init>(Lsxa;)V

    invoke-virtual {p4, p2}, Ld0;->plus(Lh04;)Lh04;
    ...
    sget-object p5, Lnw4;->o:Lnw4;

    invoke-static {p1, p5}, Lj5e;->C(ILnw4;)J

    move-result-wide p5

    invoke-static {p4, p5, p6}, Lqbf;->I(Lbq5;J)Lt52;
    ...
    invoke-direct {p0, p1, p4, p3}, Lgs5;-><init>(Lbq5;Lt96;I)V
...
.method public static C(Ljava/lang/String;)Ljava/lang/Long;
    ...
    invoke-static {v0, p0}, Lwde;->s0(ILjava/lang/String;)Ljava/lang/String;
...
.method public final H()V
    ...
    invoke-direct {v2, p0, v1}, Ld44;-><init>(Lsxa;Landroid/os/Handler;)V
...
.method public final x()V
    ...
    invoke-static {v2}, Lyr3;->r0(Ljava/lang/Throwable;)Ljava/lang/String;
    ...
    :cond_1
    :goto_0
    iget-object v0, p0, Lsxa;->o0:Lq4e;
