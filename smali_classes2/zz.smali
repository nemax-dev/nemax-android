...
.method public final onClick(Landroid/content/DialogInterface;I)V
    ...
    invoke-virtual {p0, p1}, Lru/ok/messages/views/dialogs/VideoQualityPickerDialog;->c1(Lp5g;)V
    ...
    iget-object v1, p0, Lru/ok/messages/views/dialogs/FrgDlgAudioTracksPicker;->E1:Ljava/util/ArrayList;
    ...
    iget-object p1, p1, Lru/ok/messages/media/attaches/fragments/FrgAttachVideo;->M1:Lzp9;
    ...
    :cond_6
    iget-object v1, p1, Lzp9;->x0:Ld10;

    if-eqz v1, :cond_7

    iget-object v2, p1, Lzp9;->w0:Lk09;

    if-eqz v2, :cond_7

    iget-object v3, p1, Lzp9;->r0:Li09;

    iget v4, p2, Lpcf;->s0:I

    iget v5, p2, Lpcf;->r0:I
    ...
    invoke-direct {v6, v4, v5, v7}, Lpc5;-><init>(III)V

    invoke-virtual {v3, v2, v1, v6}, Li09;->t(Lk09;Ljava/lang/String;Lwm3;)Lk09;
    ...
    iget-object p1, p1, Lcc5;->b:Lr03;

    iget-object v1, p1, Lr03;->a:Ljava/lang/Object;

    check-cast v1, Luj4;

    sget-object v2, Lpcf;->t0:Lpcf;

    if-ne p2, v2, :cond_d

    iget-object p2, v1, Ls68;->c:Lq68;
    ...
    :cond_9
    invoke-virtual {p1, p2}, Lr03;->j(Lq68;)Landroid/util/Pair;
    ...
    :cond_a
    invoke-virtual {v1}, Luj4;->a()Lij4;

    move-result-object p2

    iget-object v2, p2, Lij4;->M:Landroid/util/SparseArray;
    ...
    :cond_c
    :goto_2
    invoke-virtual {v1, p2}, Luj4;->g(Lij4;)V

    goto :goto_3

    :cond_d
    iget-object p1, v1, Ls68;->c:Lq68;
    ...
    iget v3, p2, Lpcf;->r0:I

    iget v4, p2, Lpcf;->Z:I

    iget p2, p2, Lpcf;->s0:I

    filled-new-array {p2}, [I

    move-result-object p2

    invoke-direct {v2, v3, v0, p2}, Ljj4;-><init>(II[I)V

    iget-object p1, p1, Lq68;->c:[Lwcf;
    ...
    invoke-virtual {p2, v4, p1, v2}, Lij4;->d(ILwcf;Ljj4;)V
    ...
    sget-object p1, Lkug;->f:Ljava/util/ArrayList;
