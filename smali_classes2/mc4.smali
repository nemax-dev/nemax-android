...
# direct methods
.method public synthetic constructor <init>(Lnc4;Ljava/net/Socket;II)V
    .locals 0
    ...
    iput-object p2, p0, Lmc4;->b:Ljava/net/Socket;
...
.method public final a(Ljava/lang/String;Ljava/net/InetAddress;J)V
    ...
    iget-object v0, p0, Lmc4;->a:Lnc4;

    iget-object v1, p0, Lmc4;->b:Ljava/net/Socket;
    ...
    :cond_0
    invoke-virtual {p4, p3}, Lvea;->a(Lhw7;)Z
    ...
    invoke-virtual {p4, p3, v6, v7, v3}, Lvea;->b(Lhw7;Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    invoke-virtual {p0, p3, v6, p1, v3}, Lvea;->b(Lhw7;Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    iget-object p3, v0, Lnc4;->j:Lwp4;

    if-eqz p3, :cond_a

    check-cast p3, Lxp4;

    iget-object p4, p3, Lxp4;->c:Ljava/util/concurrent/locks/ReentrantLock;

    invoke-virtual {p4}, Ljava/util/concurrent/locks/ReentrantLock;->lock()V

    :try_start_1
    iget-object p3, p3, Lxp4;->f:Ljava/util/HashMap;
    ...
    iget-object v0, v0, Lga7;->a:Ljava/net/InetAddress;
