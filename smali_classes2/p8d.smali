...
.method public static p(Landroid/view/ViewGroup;Ljava/lang/String;Landroid/view/WindowInsets;I)Landroid/view/View;
    ...
    sget-object v0, Lo8d;->$EnumSwitchMapping$1:[I
    ...
    invoke-static {}, Lsvg;->h()I

    move-result v1

    invoke-static {p2, v1}, Lsvg;->c(Landroid/view/WindowInsets;I)Landroid/graphics/Insets;
...
.method public c(Landroid/view/Window;)V
    ...
    :cond_1
    invoke-interface {p0}, Lp8d;->R()Ljava/lang/Integer;

    move-result-object v0

    const/4 v1, 0x0

    invoke-interface {p0, p1, v1, v0, v2}, Lp8d;->t(Landroid/view/Window;Ljava/lang/Integer;Ljava/lang/Integer;Z)V
...
.method public m(Landroid/view/Window;)V
    ...
    invoke-interface {p0}, Lp8d;->getContext()Landroid/content/Context;
    ...
    invoke-virtual {v1, v3}, Lrx9;->l(Landroid/content/Context;)Lfv4;
    ...
    invoke-interface {p0, p1, v2, v2, v0}, Lp8d;->t(Landroid/view/Window;Ljava/lang/Integer;Ljava/lang/Integer;Z)V
...
.method public t(Landroid/view/Window;Ljava/lang/Integer;Ljava/lang/Integer;Z)V
    ...
    invoke-direct {v1, p2, v0, p3, p0}, Ln8d;-><init>(Ljava/lang/Integer;Landroid/view/ViewGroup;Ljava/lang/Integer;Lp8d;)V
    ...
    invoke-direct {p3, p2}, Lsae;-><init>(Landroid/view/View;)V
    ...
    invoke-direct {v0, v1, p3}, Lyvg;-><init>(Landroid/view/WindowInsetsController;Lsae;)V
    ...
    invoke-direct {v0, p1, p3}, Lxvg;-><init>(Landroid/view/Window;Lsae;)V

    :goto_1
    sget-object p3, Lfv4;->t0:Lrx9;

    invoke-virtual {p3, p2}, Lrx9;->n(Landroid/view/View;)Lvra;
    ...
    invoke-virtual {v0, p2}, Lds;->y(Z)V
    ...
    :cond_6
    invoke-virtual {v0, p2}, Lds;->z(Z)V
