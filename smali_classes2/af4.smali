...
.method public final B(Lore;Ljava/lang/Object;)V
    ...
    invoke-static {v8}, Lpod;->F(I)I

    move-result v8

    int-to-long v8, v8

    invoke-interface {p1, v7, v8, v9}, Lmre;->k(IJ)V

    iget-boolean v7, p0, Lrm3;->b:Z

    int-to-long v7, v7

    invoke-interface {p1, v6, v7, v8}, Lmre;->k(IJ)V

    iget-boolean v6, p0, Lrm3;->c:Z

    int-to-long v6, v6

    invoke-interface {p1, v5, v6, v7}, Lmre;->k(IJ)V

    iget-boolean v5, p0, Lrm3;->d:Z

    int-to-long v5, v5

    invoke-interface {p1, v4, v5, v6}, Lmre;->k(IJ)V

    iget-boolean v4, p0, Lrm3;->e:Z

    int-to-long v4, v4

    invoke-interface {p1, v3, v4, v5}, Lmre;->k(IJ)V

    iget-wide v3, p0, Lrm3;->f:J

    invoke-interface {p1, v2, v3, v4}, Lmre;->k(IJ)V

    iget-wide v2, p0, Lrm3;->g:J
    ...
    :cond_5
    invoke-interface {p1, v7}, Lmre;->Z(I)V
    ...
    iget-wide v0, p2, Lc1f;->a:J

    invoke-interface {p1, p0, v0, v1}, Lmre;->k(IJ)V

    iget-object p0, p2, Lc1f;->b:Lm3b;
    ...
    iget-object p0, p2, Lbxc;->a:Ljava/lang/String;
    ...
    :goto_9
    iget-object p0, p2, Lbxc;->b:Ljava/lang/String;
    ...
    iget-object p0, p2, Lbxc;->d:Ljava/lang/String;
    ...
    :goto_b
    iget-object p0, p2, Lbxc;->e:Ljava/util/Set;

    invoke-static {p0}, Lw5h;->h(Ljava/util/Set;)Ljava/lang/String;
    ...
    iget-object p0, p2, Lbxc;->g:Ljava/util/List;

    const/4 v0, 0x0

    if-eqz p0, :cond_c

    invoke-static {p0}, Lw09;->b(Ljava/util/List;)[B
    ...
    :cond_d
    invoke-interface {p1, v1, p0}, Lmre;->l(I[B)V

    :goto_d
    iget-object p0, p2, Lbxc;->h:Ljava/util/Map;

    if-eqz p0, :cond_e

    invoke-static {p0}, Lxu0;->j(Ljava/util/Map;)Lh36;
    ...
    :goto_f
    iget-object p0, p2, Lbxc;->i:Ljava/util/List;

    if-eqz p0, :cond_10

    invoke-static {p0}, Lxu0;->l(Ljava/util/List;)Lh36;
    ...
    :goto_11
    iget-object p0, p2, Lbxc;->j:Ljava/util/Set;

    if-eqz p0, :cond_12

    invoke-static {p0}, Lxu0;->k(Ljava/util/Set;)Lh36;
    ...
    invoke-interface {p1, p0}, Lmre;->Z(I)V

    goto :goto_12

    :cond_13
    invoke-interface {p1, p0, v0}, Lmre;->l(I[B)V

    :goto_12
    const/16 p0, 0xb

    iget-wide v0, p2, Lbxc;->k:J

    invoke-interface {p1, p0, v0, v1}, Lmre;->k(IJ)V

    iget-object p0, p2, Lbxc;->l:Lpo9;

    invoke-static {p0}, Lw5h;->v(Lpo9;)[B
    ...
    :goto_13
    iget-object p0, p2, Lbxc;->m:Ljava/lang/Long;
    ...
    :goto_14
    iget-object p0, p2, Lbxc;->n:Ljava/lang/Long;
    ...
    iget-wide v0, p2, Lq4b;->a:J

    invoke-interface {p1, p0, v0, v1}, Lmre;->k(IJ)V

    const/4 p0, 0x2

    iget-wide v0, p2, Lq4b;->b:J
    ...
    iget-object p0, p2, Lq4b;->d:Ljava/lang/String;
    ...
    iget-wide v0, p2, Lq4b;->e:J

    invoke-interface {p1, p0, v0, v1}, Lmre;->k(IJ)V

    iget-object p0, p2, Lq4b;->f:Ljava/lang/String;
    ...
    :goto_18
    iget-object p0, p2, Lq4b;->g:Ljava/lang/String;
    ...
    :goto_19
    iget-object p0, p2, Lq4b;->h:Ljava/lang/String;
    ...
    :goto_1a
    iget-object p0, p2, Lq4b;->i:Ljava/lang/String;
