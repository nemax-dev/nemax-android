...
# direct methods
.method public constructor <init>(Lv61;Lftb;Lv0d;ZLyx0;Lny0;Lxec;)V
    .locals 14
    ...
    iput-object v0, p0, Lqq5;->a:Lftb;

    move/from16 v1, p4

    iput-boolean v1, p0, Lqq5;->b:Z

    move-object/from16 v0, p5

    iput-object v0, p0, Lqq5;->c:Lyx0;
    ...
    invoke-direct/range {v2 .. v7}, Lch4;-><init>(Lv0d;Lu61;Lxec;Ljava/lang/String;Ljava/lang/String;)V

    iput-object v2, p0, Lqq5;->d:Lch4;

    new-instance v8, Lch4;
    ...
    invoke-direct/range {v8 .. v13}, Lch4;-><init>(Lv0d;Lu61;Lxec;Ljava/lang/String;Ljava/lang/String;)V

    iput-object v8, p0, Lqq5;->e:Lch4;
    ...
    invoke-direct/range {v0 .. v5}, Lvv1;-><init>(ZLv0d;Lny0;Lu61;Lxec;)V

    iput-object v0, p0, Lqq5;->f:Lvv1;

    return-void
.end method

.method public static b(Lnve;)Z
    .locals 2
    ...
    iget-object v0, v0, Leae;->j:Ljava/math/BigInteger;
...
.method public final a(Lzec;)V
    ...
    iget-object v1, p0, Lqq5;->f:Lvv1;

    iget-boolean v2, v1, Lvv1;->b:Z

    if-nez v2, :cond_e

    iget-object v2, p0, Lqq5;->d:Lch4;

    iget-boolean v3, v2, Lch4;->a:Z

    if-nez v3, :cond_e

    iget-object v3, p0, Lqq5;->e:Lch4;

    iget-boolean v4, v3, Lch4;->a:Z
    ...
    :cond_0
    iget-object v4, p0, Lqq5;->c:Lyx0;

    invoke-virtual {v4}, Lyx0;->invoke()Ljava/lang/Object;
    ...
    :cond_1
    invoke-static {v0, p0}, Ln8g;->x(Ljava/util/List;Lp12;)Ljava/util/ArrayList;

    move-result-object p0

    invoke-static {p0}, Ln8g;->w(Ljava/util/List;)Lnve;

    move-result-object p0

    invoke-static {p0}, Lqq5;->b(Lnve;)Z
    ...
    invoke-virtual {p0}, Lny0;->invoke()Ljava/lang/Object;
    ...
    invoke-virtual {p0, v2, p1, v0}, Lv61;->c(Ljava/lang/String;Lru/ok/android/externcalls/analytics/events/EventItemValue;Lru/ok/android/externcalls/analytics/events/EventItemsMap;)V
    ...
    invoke-static {p1}, Ln8g;->w(Ljava/util/List;)Lnve;

    move-result-object p1

    invoke-static {p1}, Lqq5;->b(Lnve;)Z
    ...
    :cond_c
    iget-boolean p0, p0, Lqq5;->b:Z

    if-eqz p0, :cond_d

    invoke-virtual {v3}, Lch4;->e()V

    return-void

    :cond_d
    invoke-virtual {v2}, Lch4;->e()V
...
.method public final c()V
    ...
    iget-object v0, p0, Lqq5;->e:Lch4;

    invoke-virtual {v0}, Lch4;->d()V
