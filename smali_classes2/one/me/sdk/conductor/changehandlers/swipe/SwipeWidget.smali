...
.method public static E0(Ley3;)V
    .locals 6

    invoke-virtual {p0}, Ley3;->getChildRouters()Ljava/util/List;
    ...
    sget-object v3, Lmy3;->d:Lca4;

    sget-object v4, Lmy3;->a:[Lqj7;
    ...
    invoke-virtual {v3, v5, v4}, Lca4;->N(Ljava/lang/Object;Lqj7;)Ljava/lang/Object;
    ...
    invoke-static {v1}, Lone/me/sdk/conductor/changehandlers/swipe/SwipeWidget;->E0(Ley3;)V
...
.method public final onChangeEnded(Ljy3;Lky3;)V
    ...
    invoke-super/range {p0 .. p2}, Ley3;->onChangeEnded(Ljy3;Lky3;)V
    ...
    invoke-virtual {v2, v1, v0, v4, v3}, Leka;->b(Le08;Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    :cond_4
    invoke-virtual {v0}, Lone/me/sdk/conductor/changehandlers/swipe/SwipeWidget;->y0()Ley3;
    ...
    invoke-virtual {v4, v1, v2, v5, v3}, Leka;->b(Le08;Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V

    :cond_8
    :goto_2
    instance-of v1, v8, Lkue;
    ...
    :goto_4
    new-instance v14, Lfue;

    new-instance v7, Lryc;

    const/16 v2, 0x14

    invoke-direct {v7, v2, v0}, Lryc;-><init>(ILjava/lang/Object;)V

    move-object v5, v14

    invoke-direct/range {v5 .. v11}, Lfue;-><init>(Ljava/lang/Integer;Lryc;Landroid/view/View;Landroid/view/ViewGroup;Lk81;I)V

    iput-object v0, v14, Lfue;->q:Lone/me/sdk/conductor/changehandlers/swipe/SwipeWidget;

    invoke-virtual {v0}, Lone/me/sdk/conductor/changehandlers/swipe/SwipeWidget;->F0()Ljava/lang/Long;

    move-result-object v0

    iput-object v0, v14, Lfue;->r:Ljava/lang/Long;
    ...
    const-class v15, Lfue;

    const-string v16, "onTouchEvent"

    const-string v17, "onTouchEvent(Landroid/view/MotionEvent;)Z"

    invoke-direct/range {v12 .. v19}, Lc09;-><init>(ILjava/lang/Object;Ljava/lang/Class;Ljava/lang/String;Ljava/lang/String;II)V

    invoke-interface {v3, v12}, Lkue;->setOnTouch(Lmc6;)V
    ...
    invoke-direct/range {v12 .. v19}, Lya6;-><init>(ILjava/lang/Object;Ljava/lang/Class;Ljava/lang/String;Ljava/lang/String;II)V

    invoke-interface {v3, v12}, Lkue;->setOnRequestInterceptTouchEvent(Lkc6;)V
...
.method public onChangeStarted(Ljy3;Lky3;)V
    .locals 0
    ...
    invoke-interface {p0, p2}, Lkue;->setOnTouch(Lmc6;)V

    invoke-interface {p0, p2}, Lkue;->setOnRequestInterceptTouchEvent(Lkc6;)V

    :cond_1
    return-void
.end method

.method public final y0()Ley3;
    .locals 5
    ...
    invoke-static {v1, v0}, Lz73;->i0(ILjava/util/List;)Ljava/lang/Object;
    ...
    invoke-virtual {v2, v3, p0, v4, v1}, Leka;->b(Le08;Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
