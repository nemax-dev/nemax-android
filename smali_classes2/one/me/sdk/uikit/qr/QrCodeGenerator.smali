...
.method static constructor <clinit>()V
    ...
    sget-object v0, Ln0c;->a:Lvi6;

    sput-object v0, Lone/me/sdk/uikit/qr/QrCodeGenerator;->b:Lvi6;
    ...
    sget-object v1, Lone/me/sdk/uikit/qr/QrCodeGenerator;->b:Lvi6;
...
.method public static c(Landroid/graphics/Bitmap;Landroid/graphics/drawable/Drawable;Landroid/graphics/Canvas;[IIIIILvra;)V
    .locals 12
    ...
    invoke-interface/range {p8 .. p8}, Lvra;->a()Lit2;
...
# virtual methods
.method public final e(Landroid/content/Context;Lkp5;Luxe;Ls0c;Ljava/lang/String;Landroid/graphics/drawable/Drawable;Landroid/graphics/Bitmap;Landroid/graphics/drawable/Drawable;Ljava/lang/CharSequence;Ljava/lang/CharSequence;Lqx3;)Ljava/lang/Object;
    .locals 43
    ...
    invoke-direct {v5, v1, v3}, Lo0c;-><init>(Lone/me/sdk/uikit/qr/QrCodeGenerator;Lqx3;)V

    :goto_0
    iget-object v3, v5, Lo0c;->t0:Ljava/lang/Object;
    ...
    iget-object v0, v5, Lo0c;->s0:Landroid/graphics/Bitmap;

    iget-object v1, v5, Lo0c;->r0:Landroid/graphics/Bitmap;

    iget-object v2, v5, Lo0c;->Z:Ljava/lang/String;

    iget-object v6, v5, Lo0c;->Y:Ls0c;

    iget-object v7, v5, Lo0c;->X:Lkp5;

    iget-object v5, v5, Lo0c;->o:Lone/me/sdk/uikit/qr/QrCodeGenerator;
    ...
    sget-object v11, Lbja;->d:Lbja;

    sget-object v12, Lfv4;->t0:Lrx9;

    move-object/from16 v14, p1

    invoke-virtual {v12, v14}, Lrx9;->l(Landroid/content/Context;)Lfv4;

    move-result-object v12

    invoke-virtual {v12}, Lfv4;->k()Z

    move-result v12

    invoke-virtual {v11, v12}, Lbja;->a(Z)Lvra;
    ...
    :cond_5
    invoke-interface/range {v17 .. v17}, Lvra;->a()Lit2;

    move-result-object v15

    invoke-interface {v15}, Lit2;->I()Lxa3;

    move-result-object v15

    iget-object v15, v15, Lxa3;->b:Lo93;

    iget-object v15, v15, Lo93;->d:Lx93;

    iget v15, v15, Lx93;->b:I
    ...
    invoke-static {v11, v10, v15}, Ls3f;->c(Ls3f;Landroid/text/TextPaint;Landroid/util/DisplayMetrics;)V

    invoke-interface/range {v17 .. v17}, Lvra;->a()Lit2;

    move-result-object v11

    invoke-interface {v11}, Lit2;->p()Lms0;
    ...
    invoke-static/range {v26 .. v33}, Lsl7;->a(Lsl7;Ljava/lang/CharSequence;Landroid/text/TextPaint;IIZLandroid/text/TextUtils$TruncateAt;I)Landroid/text/Layout;
    ...
    invoke-interface/range {v17 .. v17}, Lvra;->getText()Le2f;
    ...
    :try_start_3
    invoke-interface/range {v17 .. v17}, Lvra;->b()Lhe0;
    ...
    invoke-static/range {v9 .. v17}, Lone/me/sdk/uikit/qr/QrCodeGenerator;->c(Landroid/graphics/Bitmap;Landroid/graphics/drawable/Drawable;Landroid/graphics/Canvas;[IIIIILvra;)V
    :try_end_4
    ...
    invoke-virtual/range {p2 .. p2}, Lkp5;->m()Ljava/io/File;
    ...
    :try_start_7
    invoke-direct/range {v26 .. v32}, Lp0c;-><init>(Ljava/io/File;Ljava/io/File;Lkp5;Landroid/content/Context;Landroid/graphics/Bitmap;Lkotlin/coroutines/Continuation;)V
    :try_end_7
    ...
    :try_start_8
    iput-object v1, v5, Lo0c;->o:Lone/me/sdk/uikit/qr/QrCodeGenerator;
    :try_end_8
    ...
    :try_start_a
    iput-object v9, v5, Lo0c;->Y:Ls0c;

    iput-object v2, v5, Lo0c;->Z:Ljava/lang/String;

    iput-object v3, v5, Lo0c;->r0:Landroid/graphics/Bitmap;

    iput-object v0, v5, Lo0c;->s0:Landroid/graphics/Bitmap;

    const/4 v11, 0x1

    iput v11, v5, Lo0c;->v0:I

    invoke-static {v7, v6, v5}, Lvzg;->G(Lx04;Lad6;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    ...
    invoke-direct {v8, v3, v0}, Lm0c;-><init>(Landroid/net/Uri;Landroid/graphics/Bitmap;)V

    new-instance v0, Liya;

    invoke-direct {v0, v6, v8}, Liya;-><init>(Ljava/lang/Object;Ljava/lang/Object;)V

    sput-object v0, Lone/me/sdk/uikit/qr/QrCodeGenerator;->f:Liya;
    :try_end_b
    ...
    invoke-static {v1, v5, v0}, Lkug;->n(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    invoke-virtual {v8}, Lkp5;->m()Ljava/io/File;
