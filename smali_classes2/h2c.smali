...
# instance fields
.field public final A0:Lsla;

.field public final B0:Lsla;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v4, v0, Lh2c;->a:Landroid/animation/FloatEvaluator;
    ...
    iput-object v4, v0, Lh2c;->t0:Lru/ok/tamtam/android/widgets/quickcamera/CameraxCameraApiView;
    ...
    invoke-virtual {v7, v5}, Lrx9;->n(Landroid/view/View;)Lvra;
    ...
    iput-object v5, v0, Lh2c;->u0:Landroidx/appcompat/widget/AppCompatImageView;

    new-instance v10, Lsla;

    invoke-direct {v10, v1}, Lsla;-><init>(Landroid/content/Context;)V
    ...
    sget-object v2, Lpla;->b:Lpla;

    invoke-virtual {v10, v2}, Lsla;->setMode(Lpla;)V
    ...
    invoke-virtual {v10, v11, v9, v13}, Lsla;->a(FILjava/lang/String;)V

    new-instance v9, Lc2c;

    const/4 v13, 0x0

    invoke-direct {v9, v0, v13}, Lc2c;-><init>(Lh2c;I)V

    invoke-static {v10, v9}, Lo58;->M(Landroid/view/View;Landroid/view/View$OnClickListener;)V

    iput-object v10, v0, Lh2c;->v0:Lsla;
    ...
    invoke-virtual {v7, v9}, Lrx9;->n(Landroid/view/View;)Lvra;
    ...
    iput-object v9, v0, Lh2c;->w0:Landroid/widget/Chronometer;
    ...
    invoke-virtual {v7, v13}, Lrx9;->n(Landroid/view/View;)Lvra;
    ...
    invoke-static {v3, v6}, Lv7;->M(Landroid/graphics/drawable/Drawable;I)V
    ...
    invoke-interface {v7}, Lvra;->e()Lb4;

    move-result-object v7

    iget v7, v7, Lb4;->a:I

    invoke-static {v6, v7}, Lv7;->M(Landroid/graphics/drawable/Drawable;I)V
    ...
    iput-object v13, v0, Lh2c;->x0:Landroid/widget/LinearLayout;

    new-instance v3, Lsla;

    invoke-direct {v3, v1}, Lsla;-><init>(Landroid/content/Context;)V
    ...
    invoke-virtual {v3, v2}, Lsla;->setMode(Lpla;)V

    new-instance v6, Lc2c;

    const/4 v7, 0x1

    invoke-direct {v6, v0, v7}, Lc2c;-><init>(Lh2c;I)V

    invoke-static {v3, v6}, Lo58;->M(Landroid/view/View;Landroid/view/View$OnClickListener;)V

    iput-object v3, v0, Lh2c;->y0:Lsla;

    new-instance v6, Lky1;

    invoke-direct {v6, v1}, Lky1;-><init>(Landroid/content/Context;)V
    ...
    invoke-direct {v7, v0, v8}, Lc2c;-><init>(Lh2c;I)V

    invoke-static {v6, v7}, Lo58;->M(Landroid/view/View;Landroid/view/View$OnClickListener;)V

    iput-object v6, v0, Lh2c;->z0:Lky1;

    new-instance v7, Lsla;

    invoke-direct {v7, v1}, Lsla;-><init>(Landroid/content/Context;)V
    ...
    invoke-virtual {v7, v2}, Lsla;->setMode(Lpla;)V
    ...
    invoke-virtual {v7, v11, v8, v9}, Lsla;->a(FILjava/lang/String;)V

    new-instance v8, Lc2c;

    const/4 v9, 0x3

    invoke-direct {v8, v0, v9}, Lc2c;-><init>(Lh2c;I)V

    invoke-static {v7, v8}, Lo58;->M(Landroid/view/View;Landroid/view/View$OnClickListener;)V

    iput-object v7, v0, Lh2c;->A0:Lsla;

    new-instance v8, Lsla;

    invoke-direct {v8, v1}, Lsla;-><init>(Landroid/content/Context;)V
    ...
    invoke-virtual {v8, v2}, Lsla;->setMode(Lpla;)V

    new-instance v2, Lc2c;

    const/4 v9, 0x4

    invoke-direct {v2, v0, v9}, Lc2c;-><init>(Lh2c;I)V

    invoke-static {v8, v2}, Lo58;->M(Landroid/view/View;Landroid/view/View$OnClickListener;)V

    iput-object v8, v0, Lh2c;->B0:Lsla;
    ...
    invoke-direct {v2, v3, v3, v7}, Lar0;-><init>(IIZ)V

    new-instance v7, Lca7;

    invoke-direct {v7, v3, v2}, Lca7;-><init>(ILar0;)V

    const/4 v8, 0x0

    invoke-static {v6, v7, v8}, Lh3e;->e(Landroid/view/View;Lca7;Lmc6;)V

    iput-object v6, v0, Lh2c;->C0:Landroid/widget/FrameLayout;

    new-instance v2, Lwfa;

    const/16 v7, 0xd

    invoke-direct {v2, v1, v7}, Lwfa;-><init>(Landroid/content/Context;I)V

    invoke-static {v3, v2}, Lvb7;->l(ILkc6;)Lvl7;

    move-result-object v2

    iput-object v2, v0, Lh2c;->D0:Ljava/lang/Object;
    ...
    iput-object v2, v0, Lh2c;->E0:Ljava/lang/Object;
    ...
    iput-object v1, v0, Lh2c;->F0:Ljava/lang/Object;
...
.method public static final synthetic a(Lh2c;)Z
    .locals 0

    invoke-direct {p0}, Lh2c;->getCanRecordingVideo()Z
...
.method public static final b(Lh2c;Lux1;)V
    .locals 6
    ...
    invoke-direct {p0}, Lh2c;->getFlashOnDrawable()Landroid/graphics/drawable/Drawable;
    ...
    :cond_1
    invoke-direct {p0}, Lh2c;->getFlashAutoDrawable()Landroid/graphics/drawable/Drawable;
    ...
    :cond_3
    invoke-direct {p0}, Lh2c;->getFlashOffDrawable()Landroid/graphics/drawable/Drawable;
    ...
    :cond_7
    :goto_1
    iget-object v1, p0, Lh2c;->y0:Lsla;

    iget-object v1, v1, Lsla;->c:Lzoa;

    invoke-virtual {v1, v0}, Landroidx/appcompat/widget/AppCompatImageView;->setImageDrawable(Landroid/graphics/drawable/Drawable;)V

    invoke-static {v5}, Lmu0;->h(Ljava/lang/String;)Landroid/graphics/Path;

    move-result-object v0

    iput-object v0, v1, Lzoa;->r0:Landroid/graphics/Path;
    ...
    invoke-interface {p0, p1}, Lvx1;->setFlash(Ljava/lang/String;)V

    return-void
.end method

.method public static final c(Lh2c;FFFFF)V
    .locals 2

    iget-object v0, p0, Lh2c;->u0:Landroidx/appcompat/widget/AppCompatImageView;

    iget-object v1, p0, Lh2c;->a:Landroid/animation/FloatEvaluator;
    ...
    iget-object p0, p0, Lh2c;->C0:Landroid/widget/FrameLayout;
...
.method private final getFlashAutoDrawable()Landroid/graphics/drawable/Drawable;
    ...
    iget-object p0, p0, Lh2c;->D0:Ljava/lang/Object;
...
.method private final getFlashOffDrawable()Landroid/graphics/drawable/Drawable;
    ...
    iget-object p0, p0, Lh2c;->F0:Ljava/lang/Object;
...
.method private final getFlashOnDrawable()Landroid/graphics/drawable/Drawable;
    ...
    iget-object p0, p0, Lh2c;->E0:Ljava/lang/Object;
...
.method public final getCameraApi()Lvx1;
    .locals 0

    iget-object p0, p0, Lh2c;->t0:Lru/ok/tamtam/android/widgets/quickcamera/CameraxCameraApiView;
