...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    invoke-direct {v0, p0}, Lzj;-><init>(Ltda;)V

    iput-object v0, p0, Ltda;->a:Lzj;

    new-instance v0, Landroid/graphics/drawable/ShapeDrawable;

    invoke-direct {v0}, Landroid/graphics/drawable/ShapeDrawable;-><init>()V

    iput-object v0, p0, Ltda;->b:Landroid/graphics/drawable/ShapeDrawable;

    new-instance v1, Landroid/graphics/drawable/ShapeDrawable;

    invoke-direct {v1}, Landroid/graphics/drawable/ShapeDrawable;-><init>()V

    iput-object v1, p0, Ltda;->c:Landroid/graphics/drawable/ShapeDrawable;

    new-instance v2, Landroid/graphics/drawable/ShapeDrawable;

    invoke-direct {v2}, Landroid/graphics/drawable/ShapeDrawable;-><init>()V

    iput-object v2, p0, Ltda;->o:Landroid/graphics/drawable/ShapeDrawable;

    new-instance v3, Landroid/graphics/Matrix;

    invoke-direct {v3}, Landroid/graphics/Matrix;-><init>()V

    iput-object v3, p0, Ltda;->r0:Landroid/graphics/Matrix;

    new-instance v3, Lln2;

    const/16 v4, 0x18

    invoke-direct {v3, p1, v4}, Lln2;-><init>(Landroid/content/Context;I)V
    ...
    iput-object v3, p0, Ltda;->s0:Ljava/lang/Object;

    new-instance v3, Lqv3;

    const/16 v5, 0x19

    invoke-direct {v3, p1, v5, p0}, Lqv3;-><init>(Ljava/lang/Object;ILjava/lang/Object;)V

    invoke-static {v4, v3}, Lvb7;->l(ILkc6;)Lvl7;

    move-result-object p1

    iput-object p1, p0, Ltda;->t0:Ljava/lang/Object;
    ...
    invoke-direct {p1, v3}, Lu04;-><init>(F)V
    ...
    invoke-virtual {p0}, Ltda;->getState()Lsda;

    move-result-object p1

    invoke-virtual {p0, p1}, Ltda;->a(Lsda;)V
    ...
    invoke-virtual {p0, p1}, Ltda;->onThemeChanged(Lvra;)V
...
.method public final a(Lsda;)V
    ...
    iget-object v1, p0, Ltda;->t0:Ljava/lang/Object;

    const/16 v2, 0x8

    iget-object p0, p0, Ltda;->s0:Ljava/lang/Object;
...
.method public final getState()Lsda;
    .locals 2

    sget-object v0, Ltda;->u0:[Lqj7;

    const/4 v1, 0x0

    aget-object v0, v0, v1

    iget-object p0, p0, Ltda;->a:Lzj;
...
.method public final onSizeChanged(IIII)V
    ...
    iget-object p3, p0, Ltda;->r0:Landroid/graphics/Matrix;
    ...
    iget-object p1, p0, Ltda;->b:Landroid/graphics/drawable/ShapeDrawable;
    ...
    iget-object p1, p0, Ltda;->c:Landroid/graphics/drawable/ShapeDrawable;
    ...
    iget-object p0, p0, Ltda;->o:Landroid/graphics/drawable/ShapeDrawable;
...
.method public final onThemeChanged(Lvra;)V
    ...
    iget-object v1, v0, Ltda;->b:Landroid/graphics/drawable/ShapeDrawable;
    ...
    invoke-interface/range {p1 .. p1}, Lvra;->d()Lsm6;

    move-result-object v3

    iget-object v3, v3, Lsm6;->b:Lrm6;

    iget-object v7, v3, Lrm6;->a:[I
    ...
    iget-object v3, v0, Ltda;->r0:Landroid/graphics/Matrix;

    invoke-virtual {v2, v3}, Landroid/graphics/Shader;->setLocalMatrix(Landroid/graphics/Matrix;)V

    invoke-virtual {v1, v2}, Landroid/graphics/Paint;->setShader(Landroid/graphics/Shader;)Landroid/graphics/Shader;

    iget-object v1, v0, Ltda;->c:Landroid/graphics/drawable/ShapeDrawable;
    ...
    iget-object v2, v2, Lsm6;->b:Lrm6;

    iget-object v13, v2, Lrm6;->c:[I
    ...
    iget-object v1, v0, Ltda;->o:Landroid/graphics/drawable/ShapeDrawable;
    ...
    iget-object v0, v0, Ltda;->s0:Ljava/lang/Object;
...
.method public final setState(Lsda;)V
    .locals 2
...
.method public final setText(I)V
    ...
    .line 5
    iget-object v0, p0, Ltda;->s0:Ljava/lang/Object;
