...
.method public final a(JLjava/lang/Long;Ljava/lang/Long;)V
    ...
    invoke-virtual {p4, v4, v5}, Lbb2;->z(J)Lu72;
    ...
    invoke-virtual {p3, v4, v5}, Lbb2;->F(J)Lu72;
    ...
    iget-object p4, p4, Lxb2;->b0:Lnha;

    if-nez p4, :cond_3

    const-string p0, "draft is null, ignore"

    invoke-static {v1, p0, v0}, Lkug;->u(Ljava/lang/String;Ljava/lang/String;Ljava/util/concurrent/CancellationException;)V

    return-void

    :cond_3
    invoke-virtual {p4}, Lnha;->b()Ljava/lang/Long;
