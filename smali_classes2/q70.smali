...
# direct methods
.method public constructor <init>(Landroid/content/Context;Lc5;Lvl7;Lvl7;Lvl7;)V
    .locals 0
    ...
    iput-object p2, p0, Lq70;->b:Lc5;

    iput-object p3, p0, Lq70;->c:Lvl7;

    iput-object p4, p0, Lq70;->d:Lvl7;

    iput-object p5, p0, Lq70;->e:Lvl7;
...
.method public final addAccount(Landroid/accounts/AccountAuthenticatorResponse;Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Landroid/os/Bundle;)Landroid/os/Bundle;
    ...
    invoke-virtual {p2}, Le5;->a()Landroid/accounts/Account;

    move-result-object p2

    if-eqz p2, :cond_0

    iget-object p2, p0, Lq70;->b:Lc5;
    ...
    iget-object p0, p0, Lq70;->a:Landroid/content/Context;

    sget p2, Ldcc;->account_already_exists:I
...
.method public final getAccountRemovalAllowed(Landroid/accounts/AccountAuthenticatorResponse;Landroid/accounts/Account;)Landroid/os/Bundle;
    ...
    invoke-virtual {p2}, Lqba;->e()Z

    move-result p2

    sget v0, Lkld;->o:I

    iget-object p0, p0, Lq70;->e:Lvl7;
    ...
    invoke-direct {v0, p2}, Lkld;-><init>(Z)V
