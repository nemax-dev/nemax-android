...
.method static constructor <clinit>()V
    ...
    invoke-static {v0, v1}, Lrp5;->a(FF)J

    move-result-wide v2

    new-instance v4, Lrp5;

    invoke-direct {v4, v2, v3}, Lrp5;-><init>(J)V

    const/high16 v2, 0x44610000    # 900.0f

    invoke-static {v2, v1}, Lrp5;->a(FF)J

    move-result-wide v5

    new-instance v3, Lrp5;

    invoke-direct {v3, v5, v6}, Lrp5;-><init>(J)V

    const v5, 0x44c1c000    # 1550.0f

    invoke-static {v5, v0}, Lrp5;->a(FF)J

    move-result-wide v6

    new-instance v8, Lrp5;

    invoke-direct {v8, v6, v7}, Lrp5;-><init>(J)V

    const v6, 0x44dac000    # 1750.0f

    invoke-static {v6, v1}, Lrp5;->a(FF)J

    move-result-wide v9

    new-instance v7, Lrp5;

    invoke-direct {v7, v9, v10}, Lrp5;-><init>(J)V

    const/high16 v9, 0x44fa0000    # 2000.0f

    invoke-static {v9, v1}, Lrp5;->a(FF)J

    move-result-wide v10

    new-instance v12, Lrp5;

    invoke-direct {v12, v10, v11}, Lrp5;-><init>(J)V

    filled-new-array {v4, v3, v8, v7, v12}, [Lrp5;
    ...
    sput-object v3, Losf;->a:Ljava/util/List;
    ...
    sput-object v0, Losf;->b:Ljava/util/List;
