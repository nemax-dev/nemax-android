...
.field public final d:Lmqc;

.field public final e:Ljava/lang/ThreadLocal;


# direct methods
.method public constructor <init>(Lhoe;Lo75;)V
    .locals 2

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p2, p0, Lqh7;->a:Lo75;
    ...
    iput-object v0, p0, Lqh7;->b:Ljava/lang/String;

    new-instance v0, Luz2;

    const/4 v1, 0x1

    invoke-direct {v0, p1, v1}, Luz2;-><init>(Lhoe;I)V

    new-instance p1, Lkle;

    invoke-direct {p1, v0}, Lkle;-><init>(Ld96;)V

    iput-object p1, p0, Lqh7;->c:Lkle;

    new-instance p1, Lmqc;

    const/16 v0, 0x1d

    invoke-direct {p1, v0, p2}, Lmqc;-><init>(ILjava/lang/Object;)V

    iput-object p1, p0, Lqh7;->d:Lmqc;
    ...
    iput-object p1, p0, Lqh7;->e:Ljava/lang/ThreadLocal;

    return-void
.end method

.method public static a(Lqh7;Ljava/lang/CharSequence;Landroid/text/TextPaint;IIZLandroid/text/TextUtils$TruncateAt;I)Landroid/text/Layout;
    .locals 12
    ...
    iget-object v2, p0, Lqh7;->e:Ljava/lang/ThreadLocal;
    ...
    invoke-virtual/range {v3 .. v11}, Lqh7;->b(Ljava/lang/CharSequence;Landroid/text/TextPaint;IILandroid/text/Layout$Alignment;ZLandroid/text/TextUtils$TruncateAt;I)Landroid/text/StaticLayout;
    ...
    iget-object p2, p1, Lxh6;->a:Lkotlinx/coroutines/internal/ContextScope;

    new-instance v0, Lwh6;

    const/4 v1, 0x0

    invoke-direct {v0, v2, p1, v1}, Lwh6;-><init>(Landroid/text/Layout;Lxh6;Lkotlin/coroutines/Continuation;)V
    ...
    iget-object p0, p0, Lqh7;->b:Ljava/lang/String;
...
.method public final b(Ljava/lang/CharSequence;Landroid/text/TextPaint;IILandroid/text/Layout$Alignment;ZLandroid/text/TextUtils$TruncateAt;I)Landroid/text/StaticLayout;
    ...
    iget-object v10, v1, Lqh7;->b:Ljava/lang/String;
    ...
    invoke-static {v10, v0, v2, v3}, Lz76;->r(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V

    iget-object v2, v1, Lqh7;->a:Lo75;

    invoke-static {v2, v0}, Lo75;->b(Lo75;Ljava/lang/Throwable;)V
    ...
    :goto_2
    :try_start_1
    iget-object v12, v1, Lqh7;->d:Lmqc;
    ...
    invoke-virtual/range {v12 .. v19}, Lmqc;->G(Ljava/lang/CharSequence;Landroid/text/TextPaint;ILandroid/text/Layout$Alignment;ZLandroid/text/TextUtils$TruncateAt;I)Landroid/text/StaticLayout;
    ...
    invoke-static {v11, v0}, Lis8;->O(II)Lo67;
    ...
    invoke-virtual/range {v2 .. v9}, Lmqc;->G(Ljava/lang/CharSequence;Landroid/text/TextPaint;ILandroid/text/Layout$Alignment;ZLandroid/text/TextUtils$TruncateAt;I)Landroid/text/StaticLayout;
    ...
    invoke-static {v10, v0}, Lz76;->M(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual/range {v1 .. v8}, Lmqc;->G(Ljava/lang/CharSequence;Landroid/text/TextPaint;ILandroid/text/Layout$Alignment;ZLandroid/text/TextUtils$TruncateAt;I)Landroid/text/StaticLayout;
