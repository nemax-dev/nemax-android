...
# direct methods
.method public constructor <init>(Landroid/content/Context;Lela;Ljd4;Ldha;Lihb;)V
    .locals 0

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Ll0a;->a:Landroid/content/Context;

    iput-object p2, p0, Ll0a;->b:Lela;

    iput-object p3, p0, Ll0a;->c:Ljd4;

    iput-object p4, p0, Ll0a;->d:Ldha;

    iput-object p5, p0, Ll0a;->e:Lihb;
...
# virtual methods
.method public final a()Lk0a;
    .locals 12

    iget-object v0, p0, Ll0a;->c:Ljd4;

    invoke-virtual {v0}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    iget-object p0, p0, Ll0a;->a:Landroid/content/Context;

    sget v0, Lbdc;->tt_notif_category_active_calls:I
    ...
    invoke-direct/range {v1 .. v11}, Lk0a;-><init>(Ljava/lang/String;Ljava/lang/String;ZZLandroid/net/Uri;Z[JZIZ)V

    return-object v1
.end method

.method public final b()Lk0a;
    .locals 14

    iget-object v0, p0, Ll0a;->e:Lihb;

    check-cast v0, Llhb;

    iget-object v1, v0, Llhb;->c:Lip;

    const-string v2, "app.notification.chats.ringtone"

    invoke-virtual {v1, v2}, Lip;->w(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {p0, v1}, Ll0a;->h(Z)Landroid/net/Uri;
    ...
    sget v1, Lbdc;->tt_notif_category_chats:I

    invoke-virtual {p0, v1}, Landroid/content/Context;->getString(I)Ljava/lang/String;

    move-result-object v5

    iget-object p0, v0, Llhb;->c:Lip;
    ...
    invoke-direct/range {v3 .. v13}, Lk0a;-><init>(Ljava/lang/String;Ljava/lang/String;ZZLandroid/net/Uri;Z[JZIZ)V

    return-object v3
.end method

.method public final c()Lk0a;
    .locals 14
    ...
    invoke-virtual {p0, v2}, Ll0a;->h(Z)Landroid/net/Uri;
    ...
    sget v1, Lbdc;->tt_notif_category_dialogs:I
...
.method public final d()Lk0a;
    ...
    iget-object v0, p0, Ll0a;->a:Landroid/content/Context;

    sget v1, Lbdc;->tt_notif_category_inapp:I

    invoke-virtual {v0, v1}, Landroid/content/Context;->getString(I)Ljava/lang/String;

    move-result-object v4

    iget-object p0, p0, Ll0a;->e:Lihb;
    ...
    invoke-direct/range {v2 .. v12}, Lk0a;-><init>(Ljava/lang/String;Ljava/lang/String;ZZLandroid/net/Uri;Z[JZIZ)V
...
.method public final e(Lk0a;)V
    ...
    iget-object v1, p1, Lk0a;->a:Ljava/lang/String;
    ...
    iget-boolean v0, p1, Lk0a;->c:Z

    const/4 v2, 0x4

    if-eqz v0, :cond_1

    iget-boolean v0, p1, Lk0a;->f:Z
    ...
    iget-object v5, p1, Lk0a;->b:Ljava/lang/String;

    invoke-direct {v3, v1, v5, v0}, Landroid/app/NotificationChannel;-><init>(Ljava/lang/String;Ljava/lang/CharSequence;I)V

    iget-object v0, p1, Lk0a;->e:Landroid/net/Uri;

    if-eqz v0, :cond_5

    iget-object v5, p0, Ll0a;->c:Ljd4;
    ...
    invoke-virtual {v0}, Lela;->d()I

    move-result v0

    invoke-virtual {v3, v0}, Landroid/app/NotificationChannel;->setLightColor(I)V

    iget-object v0, p0, Ll0a;->d:Ldha;

    invoke-virtual {v0, v1}, Ldha;->b(Ljava/lang/String;)Ljava/lang/String;
...
.method public final f()V
    ...
    iget-object v1, v0, Ll0a;->d:Ldha;

    iget-object v2, v1, Ldha;->e:Lxue;
    ...
    invoke-direct {v3, v4}, Lvr;-><init>(I)V
    ...
    invoke-virtual {v3, v4}, Lvr;->add(Ljava/lang/Object;)Z
    ...
    invoke-virtual {v3, v2}, Lvr;->contains(Ljava/lang/Object;)Z
    ...
    invoke-virtual {v1, v4, v2}, Ldha;->a(ILjava/lang/String;)V
    ...
    invoke-virtual {v1, v3, v2}, Ldha;->a(ILjava/lang/String;)V

    :cond_3
    invoke-virtual {v0}, Ll0a;->i()Landroid/app/NotificationManager;
    ...
    invoke-virtual {v0}, Ll0a;->b()Lk0a;

    move-result-object v3

    invoke-virtual {v0, v3}, Ll0a;->e(Lk0a;)V
    ...
    iget-object v6, v0, Ll0a;->e:Lihb;

    iget-object v7, v0, Ll0a;->a:Landroid/content/Context;
    ...
    iget-object v8, v3, Llhb;->c:Lip;

    const-string v9, "app.notification.ringtone"

    invoke-virtual {v8, v9}, Lip;->w(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {v0, v5}, Ll0a;->h(Z)Landroid/net/Uri;

    move-result-object v14

    sget v8, Lbdc;->tt_notif_category_misc:I
    ...
    invoke-virtual {v3, v4, v5}, Lyl7;->getBoolean(Ljava/lang/String;Z)Z
    ...
    invoke-direct/range {v9 .. v19}, Lk0a;-><init>(Ljava/lang/String;Ljava/lang/String;ZZLandroid/net/Uri;Z[JZIZ)V

    invoke-virtual {v0, v9}, Ll0a;->e(Lk0a;)V
    ...
    sget v3, Lbdc;->tt_notif_category_file_loading:I
    ...
    invoke-direct/range {v8 .. v18}, Lk0a;-><init>(Ljava/lang/String;Ljava/lang/String;ZZLandroid/net/Uri;Z[JZIZ)V

    invoke-virtual {v0, v8}, Ll0a;->e(Lk0a;)V
    ...
    sget v3, Lbdc;->tt_notif_category_media:I
    ...
    sget v3, Lbdc;->tt_notif_category_incoming_calls:I
    ...
    sget v3, Lbdc;->tt_notif_category_live_location:I
...
.method public final h(Z)Landroid/net/Uri;
    ...
    iget-object p1, v0, Llhb;->c:Lip;

    const-string v0, "app.notification.ringtone"

    invoke-virtual {p1, v0}, Lip;->w(Ljava/lang/String;)Ljava/lang/String;
...
.method public final i()Landroid/app/NotificationManager;
    ...
    iget-object v0, p0, Ll0a;->f:Landroid/app/NotificationManager;
    ...
    iput-object v0, p0, Ll0a;->f:Landroid/app/NotificationManager;

    :cond_0
    iget-object p0, p0, Ll0a;->f:Landroid/app/NotificationManager;
