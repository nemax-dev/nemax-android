...
# direct methods
.method public constructor <init>(Lx64;Lymd;)V
    .locals 0

    invoke-direct {p0}, Ljava/lang/Thread;-><init>()V

    iput-object p2, p0, Lz64;->a:Lymd;

    const/16 p2, 0x1e

    iput p2, p0, Lz64;->b:I

    iput-object p1, p0, Lz64;->c:Lx64;

    new-instance p1, Ljava/util/concurrent/ConcurrentLinkedQueue;

    invoke-direct {p1}, Ljava/util/concurrent/ConcurrentLinkedQueue;-><init>()V

    iput-object p1, p0, Lz64;->o:Ljava/util/concurrent/ConcurrentLinkedQueue;
    ...
    iput-object p1, p0, Lz64;->X:Ljava/util/concurrent/atomic/AtomicInteger;

    new-instance p1, Ljava/util/concurrent/locks/ReentrantLock;

    invoke-direct {p1}, Ljava/util/concurrent/locks/ReentrantLock;-><init>()V

    iput-object p1, p0, Lz64;->r0:Ljava/util/concurrent/locks/ReentrantLock;

    invoke-virtual {p1}, Ljava/util/concurrent/locks/ReentrantLock;->newCondition()Ljava/util/concurrent/locks/Condition;

    move-result-object p1

    iput-object p1, p0, Lz64;->s0:Ljava/util/concurrent/locks/Condition;

    new-instance p1, Ljava/util/concurrent/locks/ReentrantLock;

    invoke-direct {p1}, Ljava/util/concurrent/locks/ReentrantLock;-><init>()V

    iput-object p1, p0, Lz64;->t0:Ljava/util/concurrent/locks/ReentrantLock;
...
.method public final run()V
    ...
    iget-object v0, p0, Lz64;->t0:Ljava/util/concurrent/locks/ReentrantLock;

    invoke-virtual {v0}, Ljava/util/concurrent/locks/ReentrantLock;->lock()V

    :try_start_0
    iget-object v2, p0, Lz64;->c:Lx64;
    ...
    iget-object v2, v2, Lx64;->a:Lorg/webrtc/DataChannel;
    ...
    iget-object v0, p0, Lz64;->Y:Ljj;

    if-nez v0, :cond_7

    iget-object v0, p0, Lz64;->o:Ljava/util/concurrent/ConcurrentLinkedQueue;
    ...
    :cond_4
    :try_start_1
    iget-object v0, p0, Lz64;->r0:Ljava/util/concurrent/locks/ReentrantLock;
    ...
    :try_start_2
    iget-object v2, p0, Lz64;->s0:Ljava/util/concurrent/locks/Condition;
    ...
    :cond_9
    iget-object v0, p0, Lz64;->X:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    :cond_15
    iget-object v2, p0, Lz64;->a:Lymd;

    array-length v4, v8

    iget-object v2, v2, Lymd;->a:Ljava/lang/Object;
    ...
    invoke-virtual {v2, v7, v8}, Lx64;->e(I[B)Z
    ...
    iget-object v2, v2, Lymd;->b:Ljava/lang/Object;

    check-cast v2, Ljava/util/concurrent/atomic/AtomicInteger;

    invoke-virtual {v2}, Ljava/util/concurrent/atomic/AtomicInteger;->incrementAndGet()I

    iput-object v1, p0, Lz64;->Y:Ljj;
    :try_end_6
    ...
    iget-object p0, p0, Lz64;->o:Ljava/util/concurrent/ConcurrentLinkedQueue;
