...
.field public final d:Lpi7;

.field public final e:Lkle;


# direct methods
.method public constructor <init>(Landroid/content/Context;Lyta;Lpi7;)V
    .locals 0
    ...
    iput-object p2, p0, Lqd;->c:Lyta;

    iput-object p3, p0, Lqd;->d:Lpi7;
...
# virtual methods
.method public final c(Lryc;Ljava/lang/String;)Landroid/net/Uri;
    .locals 7

    invoke-interface {p1}, Lryc;->d()Ljava/lang/String;

    move-result-object v0

    invoke-interface {p1}, Lryc;->a()I
    ...
    invoke-direct {v0, v5, p2}, Ltra;-><init>(Ljava/lang/Object;Ljava/lang/Object;)V

    invoke-static {v1}, Lw68;->f(I)Ljava/lang/String;
    ...
    invoke-direct {v1, v5, p2}, Ltra;-><init>(Ljava/lang/Object;Ljava/lang/Object;)V
    ...
    invoke-direct {v5, v6, p2}, Ltra;-><init>(Ljava/lang/Object;Ljava/lang/Object;)V
    ...
    invoke-direct {v3, v4, p2}, Ltra;-><init>(Ljava/lang/Object;Ljava/lang/Object;)V

    filled-new-array {v0, v1, v5, v2, v3}, [Ltra;
    ...
    iget-object v5, v4, Ltra;->a:Ljava/lang/Object;
    ...
    :cond_a
    invoke-interface {p1}, Lryc;->e()Ljava/lang/Integer;
    ...
    :cond_b
    invoke-interface {p1}, Lryc;->getWidth()Ljava/lang/Integer;
    ...
    :cond_c
    invoke-interface {p1}, Lryc;->getHeight()Ljava/lang/Integer;
    ...
    invoke-interface {p1}, Lryc;->c()Landroid/net/Uri;
    ...
    invoke-interface {p1, v6, v4}, Lryc;->b(Landroid/content/ContentResolver;Landroid/net/Uri;)V
    ...
    sget-object p1, Lpyc;->a:Lpyc;

    sget-object p1, Lpyc;->b:Ljava/lang/String;
