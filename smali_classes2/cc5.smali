...
# direct methods
.method public constructor <init>(Landroid/content/Context;Ly95;Lxb5;Ltm7;Lq53;)V
    .locals 6
    ...
    iput v0, p0, Lcc5;->r0:F

    iput-object p2, p0, Lcc5;->c:Ly95;

    iput-object p3, p0, Lcc5;->o:Lxb5;
    ...
    invoke-static {p2, v4, p3, v0}, Lxg4;->a(Ljava/lang/String;IILjava/lang/String;)V

    const-string v1, "bufferForPlaybackAfterRebufferMs"

    const/16 v5, 0xbb8

    invoke-static {v1, v5, p3, v0}, Lxg4;->a(Ljava/lang/String;IILjava/lang/String;)V

    const-string v0, "minBufferMs"

    const/16 v2, 0x1b58

    invoke-static {v0, v2, v4, p2}, Lxg4;->a(Ljava/lang/String;IILjava/lang/String;)V

    invoke-static {v0, v2, v5, v1}, Lxg4;->a(Ljava/lang/String;IILjava/lang/String;)V

    const-string p2, "maxBufferMs"

    const/16 v3, 0x3a98

    invoke-static {p2, v3, v2, v0}, Lxg4;->a(Ljava/lang/String;IILjava/lang/String;)V
    ...
    invoke-direct/range {v0 .. v5}, Lxg4;-><init>(Lob4;IIII)V
    ...
    invoke-direct {v1, v2}, Llx9;-><init>(I)V

    invoke-direct {p2, p1, v1}, Luj4;-><init>(Landroid/content/Context;Llx9;)V

    invoke-virtual {p2}, Luj4;->a()Lij4;

    move-result-object v1

    invoke-virtual {p5}, Lzad;->s()Ljava/util/Locale;
    ...
    invoke-virtual {v1, p3}, Lij4;->c([Ljava/lang/String;)Lldf;
    ...
    invoke-direct {p3, p1, v1}, Leid;-><init>(Landroid/content/Context;I)V

    new-instance v1, Ldc5;

    invoke-direct {v1, p1, p3}, Ldc5;-><init>(Landroid/content/Context;Leid;)V

    iget-boolean v2, v1, Ldc5;->o:Z
    ...
    invoke-direct {v2, v4, p2}, Lbh4;-><init>(ILjava/lang/Object;)V

    iput-object v2, v1, Ldc5;->e:Lvqe;
    ...
    iput-object v2, v1, Ldc5;->f:Lvqe;

    iget-boolean v0, v1, Ldc5;->o:Z

    xor-int/2addr v0, v3

    invoke-static {v0}, Loe0;->g(Z)V

    iput-boolean v3, v1, Ldc5;->o:Z

    new-instance v0, Lu2e;

    invoke-direct {v0, v1}, Lu2e;-><init>(Ldc5;)V

    iput-object v0, p0, Lcc5;->a:Lu2e;
    ...
    invoke-direct {v3, p0}, Liu7;-><init>(Ljava/lang/Object;)V

    invoke-virtual {v2, v3}, Ljava/util/concurrent/CopyOnWriteArraySet;->add(Ljava/lang/Object;)Z

    invoke-virtual {v0}, Lu2e;->W0()V

    iget-object v1, v1, Lad5;->B0:Lkc4;

    invoke-virtual {v1}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    iget-object v1, v1, Lkc4;->Y:Le30;

    invoke-virtual {v1}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    iget-object v1, v1, Le30;->d:Ljava/lang/Object;

    check-cast v1, Ljava/util/concurrent/CopyOnWriteArraySet;

    new-instance v2, Liu7;

    invoke-direct {v2, p0}, Liu7;-><init>(Ljava/lang/Object;)V
    ...
    iput-object v2, v1, Lr03;->o:Ljava/lang/Object;

    iput-object v0, v1, Lr03;->b:Ljava/lang/Object;

    iput-object p2, v1, Lr03;->a:Ljava/lang/Object;

    iput-object p5, v1, Lr03;->X:Ljava/lang/Object;

    iput-object p4, v1, Lr03;->Y:Ljava/lang/Object;

    iput-object p3, v1, Lr03;->Z:Ljava/lang/Object;

    iput-object v1, p0, Lcc5;->b:Lr03;

    new-instance p2, Lcp;

    invoke-direct {p2, p1}, Lcp;-><init>(Landroid/content/Context;)V

    new-instance p3, Lrh8;

    const/16 p4, 0x15

    invoke-direct {p3, p4, p2}, Lrh8;-><init>(ILjava/lang/Object;)V

    iput-object p3, p0, Lcc5;->X:Lrh8;
...
.method public final B()V
    ...
    invoke-virtual {v1}, Lu2e;->A()I

    move-result p0

    invoke-virtual {v1, p0, v2, v3}, Lu2e;->X0(IJ)V
    ...
    invoke-virtual {v1, p0, v3, v4}, Lu2e;->X0(IJ)V
...
.method public final E(Lwcf;Lfdf;)V
    ...
    iget-boolean p1, p0, Lcc5;->w0:Z

    if-nez p1, :cond_0

    iget-object p1, p0, Lcc5;->b:Lr03;

    invoke-virtual {p1}, Lr03;->k()Z

    move-result p1

    iput-boolean p1, p0, Lcc5;->w0:Z

    :cond_0
    iget-object p0, p0, Lcc5;->Y:Lwx7;
...
.method public final G()V
    ...
    iget-object v1, v0, Lad5;->H0:La30;

    invoke-virtual {v0}, Lad5;->l()Z
    ...
    invoke-virtual {v0, v1}, Lad5;->j1(Lcom/google/android/exoplayer2/ExoPlaybackException;)V
...
.method public final d(F)V
    ...
    invoke-static {p1, v3, v2}, Llsf;->h(FFF)F

    move-result v2

    iget v4, v0, Lad5;->d1:F
    ...
    :cond_0
    iput v2, v0, Lad5;->d1:F

    iget-object v4, v0, Lad5;->H0:La30;
    ...
    invoke-virtual {v0, v6, v5, v4}, Lad5;->g1(IILjava/lang/Object;)V
    ...
    invoke-direct {v4, v5, v2}, Lic5;-><init>(IF)V

    const/16 v2, 0x16

    invoke-virtual {v0, v2, v4}, Le30;->m(ILeu7;)V

    :goto_0
    iget-object v0, p0, Lcc5;->Y:Lwx7;

    if-eqz v0, :cond_3

    iget-object v2, v0, Lwx7;->e:Lx2;

    if-eqz v2, :cond_1

    invoke-interface {v2}, Lsl8;->X()V

    :cond_1
    iget-object v2, v0, Lwx7;->b:Lcc5;

    invoke-virtual {v2}, Lcc5;->b()Z
    ...
    invoke-virtual {v0}, Lwx7;->a()V

    goto :goto_1

    :cond_2
    invoke-virtual {v0}, Lwx7;->o()V
...
.method public final e()J
    ...
    iget-object v0, v1, Lu2e;->c:Lad5;

    invoke-virtual {v0}, Lad5;->getDuration()J

    move-result-wide v0

    iget-object v2, p0, Lcc5;->Z:Llwf;

    invoke-interface {v2}, Llwf;->h()J
    ...
    iget-object p0, v1, Lu2e;->c:Lad5;

    invoke-virtual {p0}, Lad5;->getDuration()J
...
.method public final g()V
    ...
    iget-object p0, p0, Lcc5;->X:Lrh8;

    invoke-virtual {p0}, Lrh8;->h()Ljava/lang/Object;
...
.method public final k(I)V
    ...
    iget-object p1, p0, Lcc5;->a:Lu2e;

    invoke-virtual {p1}, Lu2e;->getRepeatMode()I
    ...
    iget-object p1, p0, Lwx7;->e:Lx2;

    if-eqz p1, :cond_2

    invoke-interface {p1}, Lsl8;->i()V
...
.method public final onAudioFocusChange(I)V
    ...
    invoke-virtual {p0, p1}, Lcc5;->d(F)V
...
.method public final pause()V
    ...
    invoke-virtual {v0, v1}, Lu2e;->Y0(Z)V
...
.method public final u(Lcom/google/android/exoplayer2/PlaybackException;)V
    ...
    invoke-interface {v0, p1}, Lsl8;->H(Ljava/lang/Throwable;)V
