...
.method public synthetic constructor <init>(Lru/ok/messages/media/crop/FrgTamCropImage;I)V
    ...
    iput-object p1, p0, Lbc6;->b:Lru/ok/messages/media/crop/FrgTamCropImage;
...
.method public final run()V
    ...
    iget-object p0, p0, Lbc6;->b:Lru/ok/messages/media/crop/FrgTamCropImage;
    ...
    iget-object v2, v2, Lone/me/image/crop/view/ImageCropView;->a:Lwh6;

    invoke-virtual {v2}, Lza7;->getInitialMatrix()Landroid/graphics/Matrix;

    move-result-object v3

    iget-object v2, v2, Ljef;->t0:Landroid/graphics/Matrix;
    ...
    invoke-virtual {v2}, Lone/me/image/crop/view/ImageCropView;->getCropState()Lb34;
    ...
    :goto_1
    iget-object v0, v0, Lone/me/image/crop/view/ImageCropView;->a:Lwh6;

    invoke-virtual {v0}, Ljef;->getViewBitmap()Landroid/graphics/Bitmap;

    move-result-object v1

    invoke-virtual {v0}, Ljef;->getImageOutputPath()Ljava/lang/String;

    move-result-object v2

    invoke-virtual {v0}, Lza7;->getCropState()Lb34;
    ...
    iget-object v4, v0, Lb34;->c:[F

    iget-object v0, v0, Lb34;->a:Landroid/graphics/RectF;
    ...
    invoke-direct {v0, p0, v1}, Lbc6;-><init>(Lru/ok/messages/media/crop/FrgTamCropImage;I)V

    new-instance v1, Ltc3;

    const/4 v2, 0x1

    invoke-direct {v1, v2, v0}, Ltc3;-><init>(ILjava/lang/Object;)V
    ...
    invoke-direct {v2, p0, v3}, Lbc6;-><init>(Lru/ok/messages/media/crop/FrgTamCropImage;I)V

    new-instance v3, Ljr5;

    const/16 v4, 0x8

    invoke-direct {v3, v4, p0}, Ljr5;-><init>(ILjava/lang/Object;)V

    new-instance p0, Lms1;

    const/4 v4, 0x0

    invoke-direct {p0, v3, v4, v2}, Lms1;-><init>(Ljava/lang/Object;ILjava/lang/Object;)V

    :try_start_2
    new-instance v2, Lyc3;

    invoke-direct {v2, p0, v1}, Lyc3;-><init>(Lad3;Lo6d;)V

    invoke-virtual {v0, v2}, Lqc3;->h(Lad3;)V
    :try_end_2
    ...
    iget-object p0, p0, Lone/me/image/crop/view/ImageCropView;->a:Lwh6;

    const/4 v0, 0x0

    iput v0, p0, Lza7;->E0:F

    invoke-virtual {p0}, Lza7;->f()V
    ...
    iget-object v1, v0, Lza7;->B0:Landroid/graphics/RectF;
    ...
    iget-object v3, v0, Ljef;->t0:Landroid/graphics/Matrix;
    ...
    invoke-virtual {v0, v3}, Ljef;->setImageMatrix(Landroid/graphics/Matrix;)V
    ...
    iget-object v1, v0, Lza7;->C0:Landroid/graphics/Matrix;

    invoke-virtual {v1}, Landroid/graphics/Matrix;->reset()V

    invoke-virtual {v0}, Ljef;->getCurrentScale()F
    ...
    iget-object v2, v0, Lza7;->D0:Landroid/graphics/RectF;

    iget-object v0, v0, Lza7;->B0:Landroid/graphics/RectF;
    ...
    iget-object v1, v1, Lone/me/image/crop/view/ImageCropView;->a:Lwh6;

    iget-object v2, v1, Lza7;->B0:Landroid/graphics/RectF;
    ...
    iget-object v5, v1, Ljef;->t0:Landroid/graphics/Matrix;

    const/high16 v6, 0x42b40000    # 90.0f

    invoke-virtual {v5, v6, v4, v2}, Landroid/graphics/Matrix;->postRotate(FFF)Z

    invoke-virtual {v1, v5}, Ljef;->setImageMatrix(Landroid/graphics/Matrix;)V

    iget-object v1, p0, Lru/ok/messages/media/crop/FrgTamCropImage;->A1:Lone/me/image/crop/view/ImageCropView;

    iget-object v1, v1, Lone/me/image/crop/view/ImageCropView;->b:Lexa;

    iget v2, v1, Lexa;->s0:F

    div-float v2, v3, v2

    iput v2, v1, Lexa;->s0:F

    iget-object v4, v1, Lexa;->a:Landroid/graphics/RectF;

    invoke-virtual {v1, v4, v2}, Lexa;->a(Landroid/graphics/RectF;F)V

    invoke-virtual {v1}, Lexa;->b()V

    iget-object v2, v1, Lexa;->L0:Lfxa;
    ...
    invoke-virtual {v2, v4}, Lza7;->setCropRect(Landroid/graphics/RectF;)V
    ...
    iget-object v2, v1, Lza7;->C0:Landroid/graphics/Matrix;
    ...
    iget-object v3, v1, Lza7;->D0:Landroid/graphics/RectF;

    iget-object v1, v1, Lza7;->B0:Landroid/graphics/RectF;
    ...
    iget-object v0, v2, Lone/me/image/crop/view/ImageCropView;->a:Lwh6;

    iget-object v2, v0, Lza7;->B0:Landroid/graphics/RectF;
    ...
    iget-object v4, v0, Ljef;->t0:Landroid/graphics/Matrix;
    ...
    invoke-virtual {v0, v4}, Ljef;->setImageMatrix(Landroid/graphics/Matrix;)V
