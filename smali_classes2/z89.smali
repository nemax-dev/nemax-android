...
.method public final o(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {p1}, Ly79;->A()Lmi9;

    move-result-object p1

    iget-object p1, p1, Lmi9;->f:Lq4e;
    ...
    iget-object p0, p0, Lone/me/messages/list/ui/MessagesListWidget;->F0:Lcac;
    ...
    iget-object v0, p0, Lmi9;->f:Lq4e;

    iget-object v2, p0, Lmi9;->f:Lq4e;
    ...
    iget-object v0, v0, Lgi9;->a:Ljava/util/Set;
    ...
    invoke-direct {p0}, Lgi9;-><init>()V

    invoke-virtual {v2, v3, p0}, Lq4e;->m(Ljava/lang/Object;Ljava/lang/Object;)Z

    return-object v1

    :cond_2
    iget-object p0, p0, Lmi9;->d:Ljw;
    ...
    iget-object p0, p0, Lone/me/messages/list/ui/MessagesListWidget;->T0:Lh35;

    if-eqz p0, :cond_14

    iput-boolean v2, p0, Lh35;->q:Z
    ...
    iget-wide v4, p1, Lj59;->a:J

    invoke-interface {v0, v4, v5}, Lz49;->e(J)Lone/me/messages/list/loader/MessageModel;
    ...
    iget-object v0, v0, Lone/me/messages/list/loader/MessageModel;->w0:Lyz8;
    ...
    :goto_0
    invoke-virtual {v4, v0, v2}, Lru/ok/onechat/reactions/ReactionsViewModel;->j(Lyz8;Z)Lgp7;
    ...
    iget-object p1, p0, Lcac;->i:Lw45;

    iget-object v6, p0, Lcac;->h:Landroid/graphics/Rect;

    iget-object v7, p0, Lcac;->a:Landroidx/recyclerview/widget/RecyclerView;

    invoke-virtual {v7, v4, v5}, Landroidx/recyclerview/widget/RecyclerView;->N(J)Luhc;
    ...
    :cond_7
    iget-object v8, v8, Luhc;->a:Landroid/view/View;

    instance-of v10, v8, Lrv8;
    ...
    invoke-virtual {v10}, Lrv8;->getContentView$message_list_release()Landroid/view/View;
    ...
    iget-object v11, p0, Lcac;->f:Ljava/util/concurrent/ExecutorService;

    invoke-direct {v10, v9, v11}, Llac;-><init>(Landroid/content/Context;Ljava/util/concurrent/ExecutorService;)V

    invoke-static {v4, v5}, Ljava/lang/Long;->valueOf(J)Ljava/lang/Long;

    move-result-object v4

    iput-object v4, v10, Llac;->n0:Ljava/lang/Long;

    iput-object v8, v10, Llac;->X:Landroid/view/View;

    iget-object v4, v10, Llac;->Y:[I
    ...
    iput-object v4, v10, Llac;->o:Landroid/graphics/Rect;

    new-instance v4, Lbac;

    iget-object v5, v10, Llac;->a:Landroid/content/Context;

    iget-object v6, v10, Llac;->b:Ljava/util/concurrent/ExecutorService;

    invoke-direct {v4, v5, v6}, Lbac;-><init>(Landroid/content/Context;Ljava/util/concurrent/Executor;)V

    invoke-virtual {v4, v0, v3}, Lbac;->a(Ljava/util/List;Ljava/lang/Integer;)V

    iput-object v10, v4, Lbac;->b:Laac;

    iput-object v4, v10, Llac;->c:Lbac;
    ...
    iget-object v5, v10, Llac;->c:Lbac;

    if-eqz v5, :cond_c

    iget-object v3, v5, Lbac;->d:Landroidx/recyclerview/widget/RecyclerView;
    ...
    iget-object v0, v10, Llac;->c:Lbac;

    if-eqz v0, :cond_e

    iget-object v0, v0, Lbac;->d:Landroidx/recyclerview/widget/RecyclerView;

    if-eqz v0, :cond_e

    iget-object v3, v10, Llac;->o:Landroid/graphics/Rect;
    ...
    iput-object v0, v10, Llac;->q0:Llud;

    iget-object v11, v10, Llac;->c:Lbac;

    iget-object v9, v10, Llac;->X:Landroid/view/View;

    iget-object v12, v10, Llac;->o:Landroid/graphics/Rect;
    ...
    invoke-direct/range {v8 .. v13}, Lso;-><init>(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;I)V

    new-instance v0, Li5a;

    invoke-direct {v0, v9, v8}, Li5a;-><init>(Landroid/view/View;Ld96;)V
    ...
    :goto_7
    invoke-virtual {v7, p1}, Landroidx/recyclerview/widget/RecyclerView;->r0(Lkhc;)V

    invoke-virtual {v7, p1}, Landroidx/recyclerview/widget/RecyclerView;->m(Lkhc;)V

    iput-object v10, p0, Lcac;->g:Llac;
