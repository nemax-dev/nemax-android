...
.method public constructor <init>(Landroid/content/Context;Lhn5;)V
    ...
    invoke-direct {p0, p1, p2}, Lcad;-><init>(Landroid/content/Context;Lhn5;)V
    ...
    iput-object p1, p0, Lip;->m:Ljava/util/WeakHashMap;
...
.method public final v()[I
    ...
    sget-object v0, Lip;->n:[I

    if-nez v0, :cond_0

    iget-object p0, p0, Li3;->f:Landroid/content/Context;

    invoke-virtual {p0}, Landroid/content/Context;->getResources()Landroid/content/res/Resources;

    move-result-object v0

    sget v1, Lw3c;->led_1:I
    ...
    sput-object p0, Lip;->n:[I

    :cond_0
    sget-object p0, Lip;->n:[I
...
.method public final w(Ljava/lang/String;)Ljava/lang/String;
    ...
    iget-object v0, p0, Li3;->g:Lyl7;

    const-string v1, "DEFAULT"

    invoke-virtual {v0, p1, v1}, Lyl7;->getString(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {v0, v2, v3}, Lyl7;->getBoolean(Ljava/lang/String;Z)Z
...
.method public final y(Lgsf;)V
    ...
    iget-object v0, p1, Lgsf;->b:Ljava/lang/Long;
    ...
    :cond_0
    iget-object v0, p1, Lgsf;->a:Ljava/lang/Boolean;
    ...
    :cond_1
    iget-object v0, p1, Lgsf;->c:Ljava/lang/String;
    ...
    invoke-virtual {p0, v0, v6}, Li3;->i(ILjava/lang/String;)V

    iget-object v6, p0, Lcad;->j:Lnl0;

    invoke-static {v0}, Ljava/lang/Integer;->valueOf(I)Ljava/lang/Integer;

    move-result-object v0

    invoke-virtual {v6, v0}, Lnl0;->s(Ljava/lang/Object;)V

    :cond_4
    iget-object v0, p1, Lgsf;->d:Ljava/lang/String;
    ...
    :cond_6
    :goto_1
    invoke-virtual {p0, v3}, Lcad;->r(I)V

    :cond_7
    iget-object v0, p1, Lgsf;->e:Ljava/lang/String;

    if-eqz v0, :cond_8

    const-string v1, "app.notification.ringtone"

    invoke-virtual {p0, v1, v0}, Li3;->k(Ljava/lang/String;Ljava/lang/String;)V

    :cond_8
    iget-object v0, p1, Lgsf;->f:Ljava/lang/String;
    ...
    :cond_9
    iget-object v0, p1, Lgsf;->g:Ljava/lang/String;
    ...
    :cond_a
    iget-object v0, p1, Lgsf;->i:Ljava/lang/Integer;
    ...
    invoke-static {v0}, Lb74;->s(I)I

    move-result v0

    const-string v1, "app.notification.led.color"

    invoke-virtual {p0, v0, v1}, Li3;->i(ILjava/lang/String;)V

    :cond_b
    iget-object v0, p1, Lgsf;->h:Ljava/lang/Boolean;
    ...
    :cond_c
    iget-object v0, p1, Lgsf;->j:Ljava/lang/Integer;
    ...
    :cond_d
    iget-object v0, p1, Lgsf;->k:Ljava/lang/Integer;
    ...
    :cond_e
    iget-object v0, p1, Lgsf;->l:Ljava/lang/Boolean;
    ...
    :cond_f
    iget-object v0, p1, Lgsf;->m:Ljava/lang/Boolean;
    ...
    :cond_10
    iget-object v0, p1, Lgsf;->n:Ljava/lang/Boolean;
    ...
    invoke-static {v0}, Ls8e;->j(I)Ljava/lang/String;
    ...
    invoke-static {v0}, Ls8e;->i(I)Ljava/lang/String;
    ...
    invoke-static {v0}, Ls8e;->k(I)Ljava/lang/String;
    ...
    :cond_16
    iget-object v0, p1, Lgsf;->t:Ljava/lang/Boolean;
    ...
    :cond_17
    iget-object v0, p1, Lgsf;->u:Ljava/lang/Boolean;
    ...
    :cond_18
    iget-object v0, p1, Lgsf;->v:Ljava/lang/Boolean;
    ...
    :cond_1a
    iget-object v0, p1, Lgsf;->x:Ljava/lang/Boolean;
