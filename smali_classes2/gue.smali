...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    sget v1, Lrxb;->text_typing:I

    invoke-direct {v0, p1, v1}, Lone/me/sdk/richvector/EnhancedAnimatedVectorDrawable;-><init>(Landroid/content/Context;I)V

    invoke-direct {p0, v0}, Landroid/graphics/drawable/DrawableWrapper;-><init>(Landroid/graphics/drawable/Drawable;)V

    iput-object v0, p0, Lgue;->a:Lone/me/sdk/richvector/EnhancedAnimatedVectorDrawable;

    new-instance p1, Lfue;

    const/4 v1, 0x0

    invoke-direct {p1, v0, v1}, Lfue;-><init>(Lone/me/sdk/richvector/EnhancedAnimatedVectorDrawable;I)V
    ...
    invoke-direct {p1, v0, v2}, Lfue;-><init>(Lone/me/sdk/richvector/EnhancedAnimatedVectorDrawable;I)V

    invoke-static {v1, p1}, Lltg;->s(ILd96;)Lth7;

    move-result-object p1

    iput-object p1, p0, Lgue;->o:Ljava/lang/Object;
    ...
    iput-object p1, p0, Lgue;->X:Ljava/lang/Object;
    ...
    invoke-direct {v0, p0, v1}, Lxl5;-><init>(Landroid/graphics/drawable/Drawable$Callback;I)V

    invoke-virtual {p1, v0}, Lone/me/sdk/richvector/EnhancedAnimatedVectorDrawable;->registerAnimationCallback(Lce;)V
...
.method public final isRunning()Z
    ...
    iget-object p0, p0, Lgue;->a:Lone/me/sdk/richvector/EnhancedAnimatedVectorDrawable;
...
.method public final onThemeChanged(Lnma;)V
    ...
    invoke-interface/range {p1 .. p1}, Lnma;->getIcon()Lmv6;
    ...
    iget-object v3, v0, Lgue;->c:Ljava/lang/Object;
    ...
    :cond_0
    iget-object v4, v0, Lgue;->o:Ljava/lang/Object;
    ...
    :cond_1
    iget-object v5, v0, Lgue;->X:Ljava/lang/Object;
    ...
    :cond_2
    iget-object v6, v0, Lgue;->b:Landroid/animation/AnimatorSet;
    ...
    :goto_0
    iget-object v9, v0, Lgue;->b:Landroid/animation/AnimatorSet;
    ...
    :goto_1
    invoke-static {v1, v12}, Lnoa;->Q(IF)I

    move-result v12

    const/high16 v13, 0x3e800000    # 0.25f

    invoke-static {v1, v13}, Lnoa;->Q(IF)I
    ...
    :goto_3
    invoke-static {v1, v7}, Lnoa;->Q(IF)I

    move-result v7

    invoke-static {v3, v12, v14, v15, v7}, Lgue;->a(Lone/me/sdk/richvector/VectorPath;IIII)Landroid/animation/ObjectAnimator;
    ...
    invoke-static {v4, v7, v12, v14, v15}, Lgue;->a(Lone/me/sdk/richvector/VectorPath;IIII)Landroid/animation/ObjectAnimator;
    ...
    invoke-static {v5, v7, v12, v2, v1}, Lgue;->a(Lone/me/sdk/richvector/VectorPath;IIII)Landroid/animation/ObjectAnimator;
    ...
    iput-object v9, v0, Lgue;->b:Landroid/animation/AnimatorSet;
