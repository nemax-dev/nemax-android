...
.method public constructor <init>(Landroid/util/Size;)V
    ...
    iput-object v1, p0, Lc2g;->a:Ljava/lang/String;

    new-instance v2, Ljava/util/concurrent/atomic/AtomicBoolean;

    invoke-direct {v2}, Ljava/util/concurrent/atomic/AtomicBoolean;-><init>()V

    iput-object v2, p0, Lc2g;->b:Ljava/util/concurrent/atomic/AtomicBoolean;

    new-instance v2, Ljava/util/concurrent/CopyOnWriteArraySet;

    invoke-direct {v2}, Ljava/util/concurrent/CopyOnWriteArraySet;-><init>()V

    iput-object v2, p0, Lc2g;->Y:Ljava/util/concurrent/CopyOnWriteArraySet;

    new-instance v2, Ljava/util/LinkedHashMap;

    invoke-direct {v2}, Ljava/util/LinkedHashMap;-><init>()V

    iput-object v2, p0, Lc2g;->Z:Ljava/util/LinkedHashMap;

    const/16 v2, 0x10

    new-array v3, v2, [F

    iput-object v3, p0, Lc2g;->r0:[F

    new-array v2, v2, [F

    iput-object v2, p0, Lc2g;->s0:[F
    ...
    :cond_1
    :goto_0
    invoke-static {v0}, Ly94;->m(Lnz4;)V

    new-instance v1, Lz1g;

    invoke-direct {v1, p0, p1, v0}, Lz1g;-><init>(Lc2g;Landroid/util/Size;Lnz4;)V

    iput-object v1, p0, Lc2g;->c:Lz1g;
    ...
    iput-object p1, p0, Lc2g;->o:Landroid/os/Handler;

    iget-object v0, v1, Lz1g;->o:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    invoke-virtual {p0}, Lc2g;->release()V
    ...
    invoke-direct {v0, p1}, Lpp6;-><init>(Landroid/os/Handler;)V

    iput-object v0, p0, Lc2g;->X:Lpp6;

    return-void
.end method

.method public static final d(Lc2g;Landroid/util/Size;Lnz4;)V
    .locals 5
    ...
    :cond_1
    :goto_0
    invoke-virtual {p0}, Lc2g;->e()V

    iget-boolean v0, p0, Lc2g;->u0:Z

    if-nez v0, :cond_3

    iget-object v0, p0, Lc2g;->t0:Lu2g;

    if-nez v0, :cond_2

    new-instance v0, Lu2g;

    invoke-direct {v0, p1, p2}, Lu2g;-><init>(Landroid/util/Size;Lnz4;)V

    iput-object v0, p0, Lc2g;->t0:Lu2g;
...
.method public static g(Lc2g;Lkc6;Lkc6;I)V
    .locals 3
    ...
    :cond_0
    iget-object p3, p0, Lc2g;->o:Landroid/os/Handler;
...
.method public final a(Lgse;)V
    ...
    :cond_1
    :goto_0
    iget-object v0, p0, Lc2g;->b:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    iget-object v0, p0, Lc2g;->o:Landroid/os/Handler;

    new-instance v3, Ls6e;

    const/16 v4, 0x14

    invoke-direct {v3, p0, v4, v1}, Ls6e;-><init>(Ljava/lang/Object;ILjava/lang/Object;)V
...
.method public final c(Lzre;)V
    ...
    iget-object v4, p1, Lzre;->o:Landroid/util/Size;
    ...
    invoke-direct {v0, p1, v1, p0}, Lx8f;-><init>(Ljava/lang/Object;ILjava/lang/Object;)V
    ...
    iget-object p1, p0, Lc2g;->o:Landroid/os/Handler;

    new-instance v1, Ls6e;

    const/16 v4, 0x14

    invoke-direct {v1, p0, v4, v0}, Ls6e;-><init>(Ljava/lang/Object;ILjava/lang/Object;)V
    ...
    invoke-virtual {v3}, Lya6;->invoke()Ljava/lang/Object;
...
.method public final f()V
    ...
    iget-boolean v1, p0, Lc2g;->u0:Z

    if-eqz v1, :cond_2

    iget v1, p0, Lc2g;->v0:I

    if-nez v1, :cond_2

    iget-object v1, p0, Lc2g;->Z:Ljava/util/LinkedHashMap;
    ...
    invoke-static {v0, v3}, Lkug;->U(Ljava/lang/String;Ljava/lang/String;)V

    invoke-virtual {v4}, Lzre;->close()V
...
.method public final release()V
    ...
    iget-object v0, p0, Lc2g;->Y:Ljava/util/concurrent/CopyOnWriteArraySet;
