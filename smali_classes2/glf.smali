...
.field public final r0:Lflf;

.field public final s0:Lflf;

.field public final t0:Lflf;
...
.method static constructor <clinit>()V
    ...
    sput-object v3, Lglf;->y0:[Lof7;

    new-instance v0, Landroid/text/TextPaint;

    invoke-direct {v0}, Landroid/text/TextPaint;-><init>()V

    sput-object v0, Lglf;->z0:Landroid/text/TextPaint;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput v2, p0, Lglf;->o0:F

    new-instance v2, Ltif;

    const/4 v3, 0x2

    invoke-direct {v2, v3}, Ltif;-><init>(I)V

    invoke-static {v1, v2}, Lltg;->s(ILd96;)Lth7;

    move-result-object v2

    iput-object v2, p0, Lglf;->p0:Ljava/lang/Object;
    ...
    iget-object v2, v2, Lca3;->g:Lxa3;

    iget v2, v2, Lxa3;->a:I

    iput v2, p0, Lglf;->q0:I

    new-instance v2, Lflf;

    const/4 v3, 0x1

    invoke-direct {v2, p0, v3}, Lflf;-><init>(Lglf;I)V

    iput-object v2, p0, Lglf;->r0:Lflf;
    ...
    iput-object v2, p0, Lglf;->s0:Lflf;
    ...
    iput-object v2, p0, Lglf;->t0:Lflf;
    ...
    invoke-static {v1, v3}, Lltg;->s(ILd96;)Lth7;

    move-result-object v1

    iput-object v1, p0, Lglf;->w0:Ljava/lang/Object;

    new-instance v1, Lflf;

    const/4 v3, 0x0

    invoke-direct {v1, p0, v3}, Lflf;-><init>(Lglf;I)V

    iput-object v1, p0, Lglf;->x0:Lflf;
    ...
    sget-object v3, Lglf;->z0:Landroid/text/TextPaint;
    ...
    invoke-virtual {v1, v4}, Leue;->e(Lix4;)J

    move-result-wide v4

    invoke-static {v4, v5, p1}, Lpn4;->b(JLandroid/content/Context;)F

    move-result v4

    invoke-virtual {v3, v4}, Landroid/graphics/Paint;->setTextSize(F)V

    iget-wide v4, v1, Leue;->e:J
    ...
    iget-object p1, v1, Leue;->f:Ljava/lang/String;
    ...
    sget-object p1, Lglf;->y0:[Lof7;

    const/4 v1, 0x2

    aget-object p1, p1, v1

    iget-object p1, v2, Lt2;->b:Ljava/lang/Object;
    ...
    invoke-direct {p0}, Lglf;->getDrawableColor()I

    move-result v0

    invoke-virtual {p1, v0}, Landroid/graphics/drawable/Drawable;->setTint(I)V

    iput-object p1, p0, Lglf;->u0:Landroid/graphics/drawable/Drawable;

    :cond_0
    return-void
.end method

.method public static final synthetic a(Lglf;)I
    .locals 0
...
.method public static final synthetic b(Lglf;)Landroid/text/BoringLayout$Metrics;
    .locals 0

    invoke-direct {p0}, Lglf;->getMetrics()Landroid/text/BoringLayout$Metrics;
...
.method private final getBackgroundColor()I
    ...
    sget-object v0, Lglf;->y0:[Lof7;

    const/4 v1, 0x1

    aget-object v0, v0, v1

    iget-object v0, p0, Lglf;->s0:Lflf;
...
.method private final getMetrics()Landroid/text/BoringLayout$Metrics;
    ...
    iget-object p0, p0, Lglf;->w0:Ljava/lang/Object;
...
.method private final getText()Ljava/lang/CharSequence;
    ...
    iget-object p0, p0, Lglf;->x0:Lflf;
...
.method private final setText(Ljava/lang/CharSequence;)V
    ...
    iget-object v1, p0, Lglf;->x0:Lflf;
...
.method public final onDraw(Landroid/graphics/Canvas;)V
    ...
    iget-object v0, p0, Lglf;->v0:Landroid/text/Layout;
    ...
    sget-object v3, Lglf;->y0:[Lof7;

    const/4 v4, 0x0

    aget-object v3, v3, v4

    iget-object v3, p0, Lglf;->r0:Lflf;
    ...
    iget-object v3, p0, Lglf;->p0:Ljava/lang/Object;
    ...
    invoke-direct {p0}, Lglf;->getBackgroundColor()I
    ...
    iget-object p1, p0, Lglf;->u0:Landroid/graphics/drawable/Drawable;
...
.method public final onMeasure(II)V
    ...
    iget-object p1, p0, Lglf;->v0:Landroid/text/Layout;
    ...
    :goto_0
    iget-object v1, p0, Lglf;->u0:Landroid/graphics/drawable/Drawable;
    ...
    :cond_1
    sget-object v1, Lglf;->y0:[Lof7;

    aget-object p2, v1, p2

    iget-object p2, p0, Lglf;->r0:Lflf;
...
.method public final setBackgroundEnabled(Z)V
    ...
    iget-object v1, p0, Lglf;->r0:Lflf;
...
.method public final setCapsuleInside(Z)V
    ...
    iget-object v1, p0, Lglf;->s0:Lflf;
...
.method public final setContent(Ljava/lang/CharSequence;)V
    ...
    invoke-direct {p0, p1}, Lglf;->setText(Ljava/lang/CharSequence;)V
...
.method public final setDrawableEnabled(Z)V
    ...
    iget-object v1, p0, Lglf;->t0:Lflf;
