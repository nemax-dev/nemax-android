...
# direct methods
.method public constructor <init>(Ltc;Lrv0;Lvs9;Lo75;Lkmg;)V
    .locals 0

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Lnod;->a:Ltc;

    iput-object p2, p0, Lnod;->b:Lrv0;

    iput-object p4, p0, Lnod;->c:Lo75;

    iput-object p5, p0, Lnod;->d:Lkmg;
...
.method public final a(ILjava/lang/String;Ljava/util/List;)Ljava/util/ArrayList;
    ...
    iget-object v5, p0, Lnod;->a:Ltc;

    invoke-virtual {v5, v3, v4}, Ltc;->g(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-direct {v3, p1, v1}, Lxtd;-><init>(ILjava/lang/String;)V
    ...
    invoke-direct {v3, v4, v5, v1}, Lwcd;-><init>(JLjava/util/List;)V

    const/4 v1, 0x1

    iput-boolean v1, v3, Lwcd;->j:Z

    iput-object p2, v3, Lwcd;->h:Ljava/lang/String;

    iput-object v2, v3, Lwcd;->i:Ljava/util/List;
...
.method public final b(Lru/ok/tamtam/android/util/share/ShareData;Ljava/util/List;Ljava/lang/String;Ljava/util/List;)V
    ...
    invoke-virtual {v0, v12, v6, v5}, Lnod;->a(ILjava/lang/String;Ljava/util/List;)Ljava/util/ArrayList;
    ...
    invoke-virtual {v0, v12, v13, v5}, Lnod;->a(ILjava/lang/String;Ljava/util/List;)Ljava/util/ArrayList;
    ...
    invoke-virtual {v0, v14, v6, v5}, Lnod;->a(ILjava/lang/String;Ljava/util/List;)Ljava/util/ArrayList;
    ...
    :cond_6
    invoke-virtual {v0, v14, v13, v5}, Lnod;->a(ILjava/lang/String;Ljava/util/List;)Ljava/util/ArrayList;
    ...
    invoke-virtual {v0, v6, v13, v5}, Lnod;->a(ILjava/lang/String;Ljava/util/List;)Ljava/util/ArrayList;
    ...
    sget-object v15, Lt10;->Z:Lt10;

    iput-object v15, v14, Ly00;->a:Lt10;

    new-instance v15, Lp10;

    invoke-direct {v15}, Ljava/lang/Object;-><init>()V

    iput-object v10, v15, Lp10;->b:Ljava/lang/String;

    new-instance v13, Lp10;

    invoke-direct {v13, v15}, Lp10;-><init>(Lp10;)V

    iput-object v13, v14, Ly00;->g:Lp10;
    ...
    invoke-direct {v14, v6, v7, v10, v13}, Lbdd;-><init>(JLjava/lang/String;Lx10;)V

    iput-boolean v12, v14, Lbdd;->i:Z
    ...
    new-instance v8, Lscd;

    invoke-direct {v8, v6, v7}, Lycd;-><init>(J)V

    iput-object v5, v8, Lscd;->g:Ljava/lang/String;
    ...
    invoke-static/range {v19 .. v19}, Lno9;->p(Ljava/lang/CharSequence;)Z

    move-result v6

    if-nez v6, :cond_12

    new-instance v16, Lbdd;
    ...
    invoke-direct/range {v16 .. v21}, Lbdd;-><init>(JLjava/lang/String;ZLjava/util/List;)V
    ...
    invoke-direct {v5, v4}, Lkj0;-><init>(Ljava/lang/String;)V

    iget-object v4, v0, Lnod;->b:Lrv0;
    ...
    invoke-direct {v7, v3, v4, v6, v8}, Ldcd;-><init>(JLjava/lang/Object;I)V

    const/4 v3, 0x0

    iput-object v3, v7, Lycd;->e:Ljava/lang/String;

    new-instance v4, Ladd;

    invoke-direct {v4, v7}, Ladd;-><init>(Ldcd;)V

    iget-object v6, v0, Lnod;->d:Lkmg;

    invoke-virtual {v6, v4}, Lkmg;->a(Lzbd;)V
