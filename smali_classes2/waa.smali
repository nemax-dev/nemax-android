...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Lwaa;->v0:Landroid/graphics/Rect;

    new-instance v0, Landroid/graphics/Rect;

    invoke-direct {v0}, Landroid/graphics/Rect;-><init>()V

    iput-object v0, p0, Lwaa;->w0:Landroid/graphics/Rect;
    ...
    invoke-static {v1, v2, v3}, Leue;->c(Leue;Landroid/text/TextPaint;Landroid/util/DisplayMetrics;)V
    ...
    iput-object v0, p0, Lwaa;->x0:Landroid/widget/EditText;

    new-instance v5, Ljava/util/LinkedHashMap;

    invoke-direct {v5}, Ljava/util/LinkedHashMap;-><init>()V

    iput-object v5, p0, Lwaa;->y0:Ljava/util/LinkedHashMap;

    new-instance v5, Ljk9;

    invoke-direct {v5}, Ljk9;-><init>()V

    iput-object v5, p0, Lwaa;->z0:Ljk9;
    ...
    iput-object v5, p0, Lwaa;->A0:Ljava/lang/Object;

    new-instance v5, Lqq3;

    const/16 v7, 0x19

    invoke-direct {v5, p1, v7, p0}, Lqq3;-><init>(Ljava/lang/Object;ILjava/lang/Object;)V

    invoke-static {v6, v5}, Lltg;->s(ILd96;)Lth7;

    move-result-object p1

    iput-object p1, p0, Lwaa;->B0:Ljava/lang/Object;
    ...
    invoke-direct {p1, p0}, Lvaa;-><init>(Lwaa;)V
...
.method private final getCancelChipDrawable()Lone/me/sdk/richvector/EnhancedVectorDrawable;
    ...
    iget-object p0, p0, Lwaa;->B0:Ljava/lang/Object;
...
.method private final getMaterialThemeWrapper()Landroid/view/ContextThemeWrapper;
    ...
    iget-object p0, p0, Lwaa;->A0:Ljava/lang/Object;
...
.method public final a(JJLjava/lang/CharSequence;Ljava/lang/String;Ljava/lang/String;)V
    ...
    iget-object v1, p0, Lwaa;->y0:Ljava/util/LinkedHashMap;
    ...
    invoke-direct {p0}, Lwaa;->getMaterialThemeWrapper()Landroid/view/ContextThemeWrapper;
    ...
    invoke-static {v0, v2, v4}, Leue;->c(Leue;Landroid/text/TextPaint;Landroid/util/DisplayMetrics;)V
    ...
    invoke-virtual/range {v2 .. v10}, Lwaa;->b(Lcom/google/android/material/chip/Chip;ZJJLjava/lang/CharSequence;Ljava/lang/String;)V
    ...
    invoke-direct/range {v2 .. v10}, Lsaa;-><init>(Lwaa;Lcom/google/android/material/chip/Chip;JJLjava/lang/CharSequence;Ljava/lang/String;)V
    ...
    iget-object p0, p0, Lwaa;->u0:Luaa;
...
.method public final b(Lcom/google/android/material/chip/Chip;ZJJLjava/lang/CharSequence;Ljava/lang/String;)V
    ...
    invoke-direct {p0}, Lwaa;->getCancelChipDrawable()Lone/me/sdk/richvector/EnhancedVectorDrawable;
    ...
    invoke-direct {p2, p0, p3, p4, p1}, Ltaa;-><init>(Lwaa;JLcom/google/android/material/chip/Chip;)V
    ...
    :cond_0
    iget-object p2, p0, Lwaa;->z0:Ljk9;

    invoke-virtual {p2, p5, p6}, Ljk9;->d(J)Ljava/lang/Object;
    ...
    invoke-direct {p3, p4}, Lq6a;-><init>(Landroid/content/Context;)V

    invoke-virtual {p2, p5, p6, p3}, Ljk9;->g(JLjava/lang/Object;)V
    ...
    invoke-static {p7, p2}, Lz8c;->a(Ljava/lang/CharSequence;Ljava/lang/Long;)Ltc0;

    move-result-object p2

    invoke-virtual {p3, p2, p8}, Lq6a;->b(Ltc0;Ljava/lang/String;)V
    ...
    :goto_0
    invoke-direct {p0, p1}, Lwaa;->setChipStyle(Lcom/google/android/material/chip/Chip;)V
...
.method public final d()V
    ...
    iget-object v1, p0, Lwaa;->v0:Landroid/graphics/Rect;

    invoke-virtual {v0, v1}, Landroid/view/View;->getHitRect(Landroid/graphics/Rect;)V

    iget-object v0, p0, Lwaa;->w0:Landroid/graphics/Rect;
...
.method public final getCallback()Luaa;
    .locals 0
...
.method public final getEditText()Landroid/widget/EditText;
    ...
    iget-object p0, p0, Lwaa;->x0:Landroid/widget/EditText;
...
.method public final onDetachedFromWindow()V
    ...
    iget-object v0, p0, Lwaa;->z0:Ljk9;

    invoke-virtual {v0}, Ljk9;->a()V

    iget-object v0, p0, Lwaa;->y0:Ljava/util/LinkedHashMap;
...
.method public final onThemeChanged(Lnma;)V
    ...
    iget-object v1, p0, Lwaa;->x0:Landroid/widget/EditText;
    ...
    iget-object p1, p0, Lwaa;->y0:Ljava/util/LinkedHashMap;
    ...
    invoke-direct {p0, v0}, Lwaa;->setChipStyle(Lcom/google/android/material/chip/Chip;)V
    ...
    invoke-static {p0, p1, v0}, Lds0;->G0(Lnjf;Ljava/lang/String;I)V
...
.method public final onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    iget-object v2, p0, Lwaa;->w0:Landroid/graphics/Rect;
    ...
    iget-object v0, p0, Lwaa;->v0:Landroid/graphics/Rect;
...
.method public final setCallback(Luaa;)V
    .locals 0

    iput-object p1, p0, Lwaa;->u0:Luaa;
