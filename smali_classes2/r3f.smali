...
# static fields
.field public static final a:Lq3f;
...
# virtual methods
.method public final a(Ld3e;)Ljava/lang/CharSequence;
    .locals 0
    ...
    invoke-virtual {p0, p1}, Lr3f;->c(Landroid/content/res/Resources;)Ljava/lang/CharSequence;
...
.method public final c(Landroid/content/res/Resources;)Ljava/lang/CharSequence;
    ...
    iget-object v0, p0, Lo3f;->c:Ljava/util/List;
    ...
    :cond_2
    instance-of v0, p0, Lq3f;

    if-eqz v0, :cond_3

    check-cast p0, Lq3f;

    iget-object p0, p0, Lq3f;->b:Ljava/lang/CharSequence;

    return-object p0

    :cond_3
    instance-of v0, p0, Lk3f;

    if-eqz v0, :cond_4

    check-cast p0, Lk3f;

    iget-object v0, p0, Lk3f;->o:Ljava/util/List;
