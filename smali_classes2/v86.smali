...
.method public synthetic constructor <init>(Lru/ok/messages/media/crop/FrgTamCropImage;I)V
    ...
    iput-object p1, p0, Lv86;->b:Lru/ok/messages/media/crop/FrgTamCropImage;
...
.method public final run()V
    ...
    iget-object p0, p0, Lv86;->b:Lru/ok/messages/media/crop/FrgTamCropImage;
    ...
    iget-object v2, v2, Lone/me/image/crop/view/ImageCropView;->a:Loe6;

    invoke-virtual {v2}, Ly67;->getInitialMatrix()Landroid/graphics/Matrix;

    move-result-object v3

    iget-object v2, v2, Lo4f;->p0:Landroid/graphics/Matrix;
    ...
    invoke-virtual {v2}, Lone/me/image/crop/view/ImageCropView;->getCropState()Ll24;
    ...
    :goto_1
    iget-object v0, v0, Lone/me/image/crop/view/ImageCropView;->a:Loe6;

    invoke-virtual {v0}, Lo4f;->getViewBitmap()Landroid/graphics/Bitmap;

    move-result-object v1

    invoke-virtual {v0}, Lo4f;->getImageOutputPath()Ljava/lang/String;

    move-result-object v2

    invoke-virtual {v0}, Ly67;->getCropState()Ll24;
    ...
    iget-object v4, v0, Ll24;->c:[F

    iget-object v0, v0, Ll24;->a:Landroid/graphics/RectF;
    ...
    invoke-direct {v0, p0, v1}, Lv86;-><init>(Lru/ok/messages/media/crop/FrgTamCropImage;I)V

    new-instance v1, Lyb3;

    const/4 v2, 0x1

    invoke-direct {v1, v2, v0}, Lyb3;-><init>(ILjava/lang/Object;)V
    ...
    invoke-virtual {v0, v1}, Lvb3;->h(Lvxc;)Lfc3;
    ...
    invoke-direct {v1, p0, v2}, Lv86;-><init>(Lru/ok/messages/media/crop/FrgTamCropImage;I)V
    ...
    invoke-direct {p0, v2, v3, v1}, Lgs1;-><init>(Ljava/lang/Object;ILjava/lang/Object;)V
    ...
    iget-object p0, p0, Lone/me/image/crop/view/ImageCropView;->a:Loe6;

    const/4 v0, 0x0

    iput v0, p0, Ly67;->A0:F

    invoke-virtual {p0}, Ly67;->f()V
    ...
    iget-object v1, v0, Ly67;->x0:Landroid/graphics/RectF;
    ...
    iget-object v3, v0, Lo4f;->p0:Landroid/graphics/Matrix;
    ...
    invoke-virtual {v0, v3}, Lo4f;->setImageMatrix(Landroid/graphics/Matrix;)V
    ...
    iget-object v1, v0, Ly67;->y0:Landroid/graphics/Matrix;

    invoke-virtual {v1}, Landroid/graphics/Matrix;->reset()V

    invoke-virtual {v0}, Lo4f;->getCurrentScale()F
    ...
    iget-object v2, v0, Ly67;->z0:Landroid/graphics/RectF;

    iget-object v0, v0, Ly67;->x0:Landroid/graphics/RectF;
    ...
    iget-object v1, v1, Lone/me/image/crop/view/ImageCropView;->a:Loe6;

    iget-object v2, v1, Ly67;->x0:Landroid/graphics/RectF;
    ...
    iget-object v5, v1, Lo4f;->p0:Landroid/graphics/Matrix;

    const/high16 v6, 0x42b40000    # 90.0f

    invoke-virtual {v5, v6, v4, v2}, Landroid/graphics/Matrix;->postRotate(FFF)Z

    invoke-virtual {v1, v5}, Lo4f;->setImageMatrix(Landroid/graphics/Matrix;)V

    iget-object v1, p0, Lru/ok/messages/media/crop/FrgTamCropImage;->w1:Lone/me/image/crop/view/ImageCropView;

    iget-object v1, v1, Lone/me/image/crop/view/ImageCropView;->b:Loqa;

    iget v2, v1, Loqa;->o0:F

    div-float v2, v3, v2

    iput v2, v1, Loqa;->o0:F

    iget-object v4, v1, Loqa;->a:Landroid/graphics/RectF;

    invoke-virtual {v1, v4, v2}, Loqa;->a(Landroid/graphics/RectF;F)V

    invoke-virtual {v1}, Loqa;->b()V

    iget-object v2, v1, Loqa;->H0:Lpqa;
    ...
    invoke-virtual {v2, v4}, Ly67;->setCropRect(Landroid/graphics/RectF;)V
    ...
    iget-object v2, v1, Ly67;->y0:Landroid/graphics/Matrix;
    ...
    iget-object v3, v1, Ly67;->z0:Landroid/graphics/RectF;

    iget-object v1, v1, Ly67;->x0:Landroid/graphics/RectF;
    ...
    iget-object v0, v2, Lone/me/image/crop/view/ImageCropView;->a:Loe6;

    iget-object v2, v0, Ly67;->x0:Landroid/graphics/RectF;
    ...
    iget-object v4, v0, Lo4f;->p0:Landroid/graphics/Matrix;
    ...
    invoke-virtual {v0, v4}, Lo4f;->setImageMatrix(Landroid/graphics/Matrix;)V
