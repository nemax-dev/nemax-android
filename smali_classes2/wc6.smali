...
.method public final W(Ljava/util/Set;)V
    ...
    iget-object p0, p0, Lwc6;->a:Ltd6;

    iget-object v0, p0, Ltd6;->q0:Lq4e;
    ...
    iget-object v0, p0, Ltd6;->G0:Lt1e;
    ...
    invoke-direct {v1, p0, p1, v2}, Lnd6;-><init>(Ltd6;Ljava/util/Set;Lkotlin/coroutines/Continuation;)V
    ...
    iput-object p1, p0, Ltd6;->G0:Lt1e;

    goto :goto_1

    :cond_2
    invoke-static {p0, v3}, Ltd6;->r(Ltd6;I)V

    :goto_1
    iget-object p1, p0, Ltd6;->Y:Lmc6;

    iget-object p0, p0, Ltd6;->A0:Ln8d;

    invoke-static {p0}, Le64;->k(Ln8d;)Ljava/util/ArrayList;

    move-result-object p0

    iget-object p1, p1, Lmc6;->c:Lt65;

    new-instance v0, Lgc6;

    invoke-direct {v0, p0}, Lgc6;-><init>(Ljava/util/List;)V
