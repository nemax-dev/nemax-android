...
.method public final run()V
    ...
    iget-object v1, v0, Lswg;->b:Ljava/lang/Object;

    check-cast v1, Lcom/my/tracker/obfuscated/t;

    iget-object v0, v0, Lswg;->c:Ljava/lang/Object;
    ...
    iget-object v2, v1, Ld1h;->l:Ljava/util/concurrent/atomic/AtomicInteger;

    invoke-virtual {v2}, Ljava/util/concurrent/atomic/AtomicInteger;->incrementAndGet()I

    iget-object v2, v1, Ld1h;->u:Lg7f;

    invoke-virtual {v2}, Lg7f;->a()V

    iget v2, v0, Lf0h;->b:I

    int-to-long v3, v2

    iget-wide v5, v1, Ld1h;->h:J
    ...
    invoke-static {v3, v5, v6, v0}, Low7;->j(Ljava/lang/StringBuilder;JLjava/lang/String;)Ljava/lang/String;

    move-result-object v0

    invoke-interface {v2, v4, v0}, Lxec;->log(Ljava/lang/String;Ljava/lang/String;)V

    iget-object v0, v1, Ld1h;->n:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    iget v13, v11, Lua6;->a:I

    add-int/2addr v13, v3

    iget-wide v14, v11, Lua6;->b:J

    add-long/2addr v14, v9

    invoke-direct {v12, v13, v14, v15}, Lua6;-><init>(IJ)V
    ...
    invoke-interface {v2, v4, v7}, Lxec;->log(Ljava/lang/String;Ljava/lang/String;)V

    iget-object v2, v1, Ld1h;->n:Ljava/util/concurrent/atomic/AtomicInteger;

    invoke-virtual {v2}, Ljava/util/concurrent/atomic/AtomicInteger;->incrementAndGet()I

    :cond_2
    iget-object v2, v1, Ld1h;->m:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    :try_start_0
    iget-object v2, v2, Ld9a;->e:Ljava/lang/Object;
    ...
    :catch_0
    :cond_3
    iput-object v5, v1, Ld1h;->f:Ld9a;

    new-instance v2, Ld9a;

    invoke-direct {v2, v1, v0}, Ld9a;-><init>(Ld1h;Lf0h;)V

    iput-object v2, v1, Ld1h;->f:Ld9a;
    ...
    iget-boolean v7, v2, Ld9a;->d:Z

    iget-byte v8, v0, Lr8d;->a:B
    ...
    iput-boolean v7, v2, Ld9a;->d:Z

    :goto_1
    iget-object v7, v0, Lf0h;->e:Ljava/nio/ByteBuffer;

    invoke-virtual {v7}, Ljava/nio/Buffer;->remaining()I

    move-result v7

    iget-object v8, v2, Ld9a;->f:Ljava/lang/Object;

    check-cast v8, Ld1h;

    iget-object v8, v8, Ld1h;->c:[B
    ...
    :cond_6
    iget-object v8, v0, Lf0h;->e:Ljava/nio/ByteBuffer;

    iget-object v9, v2, Ld9a;->f:Ljava/lang/Object;

    check-cast v9, Ld1h;

    iget-object v9, v9, Ld1h;->c:[B

    invoke-virtual {v8, v9, v6, v7}, Ljava/nio/ByteBuffer;->get([BII)Ljava/nio/ByteBuffer;

    iget-object v8, v2, Ld9a;->e:Ljava/lang/Object;
    ...
    iget-object v2, v1, Ld1h;->o:Ljava/util/concurrent/atomic/AtomicInteger;

    invoke-virtual {v2}, Ljava/util/concurrent/atomic/AtomicInteger;->incrementAndGet()I

    iget-object v2, v1, Ld1h;->v:Lg7f;
    ...
    iget-object v7, v1, Ld1h;->g:Lsa4;

    if-eqz v7, :cond_9

    iget-boolean v7, v7, Lsa4;->r0:Z
    ...
    :cond_a
    iput-wide v7, v1, Ld1h;->i:J

    sget-object v7, Ly0h;->a:[I
    ...
    sget-object v5, Ld1h;->F:[Ljava/lang/String;
    ...
    invoke-interface {v5, v4, v6}, Lxec;->log(Ljava/lang/String;Ljava/lang/String;)V
    ...
    :cond_16
    iput-object v5, v1, Ld1h;->j:Ljava/lang/Integer;

    iput-object v3, v1, Ld1h;->k:Ljava/lang/Integer;

    iget-object v6, v1, Ld1h;->a:Lxec;
    ...
    :cond_17
    iget-object v3, v1, Ld1h;->g:Lsa4;

    if-eqz v3, :cond_18

    invoke-virtual {v3}, Lsa4;->a()V

    const/4 v3, 0x0

    iput-object v3, v1, Ld1h;->g:Lsa4;
    ...
    iget-object v4, v1, Ld1h;->b:Lq2d;

    iget-object v5, v1, Ld1h;->a:Lxec;

    invoke-direct {v3, v1, v2, v4, v5}, Lsa4;-><init>(Ld1h;ILq2d;Lxec;)V

    iput-object v3, v1, Ld1h;->g:Lsa4;

    :goto_b
    iget-object v2, v1, Ld1h;->g:Lsa4;
    ...
    :cond_19
    iget-object v2, v1, Ld1h;->z:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    iput-boolean v3, v2, Lsa4;->s0:Z

    iget-object v4, v2, Lsa4;->v0:Ljava/util/concurrent/atomic/AtomicInteger;

    iget-object v2, v2, Lsa4;->u0:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    iget-object v2, v1, Ld1h;->r:Ljava/util/concurrent/atomic/AtomicInteger;

    invoke-virtual {v2}, Ljava/util/concurrent/atomic/AtomicInteger;->incrementAndGet()I

    iput-boolean v3, v1, Ld1h;->B:Z
    ...
    iget-boolean v3, v2, Ld9a;->d:Z

    iget-boolean v4, v1, Ld1h;->B:Z
    ...
    iget-object v2, v1, Ld1h;->y:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    invoke-direct {v5, v6}, Lic;-><init>(I)V
    ...
    iget-object v5, v1, Ld1h;->j:Ljava/lang/Integer;
    ...
    iget-object v5, v1, Ld1h;->k:Ljava/lang/Integer;
    ...
    :goto_d
    iget-boolean v6, v3, Lsa4;->s0:Z

    if-eqz v6, :cond_1e

    if-nez v4, :cond_1e

    iget-object v4, v3, Lsa4;->y0:Ld1h;

    iget-object v4, v4, Ld1h;->r:Ljava/util/concurrent/atomic/AtomicInteger;

    invoke-virtual {v4}, Ljava/util/concurrent/atomic/AtomicInteger;->incrementAndGet()I

    iget-object v3, v3, Lsa4;->y0:Ld1h;

    iget-object v4, v2, Lorg/webrtc/EncodedImage;->buffer:Ljava/nio/ByteBuffer;

    iget-object v6, v3, Ld1h;->y:Ljava/util/concurrent/atomic/AtomicInteger;

    invoke-virtual {v6}, Ljava/util/concurrent/atomic/AtomicInteger;->decrementAndGet()I

    invoke-virtual {v4}, Ljava/nio/ByteBuffer;->rewind()Ljava/nio/Buffer;

    iget-object v3, v3, Ld1h;->z:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    :cond_1e
    iget-object v6, v3, Lsa4;->t0:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    iput-boolean v6, v3, Lsa4;->s0:Z

    if-eqz v4, :cond_20

    iget-object v4, v3, Lsa4;->u0:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    iget-object v6, v3, Lsa4;->X:Landroid/os/Handler;

    new-instance v7, Lkl1;

    const/4 v8, 0x5

    invoke-direct {v7, v3, v2, v4, v8}, Lkl1;-><init>(Ljava/lang/Object;Ljava/lang/Object;II)V
    ...
    iget-object v7, v4, Ld1h;->y:Ljava/util/concurrent/atomic/AtomicInteger;

    invoke-virtual {v7}, Ljava/util/concurrent/atomic/AtomicInteger;->decrementAndGet()I

    invoke-virtual {v6}, Ljava/nio/ByteBuffer;->rewind()Ljava/nio/Buffer;

    iget-object v4, v4, Ld1h;->z:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    iput-boolean v4, v3, Lsa4;->s0:Z

    iget-object v4, v3, Lsa4;->v0:Ljava/util/concurrent/atomic/AtomicInteger;

    iget-object v3, v3, Lsa4;->u0:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    iget-object v3, v1, Ld1h;->p:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    iget-object v2, v1, Ld1h;->q:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    :goto_11
    iget-byte v0, v0, Lr8d;->a:B

    and-int/lit8 v0, v0, 0x8

    if-eqz v0, :cond_28

    iget-object v0, v1, Ld1h;->g:Lsa4;
    ...
    invoke-interface {v4, v0, v5}, Lxec;->log(Ljava/lang/String;Ljava/lang/String;)V
    :try_end_2
    ...
    iget-object v4, v1, Lrmb;->a:Ljava/lang/Object;
    ...
    invoke-interface {v4, v5, v6, v0}, Lxec;->reportException(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    :try_start_3
    iget-object v2, v1, Lc0h;->d:Lt0d;

    iget-object v2, v2, Lt0d;->d:Lqo4;

    if-eqz v2, :cond_2a

    iget-object v3, v1, Lc0h;->c:Ls0d;

    invoke-virtual {v2, v3, v0}, Lqo4;->b(Ls0d;Ljava/lang/Throwable;)V
    :try_end_3
    ...
    iget-object v1, v1, Lc0h;->a:Lxec;

    const-string v2, "ProtocolInfo"

    const-string v3, "rtc.command.handle.command.onerror"

    invoke-interface {v1, v2, v3, v0}, Lxec;->reportException(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    iget-object v2, v2, Lt0d;->c:Ly0d;

    if-eqz v2, :cond_2b

    iget-object v3, v1, Lc0h;->c:Ls0d;

    invoke-interface {v2, v3, v0}, Ly0d;->a(Ls0d;Ld1d;)V
    :try_end_4
    ...
    iget-object v1, v1, Lp5;->c:Ljava/lang/Object;
    ...
    invoke-virtual {v1, v0}, Lone/me/sdk/zoom/ZoomableDraweeView;->o(La27;)V
    ...
    invoke-virtual {v1, v0, v2}, Lvwg;->a(Lrxg;Z)V
