...
.method public constructor <init>(Lj49;)V
    ...
    iget-object p1, p0, Loue;->c:Ljava/util/List;

    if-nez p1, :cond_0

    sget-object p1, Ljava/util/Collections;->EMPTY_LIST:Ljava/util/List;

    iput-object p1, p0, Loue;->c:Ljava/util/List;

    :cond_0
    iget-object p1, p0, Loue;->o:Ljava/util/Map;

    if-nez p1, :cond_1

    sget-object p1, Ljava/util/Collections;->EMPTY_MAP:Ljava/util/Map;

    iput-object p1, p0, Loue;->o:Ljava/util/Map;
...
.method public final c(Lj49;Ljava/lang/String;)V
    ...
    iput-object p2, p0, Loue;->o:Ljava/util/Map;
    ...
    iget-object v1, p0, Loue;->o:Ljava/util/Map;
...
.method public final toString()Ljava/lang/String;
    ...
    iget-object v0, p0, Loue;->c:Ljava/util/List;

    invoke-static {v0}, Le5h;->h(Ljava/util/Collection;)I

    move-result v0

    iget-object p0, p0, Loue;->o:Ljava/util/Map;
