...
# direct methods
.method public constructor <init>(Landroid/content/Context;Lxfa;Lkc4;Lbca;Lx9b;)V
    .locals 0
    ...
    iput-object p2, p0, Lqv9;->b:Lxfa;

    iput-object p3, p0, Lqv9;->c:Lkc4;

    iput-object p4, p0, Lqv9;->d:Lbca;

    iput-object p5, p0, Lqv9;->e:Lx9b;
...
# virtual methods
.method public final a()Lpv9;
    .locals 12

    iget-object v0, p0, Lqv9;->c:Lkc4;

    invoke-virtual {v0}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    iget-object p0, p0, Lqv9;->a:Landroid/content/Context;

    sget v0, Lm5c;->tt_notif_category_active_calls:I
    ...
    invoke-direct/range {v1 .. v11}, Lpv9;-><init>(Ljava/lang/String;Ljava/lang/String;ZZLandroid/net/Uri;Z[JZIZ)V

    return-object v1
.end method

.method public final b()Lpv9;
    .locals 14

    iget-object v0, p0, Lqv9;->e:Lx9b;

    check-cast v0, Laab;

    iget-object v1, v0, Laab;->c:Lbp;

    const-string v2, "app.notification.chats.ringtone"

    invoke-virtual {v1, v2}, Lbp;->v(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {p0, v1}, Lqv9;->h(Z)Landroid/net/Uri;
    ...
    sget v1, Lm5c;->tt_notif_category_chats:I

    invoke-virtual {p0, v1}, Landroid/content/Context;->getString(I)Ljava/lang/String;

    move-result-object v5

    iget-object p0, v0, Laab;->c:Lbp;
    ...
    invoke-direct/range {v3 .. v13}, Lpv9;-><init>(Ljava/lang/String;Ljava/lang/String;ZZLandroid/net/Uri;Z[JZIZ)V
...
.method public final c()Lpv9;
    ...
    invoke-virtual {p0, v2}, Lqv9;->h(Z)Landroid/net/Uri;
    ...
    sget v1, Lm5c;->tt_notif_category_dialogs:I
...
.method public final d()Lpv9;
    .locals 13

    iget-object v0, p0, Lqv9;->b:Lxfa;
    ...
    iget-object v0, p0, Lqv9;->a:Landroid/content/Context;

    sget v1, Lm5c;->tt_notif_category_inapp:I

    invoke-virtual {v0, v1}, Landroid/content/Context;->getString(I)Ljava/lang/String;

    move-result-object v4

    iget-object p0, p0, Lqv9;->e:Lx9b;
    ...
    invoke-direct/range {v2 .. v12}, Lpv9;-><init>(Ljava/lang/String;Ljava/lang/String;ZZLandroid/net/Uri;Z[JZIZ)V
...
.method public final e(Lpv9;)V
    ...
    iget-object v1, p1, Lpv9;->a:Ljava/lang/String;
    ...
    iget-boolean v0, p1, Lpv9;->c:Z

    const/4 v2, 0x4

    if-eqz v0, :cond_1

    iget-boolean v0, p1, Lpv9;->f:Z
    ...
    iget-object v5, p1, Lpv9;->b:Ljava/lang/String;

    invoke-direct {v3, v1, v5, v0}, Landroid/app/NotificationChannel;-><init>(Ljava/lang/String;Ljava/lang/CharSequence;I)V

    iget-object v0, p1, Lpv9;->e:Landroid/net/Uri;

    if-eqz v0, :cond_5

    iget-object v5, p0, Lqv9;->c:Lkc4;
    ...
    invoke-virtual {v0}, Lxfa;->d()I

    move-result v0

    invoke-virtual {v3, v0}, Landroid/app/NotificationChannel;->setLightColor(I)V

    iget-object v0, p0, Lqv9;->d:Lbca;

    invoke-virtual {v0, v1}, Lbca;->b(Ljava/lang/String;)Ljava/lang/String;
...
.method public final f()V
    ...
    iget-object v1, v0, Lqv9;->d:Lbca;

    iget-object v2, v1, Lbca;->e:Lkle;
    ...
    invoke-virtual {v3, v4}, Lms;->add(Ljava/lang/Object;)Z
    ...
    invoke-virtual {v3, v2}, Lms;->contains(Ljava/lang/Object;)Z
    ...
    invoke-virtual {v1, v4, v2}, Lbca;->a(ILjava/lang/String;)V
    ...
    invoke-virtual {v1, v3, v2}, Lbca;->a(ILjava/lang/String;)V

    :cond_3
    invoke-virtual {v0}, Lqv9;->i()Landroid/app/NotificationManager;
    ...
    invoke-virtual {v0}, Lqv9;->b()Lpv9;

    move-result-object v3

    invoke-virtual {v0, v3}, Lqv9;->e(Lpv9;)V
    ...
    iget-object v6, v0, Lqv9;->e:Lx9b;

    iget-object v7, v0, Lqv9;->a:Landroid/content/Context;
    ...
    iget-object v8, v3, Laab;->c:Lbp;

    const-string v9, "app.notification.ringtone"

    invoke-virtual {v8, v9}, Lbp;->v(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {v0, v5}, Lqv9;->h(Z)Landroid/net/Uri;

    move-result-object v14

    sget v8, Lm5c;->tt_notif_category_misc:I
    ...
    invoke-direct/range {v9 .. v19}, Lpv9;-><init>(Ljava/lang/String;Ljava/lang/String;ZZLandroid/net/Uri;Z[JZIZ)V

    invoke-virtual {v0, v9}, Lqv9;->e(Lpv9;)V
    ...
    sget v3, Lm5c;->tt_notif_category_file_loading:I
    ...
    invoke-direct/range {v8 .. v18}, Lpv9;-><init>(Ljava/lang/String;Ljava/lang/String;ZZLandroid/net/Uri;Z[JZIZ)V

    invoke-virtual {v0, v8}, Lqv9;->e(Lpv9;)V
    ...
    sget v3, Lm5c;->tt_notif_category_media:I
    ...
    sget v3, Lm5c;->tt_notif_category_incoming_calls:I
    ...
    sget v3, Lm5c;->tt_notif_category_live_location:I
...
.method public final h(Z)Landroid/net/Uri;
    ...
    iget-object p1, v0, Laab;->c:Lbp;

    const-string v0, "app.notification.ringtone"

    invoke-virtual {p1, v0}, Lbp;->v(Ljava/lang/String;)Ljava/lang/String;
...
.method public final i()Landroid/app/NotificationManager;
    ...
    iget-object v0, p0, Lqv9;->f:Landroid/app/NotificationManager;
    ...
    iput-object v0, p0, Lqv9;->f:Landroid/app/NotificationManager;

    :cond_0
    iget-object p0, p0, Lqv9;->f:Landroid/app/NotificationManager;
