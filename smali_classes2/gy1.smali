...
.field public final s0:Lk0f;

.field public t0:Lfy1;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object p1, p0, Lgy1;->c:Landroid/animation/IntEvaluator;

    new-instance p1, Landroid/animation/FloatEvaluator;

    invoke-direct {p1}, Landroid/animation/FloatEvaluator;-><init>()V

    iput-object p1, p0, Lgy1;->o:Landroid/animation/FloatEvaluator;
    ...
    iput-object p1, p0, Lgy1;->s0:Lk0f;
...
.method public static final b(Lgy1;IIIIFFIIIIF)V
    .locals 1

    iget-object v0, p0, Lgy1;->c:Landroid/animation/IntEvaluator;
    ...
    iget-object p3, p0, Lgy1;->o:Landroid/animation/FloatEvaluator;
    ...
    iget-object p1, p0, Lgy1;->s0:Lk0f;
...
.method public final a(ZZ)V
    ...
    :cond_0
    iput-boolean p1, p0, Lgy1;->u0:Z

    iget-object v1, p0, Lgy1;->b:Landroid/animation/ValueAnimator;
    ...
    iget-boolean v1, p0, Lgy1;->u0:Z

    iget-boolean v3, v2, Lqub;->b:Z
    ...
    :cond_3
    iput-boolean v1, v2, Lqub;->b:Z

    iget-object v3, v2, Lqub;->c:Landroid/animation/ValueAnimator;
    ...
    :cond_4
    iget-object v3, v2, Lqub;->q0:Landroidx/appcompat/widget/AppCompatImageView;
    ...
    :goto_0
    iget-object v6, v2, Lqub;->y0:Landroid/widget/FrameLayout;
    ...
    iput-object v11, v2, Lqub;->c:Landroid/animation/ValueAnimator;
    ...
    invoke-direct/range {v2 .. v8}, Lmub;-><init>(Landroid/view/View;FFFFI)V
    ...
    invoke-static/range {v2 .. v7}, Lqub;->b(Lqub;FFFFF)V
    ...
    invoke-static {p0}, Liwd;->u(Landroid/view/ViewGroup;)Landroid/view/ViewGroup;
    ...
    :cond_9
    iget v2, p0, Lgy1;->n0:I

    :goto_4
    iget-boolean v4, p0, Lgy1;->u0:Z
    ...
    :cond_b
    iget v10, p0, Lgy1;->p0:F

    goto :goto_6

    :goto_7
    iget-object v8, p0, Lgy1;->s0:Lk0f;

    iget v10, v8, Lk0f;->a:I
    ...
    iput-object v13, p0, Lgy1;->b:Landroid/animation/ValueAnimator;
    ...
    invoke-direct/range {v0 .. v11}, Ley1;-><init>(Lgy1;IIIIFFIIII)V
    ...
    invoke-static/range {v0 .. v11}, Lgy1;->b(Lgy1;IIIIFFIIIIF)V
...
.method public final getListener()Lfy1;
    .locals 0
...
.method public final onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    iget-object v1, p0, Lgy1;->s0:Lk0f;
...
.method public final setListener(Lfy1;)V
    .locals 0

    iput-object p1, p0, Lgy1;->t0:Lfy1;
...
.method public final setPreviewTranslationY(F)V
    ...
    iput p1, p0, Lgy1;->p0:F

    iget-boolean v0, p0, Lgy1;->u0:Z
