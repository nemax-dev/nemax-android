...
.method public final g(Lcua;F)V
    ...
    iget-object p0, p0, Lbua;->a:Ldua;

    iget-object p0, p0, Ldua;->o:Lje3;

    invoke-virtual {p0, p2}, Lje3;->a(F)V
...
.method public final u(Lqk0;II)V
    ...
    invoke-static {p0, p3}, Ly95;->b(Ly95;Ljava/lang/Throwable;)V

    :cond_0
    invoke-virtual {p2, p1}, Lje3;->H(Ljava/lang/Throwable;)V

    return-void

    :pswitch_2
    invoke-virtual {p2}, Lje3;->i()V

    return-void

    :pswitch_3
    invoke-virtual {p2}, Lje3;->d()V

    return-void

    :pswitch_4
    iget-object p1, p0, Ldua;->Z:Le30;

    const/4 p3, 0x3

    iget p0, p0, Ldua;->Y:I

    invoke-virtual {p1, p3, p0}, Le30;->l(II)V

    invoke-virtual {p2}, Lje3;->f()V
