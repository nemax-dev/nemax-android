...
.method static constructor <clinit>()V
    ...
    sput-object v0, Ljdd;->Z:Ljava/lang/ref/WeakReference;

    return-void
.end method

.method public constructor <init>(JJILck4;)V
    .locals 1

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-wide p1, p0, Ljdd;->b:J

    iput-wide p3, p0, Ljdd;->c:J

    iput p5, p0, Ljdd;->o:I

    iput-object p6, p0, Ljdd;->X:Lck4;
    ...
    invoke-static {p1, p2, p6, v0}, Ldw1;->l(JLjava/lang/String;Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object p1

    invoke-static {p3, p4, v0, p5, p1}, Lcx3;->l(JLjava/lang/String;Ljava/lang/String;Ljava/lang/StringBuilder;)V
    ...
    iput-object p1, p0, Ljdd;->Y:Ljava/lang/String;
...
.method public final c()I
    ...
    iget-object v0, p0, Ljdd;->Y:Ljava/lang/String;
    ...
    iget-object p0, p0, Lg64;->f:Lzpc;

    invoke-virtual {p0}, Lzpc;->b()Lase;
    ...
    invoke-static {v3}, Ldw1;->m(Ljava/lang/String;)Ljava/lang/StringBuilder;
    ...
    invoke-static {v3, v4}, Lltg;->d(Ljava/lang/StringBuilder;I)V
    ...
    invoke-static {v3, v5}, Lltg;->d(Ljava/lang/StringBuilder;I)V
    ...
    invoke-virtual {v3, v6, v7, v8}, Lvpc;->k(IJ)V
    ...
    invoke-virtual {v3, v4, v6, v7}, Lvpc;->k(IJ)V
    ...
    invoke-virtual {p0, v3}, Lfpc;->n(Lyhe;)Landroid/database/Cursor;
...
.method public final e()[B
    ...
    iget-object v1, p0, Ljdd;->X:Lck4;

    iget-byte v1, v1, Lck4;->a:B

    iput v1, v0, Lru/ok/tamtam/nano/Tasks$SyncChatHistory;->itemTypeId:I

    iget-object p0, p0, Ljdd;->Y:Ljava/lang/String;
...
.method public final equals(Ljava/lang/Object;)Z
    ...
    iget-wide v4, p1, Ljdd;->c:J

    cmp-long v2, v2, v4

    if-nez v2, :cond_2

    iget-object p0, p0, Ljdd;->X:Lck4;

    iget-object p1, p1, Ljdd;->X:Lck4;
...
.method public final j(Lyca;Ljm4;)Ljava/util/concurrent/ExecutorService;
    ...
    sget-object p0, Ljdd;->Z:Ljava/lang/ref/WeakReference;
    ...
    :try_start_0
    sget-object v0, Ljdd;->Z:Ljava/lang/ref/WeakReference;
    ...
    invoke-virtual {p1, v0, v1, p2, v2}, Lyca;->f(ILjava/lang/String;II)Ljava/util/concurrent/ExecutorService;
    ...
    sput-object p1, Ljdd;->Z:Ljava/lang/ref/WeakReference;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public final x()V
    ...
    iget-object v1, v0, Ljdd;->Y:Ljava/lang/String;
    ...
    :cond_1
    iget-object v4, v0, Ljdd;->Y:Ljava/lang/String;
    ...
    iget-object v2, v0, Ljdd;->Y:Ljava/lang/String;
    ...
    invoke-static {v2, v3, v4}, Lz76;->p(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    iget-wide v7, v0, Ljdd;->b:J

    invoke-virtual {v0}, Ljdd;->e()[B

    move-result-object v4

    iget-object v9, v1, Lase;->a:Lfpc;

    invoke-virtual {v9}, Lfpc;->b()V

    iget-object v1, v1, Lase;->e:Lwoc;

    invoke-virtual {v1}, Lu2;->f()Lzhe;

    move-result-object v10

    invoke-interface {v10, v5, v4}, Lxhe;->l(I[B)V

    int-to-long v11, v6

    const/4 v4, 0x2

    invoke-interface {v10, v4, v11, v12}, Lxhe;->k(IJ)V

    invoke-interface {v10, v2, v7, v8}, Lxhe;->k(IJ)V

    :try_start_0
    invoke-virtual {v9}, Lfpc;->c()V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    :try_start_1
    invoke-interface {v10}, Lzhe;->C()I

    invoke-virtual {v9}, Lfpc;->q()V
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_1

    :try_start_2
    invoke-virtual {v9}, Lfpc;->k()V
    :try_end_2
    .catchall {:try_start_2 .. :try_end_2} :catchall_0

    invoke-virtual {v1, v10}, Lu2;->u(Lzhe;)V
    ...
    iget-wide v6, v0, Ljdd;->c:J

    invoke-virtual {v1, v6, v7}, Lbb2;->C(J)Ll72;
    ...
    invoke-virtual {v4, v1}, Lbb2;->P(Ll72;)Z
    ...
    iget-wide v1, v0, Ljdd;->b:J

    iget-object v3, v0, Ljdd;->X:Lck4;
    ...
    invoke-static/range {v6 .. v17}, Lsd2;->b(Lsd2;JJJJJLck4;)J

    goto/16 :goto_6

    :cond_8
    iget-object v4, v1, Ll72;->c:Lwu8;
    ...
    iget-object v6, v0, Ljdd;->Y:Ljava/lang/String;
    ...
    iget-object v9, v1, Ll72;->b:Lxb2;

    iget-wide v9, v9, Lxb2;->a:J

    iget-object v11, v1, Ll72;->c:Lwu8;
    ...
    invoke-virtual {v7, v8, v6, v9, v3}, Lvea;->b(Lhw7;Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    invoke-static {v3, v4}, Lo75;->b(Lo75;Ljava/lang/Throwable;)V
    ...
    iget-wide v13, v0, Ljdd;->b:J

    iget-object v1, v3, Lsd2;->c:Ljava/lang/String;

    const-string v4, "firstPageDelayed: chatId = "

    invoke-static {v7, v8, v4, v1}, Lc22;->l(JLjava/lang/String;Ljava/lang/String;)V

    iget-object v1, v3, Lsd2;->a:Lth7;
    ...
    invoke-direct/range {v4 .. v18}, Lnd2;-><init>(JJJJJJLck4;I)V

    iget-object v1, v3, Lsd2;->b:Lth7;
    ...
    invoke-static {v1, v4}, Lhqe;->b(Lhqe;Lil;)J
    ...
    invoke-virtual {v4, v3}, Lqb2;->d(Lck4;)Ljava/util/ArrayList;

    move-result-object v3

    invoke-static {v14, v15, v3}, Lu77;->q(JLjava/util/List;)Ltra;
    ...
    invoke-static {v4, v7, v6}, Lz76;->m(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V

    if-nez v3, :cond_11

    iget-object v2, v0, Ljdd;->X:Lck4;

    invoke-virtual {v1, v14, v15, v2}, Ll72;->i(JLck4;)J
    ...
    invoke-static/range {v9 .. v20}, Lsd2;->b(Lsd2;JJJJJLck4;)J
    ...
    invoke-virtual {v1, v14, v15, v6}, Ll72;->i(JLck4;)J
    ...
    invoke-virtual/range {v9 .. v17}, Lpw8;->n(JJJZLck4;)Ljava/util/ArrayList;
    ...
    invoke-virtual {v6, v14}, Lqb2;->d(Lck4;)Ljava/util/ArrayList;

    move-result-object v6

    invoke-static {v6}, Lu77;->O(Ljava/util/ArrayList;)Ljava/lang/String;
    ...
    invoke-static {v4, v8, v6}, Lz76;->m(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V

    invoke-virtual {v0}, Lzbd;->f()Lsd2;

    move-result-object v16

    iget-wide v8, v1, Ll72;->a:J

    iget-wide v6, v7, Lxb2;->a:J

    iget-wide v10, v0, Ljdd;->b:J
    ...
    invoke-static/range {v16 .. v27}, Lsd2;->c(Lsd2;JJJJJLck4;)J
    ...
    iget-object v7, v4, Lwu8;->a:Lrw8;

    iget-wide v7, v7, Lrw8;->c:J
    ...
    :cond_17
    iget-object v10, v4, Lwu8;->a:Lrw8;

    iget-wide v10, v10, Lrw8;->c:J

    invoke-static {v10, v11, v3}, Lu77;->G(JLpb2;)Z
    ...
    invoke-virtual {v7, v9}, Lqb2;->d(Lck4;)Ljava/util/ArrayList;

    move-result-object v7

    invoke-static {v7}, Lu77;->O(Ljava/util/ArrayList;)Ljava/lang/String;
    ...
    invoke-static {v2, v4, v3}, Lz76;->m(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    invoke-static/range {v14 .. v23}, Lsd2;->a(Lsd2;JJJJLck4;)V
    ...
    invoke-virtual {v3, v4}, Lqb2;->d(Lck4;)Ljava/util/ArrayList;
    ...
    iget-object v9, v0, Ljdd;->X:Lck4;

    invoke-virtual {v1, v7, v8, v9}, Ll72;->i(JLck4;)J
    ...
    invoke-static {v8, v9, v7}, Lu77;->G(JLpb2;)Z
    ...
    iget-object v1, v4, Lwu8;->a:Lrw8;

    iget-wide v1, v1, Lrw8;->c:J

    iget-wide v3, v0, Ljdd;->b:J

    iget-object v6, v0, Ljdd;->X:Lck4;
    ...
    invoke-static/range {v10 .. v21}, Lsd2;->c(Lsd2;JJJJJLck4;)J

    :goto_6
    iget-object v1, v0, Ljdd;->Y:Ljava/lang/String;

    iget-wide v2, v0, Ljdd;->b:J
    ...
    invoke-static {v2, v3, v8, v9}, Ldw1;->l(JLjava/lang/String;Ljava/lang/String;)Ljava/lang/StringBuilder;
...
.method public final y()V
    ...
    iget-object v1, p0, Ljdd;->Y:Ljava/lang/String;
