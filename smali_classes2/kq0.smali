...
.method public constructor <init>(Landroid/content/Context;IFZ)V
    ...
    invoke-direct {p2, p4}, Lp1e;-><init>(I)V

    goto :goto_0

    :cond_0
    new-instance p2, Lupe;

    invoke-direct {p2, p1}, Lupe;-><init>(Landroid/content/Context;)V
    ...
    invoke-direct {p2, p0, p3, p1}, Lb50;-><init>(Ljava/lang/Object;ILjava/lang/Object;)V

    iput-object p2, p0, Lkq0;->m:Lb50;
...
.method public final c()V
    ...
    iget-object v6, p0, Lkq0;->i:Lmtf;

    if-eqz v6, :cond_4

    invoke-virtual {v6}, Lmtf;->invoke()Ljava/lang/Object;
    ...
    invoke-static {v4, v6, v2}, Lz76;->K(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    invoke-interface {v3, v1, v0}, Lhq0;->i(Landroid/graphics/Bitmap;F)V

    iput-boolean v5, p0, Lkq0;->f:Z

    :cond_5
    iget-object p0, p0, Lkq0;->j:Lmtf;

    if-eqz p0, :cond_6

    invoke-virtual {p0}, Lmtf;->invoke()Ljava/lang/Object;
...
.method public final draw(Landroid/graphics/Canvas;)V
    ...
    invoke-interface {v1, p1, v0}, Lhq0;->h(Landroid/graphics/Canvas;Landroid/graphics/Bitmap;)V
    ...
    invoke-virtual {v1, p1, v0}, Lupe;->h(Landroid/graphics/Canvas;Landroid/graphics/Bitmap;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public final setAlpha(I)V
    ...
    invoke-interface {p0, p1}, Lhq0;->f(I)V
