...
# direct methods
.method public constructor <init>(Landroid/content/Context;Ly95;Ljava/lang/String;Ljava/lang/String;FFLy0c;ZLe7;)V
    .locals 1
    ...
    iput-boolean v0, p0, Lbxf;->n:Z

    iput-object p1, p0, Lbxf;->o:Landroid/content/Context;

    iput-object p2, p0, Lbxf;->p:Ly95;

    iput-object p3, p0, Lbxf;->q:Ljava/lang/String;

    iput-object p4, p0, Lbxf;->r:Ljava/lang/String;

    iput p5, p0, Lbxf;->s:F

    iput p6, p0, Lbxf;->t:F

    iput-object p7, p0, Lbxf;->u:Ly0c;

    iput-boolean p8, p0, Lbxf;->v:Z

    iput-object p9, p0, Lbxf;->w:Le7;

    return-void
.end method

.method public static a(Landroid/content/Context;Ly95;Ljava/lang/String;Ljava/lang/String;FFLy0c;ZLe7;)Z
    .locals 13
    ...
    invoke-direct/range {v1 .. v10}, Lbxf;-><init>(Landroid/content/Context;Ly95;Ljava/lang/String;Ljava/lang/String;FFLy0c;ZLe7;)V
    ...
    :cond_1
    iget-object p0, v1, Lbxf;->b:Landroid/media/MediaExtractor;
    ...
    :cond_3
    iget-object p0, v1, Lbxf;->i:Lzwg;

    if-eqz p0, :cond_4

    iget-object p1, p0, Lzwg;->o:Ljava/lang/Object;

    check-cast p1, Landroid/view/Surface;

    if-eqz p1, :cond_4

    invoke-virtual {p0}, Lzwg;->t()V

    :cond_4
    iget-object p0, v1, Lbxf;->g:Lwwa;

    if-eqz p0, :cond_23

    iget-object p1, p0, Lwwa;->b:Landroid/view/Surface;
    ...
    iget-object v0, v1, Lbxf;->b:Landroid/media/MediaExtractor;
    ...
    iget-boolean v6, v1, Lbxf;->n:Z

    if-eqz v6, :cond_8

    iget-boolean v6, v1, Lbxf;->m:Z
    ...
    iget-object v0, v1, Lbxf;->f:Lqd;

    iget-object v2, v1, Lbxf;->b:Landroid/media/MediaExtractor;
    ...
    iget-wide v5, v1, Lbxf;->x:J

    cmp-long v0, v3, v5

    if-lez v0, :cond_e

    iget-object v0, v1, Lbxf;->a:Ljava/nio/ByteBuffer;
    ...
    iget-object v3, v1, Lbxf;->b:Landroid/media/MediaExtractor;

    iget-object v4, v1, Lbxf;->a:Ljava/nio/ByteBuffer;
    ...
    iget-object v3, v1, Lbxf;->c:Lrp9;

    iget-object v4, v1, Lbxf;->a:Ljava/nio/ByteBuffer;

    iget-object v5, v3, Lrp9;->f:Ljava/lang/Object;

    check-cast v5, Landroid/media/MediaMuxer;

    invoke-virtual {v3}, Lrp9;->b()Z

    move-result v6

    if-eqz v6, :cond_c

    iget-boolean v6, v3, Lrp9;->c:Z

    if-nez v6, :cond_b

    invoke-virtual {v5}, Landroid/media/MediaMuxer;->start()V

    iput-boolean v2, v3, Lrp9;->c:Z

    :cond_b
    invoke-virtual {v3}, Lrp9;->a()V
    ...
    :cond_c
    iget-object v5, v3, Lrp9;->g:Ljava/lang/Object;
    ...
    invoke-direct {v6, v3, v4, v0}, Lqp9;-><init>(ILjava/nio/ByteBuffer;Landroid/media/MediaCodec$BufferInfo;)V
    ...
    iget-object p2, p0, Lzwg;->o:Ljava/lang/Object;
    ...
    iget-object p2, p0, Lwwa;->b:Landroid/view/Surface;
    ...
    :cond_1c
    invoke-static {p1, v3, p0}, Lkug;->n(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    invoke-static {p1, p0, v0}, Lkug;->n(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V

    iget-object p0, v1, Lbxf;->p:Ly95;
    ...
    :goto_8
    iget-object p1, v1, Lbxf;->h:Lrmb;

    if-eqz p1, :cond_25

    iget-object p1, p1, Lrmb;->a:Ljava/lang/Object;
    ...
    :cond_26
    iget-object p1, v1, Lbxf;->b:Landroid/media/MediaExtractor;
    ...
    :cond_27
    iget-object p1, v1, Lbxf;->c:Lrp9;

    if-eqz p1, :cond_28

    iget-object p1, p1, Lrp9;->f:Ljava/lang/Object;
    ...
    :cond_28
    iget-object p1, v1, Lbxf;->i:Lzwg;

    if-eqz p1, :cond_29

    iget-object p2, p1, Lzwg;->o:Ljava/lang/Object;

    check-cast p2, Landroid/view/Surface;

    if-eqz p2, :cond_29

    invoke-virtual {p1}, Lzwg;->t()V

    :cond_29
    iget-object p1, v1, Lbxf;->g:Lwwa;

    if-eqz p1, :cond_2a

    iget-object p2, p1, Lwwa;->b:Landroid/view/Surface;

    if-eqz p2, :cond_2a

    invoke-virtual {p1}, Lwwa;->a()V
...
.method public final b()Z
    ...
    iput-object v0, v5, Lbxf;->a:Ljava/nio/ByteBuffer;

    new-instance v0, Landroid/media/MediaExtractor;

    invoke-direct {v0}, Landroid/media/MediaExtractor;-><init>()V

    iput-object v0, v5, Lbxf;->b:Landroid/media/MediaExtractor;

    iget-object v1, v5, Lbxf;->q:Ljava/lang/String;

    invoke-static {v1}, Landroid/net/Uri;->parse(Ljava/lang/String;)Landroid/net/Uri;

    move-result-object v1

    iget-object v2, v5, Lbxf;->o:Landroid/content/Context;
    ...
    iget-object v1, v5, Lbxf;->r:Ljava/lang/String;
    ...
    iput-boolean v7, v0, Lrp9;->d:Z

    iput-boolean v7, v0, Lrp9;->e:Z

    new-instance v2, Ljava/util/ArrayList;

    invoke-direct {v2}, Ljava/util/ArrayList;-><init>()V

    iput-object v2, v0, Lrp9;->g:Ljava/lang/Object;

    new-instance v2, Landroid/media/MediaMuxer;

    invoke-direct {v2, v1, v7}, Landroid/media/MediaMuxer;-><init>(Ljava/lang/String;I)V

    iput-object v2, v0, Lrp9;->f:Ljava/lang/Object;

    iput-object v0, v5, Lbxf;->c:Lrp9;

    iget-object v0, v5, Lbxf;->b:Landroid/media/MediaExtractor;
    ...
    invoke-static {v0, v13}, Lkug;->m(Ljava/lang/String;Ljava/lang/String;)V
    ...
    iput-wide v0, v5, Lbxf;->y:J

    iget-object v0, v5, Lbxf;->u:Ly0c;
    ...
    invoke-direct/range {v0 .. v5}, Lrmb;-><init>(IIIILbxf;)V

    iput-object v0, v5, Lbxf;->h:Lrmb;
    ...
    iput-object v2, v1, Lzwg;->a:Ljava/lang/Object;

    sget-object v2, Landroid/opengl/EGL14;->EGL_NO_CONTEXT:Landroid/opengl/EGLContext;

    iput-object v2, v1, Lzwg;->b:Ljava/lang/Object;

    sget-object v2, Landroid/opengl/EGL14;->EGL_NO_SURFACE:Landroid/opengl/EGLSurface;

    iput-object v2, v1, Lzwg;->c:Ljava/lang/Object;

    invoke-virtual {v0}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    iput-object v0, v1, Lzwg;->o:Ljava/lang/Object;

    invoke-static {v7}, Landroid/opengl/EGL14;->eglGetDisplay(I)Landroid/opengl/EGLDisplay;

    move-result-object v0

    iput-object v0, v1, Lzwg;->a:Ljava/lang/Object;
    ...
    iget-object v14, v1, Lzwg;->a:Ljava/lang/Object;
    ...
    iget-object v2, v1, Lzwg;->a:Ljava/lang/Object;
    ...
    iput-object v0, v1, Lzwg;->b:Ljava/lang/Object;

    const-string v0, "eglCreateContext"

    invoke-static {v0}, Lzwg;->n(Ljava/lang/String;)V

    iget-object v0, v1, Lzwg;->b:Ljava/lang/Object;
    ...
    iget-object v4, v1, Lzwg;->o:Ljava/lang/Object;
    ...
    iput-object v0, v1, Lzwg;->c:Ljava/lang/Object;

    const-string v0, "eglCreateWindowSurface"

    invoke-static {v0}, Lzwg;->n(Ljava/lang/String;)V

    iget-object v0, v1, Lzwg;->c:Ljava/lang/Object;

    check-cast v0, Landroid/opengl/EGLSurface;

    if-eqz v0, :cond_3

    iput-object v1, v5, Lbxf;->i:Lzwg;
    ...
    iput-object v0, v5, Lbxf;->g:Lwwa;

    new-instance v0, Lqd;

    iget-object v1, v5, Lbxf;->g:Lwwa;

    invoke-direct {v0, v13, v12, v1, v5}, Lqd;-><init>(Ljava/lang/String;Landroid/media/MediaFormat;Lwwa;Lbxf;)V

    iput-object v0, v5, Lbxf;->f:Lqd;

    iget-object v0, v5, Lbxf;->c:Lrp9;

    iput-boolean v11, v0, Lrp9;->d:Z
    ...
    :cond_6
    iput-object v6, v1, Lzwg;->a:Ljava/lang/Object;
    ...
    iput v10, v5, Lbxf;->e:I

    iget-boolean v0, v5, Lbxf;->v:Z
