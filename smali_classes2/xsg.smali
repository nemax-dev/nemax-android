...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Lxsg;->a:Laha;

    new-instance v1, Lwsg;

    invoke-direct {v1, p1}, Lwsg;-><init>(Landroid/content/Context;)V
...
# virtual methods
.method public final a(Lcge;I)V
    .locals 7

    iget-object v0, p0, Lxsg;->r0:Lkhe;
    ...
    :cond_0
    iget-object v0, p1, Lcge;->Y:Ljava/lang/String;

    const/4 v1, 0x0

    iget-object v2, p0, Lxsg;->a:Laha;

    const/4 v3, 0x1

    iget-object v4, p0, Lxsg;->b:Lwsg;
    ...
    invoke-direct {v5, v6, p0}, Lvxe;-><init>(ILjava/lang/Object;)V

    invoke-virtual {v4, v5}, Lwsg;->setOnFirstFrameListener(Lvsg;)V

    invoke-virtual {v4, v1}, Landroid/view/View;->setVisibility(I)V

    iput-boolean v3, p0, Lxsg;->c:Z
    ...
    :cond_2
    iget-object v5, v4, Lwsg;->a:Ljava/lang/String;
    ...
    :cond_3
    iput-boolean v3, v4, Lwsg;->b:Z

    iput-object v0, v4, Lwsg;->a:Ljava/lang/String;
    ...
    invoke-virtual {v4, p2}, Lwsg;->setImageDrawable(Landroid/graphics/drawable/Drawable;)V

    goto :goto_0

    :goto_1
    iput-boolean v1, p0, Lxsg;->c:Z

    if-eqz p2, :cond_4

    iget-boolean p2, p0, Lxsg;->o:Z
    ...
    iget-object p0, v2, Laha;->b:Ljava/lang/Object;
    ...
    iget-object p0, p1, Lcge;->o:Ljava/lang/String;

    iget-object p1, v2, Laha;->b:Ljava/lang/Object;

    check-cast p1, Lone/me/sdk/uikit/common/views/OneMeDraweeView;

    invoke-static {p0}, Lb37;->b(Ljava/lang/String;)Lb37;
    ...
    invoke-virtual {p1, p0, p2}, Lone/me/sdk/uikit/common/views/OneMeDraweeView;->o(Lb37;Lb37;)V
...
.method public final b(Lp38;)V
    ...
    iget-object v0, p1, Lp38;->a:Ljava/util/Set;
    ...
    iput-object v0, p1, Lp38;->a:Ljava/util/Set;

    :cond_0
    iget-object p1, p1, Lp38;->a:Ljava/util/Set;

    if-eqz p1, :cond_1

    iget-object p0, p0, Lxsg;->b:Lwsg;
...
.method public final getSizeConfigurator()Lkhe;
    ...
    iget-object p0, p0, Lxsg;->r0:Lkhe;
...
.method public final setSizeConfigurator(Lkhe;)V
    ...
    iput-object p1, p0, Lxsg;->r0:Lkhe;
