...
.method public final onClick(Landroid/content/DialogInterface;I)V
    ...
    iget-object p0, p0, Lt00;->b:Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1}, Lru/ok/messages/views/dialogs/VideoQualityPickerDialog;->c1(Luuf;)V
    ...
    iget-object p1, p1, Lru/ok/messages/media/attaches/fragments/FrgAttachVideo;->I1:Lul9;
    ...
    :cond_6
    iget-object v1, p1, Lul9;->t0:Lx10;

    if-eqz v1, :cond_7

    iget-object v2, p1, Lul9;->s0:Lrw8;

    if-eqz v2, :cond_7

    iget-object v3, p1, Lul9;->n0:Lpw8;

    iget v4, p2, Lx2f;->o0:I

    iget v5, p2, Lx2f;->n0:I
    ...
    invoke-direct {v6, v4, v5, v7}, Lda5;-><init>(III)V

    invoke-virtual {v3, v2, v1, v6}, Lpw8;->t(Lrw8;Ljava/lang/String;Lgm3;)Lrw8;
    ...
    iget-object p1, p1, Lr95;->b:Lmd3;

    iget-object v1, p1, Lmd3;->a:Ljava/lang/Object;

    check-cast v1, Lsi4;

    sget-object v2, Lx2f;->p0:Lx2f;

    if-ne p2, v2, :cond_d

    iget-object p2, v1, Ls28;->c:Lq28;
    ...
    :cond_9
    invoke-virtual {p1, p2}, Lmd3;->o(Lq28;)Landroid/util/Pair;
    ...
    :cond_a
    invoke-virtual {v1}, Lsi4;->a()Lgi4;

    move-result-object p2

    iget-object v2, p2, Lgi4;->M:Landroid/util/SparseArray;
    ...
    :cond_c
    :goto_2
    invoke-virtual {v1, p2}, Lsi4;->g(Lgi4;)V

    goto :goto_3

    :cond_d
    iget-object p1, v1, Ls28;->c:Lq28;
    ...
    iget v3, p2, Lx2f;->n0:I

    iget v4, p2, Lx2f;->Z:I

    iget p2, p2, Lx2f;->o0:I

    filled-new-array {p2}, [I

    move-result-object p2

    invoke-direct {v2, v3, v0, p2}, Lhi4;-><init>(II[I)V

    iget-object p1, p1, Lq28;->c:[Le3f;
    ...
    invoke-virtual {p2, v4, p1, v2}, Lgi4;->d(ILe3f;Lhi4;)V
