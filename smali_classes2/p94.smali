...
# direct methods
.method public constructor <init>(Lmpg;ILwtc;Li7c;)V
    .locals 1

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Lp94;->u0:Lmpg;

    const/4 p1, 0x0

    iput-boolean p1, p0, Lp94;->Z:Z

    iput-boolean p1, p0, Lp94;->n0:Z

    const/4 v0, 0x1

    iput-boolean v0, p0, Lp94;->o0:Z

    new-instance v0, Ljava/util/concurrent/atomic/AtomicInteger;

    invoke-direct {v0, p1}, Ljava/util/concurrent/atomic/AtomicInteger;-><init>(I)V

    iput-object v0, p0, Lp94;->p0:Ljava/util/concurrent/atomic/AtomicInteger;

    new-instance v0, Ljava/util/concurrent/atomic/AtomicInteger;

    invoke-direct {v0, p1}, Ljava/util/concurrent/atomic/AtomicInteger;-><init>(I)V

    iput-object v0, p0, Lp94;->q0:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    iput-object p1, p0, Lp94;->r0:Ljava/util/concurrent/atomic/AtomicInteger;

    new-instance p1, Ljava/util/concurrent/atomic/AtomicInteger;

    invoke-direct {p1, v0}, Ljava/util/concurrent/atomic/AtomicInteger;-><init>(I)V

    iput-object p1, p0, Lp94;->s0:Ljava/util/concurrent/atomic/AtomicInteger;

    new-instance p1, Ljava/util/concurrent/atomic/AtomicInteger;

    invoke-direct {p1, v0}, Ljava/util/concurrent/atomic/AtomicInteger;-><init>(I)V

    iput-object p1, p0, Lp94;->t0:Ljava/util/concurrent/atomic/AtomicInteger;

    iput-object p3, p0, Lp94;->b:Lwtc;

    iput-object p4, p0, Lp94;->c:Li7c;

    new-instance p1, Lorg/webrtc/VpxDecoderWrapper;

    invoke-direct {p1}, Lorg/webrtc/VpxDecoderWrapper;-><init>()V

    iput-object p1, p0, Lp94;->a:Lorg/webrtc/VpxDecoderWrapper;
    ...
    iput-object p1, p0, Lp94;->o:Landroid/os/HandlerThread;
    ...
    iput-object p3, p0, Lp94;->X:Landroid/os/Handler;
    ...
    invoke-direct {p1, p2, p4, p0}, Lx30;-><init>(IILjava/lang/Object;)V
...
.method public final a()V
    ...
    iput-boolean v0, p0, Lp94;->Z:Z

    iget-object v1, p0, Lp94;->c:Li7c;
    ...
    iget-object v1, p0, Lp94;->o:Landroid/os/HandlerThread;

    iget-object v2, p0, Lp94;->u0:Lmpg;

    iget-object v2, v2, Lmpg;->e:Landroid/os/Handler;

    iget-object v3, p0, Lp94;->a:Lorg/webrtc/VpxDecoderWrapper;
...
.method public final onDecodeError(I)V
    ...
    iget-object p1, p0, Lp94;->u0:Lmpg;

    iget-object v0, p1, Lmpg;->x:Lmxe;
    ...
    iput-boolean p1, p0, Lp94;->o0:Z

    iget-object p1, p0, Lp94;->r0:Ljava/util/concurrent/atomic/AtomicInteger;

    iget-object p0, p0, Lp94;->q0:Ljava/util/concurrent/atomic/AtomicInteger;
...
.method public final onFrame(Lorg/webrtc/VideoFrame;)V
    ...
    :cond_0
    iget-object v0, p0, Lp94;->u0:Lmpg;
    ...
    :cond_1
    iget-object v1, v1, Lzzc;->e:Lwua;

    invoke-virtual {v1, v0, p1}, Lwua;->a(Lwg1;Lorg/webrtc/VideoFrame;)V

    :cond_2
    :goto_0
    iget-object v0, p0, Lp94;->s0:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    iget-object p0, p0, Lp94;->t0:Ljava/util/concurrent/atomic/AtomicInteger;
