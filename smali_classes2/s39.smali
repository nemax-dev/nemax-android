...
# direct methods
.method public constructor <init>(Landroid/content/Context;Lvl7;Lvl7;Lpn4;I)V
    .locals 0
    ...
    iput-object p2, p0, Ls39;->b:Lvl7;

    iput-object p3, p0, Ls39;->c:Lvl7;

    invoke-virtual {p1}, Landroid/content/Context;->getApplicationContext()Landroid/content/Context;

    move-result-object p1

    iput-object p1, p0, Ls39;->d:Landroid/content/Context;

    invoke-virtual {p4}, Lpn4;->b()Lun4;
...
.method public final a([B)Lr39;
    ...
    invoke-virtual {p0, v3}, Ls39;->b(Ljava/lang/String;)Ltgc;

    move-result-object v3

    invoke-direct {v7, v5, v3}, Lahc;-><init>(Lbhc;Ltgc;)V
    ...
    invoke-direct {v3, v7, v4}, Lq39;-><init>(Lahc;I)V
    ...
    invoke-virtual {p0, p1}, Ls39;->b(Ljava/lang/String;)Ltgc;

    move-result-object p0

    invoke-direct {v7, v5, p0}, Lahc;-><init>(Lbhc;Ltgc;)V

    move-object v5, v7

    :goto_1
    invoke-direct {v1, v0, v2, v5}, Lr39;-><init>(Ljava/util/List;ILahc;)V
    ...
    invoke-static {v6, v3}, Low7;->e(ILjava/lang/String;)Ljava/lang/String;
...
.method public final b(Ljava/lang/String;)Ltgc;
    .locals 2

    iget-object v0, p0, Ls39;->d:Landroid/content/Context;
    ...
    invoke-interface {p0, v0, p1}, Lg35;->b(ILjava/lang/CharSequence;)Ljava/lang/CharSequence;

    move-result-object p0

    invoke-direct {v1, p0}, Ltgc;-><init>(Ljava/lang/CharSequence;)V
...
.method public final c(Ljava/util/Map;)Ljava/util/LinkedHashMap;
    ...
    iget-object v4, v1, Lo39;->a:Ljava/util/ArrayList;
    ...
    iget-object v8, v6, Ll39;->a:Lk39;

    invoke-virtual {p0, v8}, Ls39;->d(Lk39;)Lahc;

    move-result-object v8

    iget v6, v6, Ll39;->b:I

    invoke-direct {v7, v8, v6}, Lq39;-><init>(Lahc;I)V
    ...
    iget-object v1, v1, Lo39;->c:Lk39;

    if-eqz v1, :cond_1

    invoke-virtual {p0, v1}, Ls39;->d(Lk39;)Lahc;
    ...
    invoke-direct {v1, v5, v4, v3}, Lr39;-><init>(Ljava/util/List;ILahc;)V
...
.method public final d(Lk39;)Lahc;
    .locals 5

    new-instance v0, Lahc;

    iget-object v1, p1, Lk39;->a:Lp39;
    ...
    invoke-direct {v2, v3, v4}, Lw1;-><init>(ILjava/lang/Object;)V
    ...
    iget-object p1, p1, Lk39;->b:Ljava/lang/String;

    invoke-virtual {p0, p1}, Ls39;->b(Ljava/lang/String;)Ltgc;

    move-result-object p0

    invoke-direct {v0, v3, p0}, Lahc;-><init>(Lbhc;Ltgc;)V
