...
# direct methods
.method public constructor <init>(Lorg/webrtc/EglBase$Context;ZLxec;)V
    .locals 2
    ...
    iput-object v0, p0, Lj0b;->b:Lorg/webrtc/SoftwareVideoEncoderFactory;

    new-instance v0, Ljava/util/concurrent/CopyOnWriteArraySet;

    invoke-direct {v0}, Ljava/util/concurrent/CopyOnWriteArraySet;-><init>()V

    iput-object v0, p0, Lj0b;->f:Ljava/util/concurrent/CopyOnWriteArraySet;
    ...
    iput-object v0, p0, Lj0b;->a:Lorg/webrtc/HardwareVideoEncoderFactory;

    if-eqz p2, :cond_0

    new-instance p1, Ll0b;

    invoke-direct {p1, p0, p3}, Ll0b;-><init>(Lj0b;Lxec;)V
    ...
    :goto_0
    iput-object p1, p0, Lj0b;->c:Ll0b;

    iput-object p3, p0, Lj0b;->d:Lxec;
...
.method public final createEncoder(Lorg/webrtc/VideoCodecInfo;)Lorg/webrtc/VideoEncoder;
    ...
    invoke-interface {v0, v3, v2}, Lxec;->log(Ljava/lang/String;Ljava/lang/String;)V
    ...
    :goto_0
    iget-object v1, p0, Lj0b;->a:Lorg/webrtc/HardwareVideoEncoderFactory;
    ...
    :cond_2
    :goto_1
    iget-object v0, p0, Lj0b;->b:Lorg/webrtc/SoftwareVideoEncoderFactory;
    ...
    invoke-direct {v2, p1, v3}, Li1b;-><init>(Lq1b;I)V

    new-instance v3, Li2h;

    const/4 v4, 0x1

    invoke-direct {v3, p1, v2, v4}, Li2h;-><init>(Lq1b;Lxm3;I)V

    const-string v2, "onNewCodecIsCreating"

    invoke-virtual {p1, v2, v3}, Lq1b;->i(Ljava/lang/String;Ljava/lang/Runnable;)V
...
.method public final getSupportedCodecs()[Lorg/webrtc/VideoCodecInfo;
    ...
    iget-object p0, p0, Lj0b;->b:Lorg/webrtc/SoftwareVideoEncoderFactory;
...
.method public final q(Lxa8;)V
    ...
    invoke-virtual {p0, p1}, Ll0b;->q(Lxa8;)V
