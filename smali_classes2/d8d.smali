...
# direct methods
.method public constructor <init>(Lklc;Ljava/util/concurrent/ExecutorService;)V
    .locals 0

    invoke-direct {p0, p2}, Lmtd;-><init>(Ljava/util/concurrent/Executor;)V

    iput-object p1, p0, Ld8d;->X:Lklc;

    iput-object p2, p0, Ld8d;->Y:Ljava/util/concurrent/ExecutorService;
...
.method public final H(Leud;I)V
    ...
    invoke-virtual {p1, p0}, Lc8d;->F(Lwb6;)V
...
.method public final t(Landroid/view/ViewGroup;I)Luhc;
    ...
    iget-object p0, p0, Ld8d;->X:Lklc;

    invoke-direct {p1, p0, p2, v0, v1}, Lc8d;-><init>(Lklc;Lone/me/sdk/uikit/common/views/OneMeDraweeView;Landroidx/appcompat/widget/AppCompatTextView;Landroid/widget/LinearLayout;)V
