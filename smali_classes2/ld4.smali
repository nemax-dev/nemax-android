...
# direct methods
.method public synthetic constructor <init>(Lmd4;Ljava/net/Socket;II)V
    .locals 0
    ...
    iput-object p2, p0, Lld4;->b:Ljava/net/Socket;
...
.method public final a(Ljava/lang/String;Ljava/net/InetAddress;J)V
    ...
    iget-object v1, p0, Lld4;->b:Ljava/net/Socket;
    ...
    :cond_0
    invoke-virtual {p4, p3}, Leka;->a(Le08;)Z
    ...
    invoke-virtual {p4, p3, v6, v7, v3}, Leka;->b(Le08;Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    invoke-virtual {p0, p3, v6, p1, v3}, Leka;->b(Le08;Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    iget-object p3, v0, Lmd4;->j:Lhr4;

    if-eqz p3, :cond_a

    check-cast p3, Lir4;

    iget-object p4, p3, Lir4;->c:Ljava/util/concurrent/locks/ReentrantLock;

    invoke-virtual {p4}, Ljava/util/concurrent/locks/ReentrantLock;->lock()V

    :try_start_1
    iget-object p3, p3, Lir4;->f:Ljava/util/HashMap;
    ...
    iget-object v0, v0, Lie7;->a:Ljava/net/InetAddress;
