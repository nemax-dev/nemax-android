...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lvi0;->i:Ljava/util/regex/Pattern;

    return-void
.end method

.method public constructor <init>(Ltz4;Lyj3;Lx0e;Ltk3;)V
    .locals 2
    ...
    iput-object v0, p0, Lvi0;->g:Lnj3;

    new-instance v0, Ljava/util/concurrent/ConcurrentHashMap;

    invoke-direct {v0}, Ljava/util/concurrent/ConcurrentHashMap;-><init>()V

    iput-object v0, p0, Lvi0;->h:Ljava/util/concurrent/ConcurrentHashMap;

    iput-object p1, p0, Lvi0;->a:Ltz4;

    iput-object p4, p0, Lvi0;->b:Ltk3;

    iput-object p3, p0, Lvi0;->c:Lx0e;

    iput-object p2, p0, Lvi0;->f:Lyj3;
...
.method public static n(Ljavax/net/SocketFactory;)Ljava/net/Socket;
    ...
    :goto_1
    invoke-static {v0}, Lvi0;->p(Ljava/net/Socket;)V
...
.method public static o(IZ)J
    ...
    invoke-virtual {p1, v2, v4, p0, v3}, Lvea;->b(Lhw7;Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method public final b()V
    ...
    iget-object p0, p0, Lvi0;->h:Ljava/util/concurrent/ConcurrentHashMap;
...
.method public connect()Ljava/net/Socket;
    ...
    invoke-direct {v1, v3}, Lnj3;-><init>(Z)V

    iput-object v1, v0, Lvi0;->g:Lnj3;

    new-instance v1, Ljava/lang/StringBuilder;

    invoke-direct {v1}, Ljava/lang/StringBuilder;-><init>()V

    invoke-interface {v0}, Lt43;->i()Ljava/lang/String;

    move-result-object v4

    invoke-virtual {v1, v4}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    invoke-interface {v0}, Lt43;->d()I
    ...
    :try_start_0
    iget-object v5, v0, Lvi0;->h:Ljava/util/concurrent/ConcurrentHashMap;

    new-instance v6, Lxh;

    const/4 v7, 0x2

    invoke-direct {v6, v7, v0}, Lxh;-><init>(ILjava/lang/Object;)V
    ...
    iget-object v6, v0, Lvi0;->g:Lnj3;

    iput-object v1, v6, Lnj3;->g:Ljava/lang/String;

    iput v4, v6, Lnj3;->h:I

    invoke-virtual {v0, v5, v1, v4}, Lvi0;->m(Ljavax/net/SocketFactory;Ljava/lang/String;I)Ljava/net/Socket;

    move-result-object v5

    iput-object v5, v0, Lvi0;->d:Ljava/net/Socket;

    instance-of v6, v5, Ljavax/net/ssl/SSLSocket;

    if-nez v6, :cond_0

    iget-object v1, v0, Lvi0;->g:Lnj3;
    ...
    :cond_0
    iget-object v6, v0, Lvi0;->c:Lx0e;

    check-cast v5, Ljavax/net/ssl/SSLSocket;

    sget-object v8, Lvi0;->i:Ljava/util/regex/Pattern;
    ...
    iget-object v8, v0, Lvi0;->f:Lyj3;

    iget-object v8, v8, Lyj3;->a:Ljava/lang/String;
    ...
    iget-object v10, v6, Ly0e;->a:Ljava/lang/String;
    ...
    :cond_2
    invoke-virtual {v11, v9}, Lvea;->a(Lhw7;)Z
    ...
    invoke-static {v13, v8, v14}, Lw68;->l(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v13

    invoke-virtual {v11, v9, v10, v13, v12}, Lvea;->b(Lhw7;Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    iget-object v13, v6, Ly0e;->d:Lauf;

    iget-object v13, v13, Lauf;->b:Ljava/lang/Object;
    ...
    iput-wide v14, v13, Lz0e;->g:J

    iget-wide v3, v13, Lz0e;->h:J

    add-long/2addr v3, v14

    iput-wide v3, v13, Lz0e;->h:J

    iget v3, v13, Lz0e;->i:I

    add-int/lit8 v3, v3, 0x1

    iput v3, v13, Lz0e;->i:I
    ...
    iget-object v7, v6, Ly0e;->d:Lauf;

    iget-object v7, v7, Lauf;->b:Ljava/lang/Object;
    ...
    invoke-virtual {v7, v3, v4}, Lz0e;->a(J)V
    ...
    iget-object v5, v6, Ly0e;->a:Ljava/lang/String;
    ...
    :cond_5
    invoke-virtual {v6, v9}, Lvea;->a(Lhw7;)Z
    ...
    invoke-static {v3, v4, v7, v8}, Lw68;->j(JLjava/lang/String;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v3

    const/4 v4, 0x0

    invoke-virtual {v6, v9, v5, v3, v4}, Lvea;->b(Lhw7;Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V

    :cond_6
    :goto_2
    iget-object v3, v0, Lvi0;->g:Lnj3;
    ...
    :goto_3
    iget-object v4, v0, Lvi0;->c:Lx0e;

    check-cast v4, Ly0e;

    iget-object v4, v4, Ly0e;->c:Lz0e;

    iget-wide v5, v4, Lz0e;->a:J

    iget v7, v4, Lz0e;->c:I

    move/from16 v8, v17

    iget-wide v9, v4, Lz0e;->b:J
    ...
    iget-wide v9, v4, Lz0e;->d:J

    iget v11, v4, Lz0e;->f:I

    if-le v11, v8, :cond_a

    iget-wide v11, v4, Lz0e;->e:J

    iget v13, v4, Lz0e;->f:I
    ...
    iget-wide v12, v4, Lz0e;->g:J

    iget v14, v4, Lz0e;->i:I

    if-le v14, v8, :cond_b

    iget-wide v14, v4, Lz0e;->h:J
    ...
    invoke-direct/range {v22 .. v37}, La1e;-><init>(JJIJJIJJI)V

    move-object/from16 v4, v22

    iget-object v5, v0, Lvi0;->g:Lnj3;

    iget-wide v6, v4, La1e;->j:J
    ...
    iput-wide v6, v5, Lnj3;->f:J

    invoke-static {v3}, Ljava/lang/Integer;->valueOf(I)Ljava/lang/Integer;

    move-result-object v3

    invoke-virtual {v4}, La1e;->toString()Ljava/lang/String;
    ...
    invoke-virtual {v7, v1, v2}, Lz0e;->a(J)V

    invoke-static {v5, v8}, Lxu7;->q(Ljavax/net/ssl/SSLSocket;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v1

    iget-object v2, v6, Ly0e;->a:Ljava/lang/String;

    const/4 v4, 0x0

    invoke-static {v2, v1, v4}, Lz76;->p(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    iget v1, v13, Lz0e;->i:I

    const/16 v17, 0x1

    add-int/lit8 v1, v1, 0x1

    iput v1, v13, Lz0e;->i:I
...
.method public final f()V
    ...
    iget-object p0, p0, Ltk3;->c:Ljava/lang/Object;
    ...
    invoke-static {p0, v3}, Lw68;->h(ILjava/lang/String;)Ljava/lang/String;

    move-result-object p0

    const/4 v3, 0x0

    invoke-virtual {v1, v2, v0, p0, v3}, Lvea;->b(Lhw7;Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method public m(Ljavax/net/SocketFactory;Ljava/lang/String;I)Ljava/net/Socket;
    ...
    :try_start_0
    invoke-interface {p0}, Lt43;->j()I

    move-result v0

    invoke-virtual {p0, p1, p2, p3, v0}, Lvi0;->l(Ljava/net/Socket;Ljava/lang/String;II)V
    :try_end_0
    .catch Ljava/io/IOException; {:try_start_0 .. :try_end_0} :catch_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    :goto_0
    invoke-static {p1}, Lvi0;->p(Ljava/net/Socket;)V
