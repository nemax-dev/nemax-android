...
.field public volatile e:Lc2h;


# direct methods
.method public constructor <init>(Lj0b;Lxec;)V
    .locals 1

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Ll0b;->a:Lj0b;

    iput-object p2, p0, Ll0b;->b:Lxec;
    ...
    invoke-direct {p1, p2, v0}, Lc2h;-><init>(IZ)V

    iput-object p1, p0, Ll0b;->e:Lc2h;
...
.method public final a()Lorg/webrtc/VideoCodecInfo;
    ...
    iget-object v0, p0, Ll0b;->d:Lorg/webrtc/VideoCodecInfo;
    ...
    :cond_0
    iget-object v0, p0, Ll0b;->e:Lc2h;

    iget v1, v0, Lc2h;->a:I

    sget-object v2, Lk0b;->$EnumSwitchMapping$0:[I
    ...
    :cond_1
    iget-boolean v0, v0, Lc2h;->b:Z

    const-string v1, "VP8"

    if-eqz v0, :cond_3

    iget-object v0, p0, Ll0b;->a:Lj0b;

    iget-object v0, v0, Lj0b;->a:Lorg/webrtc/HardwareVideoEncoderFactory;
    ...
    invoke-static {v0, v2}, Ll0b;->b([Lorg/webrtc/VideoCodecInfo;Ljava/lang/String;)Lorg/webrtc/VideoCodecInfo;

    move-result-object v2

    if-nez v2, :cond_2

    invoke-static {v0, v1}, Ll0b;->b([Lorg/webrtc/VideoCodecInfo;Ljava/lang/String;)Lorg/webrtc/VideoCodecInfo;
    ...
    iget-object v0, v0, Lj0b;->b:Lorg/webrtc/SoftwareVideoEncoderFactory;
    ...
    :cond_4
    :goto_0
    iget-object v1, p0, Ll0b;->c:Lorg/webrtc/VideoCodecInfo;
    ...
    iget-object p0, p0, Ll0b;->c:Lorg/webrtc/VideoCodecInfo;
...
.method public final onAvailableBitrate(I)Lorg/webrtc/VideoCodecInfo;
    ...
    invoke-virtual {p0}, Ll0b;->a()Lorg/webrtc/VideoCodecInfo;
...
.method public final onCurrentEncoder(Lorg/webrtc/VideoCodecInfo;)V
    ...
    iput-object p1, p0, Ll0b;->d:Lorg/webrtc/VideoCodecInfo;

    :cond_0
    iput-object p1, p0, Ll0b;->c:Lorg/webrtc/VideoCodecInfo;

    iget-object v0, p0, Ll0b;->b:Lxec;

    iget-object p0, p0, Ll0b;->e:Lc2h;
...
.method public final onEncoderBroken()Lorg/webrtc/VideoCodecInfo;
    ...
    iget-object v0, p0, Ll0b;->c:Lorg/webrtc/VideoCodecInfo;

    iget-object v1, p0, Ll0b;->d:Lorg/webrtc/VideoCodecInfo;
    ...
    invoke-interface {v4, v2, v0}, Lxec;->log(Ljava/lang/String;Ljava/lang/String;)V

    :cond_0
    iput-object v1, p0, Ll0b;->d:Lorg/webrtc/VideoCodecInfo;
    ...
    :cond_2
    iput-object v1, p0, Ll0b;->c:Lorg/webrtc/VideoCodecInfo;
...
.method public final q(Lxa8;)V
    ...
    invoke-direct {v0, v1, p1}, Lc2h;-><init>(IZ)V

    iput-object v0, p0, Ll0b;->e:Lc2h;
