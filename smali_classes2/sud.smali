...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Lsud;->r0:Ltmf;

    new-instance v1, Lf78;

    invoke-direct {v1, p1}, Lf78;-><init>(Landroid/content/Context;)V

    iput-object v1, p0, Lsud;->s0:Lf78;
    ...
    iput-object v2, p0, Lsud;->t0:Lone/me/sdk/uikit/common/views/OneMeDraweeView;

    new-instance v3, Lbga;

    const/16 v4, 0x1b

    invoke-direct {v3, p1, v4}, Lbga;-><init>(Landroid/content/Context;I)V
    ...
    iput-object v3, p0, Lsud;->u0:Ljava/lang/Object;

    new-instance v3, Lbga;

    const/16 v5, 0x1c

    invoke-direct {v3, p1, v5}, Lbga;-><init>(Landroid/content/Context;I)V

    invoke-static {v4, v3}, Lltg;->s(ILd96;)Lth7;

    move-result-object p1

    iput-object p1, p0, Lsud;->w0:Ljava/lang/Object;
...
.method private final getBlurPostProcessor()Lmq0;
    ...
    iget-object p0, p0, Lsud;->u0:Ljava/lang/Object;
...
.method private final getMediaType()Lmp8;
    .locals 0

    iget-object p0, p0, Lsud;->w0:Ljava/lang/Object;
...
.method public final b(II)I
    ...
    iget-object v0, p0, Lsud;->s0:Lf78;

    invoke-virtual {v0}, Lf78;->r()Z

    move-result v1

    iget-object v2, p0, Lsud;->t0:Lone/me/sdk/uikit/common/views/OneMeDraweeView;
    ...
    iget-object p1, p0, Lsud;->r0:Ltmf;
    ...
    invoke-virtual {p1, v3, v1}, Lxoe;->Q(II)V

    :cond_3
    iget-object p1, p0, Lsud;->w0:Ljava/lang/Object;
    ...
    invoke-static {v1, v3, p2}, Lcx3;->b(FFI)I
    ...
    invoke-direct {p0}, Lsud;->getMediaType()Lmp8;
    ...
    invoke-static {p1, p2, v3, v6, v5}, Lx28;->v(Landroid/view/View;IIII)V

    :cond_4
    iget-boolean p0, p0, Lsud;->v0:Z
...
.method public final drawChild(Landroid/graphics/Canvas;Landroid/view/View;J)Z
    ...
    iget-object v0, p0, Lsud;->t0:Lone/me/sdk/uikit/common/views/OneMeDraweeView;

    if-ne p2, v0, :cond_0

    iget-boolean v1, p0, Lsud;->v0:Z
    ...
    :cond_0
    iget-object v1, p0, Lsud;->s0:Lf78;

    if-eq p2, v1, :cond_2

    if-eq p2, v0, :cond_2

    iget-object v0, p0, Lsud;->r0:Ltmf;
...
.method public getPreviewView()Landroid/view/View;
    ...
    iget-object p0, p0, Lsud;->s0:Lf78;
...
.method public final m()Z
    ...
    iget-object p0, p0, Lsud;->r0:Ltmf;
...
.method public final t(IIII)J
    ...
    iget-object p2, p0, Lsud;->w0:Ljava/lang/Object;
    ...
    :cond_0
    iget-object p3, p0, Lsud;->r0:Ltmf;
    ...
    invoke-virtual {p3, p4, v2}, Lxoe;->R(II)V

    :cond_1
    invoke-virtual {v0}, Lf78;->getBlurOffset()I
    ...
    iget-object v3, p0, Lsud;->t0:Lone/me/sdk/uikit/common/views/OneMeDraweeView;
    ...
    :cond_3
    iget p3, v0, Lf78;->z0:I

    if-lez p3, :cond_5

    iput-boolean v2, p0, Lsud;->v0:Z
    ...
    :goto_1
    invoke-static {p2}, Lyr3;->P(Lth7;)I

    move-result p3

    invoke-virtual {p0}, Lcg8;->getDate()Le74;
    ...
    invoke-static {p2}, Lyr3;->O(Lth7;)I
...
.method public final v(Lg78;)V
    ...
    iget-object p1, p1, Lqud;->c:Ljx6;

    iget-object v0, p0, Lsud;->s0:Lf78;

    invoke-virtual {v0, p1}, Lf78;->setImageAttach(Ljx6;)V

    iget-object v0, p1, Ljx6;->b:Landroid/net/Uri;

    invoke-static {v0}, Lfz6;->d(Landroid/net/Uri;)Lfz6;

    move-result-object v0

    iget-object v1, p1, Ljx6;->i:Lzlc;

    iput-object v1, v0, Lfz6;->d:Lzlc;

    invoke-direct {p0}, Lsud;->getBlurPostProcessor()Lmq0;
    ...
    invoke-virtual {v2, v0, v1}, Lone/me/sdk/uikit/common/views/OneMeDraweeView;->l(Lez6;Lez6;)V
    ...
    invoke-static {p0, p1, v0}, Liwd;->c(Landroid/view/ViewGroup;Landroid/view/View;Landroid/view/ViewGroup$LayoutParams;)V
