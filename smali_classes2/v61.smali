...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lv61;->e:Ljava/util/List;

    return-void
.end method

.method public constructor <init>(Lru/ok/android/externcalls/analytics/CallAnalyticsSender;Lv0d;)V
    .locals 0

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Lv61;->a:Lru/ok/android/externcalls/analytics/CallAnalyticsSender;

    iput-object p2, p0, Lv61;->b:Lv0d;

    new-instance p1, Ljava/util/ArrayList;

    invoke-direct {p1}, Ljava/util/ArrayList;-><init>()V

    iput-object p1, p0, Lv61;->d:Ljava/util/ArrayList;
...
# virtual methods
.method public final b(Lh0h;Lru/ok/android/externcalls/analytics/events/EventItemsMap;)V
    .locals 4

    iget-object v0, p1, Lh0h;->c:Lru/ok/android/externcalls/analytics/events/EventItemsMap;
    ...
    iget-object p2, p1, Lh0h;->d:Ljava/lang/Long;
    ...
    :cond_0
    iget-object p2, p0, Lv61;->b:Lv0d;

    invoke-virtual {p2}, Lv0d;->e()Ljava/lang/Long;
    ...
    iget-object v3, p1, Lh0h;->a:Ljava/lang/String;

    iget-object p1, p1, Lh0h;->b:Lru/ok/android/externcalls/analytics/events/EventItemValue;
    ...
    iget-object p0, p0, Lv61;->a:Lru/ok/android/externcalls/analytics/CallAnalyticsSender;
...
.method public final c(Ljava/lang/String;Lru/ok/android/externcalls/analytics/events/EventItemValue;Lru/ok/android/externcalls/analytics/events/EventItemsMap;)V
    ...
    iget-object v1, p0, Lv61;->b:Lv0d;

    invoke-virtual {v1}, Lv0d;->e()Ljava/lang/Long;

    move-result-object v1

    invoke-direct {v0, p1, p2, p3, v1}, Lh0h;-><init>(Ljava/lang/String;Lru/ok/android/externcalls/analytics/events/EventItemValue;Lru/ok/android/externcalls/analytics/events/EventItemsMap;Ljava/lang/Long;)V

    iget-object p1, p0, Lv61;->c:Lru/ok/android/externcalls/analytics/events/EventItemsMap;

    if-nez p1, :cond_0

    iget-object p0, p0, Lv61;->d:Ljava/util/ArrayList;
    ...
    :cond_0
    invoke-virtual {p0, v0, p1}, Lv61;->b(Lh0h;Lru/ok/android/externcalls/analytics/events/EventItemsMap;)V
