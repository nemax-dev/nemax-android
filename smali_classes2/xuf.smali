...
# direct methods
.method public constructor <init>(Lorg/webrtc/PeerConnectionFactory;Ljava/lang/String;Lorg/webrtc/MediaStream;Ljava/lang/Integer;ZLd2f;Li7c;)V
    .locals 8

    invoke-direct {p0, p2, p3, p7}, Lvl3;-><init>(Ljava/lang/String;Lorg/webrtc/MediaStream;Li7c;)V

    iput-object p1, p0, Lxuf;->f:Lorg/webrtc/PeerConnectionFactory;

    iput-object p6, p0, Lxuf;->g:Ld2f;
    ...
    invoke-direct {p1, p5, p3, v0}, Lgof;-><init>(ZILeq8;)V

    iput-object p1, v2, Lxuf;->j:Lgof;
    ...
    iput-object p0, v2, Lxuf;->k:Lorg/webrtc/Size;
...
.method public final adjustFrameGeometry(Landroid/graphics/Matrix;II)Lorg/webrtc/SurfaceTextureHelper$FrameGeometry;
    ...
    :cond_0
    iget-object v1, p0, Lgof;->f:Lwwa;

    iget-object v2, p0, Lgof;->d:Ljava/lang/Integer;

    iget-object v3, p0, Lgof;->e:Ljava/lang/Integer;
    ...
    iget-object v2, p0, Lgof;->g:Ljava/lang/Integer;
    ...
    iget-object v2, p0, Lgof;->h:Ljava/lang/Integer;
    ...
    iget-object v2, p0, Lgof;->i:Ljava/lang/Integer;
    ...
    :cond_7
    :goto_1
    invoke-virtual {p0, p2, p3}, Lgof;->a(II)Lwwa;

    move-result-object v1

    iput-object v1, p0, Lgof;->f:Lwwa;

    invoke-static {p2}, Ljava/lang/Integer;->valueOf(I)Ljava/lang/Integer;

    move-result-object v2

    iput-object v2, p0, Lgof;->g:Ljava/lang/Integer;

    invoke-static {p3}, Ljava/lang/Integer;->valueOf(I)Ljava/lang/Integer;

    move-result-object v2

    iput-object v2, p0, Lgof;->h:Ljava/lang/Integer;

    invoke-static {v4}, Ljava/lang/Integer;->valueOf(I)Ljava/lang/Integer;

    move-result-object v2

    iput-object v2, p0, Lgof;->i:Ljava/lang/Integer;

    iget-object p0, p0, Lgof;->b:Leq8;
    ...
    invoke-static {v4, p2, v0, p3, v5}, Lmh0;->j(Ljava/lang/String;ILjava/lang/String;ILjava/lang/String;)Ljava/lang/StringBuilder;
    ...
    :goto_3
    invoke-interface {v1, p1, p2, p3}, Lfof;->a(Landroid/graphics/Matrix;II)Lorg/webrtc/SurfaceTextureHelper$FrameGeometry;
...
.method public final c(Lorg/webrtc/MediaStream;Lorg/webrtc/MediaStreamTrack;)V
    ...
    :cond_0
    iget-object p1, p0, Lxuf;->h:Lorg/webrtc/SurfaceTextureHelper;
    ...
    iput-object p1, p0, Lxuf;->h:Lorg/webrtc/SurfaceTextureHelper;
...
.method public final g()Lorg/webrtc/MediaSource;
    ...
    iget-object p0, p0, Lxuf;->f:Lorg/webrtc/PeerConnectionFactory;
...
.method public final m()V
    ...
    invoke-super {p0}, Lvl3;->m()V

    const/4 v0, 0x0

    iput-object v0, p0, Lxuf;->i:Lhcb;
...
.method public final u()V
    ...
    iget-object p0, p0, Lvl3;->c:Ljava/lang/Object;
    ...
    :cond_0
    iget-object v2, p0, Lxuf;->j:Lgof;

    iget-object v3, p0, Lxuf;->k:Lorg/webrtc/Size;

    iget v3, v3, Lorg/webrtc/Size;->width:I

    iget-object v4, p0, Lxuf;->k:Lorg/webrtc/Size;

    iget v4, v4, Lorg/webrtc/Size;->height:I

    invoke-virtual {v2, v3, v4}, Lgof;->b(II)Lorg/webrtc/Size;
    ...
    :cond_1
    iget-object v3, p0, Lvl3;->c:Ljava/lang/Object;
    ...
    invoke-static {v6, v4, v5, v7}, Lcx3;->h(Ljava/lang/String;IILjava/lang/String;)Ljava/lang/String;

    move-result-object v4

    invoke-interface {v3, v1, v4}, Li7c;->log(Ljava/lang/String;Ljava/lang/String;)V
