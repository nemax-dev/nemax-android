...
.method public constructor <init>(Lmve;)V
    ...
    invoke-direct {p1, v1}, Loxd;-><init>(I)V

    invoke-static {v0, p1}, Lltg;->s(ILd96;)Lth7;

    move-result-object p1

    iput-object p1, p0, Lvif;->c:Ljava/lang/Object;

    new-instance p1, Ltif;

    const/4 v1, 0x0

    invoke-direct {p1, v1}, Ltif;-><init>(I)V
    ...
    iput-object p1, p0, Lvif;->e:Ljava/util/ArrayList;

    new-instance p1, Ljava/util/ArrayList;

    invoke-direct {p1}, Ljava/util/ArrayList;-><init>()V

    iput-object p1, p0, Lvif;->f:Ljava/util/ArrayList;

    new-instance p1, Ljava/util/ArrayList;

    invoke-direct {p1}, Ljava/util/ArrayList;-><init>()V

    iput-object p1, p0, Lvif;->g:Ljava/util/ArrayList;

    new-instance p1, Ljava/util/ArrayList;

    invoke-direct {p1}, Ljava/util/ArrayList;-><init>()V

    iput-object p1, p0, Lvif;->h:Ljava/util/ArrayList;
...
.method public static a(Landroid/graphics/Canvas;Ljava/util/List;Ljava/util/List;Landroid/graphics/Paint;)V
    ...
    invoke-static {v0, p2}, Lg73;->r0(ILjava/util/List;)Ljava/lang/Object;
...
.method public static b(Ljava/util/List;Ljava/util/List;Ljava/util/List;II)V
    ...
    invoke-direct/range {v3 .. v9}, Luif;-><init>(FFFFF[F)V
