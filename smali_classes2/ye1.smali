...
# direct methods
.method public constructor <init>(Lxec;Lorg/webrtc/EglBase$Context;[ILjava/lang/String;)V
    .locals 11

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Lye1;->a:Lxec;

    iput-object p2, p0, Lye1;->b:Lorg/webrtc/EglBase$Context;

    const-string v1, "CallOpenGL_renderer_"

    move-object v8, p4

    invoke-static {v1, p4}, Lsg0;->g(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v1

    iput-object v1, p0, Lye1;->d:Ljava/lang/String;
    ...
    invoke-direct/range {v1 .. v6}, Lwe1;-><init>(Lxec;Landroid/opengl/EGLContext;[ILc09;Ljava/lang/String;)V

    iput-object v1, p0, Lye1;->e:Lwe1;

    new-instance v0, Landroid/graphics/Matrix;

    invoke-direct {v0}, Landroid/graphics/Matrix;-><init>()V

    iput-object v0, p0, Lye1;->f:Landroid/graphics/Matrix;

    new-instance v0, Lorg/webrtc/VideoFrameDrawer;

    invoke-direct {v0}, Lorg/webrtc/VideoFrameDrawer;-><init>()V

    iput-object v0, p0, Lye1;->g:Lorg/webrtc/VideoFrameDrawer;

    new-instance v0, Lorg/webrtc/GlRectDrawer;

    invoke-direct {v0}, Lorg/webrtc/GlRectDrawer;-><init>()V

    iput-object v0, p0, Lye1;->h:Lorg/webrtc/GlRectDrawer;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, Lye1;->i:Ljava/util/ArrayList;
    ...
    iget-object v1, v1, Lwe1;->a:Lxec;

    invoke-interface {v1, v3, v4, v0}, Lxec;->reportException(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V

    :goto_0
    iput-object v2, p0, Lye1;->c:Lne;
...
.method public final a()V
    ...
    iget-object v2, p0, Lwe1;->a:Lxec;

    iget-object p0, p0, Lwe1;->j:Ljava/lang/String;

    const-string v3, "Already released, ignore"

    invoke-interface {v2, p0, v3}, Lxec;->log(Ljava/lang/String;Ljava/lang/String;)V
    ...
    iget-object v1, p0, Lwe1;->a:Lxec;

    iget-object p0, p0, Lwe1;->j:Ljava/lang/String;

    const-string v2, "Release action submitted"

    invoke-interface {v1, p0, v2}, Lxec;->log(Ljava/lang/String;Ljava/lang/String;)V
...
.method public final b(Lwe1;Lgr1;Lorg/webrtc/VideoFrame;Lvi1;)V
    .locals 16
    ...
    iget-object v3, v2, Lgr1;->k:Lorg/webrtc/RendererCommon$GlDrawer;
    ...
    iget-object v1, v2, Lgr1;->l:Lhr1;

    sub-long v5, v3, v5

    sub-long/2addr v3, v7

    iget-wide v7, v1, Lhr1;->h:J

    add-long/2addr v7, v5

    iput-wide v7, v1, Lhr1;->h:J

    iget-wide v5, v1, Lhr1;->i:J

    add-long/2addr v5, v3

    iput-wide v5, v1, Lhr1;->i:J
