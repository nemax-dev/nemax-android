...
# direct methods
.method public constructor <init>(Lth7;Lth7;Lrv0;Lth7;Lkle;Lth7;Lth7;Lo75;)V
    .locals 1
    ...
    iput-object p1, p0, Luxa;->a:Lth7;

    iput-object p2, p0, Luxa;->b:Lth7;

    iput-object p3, p0, Luxa;->c:Lrv0;

    iput-object p4, p0, Luxa;->d:Lth7;

    iput-object p5, p0, Luxa;->e:Lkle;

    iput-object p6, p0, Luxa;->f:Lth7;

    iput-object p7, p0, Luxa;->g:Lth7;

    iput-object p8, p0, Luxa;->h:Lo75;
...
.method public final b(Ljava/util/List;Ljava/util/Map;Ljava/util/HashMap;)V
    ...
    iget-object v3, p0, Luxa;->f:Lth7;

    if-lez v0, :cond_2

    iget-object v0, p0, Luxa;->d:Lth7;
    ...
    invoke-direct {v5, v2}, Lwn3;-><init>(I)V
    ...
    invoke-virtual {v0, v4}, Lw5a;->t(Ljava/util/List;)[J
    ...
    invoke-virtual {v0, p1}, Lun3;->t(Ljava/util/List;)V
    ...
    iget-object v5, p0, Luxa;->h:Lo75;

    check-cast v5, Lsca;

    invoke-virtual {v5, v4}, Lsca;->c(Ljava/lang/Throwable;)V
    ...
    iget-object v4, v4, Lg64;->e:Lupc;

    iget-object v5, v4, Lupc;->a:Lgpc;

    invoke-virtual {v5}, Lgpc;->m()Lfpc;
    ...
    invoke-direct {v7, p2, v8, v4}, Lrua;-><init>(Ljava/lang/Object;ILjava/lang/Object;)V

    invoke-virtual {v5, v7}, Lfpc;->p(Ljava/lang/Runnable;)V
    ...
    invoke-static {v1, v5, v4}, Lz76;->m(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    invoke-virtual {v1}, Lupc;->c()Laya;

    move-result-object v1

    iget-object v1, v1, Laya;->a:Lfpc;
    ...
    invoke-virtual {v1, v4}, Lfpc;->d(Ljava/lang/String;)Lzhe;

    move-result-object v4

    int-to-long v7, v2

    invoke-interface {v4, v6, v7, v8}, Lxhe;->k(IJ)V

    int-to-long v5, v0

    invoke-interface {v4, v2, v5, v6}, Lxhe;->k(IJ)V
    ...
    invoke-interface {v4, v2}, Lxhe;->Z(I)V

    goto :goto_4

    :cond_7
    invoke-interface {v4, v2, v5}, Lxhe;->f(ILjava/lang/String;)V
    ...
    invoke-virtual {p1, p3}, Lun3;->x(Ljava/util/List;)Ljava/util/Set;
    ...
    invoke-virtual {p2, p1}, Lfoe;->f(Ljava/util/Collection;)V
    ...
    invoke-virtual {p1, p2, v0, v1, p0}, Lvxc;->c(Ljava/lang/Runnable;JLjava/util/concurrent/TimeUnit;)Lkp4;
...
.method public final d()V
    ...
    iget-object v3, v3, Lg64;->e:Lupc;

    invoke-virtual {v3}, Lupc;->c()Laya;
    ...
    invoke-static {v4, v5}, Lvpc;->c(ILjava/lang/String;)Lvpc;
    ...
    invoke-virtual {v5, v4, v7, v8}, Lvpc;->k(IJ)V

    iget-object v3, v3, Laya;->a:Lfpc;

    invoke-virtual {v3}, Lfpc;->b()V

    invoke-virtual {v3, v5}, Lfpc;->n(Lyhe;)Landroid/database/Cursor;
    ...
    invoke-static {v6, v4}, Li73;->Y(Ljava/lang/Iterable;I)I
    ...
    invoke-static {v6}, Lupc;->d(Lgxa;)Lfxa;
    ...
    invoke-direct {v7, v8, v5}, Lhs3;-><init>(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-direct {v3, v4, v5, v1, v6}, Lnp3;-><init>(JLjava/lang/Object;I)V
