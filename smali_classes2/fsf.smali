...
# direct methods
.method public constructor <init>(Landroid/util/Size;Ljx4;)V
    .locals 5

    invoke-direct {p0}, Lkq4;-><init>()V

    iput-object p1, p0, Lfsf;->o:Landroid/util/Size;
    ...
    iput-object v0, p0, Lfsf;->p:Ljava/lang/String;

    const/16 v1, 0x10

    new-array v1, v1, [F

    iput-object v1, p0, Lfsf;->t:[F
    ...
    invoke-virtual {p0, p2}, Lkq4;->n(Ljx4;)Lma0;
...
.method public final q()V
    ...
    iget-object v0, p0, Lfsf;->p:Ljava/lang/String;

    const-string v1, "release"

    invoke-static {v0, v1}, Lz76;->M(Ljava/lang/String;Ljava/lang/String;)V

    iget-object v0, p0, Lfsf;->s:Lone/me/sdk/gl/effects/objects/TrivialFragmentShader;
    ...
    iput-object v0, p0, Lfsf;->s:Lone/me/sdk/gl/effects/objects/TrivialFragmentShader;

    iget-object v2, p0, Lfsf;->r:Lone/me/sdk/gl/effects/objects/OesToImage2dRenderer;
    ...
    :cond_1
    iput-object v0, p0, Lfsf;->r:Lone/me/sdk/gl/effects/objects/OesToImage2dRenderer;

    iget-object v2, p0, Lfsf;->q:Lz5e;

    if-eqz v2, :cond_2

    iget-object v3, v2, Lz5e;->d:Ljava/io/Serializable;

    check-cast v3, Ljava/lang/String;

    invoke-static {v3, v1}, Lz76;->M(Ljava/lang/String;Ljava/lang/String;)V

    iget-object v1, v2, Lz5e;->e:Ljava/lang/Object;
    ...
    iget-object v1, v2, Lz5e;->f:Ljava/lang/Object;
    ...
    :cond_2
    iput-object v0, p0, Lfsf;->q:Lz5e;

    iput-object v0, p0, Lfsf;->w:Loeb;

    invoke-super {p0}, Lkq4;->q()V
...
.method public final w(Landroid/graphics/SurfaceTexture;Landroid/view/Surface;[FZ)V
    ...
    invoke-virtual {v0, v1}, Lkq4;->l(Landroid/view/Surface;)Ldb0;

    move-result-object v2

    sget-object v3, Lhb6;->j:Ldb0;
    ...
    invoke-virtual {v0, v1}, Lkq4;->h(Landroid/view/Surface;)Ldb0;
    ...
    :cond_1
    iget-object v3, v0, Lkq4;->c:Ljava/lang/Object;

    check-cast v3, Ljava/util/concurrent/atomic/AtomicBoolean;

    const/4 v8, 0x1

    invoke-static {v3, v8}, Lhb6;->d(Ljava/util/concurrent/atomic/AtomicBoolean;Z)V

    iget-object v3, v0, Lkq4;->e:Ljava/lang/Object;
    ...
    iget v11, v2, Ldb0;->b:I

    iget v12, v2, Ldb0;->c:I

    iget-object v9, v2, Ldb0;->a:Landroid/opengl/EGLSurface;
    ...
    iget-object v5, v0, Lfsf;->o:Landroid/util/Size;

    invoke-direct {v2, v5}, Lz5e;-><init>(Landroid/util/Size;)V
    ...
    iget-object v2, v10, Lz5e;->f:Ljava/lang/Object;

    move-object/from16 v17, v2

    check-cast v17, Lone/me/sdk/gl/effects/objects/FrameBuffer;

    iget-object v2, v0, Lfsf;->r:Lone/me/sdk/gl/effects/objects/OesToImage2dRenderer;
    ...
    iput-object v2, v0, Lfsf;->r:Lone/me/sdk/gl/effects/objects/OesToImage2dRenderer;

    :cond_3
    iget-object v5, v0, Lfsf;->s:Lone/me/sdk/gl/effects/objects/TrivialFragmentShader;
    ...
    iput-object v5, v0, Lfsf;->s:Lone/me/sdk/gl/effects/objects/TrivialFragmentShader;

    :cond_4
    iget-wide v6, v0, Lfsf;->u:J

    cmp-long v6, v13, v6

    iget-object v7, v0, Lfsf;->t:[F
    ...
    iget v6, v10, Lz5e;->a:I

    move/from16 v16, v8

    iget v8, v10, Lz5e;->b:I
    ...
    iget-object v3, v10, Lz5e;->e:Ljava/lang/Object;
    ...
    iget-object v4, v10, Lz5e;->c:Ljava/lang/Object;
    ...
    iget-object v4, v0, Lkq4;->k:Ljava/lang/Object;
    ...
    invoke-virtual {v0, v2}, Lkq4;->o(Landroid/opengl/EGLSurface;)V

    iput-object v1, v0, Lkq4;->k:Ljava/lang/Object;
    ...
    invoke-virtual {v4, v11}, Loeb;->invoke(Ljava/lang/Object;)Ljava/lang/Object;

    :cond_8
    iput-object v8, v0, Lfsf;->w:Loeb;
    ...
    invoke-static {v7, v4, v5}, Lnoa;->M(IJ)Ljava/lang/String;
    ...
    iget-object v4, v0, Lfsf;->p:Ljava/lang/String;

    invoke-static {v4, v2, v8}, Lz76;->p(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V

    invoke-virtual {v0, v1, v3}, Lkq4;->s(Landroid/view/Surface;Z)V
