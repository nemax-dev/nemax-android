...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "continuation",
        "<init>",
        "(Lz04;Lkotlin/coroutines/Continuation;)V",
...
.field public final dispatcher:Lz04;
...
.method public constructor <init>(Lz04;Lkotlin/coroutines/Continuation;)V
    ...
    iput-object p1, p0, Lkotlinx/coroutines/internal/DispatchedContinuation;->dispatcher:Lz04;
    ...
    invoke-virtual {p0}, Lkotlinx/coroutines/internal/DispatchedContinuation;->getContext()Lx04;

    move-result-object p1

    invoke-static {p1}, Lkotlinx/coroutines/internal/ThreadContextKt;->threadContextElements(Lx04;)Ljava/lang/Object;
...
.method private final getReusableCancellableContinuation()Lg12;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
...
.method private final synthetic loop$atomicfu(Ljava/lang/Object;Ljava/util/concurrent/atomic/AtomicReferenceFieldUpdater;Lmc6;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public final claimReusableCancellableContinuation$kotlinx_coroutines_core()Lg12;
    .locals 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
...
.method public final dispatchYield$kotlinx_coroutines_core(Lx04;Ljava/lang/Object;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput p2, p0, Lkq4;->resumeMode:I

    iget-object p2, p0, Lkotlinx/coroutines/internal/DispatchedContinuation;->dispatcher:Lz04;

    invoke-virtual {p2, p1, p0}, Lz04;->dispatchYield(Lx04;Ljava/lang/Runnable;)V

    return-void
.end method

.method public getCallerFrame()Lh14;
    .locals 1
...
.method public final release$kotlinx_coroutines_core()V
    ...
    invoke-direct {p0}, Lkotlinx/coroutines/internal/DispatchedContinuation;->getReusableCancellableContinuation()Lg12;
...
.method public final resumeCancellableWith$kotlinx_coroutines_core(Ljava/lang/Object;Lmc6;)V
    .locals 6
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-static {p1, p2}, Lha7;->k0(Ljava/lang/Object;Lmc6;)Ljava/lang/Object;

    move-result-object p2

    iget-object v0, p0, Lkotlinx/coroutines/internal/DispatchedContinuation;->dispatcher:Lz04;

    invoke-virtual {p0}, Lkotlinx/coroutines/internal/DispatchedContinuation;->getContext()Lx04;

    move-result-object v1

    invoke-virtual {v0, v1}, Lz04;->isDispatchNeeded(Lx04;)Z
    ...
    iput v1, p0, Lkq4;->resumeMode:I

    iget-object p1, p0, Lkotlinx/coroutines/internal/DispatchedContinuation;->dispatcher:Lz04;

    invoke-virtual {p0}, Lkotlinx/coroutines/internal/DispatchedContinuation;->getContext()Lx04;

    move-result-object p2

    invoke-virtual {p1, p2, p0}, Lz04;->dispatch(Lx04;Ljava/lang/Runnable;)V
    ...
    invoke-virtual {v0, p0}, Ll95;->n(Lkq4;)V

    return-void

    :cond_1
    invoke-virtual {v0, v1}, Ll95;->W(Z)V
    ...
    invoke-interface {v3, v4}, Lx04;->get(Lw04;)Lv04;
    ...
    invoke-interface {v3}, Ljf7;->getCancellationException()Ljava/util/concurrent/CancellationException;
    ...
    invoke-static {v4, v3}, Lkotlinx/coroutines/internal/ThreadContextKt;->updateThreadContext(Lx04;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-static {p2, v4, v3}, Lds;->D(Lkotlin/coroutines/Continuation;Lx04;Ljava/lang/Object;)Lsmf;
    ...
    :cond_4
    invoke-static {v4, v3}, Lkotlinx/coroutines/internal/ThreadContextKt;->restoreThreadContext(Lx04;Ljava/lang/Object;)V

    :cond_5
    :goto_1
    invoke-virtual {v0}, Ll95;->q0()Z
    ...
    :goto_2
    invoke-virtual {v0, v1}, Ll95;->d(Z)V
    ...
    :goto_3
    :try_start_4
    invoke-virtual {p0, p1, v2}, Lkq4;->handleFatalException$kotlinx_coroutines_core(Ljava/lang/Throwable;Ljava/lang/Throwable;)V
    :try_end_4
...
.method public final resumeCancelled$kotlinx_coroutines_core(Ljava/lang/Object;)Z
    ...
    invoke-interface {v0}, Ljf7;->getCancellationException()Ljava/util/concurrent/CancellationException;
    ...
    invoke-direct {p1, v0}, Lawc;-><init>(Ljava/lang/Throwable;)V
...
.method public final resumeUndispatchedWith$kotlinx_coroutines_core(Ljava/lang/Object;)V
    ...
    invoke-static {v2, v1}, Lkotlinx/coroutines/internal/ThreadContextKt;->updateThreadContext(Lx04;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-static {v0, v2, v1}, Lds;->D(Lkotlin/coroutines/Continuation;Lx04;Ljava/lang/Object;)Lsmf;
    ...
    :cond_1
    invoke-static {v2, v1}, Lkotlinx/coroutines/internal/ThreadContextKt;->restoreThreadContext(Lx04;Ljava/lang/Object;)V
...
.method public resumeWith(Ljava/lang/Object;)V
    ...
    invoke-static {p1, v1}, Lha7;->k0(Ljava/lang/Object;Lmc6;)Ljava/lang/Object;
    ...
    iput v4, p0, Lkq4;->resumeMode:I

    iget-object p1, p0, Lkotlinx/coroutines/internal/DispatchedContinuation;->dispatcher:Lz04;

    invoke-virtual {p1, v0, p0}, Lz04;->dispatch(Lx04;Ljava/lang/Runnable;)V
    ...
    invoke-virtual {v0, v2}, Ll95;->W(Z)V
    ...
    invoke-static {v3, v4}, Lkotlinx/coroutines/internal/ThreadContextKt;->updateThreadContext(Lx04;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    :try_start_2
    invoke-static {v3, v4}, Lkotlinx/coroutines/internal/ThreadContextKt;->restoreThreadContext(Lx04;Ljava/lang/Object;)V
    ...
    :goto_0
    invoke-virtual {v0, v2}, Ll95;->d(Z)V
    ...
    :goto_1
    :try_start_4
    invoke-virtual {p0, p1, v1}, Lkq4;->handleFatalException$kotlinx_coroutines_core(Ljava/lang/Throwable;Ljava/lang/Throwable;)V
    :try_end_4
    .catchall {:try_start_4 .. :try_end_4} :catchall_2
...
.method public toString()Ljava/lang/String;
    ...
    iget-object v1, p0, Lkotlinx/coroutines/internal/DispatchedContinuation;->dispatcher:Lz04;
    ...
    invoke-static {p0}, Ly94;->G(Lkotlin/coroutines/Continuation;)Ljava/lang/String;
...
.method public final tryReleaseClaimedContinuation$kotlinx_coroutines_core(Lf12;)Ljava/lang/Throwable;
    .locals 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
