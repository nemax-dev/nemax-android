...
.field public final dispatcher:Lj04;
...
.method public constructor <init>(Lj04;Lkotlin/coroutines/Continuation;)V
    ...
    iput-object p1, p0, Lkotlinx/coroutines/internal/DispatchedContinuation;->dispatcher:Lj04;
    ...
    invoke-virtual {p0}, Lkotlinx/coroutines/internal/DispatchedContinuation;->getContext()Lh04;

    move-result-object p1

    invoke-static {p1}, Lkotlinx/coroutines/internal/ThreadContextKt;->threadContextElements(Lh04;)Ljava/lang/Object;
...
.method private final getReusableCancellableContinuation()Lv02;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
...
.method private final synthetic loop$atomicfu(Ljava/lang/Object;Ljava/util/concurrent/atomic/AtomicReferenceFieldUpdater;Lf96;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public cancelCompletedResult$kotlinx_coroutines_core(Ljava/lang/Object;Ljava/lang/Throwable;)V
    ...
    instance-of p0, p1, Lsc3;

    if-eqz p0, :cond_0

    check-cast p1, Lsc3;

    iget-object p0, p1, Lsc3;->b:Lf96;
...
.method public final claimReusableCancellableContinuation$kotlinx_coroutines_core()Lv02;
    .locals 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
...
.method public final dispatchYield$kotlinx_coroutines_core(Lh04;Ljava/lang/Object;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput p2, p0, Lzo4;->resumeMode:I

    iget-object p2, p0, Lkotlinx/coroutines/internal/DispatchedContinuation;->dispatcher:Lj04;

    invoke-virtual {p2, p1, p0}, Lj04;->dispatchYield(Lh04;Ljava/lang/Runnable;)V

    return-void
.end method

.method public getCallerFrame()Lr04;
    .locals 1
...
.method public final release$kotlinx_coroutines_core()V
    ...
    invoke-direct {p0}, Lkotlinx/coroutines/internal/DispatchedContinuation;->getReusableCancellableContinuation()Lv02;
...
.method public final resumeCancellableWith$kotlinx_coroutines_core(Ljava/lang/Object;Lf96;)V
    .locals 6
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-static {p1, p2}, Lj5e;->F(Ljava/lang/Object;Lf96;)Ljava/lang/Object;

    move-result-object p2

    iget-object v0, p0, Lkotlinx/coroutines/internal/DispatchedContinuation;->dispatcher:Lj04;

    invoke-virtual {p0}, Lkotlinx/coroutines/internal/DispatchedContinuation;->getContext()Lh04;

    move-result-object v1

    invoke-virtual {v0, v1}, Lj04;->isDispatchNeeded(Lh04;)Z
    ...
    iput v1, p0, Lzo4;->resumeMode:I

    iget-object p1, p0, Lkotlinx/coroutines/internal/DispatchedContinuation;->dispatcher:Lj04;

    invoke-virtual {p0}, Lkotlinx/coroutines/internal/DispatchedContinuation;->getContext()Lh04;

    move-result-object p2

    invoke-virtual {p1, p2, p0}, Lj04;->dispatch(Lh04;Ljava/lang/Runnable;)V
    ...
    invoke-virtual {v0, p0}, Lb75;->n(Lzo4;)V

    return-void

    :cond_1
    invoke-virtual {v0, v1}, Lb75;->W(Z)V
    ...
    invoke-interface {v3, v4}, Lh04;->get(Lg04;)Lf04;
    ...
    invoke-interface {v3}, Lhb7;->getCancellationException()Ljava/util/concurrent/CancellationException;
    ...
    invoke-static {v4, v3}, Lkotlinx/coroutines/internal/ThreadContextKt;->updateThreadContext(Lh04;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-static {p2, v4, v3}, Lxu7;->w0(Lkotlin/coroutines/Continuation;Lh04;Ljava/lang/Object;)Locf;
    ...
    :cond_4
    invoke-static {v4, v3}, Lkotlinx/coroutines/internal/ThreadContextKt;->restoreThreadContext(Lh04;Ljava/lang/Object;)V

    :cond_5
    :goto_1
    invoke-virtual {v0}, Lb75;->q0()Z
    ...
    :goto_2
    invoke-virtual {v0, v1}, Lb75;->d(Z)V
    ...
    :goto_3
    :try_start_4
    invoke-virtual {p0, p1, v2}, Lzo4;->handleFatalException$kotlinx_coroutines_core(Ljava/lang/Throwable;Ljava/lang/Throwable;)V
    :try_end_4
...
.method public final resumeCancelled$kotlinx_coroutines_core(Ljava/lang/Object;)Z
    ...
    invoke-interface {v0}, Lhb7;->getCancellationException()Ljava/util/concurrent/CancellationException;
...
.method public final resumeUndispatchedWith$kotlinx_coroutines_core(Ljava/lang/Object;)V
    ...
    invoke-static {v2, v1}, Lkotlinx/coroutines/internal/ThreadContextKt;->updateThreadContext(Lh04;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-static {v0, v2, v1}, Lxu7;->w0(Lkotlin/coroutines/Continuation;Lh04;Ljava/lang/Object;)Locf;
    ...
    :cond_1
    invoke-static {v2, v1}, Lkotlinx/coroutines/internal/ThreadContextKt;->restoreThreadContext(Lh04;Ljava/lang/Object;)V
...
.method public resumeWith(Ljava/lang/Object;)V
    ...
    invoke-static {p1, v1}, Lj5e;->F(Ljava/lang/Object;Lf96;)Ljava/lang/Object;
    ...
    iput v4, p0, Lzo4;->resumeMode:I

    iget-object p1, p0, Lkotlinx/coroutines/internal/DispatchedContinuation;->dispatcher:Lj04;

    invoke-virtual {p1, v0, p0}, Lj04;->dispatch(Lh04;Ljava/lang/Runnable;)V
    ...
    invoke-virtual {v0, v2}, Lb75;->W(Z)V
    ...
    invoke-static {v3, v4}, Lkotlinx/coroutines/internal/ThreadContextKt;->updateThreadContext(Lh04;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    :try_start_2
    invoke-static {v3, v4}, Lkotlinx/coroutines/internal/ThreadContextKt;->restoreThreadContext(Lh04;Ljava/lang/Object;)V
    ...
    :goto_0
    invoke-virtual {v0, v2}, Lb75;->d(Z)V
    ...
    :goto_1
    :try_start_4
    invoke-virtual {p0, p1, v1}, Lzo4;->handleFatalException$kotlinx_coroutines_core(Ljava/lang/Throwable;Ljava/lang/Throwable;)V
    :try_end_4
    .catchall {:try_start_4 .. :try_end_4} :catchall_2
...
.method public toString()Ljava/lang/String;
    ...
    iget-object v1, p0, Lkotlinx/coroutines/internal/DispatchedContinuation;->dispatcher:Lj04;
    ...
    invoke-static {p0}, Ly84;->N(Lkotlin/coroutines/Continuation;)Ljava/lang/String;
...
.method public final tryReleaseClaimedContinuation$kotlinx_coroutines_core(Lu02;)Ljava/lang/Throwable;
    .locals 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
