...
.method public final afterTextChanged(Landroid/text/Editable;)V
    ...
    iget-object v0, p0, Lru/ok/messages/media/mediabar/MediaBarPreviewLayout;->O0:La88;
    ...
    invoke-virtual {v0}, Lru/ok/messages/media/mediabar/ActLocalMedias;->e0()Ltt7;

    move-result-object v0

    iget-object v0, v0, Ltt7;->f:Ln8d;

    iput-object p1, v0, Ln8d;->k:Ljava/lang/CharSequence;
    ...
    :goto_3
    invoke-virtual {p0, p1}, Lru/ok/messages/media/mediabar/MediaBarPreviewLayout;->y(Z)V
...
.method public final onTextChanged(Ljava/lang/CharSequence;III)V
    ...
    iget-object p2, p0, Lone/me/devmenu/utils/ValueBottomSheet;->z0:Ldbc;

    sget-object p3, Lone/me/devmenu/utils/ValueBottomSheet;->A0:[Lof7;

    const/4 p4, 0x3

    aget-object p3, p3, p4

    invoke-interface {p2, p0, p3}, Ldbc;->t(Ljava/lang/Object;Lof7;)Ljava/lang/Object;
    ...
    iget-object p2, p0, Lone/me/devmenu/server/ServerPortBottomSheet;->x0:Ldbc;

    sget-object p3, Lone/me/devmenu/server/ServerPortBottomSheet;->y0:[Lof7;
    ...
    iget-object p2, p0, Lone/me/devmenu/server/ServerHostBottomSheet;->C0:Ldbc;

    sget-object p3, Lone/me/devmenu/server/ServerHostBottomSheet;->D0:[Lof7;
    ...
    invoke-virtual {p0, p1}, Lk4d;->onTextChanged(Ljava/lang/CharSequence;)V
    ...
    invoke-virtual {p0}, Lkma;->getMaxLengthForLabel()I
    ...
    :cond_6
    invoke-static {p0, p2, v1}, Lkma;->c(Lkma;II)V

    invoke-static {p0}, Lkma;->a(Lkma;)V
    ...
    iget-object p0, p0, Lkma;->o:Ljava/lang/Object;
    ...
    iget-object p2, p0, Loga;->r0:Landroid/widget/EditText;

    if-le p4, v0, :cond_b

    iget-boolean p3, p0, Loga;->n0:Z

    if-nez p3, :cond_b

    iget-object p3, p0, Loga;->c:Lwba;

    if-eqz p3, :cond_b

    iget-object p3, p3, Lwba;->a:Ljava/lang/String;
    ...
    invoke-virtual {p0}, Loga;->getPhoneFormatterProvider()Lnga;

    move-result-object p4

    if-eqz p4, :cond_a

    invoke-interface {p4, p3, p1}, Lnga;->a(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    :cond_a
    :goto_0
    iget-object p3, p0, Loga;->s0:Ly2;

    invoke-virtual {p2, p3}, Landroid/widget/TextView;->removeTextChangedListener(Landroid/text/TextWatcher;)V

    invoke-virtual {p0, p1}, Loga;->setText(Ljava/lang/CharSequence;)V

    iget-object p0, p0, Loga;->s0:Ly2;
    ...
    sget-object p2, Lone/me/devmenu/logsviewer/LogsViewerScreen;->Y:[Lof7;
    ...
    invoke-direct {p4, p0, p1, p3}, Lyy7;-><init>(Lzy7;Ljava/lang/CharSequence;Lkotlin/coroutines/Continuation;)V

    iget-object p1, p0, Lyxf;->a:Lkotlinx/coroutines/internal/ContextScope;

    sget-object p3, Ls04;->b:Ls04;

    invoke-static {p1, p2, p3, p4}, Lyr3;->X(Lp04;Lh04;Ls04;Lt96;)Lt1e;

    move-result-object p1

    iget-object p2, p0, Lzy7;->o0:Lvfd;

    sget-object p3, Lzy7;->q0:[Lof7;

    aget-object p3, p3, v1

    invoke-virtual {p2, p0, p3, p1}, Lvfd;->N(Ljava/lang/Object;Lof7;Ljava/lang/Object;)V
    ...
    :cond_d
    :goto_2
    iget-object p1, p0, Lzy7;->o0:Lvfd;

    sget-object p2, Lzy7;->q0:[Lof7;

    aget-object p2, p2, v1

    invoke-virtual {p1, p0, p2, p3}, Lvfd;->N(Ljava/lang/Object;Lof7;Ljava/lang/Object;)V

    iget-object p0, p0, Lzy7;->n0:Lq4e;

    sget-object p1, Lr25;->a:Lr25;

    invoke-virtual {p0, p3, p1}, Lq4e;->m(Ljava/lang/Object;Ljava/lang/Object;)Z
