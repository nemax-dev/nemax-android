...
.method public synthetic constructor <init>(Lcom/google/firebase/iid/FirebaseInstanceIdReceiver;Landroid/content/Intent;Landroid/content/Context;ZLandroid/content/BroadcastReceiver$PendingResult;)V
    ...
    iput-object p3, p0, Lhnf;->o:Ljava/lang/Object;

    iput-boolean p4, p0, Lhnf;->b:Z

    iput-object p5, p0, Lhnf;->X:Ljava/lang/Object;

    return-void
.end method

.method public constructor <init>(Linf;ZLjava/io/File;Lxm5;)V
    .locals 1
    ...
    iput-object p3, p0, Lhnf;->c:Ljava/lang/Object;

    iput-object p4, p0, Lhnf;->o:Ljava/lang/Object;
...
.method public final run()V
    ...
    iget-object v1, v0, Lhnf;->c:Ljava/lang/Object;

    check-cast v1, Landroid/content/Intent;

    iget-object v2, v0, Lhnf;->o:Ljava/lang/Object;

    check-cast v2, Landroid/content/Context;

    iget-boolean v3, v0, Lhnf;->b:Z
    ...
    invoke-direct {v0, v1}, Lr63;-><init>(Landroid/content/Intent;)V
    ...
    invoke-direct {v6, v10, v11}, Lts9;-><init>(Ljava/lang/String;I)V
    ...
    invoke-direct {v8, v2, v0, v7}, Ldm3;-><init>(Landroid/content/Context;Lr63;Ljava/util/concurrent/CountDownLatch;)V
    ...
    invoke-direct {v0, v2}, Lsyc;-><init>(Landroid/content/Context;)V

    invoke-virtual {v0, v1}, Lsyc;->H(Landroid/content/Intent;)Ly9h;

    move-result-object v0

    invoke-static {v0}, Lmee;->d(Lcom/google/android/gms/tasks/Task;)Ljava/lang/Object;
    ...
    :pswitch_0
    iget-object v1, v0, Lhnf;->o:Ljava/lang/Object;

    check-cast v1, Lxm5;

    iget-boolean v2, v0, Lhnf;->b:Z

    iget-object v3, v0, Lhnf;->X:Ljava/lang/Object;

    check-cast v3, Linf;

    iget-object v3, v3, Lnp4;->a:Ljava/io/File;

    if-eqz v2, :cond_8

    :try_start_8
    invoke-static {v3}, Lyue;->c(Ljava/io/File;)V
    ...
    invoke-static {v0, v4, v2}, Linf;->i(Ljava/io/File;BZ)V
    :try_end_8
    ...
    invoke-virtual {v1}, Lxm5;->close()V
