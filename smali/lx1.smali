...
.method public constructor <init>(Lew1;ILijd;Lpp6;Z)V
    .locals 1
...
.method public final a(Landroid/hardware/camera2/TotalCaptureResult;)Lwt7;
    ...
    invoke-static {p1, v0, v1}, Le5h;->G(Lwt7;Lvt;Ljava/util/concurrent/Executor;)Lb42;
    ...
    invoke-static {p1, v0, p0}, Le5h;->G(Lwt7;Lvt;Ljava/util/concurrent/Executor;)Lb42;
...
.method public final c()V
    ...
    iget-object v1, v0, Lew1;->j:Lebf;

    const/4 v2, 0x0

    const/4 v3, 0x0

    invoke-virtual {v1, v2, v3}, Lebf;->a(Lps1;Z)V

    iget-boolean p0, p0, Llx1;->f:Z

    if-eqz p0, :cond_0

    iget-object p0, v0, Lew1;->h:Lay5;

    const/4 v0, 0x1

    invoke-virtual {p0, v3, v0}, Lay5;->a(ZZ)V
