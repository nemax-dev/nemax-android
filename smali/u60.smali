...
.method public constructor <init>(Lm90;Landroid/content/Context;)V
    ...
    iput-object v0, p0, Lu60;->c:Ljava/util/concurrent/atomic/AtomicBoolean;

    new-instance v0, Ljava/util/concurrent/atomic/AtomicBoolean;

    invoke-direct {v0, v1}, Ljava/util/concurrent/atomic/AtomicBoolean;-><init>(Z)V

    iput-object v0, p0, Lu60;->d:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    iput-object v0, p0, Lu60;->e:Ljava/util/concurrent/atomic/AtomicReference;

    iput-boolean v1, p0, Lu60;->l:Z
    ...
    invoke-static {v0, p1, p2}, Lu60;->b(ILm90;Landroid/content/Context;)Landroid/media/AudioRecord;

    move-result-object p1

    iput-object p1, p0, Lu60;->a:Landroid/media/AudioRecord;
...
.method public static b(ILm90;Landroid/content/Context;)Landroid/media/AudioRecord;
    ...
    invoke-static {v2, p2}, Lmk;->c(Landroid/media/AudioRecord$Builder;Landroid/content/Context;)V
...
.method public final a()V
    ...
    iget-object p0, p0, Lu60;->c:Ljava/util/concurrent/atomic/AtomicBoolean;
...
.method public final c(Z)V
    ...
    iget-object v0, p0, Lu60;->i:Load;

    iget-object v1, p0, Lu60;->h:Lmqc;

    if-eqz v0, :cond_0

    if-eqz v1, :cond_0

    iget-object p0, p0, Lu60;->e:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    invoke-direct {p0, v1, p1, v2}, Lj60;-><init>(Ljava/lang/Object;ZI)V

    invoke-virtual {v0, p0}, Load;->execute(Ljava/lang/Runnable;)V
...
.method public final d()V
    ...
    invoke-virtual {p0}, Lu60;->a()V

    iget-object v0, p0, Lu60;->d:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    iget-object v2, p0, Lu60;->a:Landroid/media/AudioRecord;
    ...
    iput-wide v2, p0, Lu60;->j:J

    iput-boolean v4, p0, Lu60;->l:Z

    iget-object v0, p0, Lu60;->e:Ljava/util/concurrent/atomic/AtomicReference;

    const/4 v2, 0x0

    invoke-virtual {v0, v2}, Ljava/util/concurrent/atomic/AtomicReference;->set(Ljava/lang/Object;)V

    iget-object v0, p0, Lu60;->a:Landroid/media/AudioRecord;
    ...
    :goto_1
    invoke-virtual {p0, v1}, Lu60;->c(Z)V
    ...
    iget-object p0, p0, Lu60;->a:Landroid/media/AudioRecord;
...
.method public final read(Ljava/nio/ByteBuffer;)Lp90;
    ...
    iget-object v5, p0, Lu60;->a:Landroid/media/AudioRecord;
    ...
    iget-object v5, p0, Lu60;->b:Lm90;

    iget v5, v5, Lm90;->b:I

    iget-wide v7, p0, Lu60;->j:J
    ...
    invoke-static {v11, v9}, Lcr0;->e(Ljava/lang/String;Z)V
    ...
    invoke-static {v5, v7, v8}, Lis8;->t(IJ)J
    ...
    sget-wide v7, Lu60;->m:J

    cmp-long p1, v5, v7

    if-lez p1, :cond_4

    iput-boolean v10, p0, Lu60;->l:Z
    ...
    :cond_5
    iget-wide v3, p0, Lu60;->j:J

    int-to-long v5, v0

    iget p1, p0, Lu60;->g:I

    invoke-static {p1, v5, v6}, Lis8;->L(IJ)J

    move-result-wide v5

    add-long/2addr v5, v3

    iput-wide v5, p0, Lu60;->j:J
