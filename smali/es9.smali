...
.method public constructor <init>(Ljava/util/concurrent/ThreadFactory;)V
    ...
    sget-boolean p1, Lcyc;->a:Z

    invoke-virtual {v0, p1}, Ljava/util/concurrent/ScheduledThreadPoolExecutor;->setRemoveOnCancelPolicy(Z)V

    iput-object v0, p0, Les9;->a:Ljava/util/concurrent/ScheduledThreadPoolExecutor;
...
.method public final b(Ljava/lang/Runnable;)Lkp4;
    ...
    invoke-virtual {p0, p1, v0, v1, v2}, Les9;->c(Ljava/lang/Runnable;JLjava/util/concurrent/TimeUnit;)Lkp4;
...
.method public final e(Ljava/lang/Runnable;JLjava/util/concurrent/TimeUnit;Llp4;)Lywc;
    .locals 3

    new-instance v0, Lywc;

    invoke-direct {v0, p1, p5}, Lywc;-><init>(Ljava/lang/Runnable;Llp4;)V

    if-eqz p5, :cond_0

    invoke-interface {p5, v0}, Llp4;->a(Lkp4;)Z
    ...
    :goto_0
    invoke-virtual {v0, p0}, Lywc;->a(Ljava/util/concurrent/Future;)V
    :try_end_0
    ...
    invoke-interface {p5, v0}, Llp4;->b(Lkp4;)Z
