...
# instance fields
.field public final o0:Llme;

.field public final p0:Ljava/lang/Object;

.field public final q0:Ljava/lang/Object;

.field public final r0:Lik8;
...
.method static constructor <clinit>()V
    ...
    sput-object v1, Lkme;->y0:Ljava/util/ArrayList;
    ...
    sput-object v1, Lkme;->z0:Ljava/util/ArrayList;
...
.method public constructor <init>(Landroid/content/Context;Lbk8;)V
    ...
    invoke-direct {v0, v2, v1}, Ljxg;-><init>(ILjava/lang/Object;)V
    ...
    iput-object v0, p0, Lkme;->w0:Ljava/util/ArrayList;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, Lkme;->x0:Ljava/util/ArrayList;

    iput-object p2, p0, Lkme;->o0:Llme;
    ...
    iput-object p2, p0, Lkme;->p0:Ljava/lang/Object;
    ...
    invoke-direct {v1, v0}, Lkk8;-><init>(Lkme;)V

    iput-object v1, p0, Lkme;->q0:Ljava/lang/Object;

    new-instance v0, Lik8;

    invoke-direct {v0, p0}, Lik8;-><init>(Lhk8;)V

    iput-object v0, p0, Lkme;->r0:Lik8;

    invoke-virtual {p1}, Landroid/content/Context;->getResources()Landroid/content/res/Resources;

    move-result-object p1

    sget v0, Lv4c;->mr_user_route_category_name:I
    ...
    iput-object p1, p0, Lkme;->s0:Landroid/media/MediaRouter$RouteCategory;

    invoke-virtual {p0}, Lkme;->v()V

    return-void
.end method

.method public static n(Ljava/lang/Object;)Ljme;
    .locals 1
...
.method public final a(Landroid/media/MediaRouter$RouteInfo;I)V
    ...
    invoke-static {p1}, Lkme;->n(Ljava/lang/Object;)Ljme;

    move-result-object p0

    if-eqz p0, :cond_0

    iget-object p0, p0, Ljme;->a:Lek8;

    invoke-virtual {p0, p2}, Lek8;->j(I)V
...
.method public final b(Landroid/media/MediaRouter$RouteInfo;I)V
    ...
    invoke-virtual {p0, p2}, Lek8;->k(I)V
...
.method public final d(Ljava/lang/String;)Luj8;
    ...
    invoke-virtual {p0, p1}, Lkme;->k(Ljava/lang/String;)I

    move-result p1

    if-ltz p1, :cond_0

    iget-object p0, p0, Lkme;->w0:Ljava/util/ArrayList;
    ...
    iget-object p0, p0, Lime;->a:Ljava/lang/Object;

    invoke-direct {p1, p0}, Lhme;-><init>(Ljava/lang/Object;)V
...
.method public final f(Ldj8;)V
    ...
    iget-object v1, p1, Ldj8;->b:Lxj8;

    invoke-virtual {v1}, Lxj8;->b()Ljava/util/ArrayList;
    ...
    :goto_2
    iget v1, p0, Lkme;->t0:I

    if-ne v1, v0, :cond_5

    iget-boolean v1, p0, Lkme;->u0:Z
    ...
    :cond_5
    :goto_3
    iput v0, p0, Lkme;->t0:I

    iput-boolean p1, p0, Lkme;->u0:Z
...
.method public final i(Ljava/lang/Object;)Z
    ...
    invoke-virtual {p0, p1}, Lkme;->j(Ljava/lang/Object;)I

    move-result v0

    if-gez v0, :cond_5

    invoke-virtual {p0}, Lkme;->m()Landroid/media/MediaRouter$RouteInfo;
    ...
    :goto_1
    invoke-virtual {p0, v0}, Lkme;->k(Ljava/lang/String;)I
    ...
    invoke-virtual {p0, v4}, Lkme;->k(Ljava/lang/String;)I
    ...
    invoke-direct {v3, p1, v0}, Lime;-><init>(Ljava/lang/Object;Ljava/lang/String;)V
    ...
    :cond_3
    invoke-direct {v4, v0, v1}, Lifb;-><init>(Ljava/lang/String;Ljava/lang/String;)V

    invoke-virtual {p0, v3, v4}, Lkme;->o(Lime;Lifb;)V

    invoke-virtual {v4}, Lifb;->h()Lbj8;

    move-result-object p1

    iput-object p1, v3, Lime;->c:Lbj8;
...
.method public final j(Ljava/lang/Object;)I
    ...
    iget-object v2, v2, Lime;->a:Ljava/lang/Object;
...
.method public final k(Ljava/lang/String;)I
    ...
    iget-object v2, v2, Lime;->b:Ljava/lang/String;
...
.method public final l(Lek8;)I
    .locals 3

    iget-object p0, p0, Lkme;->x0:Ljava/util/ArrayList;
...
.method public o(Lime;Lifb;)V
    .locals 2

    iget-object p0, p2, Lifb;->a:Ljava/lang/Object;

    check-cast p0, Landroid/os/Bundle;

    iget-object p1, p1, Lime;->a:Ljava/lang/Object;
    ...
    sget-object v1, Lkme;->y0:Ljava/util/ArrayList;

    invoke-virtual {p2, v1}, Lifb;->g(Ljava/util/List;)V
    ...
    sget-object v0, Lkme;->z0:Ljava/util/ArrayList;

    invoke-virtual {p2, v0}, Lifb;->g(Ljava/util/List;)V
...
.method public final p(Lek8;)V
    ...
    iget-object v1, p0, Lkme;->p0:Ljava/lang/Object;

    if-eq v0, p0, :cond_0

    check-cast v1, Landroid/media/MediaRouter;

    iget-object v0, p0, Lkme;->s0:Landroid/media/MediaRouter$RouteCategory;
    ...
    invoke-direct {v2, p1, v0}, Ljme;-><init>(Lek8;Landroid/media/MediaRouter$UserRouteInfo;)V

    invoke-virtual {v0, v2}, Landroid/media/MediaRouter$RouteInfo;->setTag(Ljava/lang/Object;)V

    iget-object p1, p0, Lkme;->r0:Lik8;
    ...
    invoke-virtual {p0, v2}, Lkme;->w(Ljme;)V
    ...
    invoke-virtual {p0, v0}, Lkme;->j(Ljava/lang/Object;)I
    ...
    iget-object p0, p0, Lime;->b:Ljava/lang/String;

    iget-object v0, p1, Lek8;->b:Ljava/lang/String;
...
.method public final q(Lek8;)V
    ...
    invoke-virtual {p0, p1}, Lkme;->l(Lek8;)I

    move-result p1

    if-ltz p1, :cond_0

    iget-object v0, p0, Lkme;->x0:Ljava/util/ArrayList;
    ...
    iget-object p1, p1, Ljme;->b:Ljava/lang/Object;
    ...
    iget-object p0, p0, Lkme;->p0:Ljava/lang/Object;
...
.method public final r(Lek8;)V
    ...
    invoke-virtual {p0, p1}, Lkme;->t(Ljava/lang/Object;)V

    return-void

    :cond_1
    iget-object p1, p1, Lek8;->b:Ljava/lang/String;
    ...
    iget-object v0, p0, Lkme;->w0:Ljava/util/ArrayList;
...
.method public final s()V
    ...
    invoke-direct {v0, v2, v3}, Lwj8;-><init>(Ljava/util/ArrayList;Z)V
...
.method public final v()V
    ...
    invoke-virtual {p0}, Lkme;->u()V

    iget-object v0, p0, Lkme;->p0:Ljava/lang/Object;
    ...
    invoke-virtual {p0, v1}, Lkme;->i(Ljava/lang/Object;)Z
    ...
    invoke-virtual {p0}, Lkme;->s()V

    :cond_2
    return-void
.end method

.method public w(Ljme;)V
    .locals 2

    iget-object p0, p1, Ljme;->b:Ljava/lang/Object;

    iget-object v0, p1, Ljme;->a:Lek8;

    iget-object v1, v0, Lek8;->d:Ljava/lang/String;
