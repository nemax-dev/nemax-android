...
.method public constructor <init>(Landroid/content/Context;Lau3;)V
    ...
    invoke-direct {v1, p1}, Ljla;-><init>(Landroid/content/Context;)V

    invoke-direct {p0, v1}, Lrpc;-><init>(Landroid/view/View;)V

    iput-object p2, p0, Lwu3;->E0:Lau3;

    iput-object v0, p0, Lwu3;->F0:Lih0;
    ...
    invoke-virtual {v1, p1}, Ljla;->setLayoutParams(Landroid/view/ViewGroup$LayoutParams;)V

    new-instance p1, Lij1;

    const/4 p2, 0x1

    invoke-direct {p1, p2, p0}, Lij1;-><init>(ILjava/lang/Object;)V
