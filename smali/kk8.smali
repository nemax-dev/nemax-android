...
.method public final onRouteAdded(Landroid/media/MediaRouter;Landroid/media/MediaRouter$RouteInfo;)V
    ...
    iget-object p0, p0, Lkk8;->a:Lkme;

    invoke-virtual {p0, p2}, Lkme;->i(Ljava/lang/Object;)Z
...
.method public final onRouteChanged(Landroid/media/MediaRouter;Landroid/media/MediaRouter$RouteInfo;)V
    ...
    invoke-static {p2}, Lkme;->n(Ljava/lang/Object;)Ljme;

    move-result-object p1

    if-nez p1, :cond_1

    invoke-virtual {p0, p2}, Lkme;->j(Ljava/lang/Object;)I

    move-result p1

    if-ltz p1, :cond_1

    iget-object p2, p0, Lkme;->w0:Ljava/util/ArrayList;
    ...
    iget-object v0, p1, Lime;->b:Ljava/lang/String;

    iget-object v1, p1, Lime;->a:Ljava/lang/Object;
    ...
    :goto_0
    invoke-direct {p2, v0, v1}, Lifb;-><init>(Ljava/lang/String;Ljava/lang/String;)V

    invoke-virtual {p0, p1, p2}, Lkme;->o(Lime;Lifb;)V

    invoke-virtual {p2}, Lifb;->h()Lbj8;

    move-result-object p2

    iput-object p2, p1, Lime;->c:Lbj8;
...
.method public final onRoutePresentationDisplayChanged(Landroid/media/MediaRouter;Landroid/media/MediaRouter$RouteInfo;)V
    ...
    :goto_1
    iget-object v2, p1, Lime;->c:Lbj8;

    iget-object v2, v2, Lbj8;->a:Landroid/os/Bundle;
    ...
    iget-object v1, p1, Lime;->c:Lbj8;

    if-eqz v1, :cond_5

    new-instance v2, Landroid/os/Bundle;

    iget-object v4, v1, Lbj8;->a:Landroid/os/Bundle;

    invoke-direct {v2, v4}, Landroid/os/Bundle;-><init>(Landroid/os/Bundle;)V

    invoke-virtual {v1}, Lbj8;->b()Ljava/util/List;
    ...
    iget-object v5, v1, Lbj8;->c:Ljava/util/List;
    ...
    :cond_4
    new-instance p2, Lbj8;

    invoke-direct {p2, v2}, Lbj8;-><init>(Landroid/os/Bundle;)V
...
.method public final onRouteSelected(Landroid/media/MediaRouter;ILandroid/media/MediaRouter$RouteInfo;)V
    ...
    iget-object p1, p0, Lkme;->p0:Ljava/lang/Object;
    ...
    :cond_0
    invoke-static {p3}, Lkme;->n(Ljava/lang/Object;)Ljme;

    move-result-object p1

    if-eqz p1, :cond_1

    iget-object p0, p1, Ljme;->a:Lek8;
    ...
    :cond_1
    invoke-virtual {p0, p3}, Lkme;->j(Ljava/lang/Object;)I
    ...
    iget-object p0, p0, Lkme;->o0:Llme;

    iget-object p1, p1, Lime;->b:Ljava/lang/String;

    check-cast p0, Lbk8;

    iget-object p2, p0, Lbk8;->m:Lzj8;

    const/16 p3, 0x106

    invoke-virtual {p2, p3}, Landroid/os/Handler;->removeMessages(I)V

    iget-object p2, p0, Lbk8;->c:Lgme;

    invoke-virtual {p0, p2}, Lbk8;->d(Lvj8;)Ldk8;

    move-result-object p0

    if-eqz p0, :cond_2

    invoke-virtual {p0, p1}, Ldk8;->a(Ljava/lang/String;)Lek8;
...
.method public final onRouteVolumeChanged(Landroid/media/MediaRouter;Landroid/media/MediaRouter$RouteInfo;)V
    ...
    iget-object v0, p1, Lime;->c:Lbj8;

    iget-object v0, v0, Lbj8;->a:Landroid/os/Bundle;
    ...
    iget-object v3, v0, Lbj8;->a:Landroid/os/Bundle;

    invoke-direct {v2, v3}, Landroid/os/Bundle;-><init>(Landroid/os/Bundle;)V

    invoke-virtual {v0}, Lbj8;->b()Ljava/util/List;
    ...
    iget-object v5, v0, Lbj8;->c:Ljava/util/List;
    ...
    iget-object v0, v0, Lbj8;->c:Ljava/util/List;
