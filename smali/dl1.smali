...
.method public synthetic constructor <init>(Loz5;IILjava/util/ArrayList;)V
    .locals 0
...
.method public final run()V
    ...
    :try_start_1
    invoke-interface {v1, v5, v6}, Lgsc;->a(I[B)V
    :try_end_1
    ...
    iget-object p0, p0, Ltn8;->j:Ljava/lang/Object;
    ...
    invoke-virtual {p0, v0, v1, v5}, Leb4;->x(ILxm8;I)V
    ...
    :try_start_2
    iget-object v0, v6, Lmz6;->a:Ljava/lang/Object;
    ...
    invoke-direct {v0, v3}, Lled;-><init>(I)V
    ...
    invoke-virtual {v0}, Lled;->b()Landroid/os/Bundle;

    move-result-object v0

    invoke-interface {v1, p0, v5, v0}, Lcv6;->a(Lwu6;ILandroid/os/Bundle;)V
    :try_end_3
    ...
    iget-boolean v1, v0, Llq7;->d:Z

    if-nez v1, :cond_2

    if-eq v5, v3, :cond_3

    iget-object v1, v0, Llq7;->b:Lfp5;

    invoke-virtual {v1, v5}, Lfp5;->a(I)V
    ...
    invoke-interface {v6, v0}, Lhq7;->invoke(Ljava/lang/Object;)V
    ...
    iget-object v1, v0, Lkq7;->b:Lfp5;

    invoke-virtual {v1, v5}, Lfp5;->a(I)V

    :cond_5
    iput-boolean v4, v0, Lkq7;->c:Z

    iget-object v0, v0, Lkq7;->a:Ljava/lang/Object;

    invoke-interface {v6, v0}, Lgq7;->invoke(Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, v6, v5}, Le66;->b(Lorg/webrtc/Size;I)V
    ...
    iget-object v0, v0, Lmhf;->a:Lmv5;

    if-eqz v0, :cond_7

    iget-object v2, v0, Lmv5;->a:Ljava/lang/String;

    :cond_7
    iput-object v2, p0, Lzz5;->q0:Ljava/lang/String;
    ...
    iget-object p0, p0, Lru4;->b:Lxm8;

    invoke-interface {v6, v0, p0, v5}, Ltu4;->x(ILxm8;I)V
    ...
    invoke-interface {p0, v5, v6}, Lzjb;->i(ILjava/lang/Object;)V
    ...
    iget-object v0, p0, Lp94;->p0:Ljava/util/concurrent/atomic/AtomicInteger;

    invoke-virtual {v0}, Ljava/util/concurrent/atomic/AtomicInteger;->decrementAndGet()I

    iget-object v0, v6, Lorg/webrtc/EncodedImage;->buffer:Ljava/nio/ByteBuffer;

    iget-object v1, p0, Lp94;->r0:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    iget-object v1, p0, Lp94;->a:Lorg/webrtc/VpxDecoderWrapper;

    invoke-virtual {v1, v0}, Lorg/webrtc/VpxDecoderWrapper;->decode(Ljava/nio/ByteBuffer;)V

    :cond_8
    iget-object p0, p0, Lp94;->u0:Lmpg;
    ...
    invoke-virtual {p0, v5, v1, v0}, Ldd3;->a(IILandroid/content/Intent;)Z
    ...
    iget-object v0, v6, Ly7;->b:Ljava/lang/Object;

    iget-object v1, p0, Ldd3;->a:Ljava/util/LinkedHashMap;
    ...
    :cond_9
    iget-object v3, p0, Ldd3;->e:Ljava/util/LinkedHashMap;
    ...
    iget-object v2, p0, Ldd3;->g:Landroid/os/Bundle;

    invoke-virtual {v2, v1}, Landroid/os/Bundle;->remove(Ljava/lang/String;)V

    iget-object p0, p0, Ldd3;->f:Ljava/util/LinkedHashMap;
    ...
    iget-object p0, p0, Ldd3;->d:Ljava/util/ArrayList;
    ...
    invoke-interface {v2, v0}, Lx7;->r(Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, v5, v6}, Lkx1;->b(ILrx1;)V
    ...
    invoke-virtual {p0, v5, v6}, Lkx1;->c(ILwr3;)V
