...
.method public constructor <init>(Lxc8;)V
    ...
    sget-object v0, Lt84;->n:Lt84;

    invoke-direct {p0, v0}, Lbt7;-><init>(Lh5h;)V

    iput-object p1, p0, Lkhd;->X:Lxc8;

    new-instance p1, Lyh0;

    const/16 v0, 0x1b

    invoke-direct {p1, v0}, Lyh0;-><init>(I)V

    iput-object p1, p0, Lkhd;->Y:Lad6;
...
.method public final r(Lrpc;I)V
    ...
    iget-object p2, p1, Ljhd;->F0:Lone/me/sdk/uikit/common/views/OneMeDraweeView;

    iget-object v0, p0, Lghd;->r0:Landroid/net/Uri;

    iput-object p0, p1, Ljhd;->H0:Lghd;

    iget-object v1, p1, Ljhd;->I0:Landroid/net/Uri;

    iget-object v2, p0, Lghd;->o:Landroid/net/Uri;
    ...
    iget-object v1, p1, Ljhd;->J0:Landroid/net/Uri;
    ...
    :cond_0
    iput-object v2, p1, Ljhd;->I0:Landroid/net/Uri;

    iput-object v0, p1, Ljhd;->J0:Landroid/net/Uri;

    invoke-static {v2}, Lc37;->d(Landroid/net/Uri;)Lc37;

    move-result-object v1

    iput-boolean v3, v1, Lc37;->h:Z
    ...
    invoke-direct {v2, v4, v0}, Lcxa;-><init>(Landroid/content/Context;Landroid/net/Uri;)V
    ...
    invoke-virtual {p2, v0, v1}, Lone/me/sdk/uikit/common/views/OneMeDraweeView;->o(Lb37;Lb37;)V

    :cond_2
    iget-object p0, p0, Lghd;->a:Lux7;

    iget-object p0, p0, Lux7;->v0:Ltx7;

    sget-object p2, Ltx7;->o:Ltx7;
    ...
    :goto_0
    iget-object p0, p1, Ljhd;->G0:Landroidx/appcompat/widget/AppCompatImageView;
...
.method public final t(Landroid/view/ViewGroup;I)Lrpc;
    ...
    invoke-static {p1, v0}, Lsw3;->b(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-direct/range {v0 .. v5}, Ljhd;-><init>(Lxc8;Lone/me/sdk/uikit/common/views/OneMeDraweeView;Landroidx/appcompat/widget/AppCompatImageView;Landroidx/appcompat/widget/AppCompatImageView;Landroid/widget/FrameLayout;)V
