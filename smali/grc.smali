...
.method public constructor <init>(I)V
    ...
    iput-object v0, p0, Lgrc;->c:Landroid/graphics/Paint;

    const/4 v0, 0x0

    iput-boolean v0, p0, Lgrc;->o:Z
    ...
    iput-boolean v0, p0, Lgrc;->n0:Z

    new-instance v1, Landroid/graphics/Path;

    invoke-direct {v1}, Landroid/graphics/Path;-><init>()V

    iput-object v1, p0, Lgrc;->o0:Landroid/graphics/Path;

    new-instance v1, Landroid/graphics/Path;

    invoke-direct {v1}, Landroid/graphics/Path;-><init>()V

    iput-object v1, p0, Lgrc;->p0:Landroid/graphics/Path;

    iput v0, p0, Lgrc;->q0:I

    new-instance v0, Landroid/graphics/RectF;

    invoke-direct {v0}, Landroid/graphics/RectF;-><init>()V

    iput-object v0, p0, Lgrc;->r0:Landroid/graphics/RectF;

    const/16 v0, 0xff

    iput v0, p0, Lgrc;->s0:I

    iget v0, p0, Lgrc;->q0:I

    if-eq v0, p1, :cond_0

    iput p1, p0, Lgrc;->q0:I
...
.method public final d()V
    ...
    iget-object v0, p0, Lgrc;->o0:Landroid/graphics/Path;

    invoke-virtual {v0}, Landroid/graphics/Path;->reset()V

    iget-object v1, p0, Lgrc;->p0:Landroid/graphics/Path;
    ...
    iget-object v3, p0, Lgrc;->r0:Landroid/graphics/RectF;
    ...
    iget-boolean v2, p0, Lgrc;->o:Z

    iget-object v5, p0, Lgrc;->a:[F
...
.method public final draw(Landroid/graphics/Canvas;)V
    ...
    iget v1, p0, Lgrc;->s0:I

    invoke-static {v0, v1}, Lnoa;->B(II)I

    move-result v0

    iget-object v1, p0, Lgrc;->c:Landroid/graphics/Paint;
    ...
    iget v2, p0, Lgrc;->s0:I

    invoke-static {v0, v2}, Lnoa;->B(II)I
    ...
    iget-object p0, p0, Lgrc;->p0:Landroid/graphics/Path;
...
.method public final getOpacity()I
    ...
    invoke-static {v0, p0}, Lnoa;->B(II)I
...
.method public final setAlpha(I)V
    ...
    iget v0, p0, Lgrc;->s0:I

    if-eq p1, v0, :cond_0

    iput p1, p0, Lgrc;->s0:I
