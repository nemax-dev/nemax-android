...
# virtual methods
.method public final a(Lyte;)Lcue;
    .locals 3
...
.method public final b(Lu0g;)Lm61;
    .locals 5
    ...
    sget p0, Lrxb;->check_outline_16:I

    invoke-virtual {v3, v4}, Lqs9;->f(Landroid/content/Context;)Lyda;
    ...
    invoke-static {p0, v1, v4}, Lv44;->x(IILandroid/content/Context;)Landroid/graphics/drawable/Drawable;
    ...
    sget p0, Lzwb;->ic_connection_fill_16:I
    ...
    sget p0, Lrxb;->ic_microphone_off_fill_16:I
    ...
    invoke-static {v3, p1}, Lmh0;->g(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-direct {p1, p0, v2, v3}, Llo5;-><init>(Landroid/graphics/drawable/Drawable;Lfo5;I)V
...
.method public final c(Z)Landroid/text/SpannableStringBuilder;
    ...
    sget v0, Lp3c;->call_incoming_video_call:I
    ...
    :cond_1
    sget p1, Lp3c;->call_incoming_audio_call:I
    ...
    invoke-static {p0, p1}, Ldw3;->b(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-direct {p1, p0, v1, v2}, Llo5;-><init>(Landroid/graphics/drawable/Drawable;Lfo5;I)V
...
.method public final d(Ljava/lang/CharSequence;ZIZZZLgc5;)Landroid/text/SpannableStringBuilder;
    .locals 3
    ...
    instance-of v2, p7, Lcc5;

    if-nez v2, :cond_0

    instance-of v2, p7, Lec5;
    ...
    instance-of p4, p7, Lcc5;

    if-nez p4, :cond_3

    instance-of p4, p7, Lec5;
    ...
    sget p2, Lzwb;->ic_share_screen_20:I

    invoke-virtual {p5, p0}, Lqs9;->f(Landroid/content/Context;)Lyda;
    ...
    invoke-static {p2, p3, p0}, Lv44;->x(IILandroid/content/Context;)Landroid/graphics/drawable/Drawable;
    ...
    sget p2, Lzwb;->ic_microphone_disable_12:I
    ...
    invoke-virtual {p5, p0}, Lqs9;->c(Landroid/content/Context;)Lzs4;
    ...
    invoke-direct {p2, p0, p3, p5}, Lfxd;-><init>(Landroid/content/Context;Lnma;Lmf1;)V
    ...
    invoke-direct {p1, p0, v0, p3}, Llo5;-><init>(Landroid/graphics/drawable/Drawable;Lfo5;I)V
...
.method public final f(ZZZLgc5;)Ljava/lang/String;
    .locals 0
    ...
    instance-of p2, p4, Lcc5;

    if-nez p2, :cond_0

    instance-of p2, p4, Lec5;
    ...
    sget p1, Lp3c;->call_connecting:I
    ...
    :pswitch_0
    sget p1, Lp3c;->call_group_wait_admin:I
    ...
    :pswitch_1
    sget p1, Lp3c;->call_group_user_not_in_chat:I
    ...
    :pswitch_2
    sget p1, Lp3c;->call_group_was_removed_from_waiting_room:I
    ...
    :pswitch_3
    sget p1, Lp3c;->call_group_was_removed_from_call:I
    ...
    :pswitch_4
    sget p1, Lp3c;->call_opponent_failed_timout:I
    ...
    :pswitch_5
    sget p1, Lp3c;->call_opponent_unavailable_privacy:I
    ...
    :pswitch_6
    sget p1, Lp3c;->call_opponent_failed:I
    ...
    :pswitch_7
    sget p1, Lp3c;->call_opponent_unavailable_busy:I
    ...
    :pswitch_8
    sget p1, Lp3c;->call_opponent_unavailable:I
...
.method public final g(ZILjava/lang/CharSequence;ZZZZLgc5;)Landroid/text/SpannableStringBuilder;
    .locals 8
    ...
    invoke-static {p3, p4}, Lwde;->P0(Ljava/lang/CharSequence;[C)Ljava/util/List;
    ...
    :goto_2
    invoke-virtual/range {v0 .. v7}, Lzo1;->d(Ljava/lang/CharSequence;ZIZZZLgc5;)Landroid/text/SpannableStringBuilder;
...
.method public final h()Lms7;
    ...
    invoke-direct {v0, v1, v2, p0}, Lms7;-><init>(IILandroid/content/Context;)V
