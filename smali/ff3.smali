...
# static fields
.field public static final d:Ldf3;

.field public static final e:Lj2d;

.field public static final f:I

.field public static final g:Lef3;
...
.method static constructor <clinit>()V
    ...
    invoke-direct {v1, v3}, Lj2d;-><init>(Ljava/lang/String;)V

    invoke-direct {v0, v1}, Lzw9;-><init>(Ljava/util/concurrent/ThreadFactory;)V

    sput-object v0, Lff3;->g:Lef3;
    ...
    invoke-direct {v3, v4, v0, v1}, Lj2d;-><init>(Ljava/lang/String;IZ)V

    sput-object v3, Lff3;->e:Lj2d;

    new-instance v0, Ldf3;

    invoke-direct {v0, v2, v3}, Ldf3;-><init>(ILjava/util/concurrent/ThreadFactory;)V

    sput-object v0, Lff3;->d:Ldf3;

    iget-object v0, v0, Ldf3;->b:[Lef3;
...
.method public constructor <init>()V
    ...
    sget-object v1, Lff3;->d:Ldf3;

    invoke-direct {v0, v1}, Ljava/util/concurrent/atomic/AtomicReference;-><init>(Ljava/lang/Object;)V

    iput-object v0, p0, Lff3;->c:Ljava/util/concurrent/atomic/AtomicReference;

    new-instance p0, Ldf3;

    sget v2, Lff3;->f:I

    sget-object v3, Lff3;->e:Lj2d;

    invoke-direct {p0, v2, v3}, Ldf3;-><init>(ILjava/util/concurrent/ThreadFactory;)V
...
.method public final a()Lm6d;
    ...
    iget-object p0, p0, Lff3;->c:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    invoke-virtual {p0}, Ldf3;->a()Lef3;

    move-result-object p0

    invoke-direct {v0, p0}, Lcf3;-><init>(Lef3;)V
...
.method public final c(Ljava/lang/Runnable;JLjava/util/concurrent/TimeUnit;)Lvq4;
    ...
    iget-object p0, p0, Lzw9;->a:Ljava/util/concurrent/ScheduledThreadPoolExecutor;
...
.method public final d(Ljava/lang/Runnable;JJLjava/util/concurrent/TimeUnit;)Lvq4;
    .locals 7
    ...
    iget-object v0, p0, Lzw9;->a:Ljava/util/concurrent/ScheduledThreadPoolExecutor;
    ...
    invoke-direct {p0, p1, v0}, Lia7;-><init>(Ljava/lang/Runnable;Ljava/util/concurrent/ScheduledExecutorService;)V
    ...
    :goto_0
    invoke-virtual {p0, p1}, Lia7;->a(Ljava/util/concurrent/Future;)V
    :try_end_0
    .catch Ljava/util/concurrent/RejectedExecutionException; {:try_start_0 .. :try_end_0} :catch_0
