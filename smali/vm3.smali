...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    invoke-direct {v3, v1, v0, v4}, Ltm3;-><init>(Landroid/content/Context;Lvm3;I)V
    ...
    iput-object v3, v0, Lvm3;->E0:Ljava/lang/Object;

    new-instance v3, Ltm3;

    const/4 v5, 0x1

    invoke-direct {v3, v1, v0, v5}, Ltm3;-><init>(Landroid/content/Context;Lvm3;I)V

    invoke-static {v4, v3}, Lltg;->s(ILd96;)Lth7;

    move-result-object v3

    iput-object v3, v0, Lvm3;->F0:Ljava/lang/Object;
    ...
    iput-object v3, v0, Lvm3;->G0:Ljava/lang/Object;

    const-wide v5, 0x7fffffffffffffffL

    iput-wide v5, v0, Lvm3;->M0:J
    ...
    invoke-direct {v3, v5, v6}, Lll3;-><init>(II)V
    ...
    invoke-direct {v0}, Lvm3;->getBackgroundDrawable()Landroid/graphics/drawable/RippleDrawable;
    ...
    invoke-direct {v5, v0, v7}, Lum3;-><init>(Lvm3;I)V

    invoke-static {v0, v5}, Laug;->y(Landroid/view/View;Landroid/view/View$OnClickListener;)V

    new-instance v5, Ld7a;

    invoke-direct {v5, v1}, Ld7a;-><init>(Landroid/content/Context;)V

    sget v7, Lpsc;->s:I

    invoke-virtual {v5, v7}, Landroid/view/View;->setId(I)V

    sget-object v7, Lu6a;->a:Lu6a;

    invoke-virtual {v5, v7}, Ld7a;->setAvatarShape(Lx6a;)V

    iput-object v5, v0, Lvm3;->B0:Ld7a;
    ...
    invoke-direct {v0}, Lvm3;->getTitleText()I
    ...
    iput-object v7, v0, Lvm3;->C0:Landroid/widget/TextView;
    ...
    sget-object v12, Lxbf;->n:Leue;

    invoke-static {v12, v11}, Leue;->d(Leue;Landroid/widget/TextView;)V

    invoke-direct {v0}, Lvm3;->getDescriptionColor()I
    ...
    sget v9, La1c;->oneme_theme_textview_for_span_attach_listener:I
    ...
    invoke-static {v11}, Lu77;->x(Landroid/view/View;)Ljava/lang/String;
    ...
    invoke-static {v9, v2}, Lz76;->M(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {v2, v11}, Lwj;->onViewAttachedToWindow(Landroid/view/View;)V

    :cond_2
    invoke-virtual {v11, v2}, Landroid/view/View;->addOnAttachStateChangeListener(Landroid/view/View$OnAttachStateChangeListener;)V

    :goto_0
    iput-object v11, v0, Lvm3;->D0:Landroid/widget/TextView;
    ...
    iput-object v2, v0, Lvm3;->H0:Landroid/view/ViewStub;
    ...
    iput-object v9, v0, Lvm3;->I0:Landroid/view/ViewStub;
    ...
    iput-object v12, v0, Lvm3;->J0:Landroid/view/ViewStub;
    ...
    invoke-virtual {v1, v6, v4, v10, v4}, Lul3;->d(IIII)V

    const/4 v13, 0x6

    invoke-virtual {v1, v6, v13, v10, v13}, Lul3;->d(IIII)V

    const/4 v14, 0x4

    invoke-virtual {v1, v6, v14, v10, v14}, Lul3;->d(IIII)V
    ...
    invoke-virtual {v1, v6, v4, v15, v4}, Lul3;->d(IIII)V
    ...
    invoke-virtual {v1, v6, v13, v15, v10}, Lul3;->d(IIII)V

    new-instance v15, Le4a;

    const/4 v8, 0x5

    invoke-direct {v15, v1, v13, v6, v8}, Le4a;-><init>(Ljava/lang/Object;III)V
    ...
    invoke-virtual {v15, v3}, Le4a;->e(I)V

    invoke-virtual {v2}, Landroid/view/View;->getId()I

    move-result v3

    invoke-virtual {v1, v6, v10, v3, v13}, Lul3;->d(IIII)V

    new-instance v3, Le4a;

    const/4 v8, 0x5

    invoke-direct {v3, v1, v10, v6, v8}, Le4a;-><init>(Ljava/lang/Object;III)V
    ...
    invoke-virtual {v3, v15}, Le4a;->e(I)V

    invoke-virtual {v11}, Landroid/view/View;->getId()I

    move-result v3

    invoke-virtual {v1, v6, v14, v3, v4}, Lul3;->d(IIII)V
    ...
    invoke-virtual {v1, v3, v4, v6, v14}, Lul3;->d(IIII)V

    new-instance v6, Le4a;

    const/4 v11, 0x5

    invoke-direct {v6, v1, v4, v3, v11}, Le4a;-><init>(Ljava/lang/Object;III)V
    ...
    invoke-virtual {v1, v3, v13, v6, v13}, Lul3;->d(IIII)V

    invoke-virtual {v7}, Landroid/view/View;->getId()I

    move-result v6

    invoke-virtual {v1, v3, v10, v6, v10}, Lul3;->d(IIII)V

    invoke-virtual {v5}, Landroid/view/View;->getId()I

    move-result v5

    invoke-virtual {v1, v3, v14, v5, v14}, Lul3;->d(IIII)V

    invoke-virtual {v1, v3}, Lul3;->g(I)Lpl3;
    ...
    invoke-virtual {v1, v2, v10, v5, v13}, Lul3;->d(IIII)V

    new-instance v5, Le4a;

    const/4 v6, 0x5

    invoke-direct {v5, v1, v10, v2, v6}, Le4a;-><init>(Ljava/lang/Object;III)V
    ...
    invoke-static {v8, v6, v5}, Ldw1;->q(FFLe4a;)V

    invoke-virtual {v1, v2, v14, v3, v14}, Lul3;->d(IIII)V
    ...
    invoke-virtual {v1, v2, v10, v3, v10}, Lul3;->d(IIII)V
...
.method private final getAudioCallButton()Landroid/widget/ImageView;
    ...
    iget-object p0, p0, Lvm3;->F0:Ljava/lang/Object;
...
.method private final getTimeTextView()Landroid/widget/TextView;
    ...
    iget-object p0, p0, Lvm3;->E0:Ljava/lang/Object;
...
.method private final getVideoCallButton()Landroid/widget/ImageView;
    ...
    iget-object p0, p0, Lvm3;->G0:Ljava/lang/Object;
...
.method public static u(Landroid/content/Context;Lvm3;)Landroid/widget/ImageView;
    .locals 5
    ...
    invoke-static {v2, v3, v0}, Ldl5;->o(FFLandroid/widget/ImageView;)V

    invoke-direct {p1}, Lvm3;->getRippleDrawableButton()Landroid/graphics/drawable/RippleDrawable;
    ...
    invoke-direct {p0, p1, v1}, Lum3;-><init>(Lvm3;I)V
...
.method public static v(Landroid/content/Context;Lvm3;)Landroid/widget/TextView;
    .locals 2
    ...
    invoke-direct {p1}, Lvm3;->getDescriptionColor()I
...
.method public static w(Landroid/content/Context;Lvm3;)Landroid/widget/ImageView;
    .locals 5
...
.method public final B(Z)V
    ...
    iput-boolean p1, p0, Lvm3;->L0:Z

    iget-object p1, p0, Lvm3;->C0:Landroid/widget/TextView;

    invoke-direct {p0}, Lvm3;->getTitleText()I
...
.method public final C(JLjava/lang/CharSequence;Ljava/lang/String;)V
    ...
    :cond_1
    iget-object p0, p0, Lvm3;->B0:Ld7a;
...
.method public final onThemeChanged(Lnma;)V
    ...
    iget-object v0, p0, Lvm3;->C0:Landroid/widget/TextView;
    ...
    invoke-direct {p0}, Lvm3;->getTimeTextView()Landroid/widget/TextView;

    move-result-object v0

    invoke-direct {p0}, Lvm3;->getDescriptionColor()I

    move-result v1

    invoke-virtual {v0, v1}, Landroid/widget/TextView;->setTextColor(I)V

    iget-object v0, p0, Lvm3;->D0:Landroid/widget/TextView;
    ...
    invoke-direct {p0}, Lvm3;->getAudioCallButton()Landroid/widget/ImageView;

    move-result-object v0

    invoke-direct {p0}, Lvm3;->getRippleDrawableButton()Landroid/graphics/drawable/RippleDrawable;

    move-result-object v1

    invoke-virtual {v0, v1}, Landroid/view/View;->setBackground(Landroid/graphics/drawable/Drawable;)V

    invoke-direct {p0}, Lvm3;->getVideoCallButton()Landroid/widget/ImageView;
    ...
    invoke-direct {p0}, Lvm3;->getBackgroundDrawable()Landroid/graphics/drawable/RippleDrawable;
...
.method public final setAvatarOverlay(Lee0;)V
    ...
    invoke-virtual {p0, p1}, Ld7a;->setCustomOverlay(Lee0;)V
...
.method public final setAvatarPlaceholder(Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-static {p0, p1, v0}, Ld7a;->n(Ld7a;Landroid/graphics/drawable/Drawable;I)V
...
.method public final setDescription(Ljava/lang/CharSequence;)V
    ...
    iget-object p0, p0, Lvm3;->D0:Landroid/widget/TextView;
...
.method public final setTime(Ljava/lang/CharSequence;)V
    ...
    iget-object v0, p0, Lvm3;->H0:Landroid/view/ViewStub;
...
.method public final setTitle(Ljava/lang/CharSequence;)V
    ...
    iget-object p0, p0, Lvm3;->C0:Landroid/widget/TextView;
...
.method public final x(Z)V
    ...
    iget-object v0, p0, Lvm3;->I0:Landroid/view/ViewStub;
...
.method public final y(Z)V
    ...
    iget-object v0, p0, Lvm3;->J0:Landroid/view/ViewStub;
