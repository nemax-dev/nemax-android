...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lq0e;->Z:Ljava/util/regex/Pattern;
...
.method public constructor <init>(Ljava/util/List;)V
    ...
    invoke-static {v0}, Lfif;->p([B)Ljava/lang/String;
    ...
    invoke-static {v0}, Lne;->c(Ljava/lang/String;)Lne;

    move-result-object v0

    invoke-virtual {v0}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    iput-object v0, p0, Lq0e;->b:Lne;
    ...
    invoke-virtual {p0, v0, p1}, Lq0e;->b(Lfsa;Ljava/nio/charset/Charset;)V

    return-void

    :cond_0
    iput-boolean v0, p0, Lq0e;->a:Z

    const/4 p1, 0x0

    iput-object p1, p0, Lq0e;->b:Lne;
...
.method public static c(Ljava/lang/String;)J
    ...
    sget-object v0, Lq0e;->Z:Ljava/util/regex/Pattern;
...
.method public final G([BIILmfe;Lfm3;)V
    ...
    iget-object v9, v0, Lq0e;->c:Lfsa;

    move-object/from16 v10, p1

    invoke-virtual {v9, v8, v10}, Lfsa;->E(I[B)V

    invoke-virtual {v9, v1}, Lfsa;->G(I)V

    invoke-virtual {v9}, Lfsa;->C()Ljava/nio/charset/Charset;
    ...
    :goto_0
    iget-boolean v8, v0, Lq0e;->a:Z

    if-nez v8, :cond_1

    invoke-virtual {v0, v9, v1}, Lq0e;->b(Lfsa;Ljava/nio/charset/Charset;)V

    :cond_1
    if-eqz v8, :cond_2

    iget-object v8, v0, Lq0e;->b:Lne;
    ...
    :goto_1
    invoke-virtual {v9, v1}, Lfsa;->h(Ljava/nio/charset/Charset;)Ljava/lang/String;
    ...
    invoke-static {v11}, Lne;->c(Ljava/lang/String;)Lne;
    ...
    invoke-static {v10}, Lve2;->f0(Ljava/lang/String;)V
    ...
    invoke-static {v10}, Lq0e;->c(Ljava/lang/String;)J
    ...
    :cond_8
    iget-object v10, v0, Lq0e;->o:Ljava/util/LinkedHashMap;
    ...
    sget-object v13, Lu0e;->a:Ljava/util/regex/Pattern;
    ...
    :try_start_0
    invoke-static {v1}, Lu0e;->a(Ljava/lang/String;)Landroid/graphics/PointF;
    ...
    :cond_a
    :try_start_1
    sget-object v13, Lu0e;->d:Ljava/util/regex/Pattern;
    ...
    invoke-static {v1}, Lw0e;->a(Ljava/lang/String;)I
    ...
    sget-object v1, Lu0e;->a:Ljava/util/regex/Pattern;
    ...
    iget v11, v0, Lq0e;->X:F

    iget v12, v0, Lq0e;->Y:F
    ...
    iget-boolean v1, v10, Lw0e;->g:Z

    iget-object v0, v10, Lw0e;->d:Ljava/lang/Integer;

    move-object/from16 v23, v0

    iget-object v0, v10, Lw0e;->c:Ljava/lang/Integer;
    ...
    :pswitch_0
    invoke-static {v0, v8}, Lw68;->q(ILjava/lang/String;)V
    ...
    invoke-direct/range {v21 .. v38}, Lw34;-><init>(Ljava/lang/CharSequence;Landroid/text/Layout$Alignment;Landroid/text/Layout$Alignment;Landroid/graphics/Bitmap;FIIFIIFFFZIIF)V

    move-object/from16 v0, v21

    invoke-static {v14, v15, v7, v6}, Lq0e;->a(JLjava/util/ArrayList;Ljava/util/ArrayList;)I

    move-result v1

    invoke-static {v4, v5, v7, v6}, Lq0e;->a(JLjava/util/ArrayList;Ljava/util/ArrayList;)I
    ...
    new-instance v19, Lz34;

    invoke-direct/range {v19 .. v24}, Lz34;-><init>(JJLjava/util/List;)V
    ...
    invoke-interface {v3, v1}, Lfm3;->accept(Ljava/lang/Object;)V
...
.method public final b(Lfsa;Ljava/nio/charset/Charset;)V
    .locals 26
    ...
    :cond_0
    :goto_0
    invoke-virtual/range {p1 .. p2}, Lfsa;->h(Ljava/nio/charset/Charset;)Ljava/lang/String;
    ...
    invoke-virtual/range {p1 .. p1}, Lfsa;->a()I

    move-result v2

    if-eqz v2, :cond_1

    invoke-virtual/range {p1 .. p2}, Lfsa;->c(Ljava/nio/charset/Charset;)C
    ...
    invoke-static {v13}, Ly84;->O(Ljava/lang/String;)Ljava/lang/String;
    ...
    new-instance v13, Ls0e;

    array-length v0, v8

    move/from16 v24, v0

    invoke-direct/range {v13 .. v24}, Ls0e;-><init>(IIIIIIIIIII)V
    ...
    invoke-static {v12, v13, v10, v0, v11}, Lmh0;->j(Ljava/lang/String;ILjava/lang/String;ILjava/lang/String;)Ljava/lang/StringBuilder;
    ...
    invoke-static {v0}, Lw0e;->a(Ljava/lang/String;)I
    ...
    invoke-static {v0}, Lw0e;->c(Ljava/lang/String;)Ljava/lang/Integer;
    ...
    invoke-static {v0}, Lw0e;->b(Ljava/lang/String;)Z
    ...
    invoke-direct/range {v15 .. v25}, Lw0e;-><init>(Ljava/lang/String;ILjava/lang/Integer;Ljava/lang/Integer;FZZZZI)V
    :try_end_5
    ...
    iget-object v0, v15, Lw0e;->a:Ljava/lang/String;
    ...
    :cond_21
    iput-object v2, v1, Lq0e;->o:Ljava/util/LinkedHashMap;
