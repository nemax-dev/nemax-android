...
.method public constructor <init>(Landroid/media/MediaCodec;Landroid/os/HandlerThread;Landroid/os/HandlerThread;)V
    ...
    iput-object p1, p0, Lpx;->a:Landroid/media/MediaCodec;

    new-instance v0, Lwx;

    invoke-direct {v0, p2}, Lwx;-><init>(Landroid/os/HandlerThread;)V

    iput-object v0, p0, Lpx;->b:Lwx;

    new-instance p2, Lux;

    invoke-direct {p2, p1, p3}, Lux;-><init>(Landroid/media/MediaCodec;Landroid/os/HandlerThread;)V

    iput-object p2, p0, Lpx;->c:Lux;
...
.method public static b(Lpx;Landroid/media/MediaFormat;Landroid/view/Surface;Landroid/media/MediaCrypto;)V
    .locals 6

    iget-object v0, p0, Lpx;->b:Lwx;

    iget-object v1, p0, Lpx;->a:Landroid/media/MediaCodec;
    ...
    iget-object p1, p0, Lpx;->c:Lux;

    iget-object p2, p1, Lux;->b:Landroid/os/HandlerThread;

    iget-boolean p3, p1, Lux;->f:Z
    ...
    invoke-direct {p3, p1, p2, v0}, Lrx;-><init>(Ljava/lang/Object;Landroid/os/Looper;I)V

    iput-object p3, p1, Lux;->c:Lrx;

    iput-boolean v5, p1, Lux;->f:Z
...
.method public final a(JIII)V
    ...
    iget-object p0, p0, Lpx;->c:Lux;

    iget-object v0, p0, Lux;->d:Ljava/util/concurrent/atomic/AtomicReference;
...
.method public final d(IJ)V
    ...
    iget-object p0, p0, Lpx;->a:Landroid/media/MediaCodec;
...
.method public final f()I
    ...
    :cond_2
    iget-object v1, p0, Lwx;->m:Ljava/lang/IllegalStateException;
    ...
    :cond_5
    iput-object v5, p0, Lwx;->j:Landroid/media/MediaCodec$CodecException;

    throw v1

    :cond_6
    iput-object v5, p0, Lwx;->m:Ljava/lang/IllegalStateException;
...
.method public final flush()V
    ...
    iget-object v0, p0, Lpx;->c:Lux;

    invoke-virtual {v0}, Lux;->a()V

    iget-object v0, p0, Lpx;->a:Landroid/media/MediaCodec;
    ...
    invoke-virtual {p0, v1}, Lwx;->a(Landroid/media/MediaCodec;)V
    ...
    :cond_0
    invoke-virtual {p0, v0}, Lwx;->a(Landroid/media/MediaCodec;)V
...
.method public final i(Landroid/media/MediaCodec$BufferInfo;)I
    ...
    :cond_2
    iget-object v0, p0, Lwx;->m:Ljava/lang/IllegalStateException;
    ...
    :cond_4
    invoke-virtual {v0}, Lky;->g()I

    move-result v0

    if-ltz v0, :cond_5

    iget-object v2, p0, Lwx;->h:Landroid/media/MediaFormat;
...
.method public final l(ILp34;J)V
    .locals 4
    ...
    iget-object p4, p2, Lp34;->d:Ljava/lang/Object;
    ...
    iget-object p4, p2, Lp34;->e:Ljava/lang/Object;
    ...
    iget-object p4, p2, Lp34;->b:Ljava/lang/Object;
...
.method public final n(Lwb8;Landroid/os/Handler;)V
    .locals 2
    ...
    invoke-direct {v0, p0, p1, v1}, Lmx;-><init>(Lwa8;Lwb8;I)V
...
.method public final release()V
    ...
    iget-object v1, p0, Lpx;->c:Lux;

    iget-boolean v2, v1, Lux;->f:Z

    if-eqz v2, :cond_0

    invoke-virtual {v1}, Lux;->a()V

    iget-object v2, v1, Lux;->b:Landroid/os/HandlerThread;
    ...
    iput-boolean v2, v1, Lux;->f:Z

    iget-object v1, p0, Lpx;->b:Lwx;
    ...
    :try_start_1
    iput-boolean v0, v1, Lwx;->l:Z

    iget-object v3, v1, Lwx;->b:Landroid/os/HandlerThread;
    ...
    iput-boolean v0, p0, Lpx;->X:Z

    :cond_2
    return-void

    :goto_1
    iget-boolean v2, p0, Lpx;->X:Z

    if-nez v2, :cond_3

    iget-object v2, p0, Lpx;->a:Landroid/media/MediaCodec;
