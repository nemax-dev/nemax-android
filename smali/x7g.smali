...
.method public static b(Landroid/view/View;Lwvg;Landroid/graphics/Rect;)Lwvg;
    .locals 1
...
.method public static j(Landroid/view/View;)Lwvg;
    .locals 7

    sget-boolean v0, Lkvg;->d:Z
    ...
    :try_start_0
    sget-object v2, Lkvg;->a:Ljava/lang/reflect/Field;
    ...
    sget-object v2, Lkvg;->b:Ljava/lang/reflect/Field;
    ...
    sget-object v3, Lkvg;->c:Ljava/lang/reflect/Field;
    ...
    invoke-static {v4, v5, v6, v2}, Laa7;->b(IIII)Laa7;

    move-result-object v2

    invoke-virtual {v3, v2}, Llvg;->i(Laa7;)V
    ...
    invoke-static {v2, v4, v5, v0}, Laa7;->b(IIII)Laa7;

    move-result-object v0

    invoke-virtual {v3, v0}, Llvg;->f(Laa7;)V

    invoke-virtual {v3}, Llvg;->b()Lwvg;

    move-result-object v0

    iget-object v2, v0, Lwvg;->a:Luvg;

    invoke-virtual {v2, v0}, Luvg;->q(Lwvg;)V
    ...
    invoke-virtual {v2, p0}, Luvg;->d(Landroid/view/View;)V
    :try_end_0
...
.method public static u(Landroid/view/View;Lq9a;)V
    .locals 2
    ...
    invoke-direct {v0, p0, p1}, Lw7g;-><init>(Landroid/view/View;Lq9a;)V
