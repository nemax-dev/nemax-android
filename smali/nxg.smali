...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0, v1}, Lpie;-><init>(Ljava/lang/String;)V

    sput-object v0, Lnxg;->e:Lpie;
    ...
    sput-object v0, Lnxg;->f:Landroid/content/Intent;

    return-void
.end method

.method public constructor <init>(Landroid/content/Context;Lsxg;)V
    .locals 5
    ...
    iput-object p1, p0, Lnxg;->c:Landroid/content/Context;

    iput-object p2, p0, Lnxg;->d:Lsxg;

    sget-object p2, Lssg;->a:Lpie;
    ...
    :cond_4
    sget-object v0, Lnxg;->e:Lpie;

    sget-object v1, Lnxg;->f:Landroid/content/Intent;

    invoke-direct {p2, p1, v0, v1}, Lgyg;-><init>(Landroid/content/Context;Lpie;Landroid/content/Intent;)V

    iput-object p2, p0, Lnxg;->a:Lgyg;

    return-void

    :cond_5
    :goto_2
    sget-object p0, Lssg;->a:Lpie;
    ...
    invoke-static {p0, p2, p1}, Lpie;->f(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/String;
...
.method public static a(Lnxg;Ljava/lang/String;)Landroid/os/Bundle;
    .locals 10
    ...
    sget-object v3, Lwvg;->a:Ljava/util/HashMap;
    ...
    :try_start_0
    sget-object v4, Lwvg;->a:Ljava/util/HashMap;
    ...
    :try_start_1
    iget-object v1, p0, Lnxg;->c:Landroid/content/Context;

    invoke-virtual {v1}, Landroid/content/Context;->getPackageName()Ljava/lang/String;

    move-result-object v1

    iget-object p0, p0, Lnxg;->c:Landroid/content/Context;
    ...
    invoke-static {p0, v1, p1}, Lpie;->f(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/String;
