...
# direct methods
.method public constructor <init>(Lqdf;Lus;)V
    .locals 0

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Lgc5;->b:Lqdf;

    iput-object p2, p0, Lgc5;->a:Lus;
...
.method public final H0(Landroidx/media3/common/PlaybackException;)V
    ...
    :cond_0
    sget-object v0, Landroidx/media3/transformer/ExportException;->b:Lcrc;
    ...
    invoke-virtual {v0, v1}, Lcrc;->get(Ljava/lang/Object;)Ljava/lang/Object;
...
.method public final c0(Ludf;)V
    ...
    iget-object v0, p0, Lgc5;->a:Lus;

    const/4 v1, 0x1

    :try_start_0
    invoke-virtual {p1, v1}, Ludf;->a(I)Z

    move-result v2

    const/4 v3, 0x2

    invoke-virtual {p1, v3}, Ludf;->a(I)Z
    ...
    invoke-static {v4, v5}, Ld22;->j(ILjava/lang/String;)V
    :try_end_0
    ...
    invoke-static {v2, p0}, Ll58;->z(Landroid/content/Context;Lpi8;)Ljava/lang/String;
...
.method public final k0(Lq7f;I)V
    ...
    iget-boolean p1, v0, Lo7f;->k:Z

    if-nez p1, :cond_3

    iget-wide v0, v0, Lo7f;->m:J
