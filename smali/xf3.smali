...
.method public final uncaughtException(Ljava/lang/Thread;Ljava/lang/Throwable;)V
    ...
    sget-object p0, Lbr6;->a:Lbr6;

    sget-boolean p0, Lnbf;->b:Z
    ...
    :cond_0
    sget-object p0, Lbr6;->c:Landroid/content/Context;
    ...
    :cond_1
    sget-object p1, Lbr6;->b:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    :goto_1
    iget-object p1, p1, Lip8;->c:Ljava/lang/Object;
    ...
    invoke-static {v1, v3, v4, p2}, Lkne;->Y(Ljava/lang/String;CCZ)Ljava/lang/String;
    ...
    invoke-static {v1, p2}, Llp5;->R(Ljava/io/File;Ljava/lang/String;)Ljava/io/File;
    ...
    :catch_0
    invoke-static {p0}, Lbr6;->a(Ljava/io/File;)V

    invoke-static {p2}, Lbr6;->a(Ljava/io/File;)V

    :goto_3
    const-string p1, "dump.hprof"

    invoke-static {v1, p1}, Llp5;->R(Ljava/io/File;Ljava/lang/String;)Ljava/io/File;
    ...
    invoke-static {p1}, Lpod;->m(Ljava/io/File;)V
    ...
    :cond_6
    invoke-static {p0, p1}, Lpod;->T(Ljava/io/File;Ljava/io/File;)V

    invoke-static {p2, v0}, Lpod;->T(Ljava/io/File;Ljava/io/File;)V
    :try_end_1
    ...
    :catch_1
    invoke-static {p1}, Lbr6;->a(Ljava/io/File;)V
