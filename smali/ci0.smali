...
.method public final getImageInfo()La27;
    ...
    invoke-interface {p0}, Ll63;->getWidth()I

    move-result v2

    invoke-interface {p0}, Ll63;->getHeight()I

    move-result v3

    invoke-interface {p0}, Ll63;->getSizeInBytes()I

    move-result v4

    invoke-virtual {p0}, Lci0;->getQualityInfo()La1c;

    move-result-object v5

    iget-object v6, p0, Lci0;->a:Ljava/util/HashMap;

    invoke-direct/range {v1 .. v6}, Lcom/facebook/imagepipeline/image/ImageInfoImpl;-><init>(IIILa1c;Ljava/util/Map;)V
...
.method public getQualityInfo()La1c;
    .locals 0

    sget-object p0, Ln47;->d:Ln47;
