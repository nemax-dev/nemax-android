...
.field private mSession2Token:Lekf;
...
.method public constructor <init>(Ljava/lang/Object;)V
    ...
    .line 1
    invoke-direct {p0, p1, v0, v0}, Landroid/support/v4/media/session/MediaSessionCompat$Token;-><init>(Ljava/lang/Object;Landroid/support/v4/media/session/IMediaSession;Lekf;)V
...
.method public constructor <init>(Ljava/lang/Object;Landroid/support/v4/media/session/IMediaSession;)V
    ...
    .line 2
    invoke-direct {p0, p1, p2, v0}, Landroid/support/v4/media/session/MediaSessionCompat$Token;-><init>(Ljava/lang/Object;Landroid/support/v4/media/session/IMediaSession;Lekf;)V

    return-void
.end method

.method public constructor <init>(Ljava/lang/Object;Landroid/support/v4/media/session/IMediaSession;Lekf;)V
    .locals 1
    ...
    .line 7
    iput-object p3, p0, Landroid/support/v4/media/session/MediaSessionCompat$Token;->mSession2Token:Lekf;
...
.method public static fromBundle(Landroid/os/Bundle;)Landroid/support/v4/media/session/MediaSessionCompat$Token;
    ...
    invoke-static {p0}, Lcsa;->o(Landroid/os/Bundle;)Lekf;
    ...
    invoke-direct {v2, p0, v0, v1}, Landroid/support/v4/media/session/MediaSessionCompat$Token;-><init>(Ljava/lang/Object;Landroid/support/v4/media/session/IMediaSession;Lekf;)V
...
.method public getSession2Token()Lekf;
    .locals 1
    ...
    :try_start_0
    iget-object p0, p0, Landroid/support/v4/media/session/MediaSessionCompat$Token;->mSession2Token:Lekf;
...
.method public setSession2Token(Lekf;)V
    .locals 1
    ...
    :try_start_0
    iput-object p1, p0, Landroid/support/v4/media/session/MediaSessionCompat$Token;->mSession2Token:Lekf;
...
.method public toBundle()Landroid/os/Bundle;
    ...
    invoke-static {v0, p0}, Lcsa;->t(Landroid/os/Bundle;Lekf;)V
