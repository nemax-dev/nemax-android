...
.method public constructor <init>(Lnz4;)V
    ...
    iput-object v0, p0, Lti4;->X:Ljava/util/concurrent/atomic/AtomicBoolean;

    const/16 v0, 0x10

    new-array v2, v0, [F

    iput-object v2, p0, Lti4;->Y:[F

    new-array v0, v0, [F

    iput-object v0, p0, Lti4;->Z:[F

    new-instance v0, Ljava/util/LinkedHashMap;

    invoke-direct {v0}, Ljava/util/LinkedHashMap;-><init>()V

    iput-object v0, p0, Lti4;->r0:Ljava/util/LinkedHashMap;

    iput v1, p0, Lti4;->s0:I

    iput-boolean v1, p0, Lti4;->t0:Z

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, Lti4;->u0:Ljava/util/ArrayList;
    ...
    iput-object v0, p0, Lti4;->b:Landroid/os/HandlerThread;
    ...
    iput-object v1, p0, Lti4;->o:Landroid/os/Handler;

    new-instance v0, Lpp6;

    invoke-direct {v0, v1}, Lpp6;-><init>(Landroid/os/Handler;)V

    iput-object v0, p0, Lti4;->c:Lpp6;

    new-instance v0, Lvr4;

    invoke-direct {v0}, Lvr4;-><init>()V

    iput-object v0, p0, Lti4;->a:Lvr4;

    :try_start_0
    new-instance v0, Lgc4;

    invoke-direct {v0, p0, p1}, Lgc4;-><init>(Lti4;Lnz4;)V
    ...
    :try_start_1
    invoke-virtual {p1}, Lss1;->get()Ljava/lang/Object;
    :try_end_1
    ...
    invoke-virtual {p0}, Lti4;->release()V
...
.method public final a(Lgse;)V
    ...
    iget-object v0, p0, Lti4;->X:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    invoke-direct {v1, p1, v2}, Lri4;-><init>(Lgse;I)V

    invoke-virtual {p0, v0, v1}, Lti4;->e(Ljava/lang/Runnable;Ljava/lang/Runnable;)V

    return-void
.end method

.method public final b(II)Lwt7;
    .locals 1

    new-instance v0, Lxb4;

    invoke-direct {v0, p1, p2, p0}, Lxb4;-><init>(IILjava/lang/Object;)V
...
.method public final c(Lzre;)V
    ...
    invoke-direct {v1, v2, p1}, Lqe4;-><init>(ILjava/lang/Object;)V
...
.method public final d()V
    ...
    iget-boolean v0, p0, Lti4;->t0:Z

    if-eqz v0, :cond_2

    iget v0, p0, Lti4;->s0:I

    if-nez v0, :cond_2

    iget-object v0, p0, Lti4;->r0:Ljava/util/LinkedHashMap;
    ...
    invoke-virtual {v2}, Lzre;->close()V

    goto :goto_0

    :cond_0
    iget-object v1, p0, Lti4;->u0:Ljava/util/ArrayList;
    ...
    invoke-virtual {v2, v3}, Lps1;->d(Ljava/lang/Throwable;)Z
    ...
    iget-object v0, p0, Lti4;->a:Lvr4;

    invoke-virtual {v0}, Lvr4;->q()V

    iget-object p0, p0, Lti4;->b:Landroid/os/HandlerThread;
...
.method public final e(Ljava/lang/Runnable;Ljava/lang/Runnable;)V
    ...
    :try_start_0
    iget-object v0, p0, Lti4;->c:Lpp6;

    new-instance v1, Li5;

    const/16 v2, 0x12

    invoke-direct {v1, p0, p2, p1, v2}, Li5;-><init>(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;I)V
...
.method public final f(Ljava/lang/Exception;)V
    ...
    iget-object p0, p0, Lti4;->u0:Ljava/util/ArrayList;
...
.method public final g(Landroid/util/Size;[FI)Landroid/graphics/Bitmap;
    ...
    invoke-static {v1, v2}, Ls53;->O([FF)V

    invoke-static {v1}, Ls53;->P([F)V
    ...
    invoke-static {v5, v4}, Lws9;->f(Ljava/lang/String;Z)V
    ...
    invoke-static {v5}, Lpe6;->b(Ljava/lang/String;)V
    ...
    invoke-static {v14}, Lpe6;->b(Ljava/lang/String;)V
    ...
    invoke-static {v15}, Lpe6;->b(Ljava/lang/String;)V
    ...
    invoke-static {v6}, Lpe6;->b(Ljava/lang/String;)V
    ...
    invoke-static {v7}, Lpe6;->b(Ljava/lang/String;)V
    ...
    invoke-static {v8}, Lpe6;->b(Ljava/lang/String;)V
    ...
    iput-object v5, v2, Lvr4;->k:Ljava/lang/Object;
    ...
    iget-object v5, v2, Lvr4;->m:Ljava/lang/Object;

    check-cast v5, Lne6;

    invoke-virtual {v5}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    instance-of v9, v5, Loe6;
    ...
    invoke-static {v1}, Lpe6;->b(Ljava/lang/String;)V
    ...
    invoke-static {v3}, Lpe6;->b(Ljava/lang/String;)V
...
.method public final h(Ljgf;)V
    .locals 11

    iget-object v0, p0, Lti4;->u0:Ljava/util/ArrayList;
    ...
    invoke-virtual {p0, p1}, Lti4;->f(Ljava/lang/Exception;)V
    ...
    :cond_3
    :goto_1
    iget-object v4, p1, Ljgf;->b:Ljava/lang/Object;

    check-cast v4, Landroid/util/Size;

    iget-object v5, p1, Ljgf;->c:Ljava/lang/Object;

    check-cast v5, [F

    invoke-virtual {p0, v4, v5, v9}, Lti4;->g(Landroid/util/Size;[FI)Landroid/graphics/Bitmap;
    ...
    :cond_5
    iget-object v9, p1, Ljgf;->a:Ljava/lang/Object;
    ...
    iget-object v8, v8, Le90;->c:Lps1;

    invoke-virtual {v8, v3}, Lps1;->b(Ljava/lang/Object;)Z
...
.method public final onFrameAvailable(Landroid/graphics/SurfaceTexture;)V
    ...
    iget-object v0, p0, Lti4;->Y:[F

    invoke-virtual {p1, v0}, Landroid/graphics/SurfaceTexture;->getTransformMatrix([F)V

    iget-object v1, p0, Lti4;->r0:Ljava/util/LinkedHashMap;
    ...
    iget-object v5, p0, Lti4;->Z:[F

    invoke-virtual {v3, v5, v0}, Lzre;->n([F[F)V
    ...
    :try_start_0
    iget-object v3, p0, Lti4;->a:Lvr4;

    invoke-virtual {p1}, Landroid/graphics/SurfaceTexture;->getTimestamp()J

    move-result-wide v6

    invoke-virtual {v3, v6, v7, v5, v4}, Lvr4;->t(J[FLandroid/view/Surface;)V
    :try_end_0
    ...
    invoke-static {v6, v7}, Lws9;->k(Ljava/lang/String;Z)V
    ...
    invoke-static {v2, v8}, Lws9;->k(Ljava/lang/String;Z)V

    new-instance v2, Ljgf;

    iget-object v3, v3, Lzre;->o:Landroid/util/Size;
    ...
    invoke-direct {v2, v4, v3, v5}, Ljgf;-><init>(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;)V

    goto :goto_0

    :cond_4
    :try_start_1
    invoke-virtual {p0, v2}, Lti4;->h(Ljgf;)V
    :try_end_1
    .catch Ljava/lang/RuntimeException; {:try_start_1 .. :try_end_1} :catch_1
