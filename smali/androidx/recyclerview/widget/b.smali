...
.method public attachForPoolingContainer(Luoc;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public clear()V
    ...
    iget-object v2, v1, Lipc;->a:Ljava/util/ArrayList;
    ...
    :cond_0
    iget-object v1, v1, Lipc;->a:Ljava/util/ArrayList;
...
.method public detachForPoolingContainer(Luoc;Z)V
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iget-object v0, v0, Lipc;->a:Ljava/util/ArrayList;
    ...
    invoke-static {v2}, Lpfb;->a(Landroid/view/View;)V
...
.method public factorInBindTime(IJ)V
    ...
    invoke-virtual {p0, p1}, Landroidx/recyclerview/widget/b;->getScrapDataForType(I)Lipc;

    move-result-object p1

    iget-wide v0, p1, Lipc;->d:J

    invoke-virtual {p0, v0, v1, p2, p3}, Landroidx/recyclerview/widget/b;->runningAverage(JJ)J

    move-result-wide p2

    iput-wide p2, p1, Lipc;->d:J
...
.method public factorInCreateTime(IJ)V
    ...
    iget-wide v0, p1, Lipc;->c:J

    invoke-virtual {p0, v0, v1, p2, p3}, Landroidx/recyclerview/widget/b;->runningAverage(JJ)J

    move-result-wide p2

    iput-wide p2, p1, Lipc;->c:J

    return-void
.end method

.method public getRecycledView(I)Lrpc;
    .locals 1
    ...
    iget-object p0, p0, Lipc;->a:Ljava/util/ArrayList;
...
.method public final getScrapDataForType(I)Lipc;
    .locals 1
...
.method public onAdapterChanged(Luoc;Luoc;Z)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public putRecycledView(Lrpc;)V
    .locals 2

    iget v0, p1, Lrpc;->Y:I

    invoke-virtual {p0, v0}, Landroidx/recyclerview/widget/b;->getScrapDataForType(I)Lipc;
    ...
    invoke-static {p0}, Lpfb;->a(Landroid/view/View;)V
...
.method public size()I
    ...
    iget-object v2, v2, Lipc;->a:Ljava/util/ArrayList;
