...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    sget-object v2, Loec;->ActionMenuItemView:[I

    invoke-virtual {p1, p2, v2, v0, v0}, Landroid/content/Context;->obtainStyledAttributes(Landroid/util/AttributeSet;[III)Landroid/content/res/TypedArray;

    move-result-object p1

    sget p2, Loec;->ActionMenuItemView_android_minWidth:I
...
.method public final d(Ljx8;)V
    ...
    iput-object p1, p0, Landroidx/appcompat/view/menu/ActionMenuItemView;->t0:Ljx8;
    ...
    invoke-virtual {p1}, Ljx8;->getTitleCondensed()Ljava/lang/CharSequence;
    ...
    iget-object p1, p0, Landroidx/appcompat/view/menu/ActionMenuItemView;->x0:Lv6;

    if-nez p1, :cond_1

    new-instance p1, Lv6;

    invoke-direct {p1, p0}, Lv6;-><init>(Landroidx/appcompat/view/menu/ActionMenuItemView;)V

    iput-object p1, p0, Landroidx/appcompat/view/menu/ActionMenuItemView;->x0:Lv6;
...
.method public final e()Z
    ...
    iget-object p0, p0, Landroidx/appcompat/view/menu/ActionMenuItemView;->t0:Ljx8;

    invoke-virtual {p0}, Ljx8;->getIcon()Landroid/graphics/drawable/Drawable;
...
.method public final j()V
    ...
    iget-object v2, p0, Landroidx/appcompat/view/menu/ActionMenuItemView;->t0:Ljx8;

    iget v2, v2, Ljx8;->I0:I
    ...
    iget-object v2, v2, Ljx8;->A0:Ljava/lang/CharSequence;
    ...
    iget-object v2, v2, Ljx8;->X:Ljava/lang/CharSequence;
    ...
    iget-object v2, v2, Ljx8;->B0:Ljava/lang/CharSequence;
    ...
    :cond_5
    iget-object v0, p0, Landroidx/appcompat/view/menu/ActionMenuItemView;->t0:Ljx8;

    iget-object v1, v0, Ljx8;->X:Ljava/lang/CharSequence;

    :goto_4
    invoke-static {p0, v1}, Lu9f;->a(Landroid/view/View;Ljava/lang/CharSequence;)V

    return-void

    :cond_6
    invoke-static {p0, v2}, Lu9f;->a(Landroid/view/View;Ljava/lang/CharSequence;)V
...
.method public final onClick(Landroid/view/View;)V
    ...
    iget-object p1, p0, Landroidx/appcompat/view/menu/ActionMenuItemView;->w0:Lex8;

    if-eqz p1, :cond_0

    iget-object p0, p0, Landroidx/appcompat/view/menu/ActionMenuItemView;->t0:Ljx8;

    invoke-interface {p1, p0}, Lex8;->a(Ljx8;)Z
...
.method public final onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    invoke-virtual {v0}, Ljx8;->hasSubMenu()Z

    move-result v0

    if-eqz v0, :cond_0

    iget-object v0, p0, Landroidx/appcompat/view/menu/ActionMenuItemView;->x0:Lv6;
...
.method public setItemInvoker(Lex8;)V
    .locals 0

    iput-object p1, p0, Landroidx/appcompat/view/menu/ActionMenuItemView;->w0:Lex8;
...
.method public setPopupCallback(Lw6;)V
    .locals 0

    iput-object p1, p0, Landroidx/appcompat/view/menu/ActionMenuItemView;->y0:Lw6;
