...
# static fields
.field public static final e1:Lc42;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroidx/appcompat/widget/SwitchCompat;->e1:Lc42;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    invoke-static {p0, v0}, Lk5f;->a(Landroid/view/View;Landroid/content/Context;)V
    ...
    iget-object v0, v11, Lvxc;->c:Ljava/lang/Object;

    move-object v4, v0

    check-cast v4, Landroid/content/res/TypedArray;

    sget-object v2, Loec;->SwitchCompat:[I
    ...
    sget p0, Loec;->SwitchCompat_android_thumb:I

    invoke-virtual {v11, p0}, Lvxc;->k(I)Landroid/graphics/drawable/Drawable;
    ...
    :cond_0
    sget p0, Loec;->SwitchCompat_track:I

    invoke-virtual {v11, p0}, Lvxc;->k(I)Landroid/graphics/drawable/Drawable;

    move-result-object p0

    iput-object p0, v0, Landroidx/appcompat/widget/SwitchCompat;->s0:Landroid/graphics/drawable/Drawable;
    ...
    :cond_1
    sget p0, Loec;->SwitchCompat_android_textOn:I
    ...
    sget p0, Loec;->SwitchCompat_android_textOff:I
    ...
    sget p0, Loec;->SwitchCompat_showText:I

    invoke-virtual {v4, p0, v9}, Landroid/content/res/TypedArray;->getBoolean(IZ)Z

    move-result p0

    iput-boolean p0, v0, Landroidx/appcompat/widget/SwitchCompat;->F0:Z

    sget p0, Loec;->SwitchCompat_thumbTextPadding:I

    invoke-virtual {v4, p0, v8}, Landroid/content/res/TypedArray;->getDimensionPixelSize(II)I

    move-result p0

    iput p0, v0, Landroidx/appcompat/widget/SwitchCompat;->x0:I

    sget p0, Loec;->SwitchCompat_switchMinWidth:I

    invoke-virtual {v4, p0, v8}, Landroid/content/res/TypedArray;->getDimensionPixelSize(II)I

    move-result p0

    iput p0, v0, Landroidx/appcompat/widget/SwitchCompat;->y0:I

    sget p0, Loec;->SwitchCompat_switchPadding:I

    invoke-virtual {v4, p0, v8}, Landroid/content/res/TypedArray;->getDimensionPixelSize(II)I

    move-result p0

    iput p0, v0, Landroidx/appcompat/widget/SwitchCompat;->z0:I

    sget p0, Loec;->SwitchCompat_splitTrack:I

    invoke-virtual {v4, p0, v8}, Landroid/content/res/TypedArray;->getBoolean(IZ)Z

    move-result p0

    iput-boolean p0, v0, Landroidx/appcompat/widget/SwitchCompat;->A0:Z

    sget p0, Loec;->SwitchCompat_thumbTint:I

    invoke-virtual {v11, p0}, Lvxc;->e(I)Landroid/content/res/ColorStateList;
    ...
    :cond_2
    sget p0, Loec;->SwitchCompat_thumbTintMode:I
    ...
    invoke-static {p0, v7}, Lxv4;->c(ILandroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuff$Mode;
    ...
    :cond_5
    sget p0, Loec;->SwitchCompat_trackTint:I
    ...
    iput-object p0, v0, Landroidx/appcompat/widget/SwitchCompat;->t0:Landroid/content/res/ColorStateList;

    iput-boolean v9, v0, Landroidx/appcompat/widget/SwitchCompat;->v0:Z

    :cond_6
    sget p0, Loec;->SwitchCompat_trackTintMode:I
    ...
    iget-object p2, v0, Landroidx/appcompat/widget/SwitchCompat;->u0:Landroid/graphics/PorterDuff$Mode;

    if-eq p2, p0, :cond_7

    iput-object p0, v0, Landroidx/appcompat/widget/SwitchCompat;->u0:Landroid/graphics/PorterDuff$Mode;

    iput-boolean v9, v0, Landroidx/appcompat/widget/SwitchCompat;->w0:Z

    :cond_7
    iget-boolean p0, v0, Landroidx/appcompat/widget/SwitchCompat;->v0:Z

    if-nez p0, :cond_8

    iget-boolean p0, v0, Landroidx/appcompat/widget/SwitchCompat;->w0:Z
    ...
    :cond_9
    sget p0, Loec;->SwitchCompat_switchTextAppearance:I
    ...
    iput-object p2, v0, Landroidx/appcompat/widget/SwitchCompat;->W0:Landroid/content/res/ColorStateList;

    :goto_1
    sget p2, Loec;->TextAppearance_android_textSize:I
    ...
    :cond_c
    sget p2, Loec;->TextAppearance_android_typeface:I

    invoke-virtual {p0, p2, p1}, Landroid/content/res/TypedArray;->getInt(II)I

    move-result p2

    sget v2, Loec;->TextAppearance_android_textStyle:I
    ...
    :goto_6
    sget p1, Loec;->TextAppearance_textAllCaps:I
    ...
    iput-object p2, p1, Lsc;->a:Ljava/util/Locale;

    iput-object p1, v0, Landroidx/appcompat/widget/SwitchCompat;->Z0:Lsc;

    goto :goto_7

    :cond_15
    iput-object v7, v0, Landroidx/appcompat/widget/SwitchCompat;->Z0:Lsc;

    :goto_7
    iget-object p1, v0, Landroidx/appcompat/widget/SwitchCompat;->B0:Ljava/lang/CharSequence;

    invoke-direct {v0, p1}, Landroidx/appcompat/widget/SwitchCompat;->setTextOnInternal(Ljava/lang/CharSequence;)V

    iget-object p1, v0, Landroidx/appcompat/widget/SwitchCompat;->D0:Ljava/lang/CharSequence;
    ...
    invoke-direct {p0, v0}, Lho;-><init>(Landroid/widget/TextView;)V

    invoke-virtual {p0, v3, v5}, Lho;->f(Landroid/util/AttributeSet;I)V

    invoke-virtual {v11}, Lvxc;->u()V
    ...
    iput p1, v0, Landroidx/appcompat/widget/SwitchCompat;->H0:I

    invoke-virtual {p0}, Landroid/view/ViewConfiguration;->getScaledMinimumFlingVelocity()I

    move-result p0

    iput p0, v0, Landroidx/appcompat/widget/SwitchCompat;->L0:I

    invoke-direct {v0}, Landroidx/appcompat/widget/SwitchCompat;->getEmojiTextViewHelper()Lin;
...
.method private getEmojiTextViewHelper()Lin;
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/SwitchCompat;->b1:Lin;
    ...
    iput-object v0, p0, Landroidx/appcompat/widget/SwitchCompat;->b1:Lin;

    :cond_0
    iget-object p0, p0, Landroidx/appcompat/widget/SwitchCompat;->b1:Lin;
...
.method private getTargetCheckedState()Z
    ...
    iget p0, p0, Landroidx/appcompat/widget/SwitchCompat;->M0:F
...
.method private getThumbScrollRange()I
    ...
    invoke-static {v0}, Lxv4;->b(Landroid/graphics/drawable/Drawable;)Landroid/graphics/Rect;
    ...
    :cond_0
    sget-object v0, Lxv4;->c:Landroid/graphics/Rect;

    :goto_0
    iget v2, p0, Landroidx/appcompat/widget/SwitchCompat;->N0:I

    iget p0, p0, Landroidx/appcompat/widget/SwitchCompat;->P0:I
...
.method private setTextOffInternal(Ljava/lang/CharSequence;)V
    ...
    invoke-direct {p0}, Landroidx/appcompat/widget/SwitchCompat;->getEmojiTextViewHelper()Lin;

    move-result-object v0

    iget-object v0, v0, Lin;->b:Lf9h;

    iget-object v0, v0, Lf9h;->b:Ljava/lang/Object;

    check-cast v0, Lxv8;

    iget-object v1, p0, Landroidx/appcompat/widget/SwitchCompat;->Z0:Lsc;

    invoke-virtual {v0, v1}, Lxv8;->R(Landroid/text/method/TransformationMethod;)Landroid/text/method/TransformationMethod;
...
.method public final b()V
    ...
    invoke-static {v0, v1}, Lpv4;->i(Landroid/graphics/drawable/Drawable;Landroid/graphics/PorterDuff$Mode;)V
...
.method public final draw(Landroid/graphics/Canvas;)V
    ...
    invoke-static {v5}, Lxv4;->b(Landroid/graphics/drawable/Drawable;)Landroid/graphics/Rect;
    ...
    :cond_0
    sget-object v5, Lxv4;->c:Landroid/graphics/Rect;
    ...
    invoke-static {v2, v0, v1, v4, v3}, Lpv4;->f(Landroid/graphics/drawable/Drawable;IIII)V
...
.method public final drawableHotspotChanged(FF)V
    ...
    invoke-static {v0, p1, p2}, Lpv4;->e(Landroid/graphics/drawable/Drawable;FF)V

    :cond_0
    iget-object p0, p0, Landroidx/appcompat/widget/SwitchCompat;->s0:Landroid/graphics/drawable/Drawable;

    if-eqz p0, :cond_1

    invoke-static {p0, p1, p2}, Lpv4;->e(Landroid/graphics/drawable/Drawable;FF)V
...
.method public final e()V
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/SwitchCompat;->c1:Ly35;

    if-nez v0, :cond_2

    iget-object v0, p0, Landroidx/appcompat/widget/SwitchCompat;->b1:Lin;

    invoke-virtual {v0}, Lin;->b()Z
    ...
    invoke-direct {v1, p0}, Ly35;-><init>(Landroidx/appcompat/widget/SwitchCompat;)V

    iput-object v1, p0, Landroidx/appcompat/widget/SwitchCompat;->c1:Ly35;

    invoke-virtual {v0, v1}, Li25;->h(Lg25;)V
...
.method public getCompoundPaddingLeft()I
    ...
    iget p0, p0, Landroidx/appcompat/widget/SwitchCompat;->z0:I
...
.method public getShowText()Z
    ...
    iget-boolean p0, p0, Landroidx/appcompat/widget/SwitchCompat;->F0:Z
...
.method public getSplitTrack()Z
    ...
    iget-boolean p0, p0, Landroidx/appcompat/widget/SwitchCompat;->A0:Z
...
.method public getTextOff()Ljava/lang/CharSequence;
    ...
    iget-object p0, p0, Landroidx/appcompat/widget/SwitchCompat;->D0:Ljava/lang/CharSequence;
...
.method public getTextOn()Ljava/lang/CharSequence;
    ...
    iget-object p0, p0, Landroidx/appcompat/widget/SwitchCompat;->B0:Ljava/lang/CharSequence;
...
.method public getTrackTintList()Landroid/content/res/ColorStateList;
    ...
    iget-object p0, p0, Landroidx/appcompat/widget/SwitchCompat;->t0:Landroid/content/res/ColorStateList;
...
.method public getTrackTintMode()Landroid/graphics/PorterDuff$Mode;
    ...
    iget-object p0, p0, Landroidx/appcompat/widget/SwitchCompat;->u0:Landroid/graphics/PorterDuff$Mode;
...
.method public final onCreateDrawableState(I)[I
    ...
    sget-object p0, Landroidx/appcompat/widget/SwitchCompat;->f1:[I
...
.method public onDraw(Landroid/graphics/Canvas;)V
    ...
    invoke-static {v4}, Lxv4;->b(Landroid/graphics/drawable/Drawable;)Landroid/graphics/Rect;
...
.method public final onLayout(ZIIII)V
    ...
    iget-object p1, p0, Landroidx/appcompat/widget/SwitchCompat;->s0:Landroid/graphics/drawable/Drawable;

    iget-object p3, p0, Landroidx/appcompat/widget/SwitchCompat;->d1:Landroid/graphics/Rect;
    ...
    invoke-static {p1}, Lxv4;->b(Landroid/graphics/drawable/Drawable;)Landroid/graphics/Rect;
    ...
    iget p3, p0, Landroidx/appcompat/widget/SwitchCompat;->N0:I
    ...
    iget p1, p0, Landroidx/appcompat/widget/SwitchCompat;->N0:I
    ...
    iget p4, p0, Landroidx/appcompat/widget/SwitchCompat;->O0:I
    ...
    iget p2, p0, Landroidx/appcompat/widget/SwitchCompat;->O0:I
    ...
    iput p2, p0, Landroidx/appcompat/widget/SwitchCompat;->R0:I

    iput p4, p0, Landroidx/appcompat/widget/SwitchCompat;->T0:I

    iput p3, p0, Landroidx/appcompat/widget/SwitchCompat;->S0:I
...
.method public setChecked(Z)V
    ...
    sget v1, Ln7c;->tag_state_description:I

    const/4 v5, 0x1

    invoke-direct/range {v0 .. v5}, Lt7g;-><init>(ILjava/lang/Class;III)V

    invoke-virtual {v0, p0, v6}, Lu58;->f(Landroid/view/View;Ljava/lang/Object;)V
    ...
    sget v1, Lhdc;->abc_capital_off:I
    ...
    sget-object v1, Landroidx/appcompat/widget/SwitchCompat;->e1:Lc42;
    ...
    iget-object p0, p0, Landroidx/appcompat/widget/SwitchCompat;->a1:Landroid/animation/ObjectAnimator;
...
.method public setEmojiCompatEnabled(Z)V
    ...
    invoke-virtual {v0, p1}, Lin;->e(Z)V
...
.method public setTextOff(Ljava/lang/CharSequence;)V
    ...
    sget v0, Lhdc;->abc_capital_off:I
