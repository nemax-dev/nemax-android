...
# static fields
.field public static final a1:Ls32;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroidx/appcompat/widget/SwitchCompat;->a1:Ls32;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    invoke-static {p0, v0}, Lvve;->a(Landroid/view/View;Landroid/content/Context;)V
    ...
    invoke-static {p1, p2, v0, v5}, Lifb;->w(Landroid/content/Context;Landroid/util/AttributeSet;[II)Lifb;

    move-result-object v11

    iget-object v0, v11, Lifb;->b:Ljava/lang/Object;

    move-object v4, v0

    check-cast v4, Landroid/content/res/TypedArray;

    sget-object v2, Lz6c;->SwitchCompat:[I
    ...
    sget p0, Lz6c;->SwitchCompat_android_thumb:I

    invoke-virtual {v11, p0}, Lifb;->k(I)Landroid/graphics/drawable/Drawable;
    ...
    :cond_0
    sget p0, Lz6c;->SwitchCompat_track:I
    ...
    :cond_1
    sget p0, Lz6c;->SwitchCompat_android_textOn:I
    ...
    sget p0, Lz6c;->SwitchCompat_android_textOff:I
    ...
    sget p0, Lz6c;->SwitchCompat_showText:I
    ...
    sget p0, Lz6c;->SwitchCompat_thumbTextPadding:I
    ...
    sget p0, Lz6c;->SwitchCompat_switchMinWidth:I
    ...
    sget p0, Lz6c;->SwitchCompat_switchPadding:I
    ...
    sget p0, Lz6c;->SwitchCompat_splitTrack:I
    ...
    sget p0, Lz6c;->SwitchCompat_thumbTint:I

    invoke-virtual {v11, p0}, Lifb;->j(I)Landroid/content/res/ColorStateList;
    ...
    :cond_2
    sget p0, Lz6c;->SwitchCompat_thumbTintMode:I
    ...
    invoke-static {p0, v7}, Lqt4;->c(ILandroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuff$Mode;
    ...
    :cond_5
    sget p0, Lz6c;->SwitchCompat_trackTint:I
    ...
    :cond_6
    sget p0, Lz6c;->SwitchCompat_trackTintMode:I
    ...
    :cond_9
    sget p0, Lz6c;->SwitchCompat_switchTextAppearance:I
    ...
    :goto_1
    sget p2, Lz6c;->TextAppearance_android_textSize:I
    ...
    :cond_c
    sget p2, Lz6c;->TextAppearance_android_typeface:I

    invoke-virtual {p0, p2, p1}, Landroid/content/res/TypedArray;->getInt(II)I

    move-result p2

    sget v2, Lz6c;->TextAppearance_android_textStyle:I
    ...
    :goto_6
    sget p1, Lz6c;->TextAppearance_textAllCaps:I
    ...
    iput-object p2, p1, Lnc;->a:Ljava/util/Locale;

    iput-object p1, v0, Landroidx/appcompat/widget/SwitchCompat;->V0:Lnc;

    goto :goto_7

    :cond_15
    iput-object v7, v0, Landroidx/appcompat/widget/SwitchCompat;->V0:Lnc;
    ...
    invoke-direct {p0, v0}, Lzn;-><init>(Landroid/widget/TextView;)V

    invoke-virtual {p0, v3, v5}, Lzn;->f(Landroid/util/AttributeSet;I)V

    invoke-virtual {v11}, Lifb;->x()V
    ...
    invoke-direct {v0}, Landroidx/appcompat/widget/SwitchCompat;->getEmojiTextViewHelper()Lbn;

    move-result-object p0

    invoke-virtual {p0, v3, v5}, Lbn;->c(Landroid/util/AttributeSet;I)V
...
.method private getEmojiTextViewHelper()Lbn;
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/SwitchCompat;->X0:Lbn;
    ...
    iput-object v0, p0, Landroidx/appcompat/widget/SwitchCompat;->X0:Lbn;

    :cond_0
    iget-object p0, p0, Landroidx/appcompat/widget/SwitchCompat;->X0:Lbn;
...
.method private getThumbScrollRange()I
    ...
    invoke-static {v0}, Lqt4;->b(Landroid/graphics/drawable/Drawable;)Landroid/graphics/Rect;
    ...
    :cond_0
    sget-object v0, Lqt4;->c:Landroid/graphics/Rect;
...
.method private setTextOffInternal(Ljava/lang/CharSequence;)V
    ...
    invoke-direct {p0}, Landroidx/appcompat/widget/SwitchCompat;->getEmojiTextViewHelper()Lbn;

    move-result-object v0

    iget-object v0, v0, Lbn;->b:Lu8d;

    iget-object v0, v0, Lu8d;->b:Ljava/lang/Object;

    check-cast v0, Lcp;

    iget-object v1, p0, Landroidx/appcompat/widget/SwitchCompat;->V0:Lnc;

    invoke-virtual {v0, v1}, Lcp;->f0(Landroid/text/method/TransformationMethod;)Landroid/text/method/TransformationMethod;
...
.method public final b()V
    ...
    invoke-static {v0, v1}, Ljt4;->i(Landroid/graphics/drawable/Drawable;Landroid/graphics/PorterDuff$Mode;)V
...
.method public final draw(Landroid/graphics/Canvas;)V
    ...
    invoke-static {v5}, Lqt4;->b(Landroid/graphics/drawable/Drawable;)Landroid/graphics/Rect;
    ...
    :cond_0
    sget-object v5, Lqt4;->c:Landroid/graphics/Rect;
    ...
    invoke-static {v2, v0, v1, v4, v3}, Ljt4;->f(Landroid/graphics/drawable/Drawable;IIII)V
...
.method public final drawableHotspotChanged(FF)V
    ...
    invoke-static {v0, p1, p2}, Ljt4;->e(Landroid/graphics/drawable/Drawable;FF)V
    ...
    invoke-static {p0, p1, p2}, Ljt4;->e(Landroid/graphics/drawable/Drawable;FF)V
...
.method public final e()V
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/SwitchCompat;->Y0:Ls15;

    if-nez v0, :cond_2

    iget-object v0, p0, Landroidx/appcompat/widget/SwitchCompat;->X0:Lbn;

    invoke-virtual {v0}, Lbn;->b()Z
    ...
    invoke-direct {v1, p0}, Ls15;-><init>(Landroidx/appcompat/widget/SwitchCompat;)V

    iput-object v1, p0, Landroidx/appcompat/widget/SwitchCompat;->Y0:Ls15;

    invoke-virtual {v0, v1}, Lc05;->h(La05;)V
...
.method public onDraw(Landroid/graphics/Canvas;)V
    ...
    invoke-static {v4}, Lqt4;->b(Landroid/graphics/drawable/Drawable;)Landroid/graphics/Rect;
...
.method public final onLayout(ZIIII)V
    ...
    invoke-static {p1}, Lqt4;->b(Landroid/graphics/drawable/Drawable;)Landroid/graphics/Rect;
...
.method public setChecked(Z)V
    ...
    sget v1, Lvzb;->tag_state_description:I

    const/4 v5, 0x1

    invoke-direct/range {v0 .. v5}, Ltwf;-><init>(ILjava/lang/Class;III)V

    invoke-virtual {v0, p0, v6}, Lu18;->f(Landroid/view/View;Ljava/lang/Object;)V
    ...
    sget v1, Ls5c;->abc_capital_off:I
    ...
    sget-object v1, Landroidx/appcompat/widget/SwitchCompat;->a1:Ls32;
...
.method public setTextOff(Ljava/lang/CharSequence;)V
    ...
    sget v0, Ls5c;->abc_capital_off:I
