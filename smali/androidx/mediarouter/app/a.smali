...
.method public final onGlobalLayout()V
    ...
    iget-object v6, v1, Landroidx/mediarouter/app/d;->R0:Ljava/util/HashSet;
    ...
    invoke-direct {v4, v3, v5}, Laxa;-><init>(Landroid/graphics/drawable/BitmapDrawable;Landroid/graphics/Rect;)V

    const/4 v12, 0x0

    iput v12, v4, Laxa;->h:F

    iget v3, v1, Landroidx/mediarouter/app/d;->s1:I

    int-to-long v5, v3

    iput-wide v5, v4, Laxa;->e:J

    iget-object v3, v1, Landroidx/mediarouter/app/d;->t1:Landroid/view/animation/Interpolator;

    iput-object v3, v4, Laxa;->d:Landroid/view/animation/Interpolator;
    ...
    iget v6, v1, Landroidx/mediarouter/app/d;->X0:I

    mul-int/2addr v6, v2

    new-instance v7, Laxa;

    invoke-direct {v7, v3, v5}, Laxa;-><init>(Landroid/graphics/drawable/BitmapDrawable;Landroid/graphics/Rect;)V

    iput v6, v7, Laxa;->g:I

    iget v3, v1, Landroidx/mediarouter/app/d;->q1:I

    int-to-long v5, v3

    iput-wide v5, v7, Laxa;->e:J

    iget-object v3, v1, Landroidx/mediarouter/app/d;->t1:Landroid/view/animation/Interpolator;

    iput-object v3, v7, Laxa;->d:Landroid/view/animation/Interpolator;
    ...
    invoke-direct {v3, v1, v4, v6, v5}, Lrh8;-><init>(Ljava/lang/Object;Ljava/lang/Object;ZI)V

    iput-object v3, v7, Laxa;->l:Lrh8;
    ...
    :goto_4
    iget-object v3, v1, Landroidx/mediarouter/app/d;->N0:Landroidx/mediarouter/app/OverlayListView;
