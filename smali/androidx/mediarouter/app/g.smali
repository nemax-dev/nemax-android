...
.field public final M0:La4d;

.field public final synthetic N0:Lpj8;
...
.method public constructor <init>(Lpj8;Landroid/view/View;)V
    ...
    iput-object p1, p0, Landroidx/mediarouter/app/g;->N0:Lpj8;
    ...
    invoke-direct {v0, v1, p0}, La4d;-><init>(ILjava/lang/Object;)V

    iput-object v0, p0, Landroidx/mediarouter/app/g;->M0:La4d;

    iput-object p2, p0, Landroidx/mediarouter/app/g;->E0:Landroid/view/View;

    sget v0, Lfyb;->mr_cast_route_icon:I
    ...
    sget v0, Lfyb;->mr_cast_route_progress_bar:I
    ...
    sget v1, Lfyb;->mr_cast_route_name:I
    ...
    sget v1, Lfyb;->mr_cast_volume_layout:I
    ...
    sget v1, Lfyb;->mr_cast_checkbox:I
    ...
    iget-object v1, p1, Lrj8;->t0:Landroid/content/Context;

    sget v2, Lyxb;->mr_cast_checkbox:I

    invoke-static {v1, v2}, Lyu0;->l(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;

    move-result-object v2

    invoke-static {v1}, Llk8;->h(Landroid/content/Context;)Z
    ...
    invoke-static {v1, v3}, Lew3;->a(Landroid/content/Context;I)I

    move-result v1

    invoke-static {v2, v1}, Ljt4;->g(Landroid/graphics/drawable/Drawable;I)V
    ...
    invoke-static {p2, v0}, Llk8;->i(Landroid/content/Context;Landroid/widget/ProgressBar;)V
    ...
    sget v1, Lpwb;->mr_dynamic_dialog_row_height:I
...
.method public final B(Lek8;)Z
    ...
    :cond_0
    iget-object p0, p0, Landroidx/mediarouter/app/g;->N0:Lpj8;

    iget-object p0, p0, Lpj8;->s0:Lrj8;

    iget-object p0, p0, Lrj8;->o0:Lek8;

    invoke-virtual {p0, p1}, Lek8;->b(Lek8;)Lvfd;
...
.method public final C(ZZ)V
    ...
    invoke-virtual {p1, p0, v1}, Lpj8;->C(Landroid/view/View;I)V
