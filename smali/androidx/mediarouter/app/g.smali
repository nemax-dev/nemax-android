...
.field public final Q0:Lvcd;

.field public final synthetic R0:Lkn8;
...
.method public constructor <init>(Lkn8;Landroid/view/View;)V
    ...
    iput-object p1, p0, Landroidx/mediarouter/app/g;->R0:Lkn8;

    iget-object p1, p1, Lkn8;->w0:Lmn8;

    sget v0, Lw5c;->mr_cast_mute_button:I
    ...
    sget v1, Lw5c;->mr_cast_volume_slider:I
    ...
    invoke-direct {p0, p1, p2, v0, v1}, Landroidx/mediarouter/app/e;-><init>(Lmn8;Landroid/view/View;Landroid/widget/ImageButton;Landroidx/mediarouter/app/MediaRouteVolumeSlider;)V
    ...
    iput-object v0, p0, Landroidx/mediarouter/app/g;->Q0:Lvcd;

    iput-object p2, p0, Landroidx/mediarouter/app/g;->I0:Landroid/view/View;

    sget v0, Lw5c;->mr_cast_route_icon:I
    ...
    sget v0, Lw5c;->mr_cast_route_progress_bar:I
    ...
    sget v1, Lw5c;->mr_cast_route_name:I
    ...
    sget v1, Lw5c;->mr_cast_volume_layout:I
    ...
    sget v1, Lw5c;->mr_cast_checkbox:I
    ...
    iget-object v1, p1, Lmn8;->x0:Landroid/content/Context;

    sget v2, Lq5c;->mr_cast_checkbox:I

    invoke-static {v1, v2}, Luzg;->n(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;

    move-result-object v2

    invoke-static {v1}, Lgo8;->h(Landroid/content/Context;)Z
    ...
    invoke-static {v1, v3}, Ltw3;->a(Landroid/content/Context;I)I

    move-result v1

    invoke-static {v2, v1}, Lpv4;->g(Landroid/graphics/drawable/Drawable;I)V
    ...
    invoke-static {p2, v0}, Lgo8;->i(Landroid/content/Context;Landroid/widget/ProgressBar;)V
    ...
    sget v1, Lh4c;->mr_dynamic_dialog_row_height:I
...
.method public final B(Lzn8;)Z
    ...
    :cond_0
    iget-object p0, p0, Landroidx/mediarouter/app/g;->R0:Lkn8;

    iget-object p0, p0, Lkn8;->w0:Lmn8;

    iget-object p0, p0, Lmn8;->s0:Lzn8;

    invoke-virtual {p0, p1}, Lzn8;->b(Lzn8;)Lk3e;
...
.method public final C(ZZ)V
    ...
    iget-object p0, p0, Landroidx/mediarouter/app/g;->M0:Landroid/widget/RelativeLayout;

    invoke-virtual {p1, p0, v1}, Lkn8;->C(Landroid/view/View;I)V
