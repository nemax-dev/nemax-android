...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Landroidx/work/impl/background/systemjob/SystemJobService;->c:Lj3b;

    return-void
.end method

.method public static b(Landroid/app/job/JobParameters;)Lkwg;
    .locals 3
    ...
    invoke-direct {v1, v0, p0}, Lkwg;-><init>(Ljava/lang/String;I)V
    :try_end_0
...
.method public final a(Lkwg;Z)V
    ...
    iget-object v3, p1, Lkwg;->a:Ljava/lang/String;
    ...
    iget-object v0, p0, Landroidx/work/impl/background/systemjob/SystemJobService;->c:Lj3b;

    invoke-virtual {v0, p1}, Lj3b;->l(Lkwg;)Lbde;
...
.method public final onCreate()V
    ...
    iput-object v0, p0, Landroidx/work/impl/background/systemjob/SystemJobService;->a:Lrwg;
    ...
    invoke-virtual {p0, v0, v1}, Lmq0;->a0(Ljava/lang/String;Ljava/lang/String;)V
...
.method public final onDestroy()V
    ...
    iget-object v0, p0, Landroidx/work/impl/background/systemjob/SystemJobService;->a:Lrwg;
...
.method public final onStartJob(Landroid/app/job/JobParameters;)Z
    ...
    iget-object v2, p0, Landroidx/work/impl/background/systemjob/SystemJobService;->a:Lrwg;
    ...
    :cond_0
    invoke-static {p1}, Landroidx/work/impl/background/systemjob/SystemJobService;->b(Landroid/app/job/JobParameters;)Lkwg;
    ...
    invoke-virtual {p0, p1, v0}, Lmq0;->r(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {p0, p1, v0}, Lmq0;->n(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {v1, v4, v0}, Lmq0;->n(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {p1}, Lqve;->b(Landroid/app/job/JobParameters;)[Landroid/net/Uri;
    ...
    iput-object v1, v0, Lcs8;->a:Ljava/lang/Object;

    :cond_3
    invoke-static {p1}, Lqve;->a(Landroid/app/job/JobParameters;)[Ljava/lang/String;
    ...
    :cond_4
    invoke-static {p1}, Lrve;->a(Landroid/app/job/JobParameters;)Landroid/net/Network;

    move-result-object p1

    iput-object p1, v0, Lcs8;->c:Ljava/lang/Object;

    iget-object p1, p0, Landroidx/work/impl/background/systemjob/SystemJobService;->a:Lrwg;

    iget-object p0, p0, Landroidx/work/impl/background/systemjob/SystemJobService;->c:Lj3b;

    invoke-virtual {p0, v2}, Lj3b;->p(Lkwg;)Lbde;

    move-result-object p0

    invoke-virtual {p1, p0, v0}, Lrwg;->h(Lbde;Lcs8;)V
...
.method public final onStopJob(Landroid/app/job/JobParameters;)Z
    ...
    invoke-virtual {p0, p1, v1}, Lmq0;->r(Ljava/lang/String;Ljava/lang/String;)V
    ...
    iget-object v2, p0, Landroidx/work/impl/background/systemjob/SystemJobService;->c:Lj3b;

    invoke-virtual {v2, p1}, Lj3b;->l(Lkwg;)Lbde;

    move-result-object v2

    if-eqz v2, :cond_2

    iget-object v3, p0, Landroidx/work/impl/background/systemjob/SystemJobService;->a:Lrwg;

    iget-object v4, v3, Lrwg;->d:Lvo8;

    new-instance v5, Lqle;

    invoke-direct {v5, v3, v2, v0}, Lqle;-><init>(Lrwg;Lbde;Z)V

    invoke-interface {v4, v5}, Ld1f;->c(Ljava/lang/Runnable;)V

    :cond_2
    iget-object p0, p0, Landroidx/work/impl/background/systemjob/SystemJobService;->a:Lrwg;

    iget-object p0, p0, Lrwg;->f:Lrjb;
    ...
    :try_start_1
    iget-object p0, p0, Lrjb;->t0:Ljava/util/HashSet;
