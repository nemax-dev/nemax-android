...
.method public final A0()V
    ...
    iget-object v1, v1, Landroidx/biometric/BiometricViewModel;->c:Lcpc;
...
.method public final S0(I)V
    ...
    iget-object p1, p0, Landroidx/biometric/BiometricViewModel;->f:Llud;
    ...
    invoke-direct {p1, v0, v1}, Llud;-><init>(IZ)V

    iput-object p1, p0, Landroidx/biometric/BiometricViewModel;->f:Llud;

    :cond_1
    iget-object p0, p0, Landroidx/biometric/BiometricViewModel;->f:Llud;

    iget-object p1, p0, Llud;->b:Ljava/lang/Object;
    ...
    :try_start_0
    invoke-static {p1}, Lb12;->a(Landroid/os/CancellationSignal;)V
    :try_end_0
...
.method public final T0()V
    ...
    invoke-direct {v4, v0}, Lxe0;-><init>(Landroidx/fragment/app/c;)V

    invoke-virtual {v4, v3}, Lxe0;->h(Landroidx/fragment/app/a;)V

    invoke-virtual {v4, v2}, Lxe0;->d(Z)I
    ...
    invoke-direct {v3, v0}, Lxe0;-><init>(Landroidx/fragment/app/c;)V

    invoke-virtual {v3, p0}, Lxe0;->h(Landroidx/fragment/app/a;)V
    ...
    :cond_3
    sget v4, Ljvb;->delay_showing_prompt_models:I
...
.method public final U0()V
    ...
    iget-object p0, p0, Landroidx/biometric/BiometricViewModel;->d:Li9d;
...
.method public final X0()V
    ...
    iget-object v3, v2, Landroidx/biometric/BiometricViewModel;->c:Lcpc;

    const/4 v4, 0x0

    if-eqz v3, :cond_1

    iget-object v3, v3, Lcpc;->a:Ljava/lang/Object;
    ...
    iget-object v2, v2, Landroidx/biometric/BiometricViewModel;->c:Lcpc;
    ...
    iget-object v2, v2, Lcpc;->c:Ljava/lang/Object;
    ...
    invoke-direct {v2, v5}, Lba7;-><init>(I)V
    ...
    iget-object v4, v4, Landroidx/biometric/BiometricViewModel;->c:Lcpc;
    ...
    iget-object v4, v4, Landroidx/biometric/BiometricViewModel;->d:Li9d;
    ...
    iget-object v6, v5, Landroidx/biometric/BiometricViewModel;->f:Llud;
    ...
    invoke-direct {v6, v7, v8}, Llud;-><init>(IZ)V

    iput-object v6, v5, Landroidx/biometric/BiometricViewModel;->f:Llud;

    :cond_b
    iget-object v5, v5, Landroidx/biometric/BiometricViewModel;->f:Llud;

    iget-object v6, v5, Llud;->b:Ljava/lang/Object;

    check-cast v6, Landroid/os/CancellationSignal;

    if-nez v6, :cond_c

    invoke-static {}, Lb12;->b()Landroid/os/CancellationSignal;

    move-result-object v6

    iput-object v6, v5, Llud;->b:Ljava/lang/Object;
    ...
    iget-object v8, v7, Landroidx/biometric/BiometricViewModel;->e:Lc38;
    ...
    invoke-direct {v8, v9}, Lc38;-><init>(Lwn0;)V

    iput-object v8, v7, Landroidx/biometric/BiometricViewModel;->e:Lc38;

    :cond_d
    iget-object v7, v7, Landroidx/biometric/BiometricViewModel;->e:Lc38;

    iget-object v8, v7, Lc38;->b:Ljava/lang/Object;

    check-cast v8, Landroid/hardware/biometrics/BiometricPrompt$AuthenticationCallback;

    if-nez v8, :cond_e

    iget-object v8, v7, Lc38;->c:Ljava/lang/Object;
    ...
    iput-object v8, v7, Lc38;->b:Ljava/lang/Object;
    ...
    sget v0, Lo3c;->default_error_msg:I
...
.method public final h0(IILandroid/content/Intent;)V
    ...
    invoke-direct {p1, p2, p3}, Ltn0;-><init>(Li9d;I)V
    ...
    :cond_0
    sget p1, Lo3c;->generic_error_user_canceled:I
...
.method public final k0(Landroid/os/Bundle;)V
    ...
    invoke-direct {p1, v0}, Ldde;-><init>(Lhyf;)V
    ...
    invoke-virtual {p1, v0}, Ldde;->b(Lq33;)Lzxf;
    ...
    iget-object v0, p1, Landroidx/biometric/BiometricViewModel;->m:Lgk9;
    ...
    iput-object v0, p1, Landroidx/biometric/BiometricViewModel;->m:Lgk9;

    :cond_1
    iget-object p1, p1, Landroidx/biometric/BiometricViewModel;->m:Lgk9;
    ...
    invoke-virtual {p1, p0, v0}, Luq7;->e(Lsk7;Lz3a;)V

    iget-object p1, p0, Landroidx/biometric/BiometricFragment;->h1:Landroidx/biometric/BiometricViewModel;

    iget-object v0, p1, Landroidx/biometric/BiometricViewModel;->n:Lgk9;
    ...
    iput-object v0, p1, Landroidx/biometric/BiometricViewModel;->n:Lgk9;

    :cond_2
    iget-object p1, p1, Landroidx/biometric/BiometricViewModel;->n:Lgk9;
    ...
    iget-object v0, p1, Landroidx/biometric/BiometricViewModel;->o:Lgk9;
    ...
    iput-object v0, p1, Landroidx/biometric/BiometricViewModel;->o:Lgk9;

    :cond_3
    iget-object p1, p1, Landroidx/biometric/BiometricViewModel;->o:Lgk9;
    ...
    iget-object v0, p1, Landroidx/biometric/BiometricViewModel;->p:Lgk9;
    ...
    iput-object v0, p1, Landroidx/biometric/BiometricViewModel;->p:Lgk9;

    :cond_4
    iget-object p1, p1, Landroidx/biometric/BiometricViewModel;->p:Lgk9;
    ...
    iget-object v0, p1, Landroidx/biometric/BiometricViewModel;->q:Lgk9;
    ...
    iput-object v0, p1, Landroidx/biometric/BiometricViewModel;->q:Lgk9;

    :cond_5
    iget-object p1, p1, Landroidx/biometric/BiometricViewModel;->q:Lgk9;
    ...
    iget-object v0, p1, Landroidx/biometric/BiometricViewModel;->r:Lgk9;
    ...
    iput-object v0, p1, Landroidx/biometric/BiometricViewModel;->r:Lgk9;

    :cond_6
    iget-object p1, p1, Landroidx/biometric/BiometricViewModel;->r:Lgk9;
