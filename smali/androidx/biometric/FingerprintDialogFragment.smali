...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Landroidx/biometric/FingerprintDialogFragment;->B1:Lne;
...
.method public final V0()Landroid/app/Dialog;
    ...
    invoke-direct {v0, v1}, Lqc;-><init>(Landroid/content/Context;)V
    ...
    :goto_0
    invoke-virtual {v0, v1}, Lqc;->setTitle(Ljava/lang/CharSequence;)Lqc;

    invoke-virtual {v0}, Lqc;->getContext()Landroid/content/Context;
    ...
    sget v3, Lk9c;->fingerprint_dialog_layout:I

    invoke-virtual {v1, v3, v2}, Landroid/view/LayoutInflater;->inflate(ILandroid/view/ViewGroup;)Landroid/view/View;

    move-result-object v1

    sget v3, Lr6c;->fingerprint_subtitle:I
    ...
    :cond_2
    :goto_1
    sget v3, Lr6c;->fingerprint_description:I
    ...
    iget-object v6, v6, Landroidx/biometric/BiometricViewModel;->c:Lrmb;

    if-eqz v6, :cond_3

    iget-object v6, v6, Lrmb;->b:Ljava/lang/Object;
    ...
    :cond_5
    :goto_3
    sget v3, Lr6c;->fingerprint_icon:I
    ...
    sget v3, Lr6c;->fingerprint_error:I
    ...
    iget-object v3, v3, Landroidx/biometric/BiometricViewModel;->c:Lrmb;
    ...
    :goto_4
    invoke-static {v3}, Lib6;->x(I)Z

    move-result v3

    if-eqz v3, :cond_7

    sget v2, Ldbc;->confirm_device_credential_password:I
    ...
    iget-object v2, v3, Lrmb;->c:Ljava/lang/Object;
    ...
    iget-object p0, v0, Lqc;->a:Lmc;

    iput-object v2, p0, Lmc;->i:Ljava/lang/CharSequence;

    iput-object v3, p0, Lmc;->j:Landroid/content/DialogInterface$OnClickListener;

    invoke-virtual {v0, v1}, Lqc;->setView(Landroid/view/View;)Lqc;

    invoke-virtual {v0}, Lqc;->create()Lrc;
...
.method public final k0(Landroid/os/Bundle;)V
    ...
    invoke-direct {v0, p1}, Luyd;-><init>(Lh9g;)V
    ...
    invoke-virtual {v0, p1}, Luyd;->c(Lh43;)Lz8g;
    ...
    iget-object v0, p1, Landroidx/biometric/BiometricViewModel;->t:Llo9;
    ...
    iput-object v0, p1, Landroidx/biometric/BiometricViewModel;->t:Llo9;

    :cond_1
    iget-object p1, p1, Landroidx/biometric/BiometricViewModel;->t:Llo9;

    new-instance v0, Lup5;

    const/4 v1, 0x0

    invoke-direct {v0, p0, v1}, Lup5;-><init>(Landroidx/fragment/app/DialogFragment;I)V
    ...
    iget-object v0, p1, Landroidx/biometric/BiometricViewModel;->u:Llo9;
    ...
    iput-object v0, p1, Landroidx/biometric/BiometricViewModel;->u:Llo9;

    :cond_2
    iget-object p1, p1, Landroidx/biometric/BiometricViewModel;->u:Llo9;
...
.method public final onCancel(Landroid/content/DialogInterface;)V
    ...
    iget-object p1, p0, Landroidx/biometric/BiometricViewModel;->r:Llo9;
    ...
    iput-object p1, p0, Landroidx/biometric/BiometricViewModel;->r:Llo9;

    :cond_0
    iget-object p0, p0, Landroidx/biometric/BiometricViewModel;->r:Llo9;
...
.method public final y0()V
    ...
    sget v1, Ldbc;->fingerprint_dialog_touch_sensor:I
