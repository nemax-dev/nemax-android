...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lif3;->g:Ljava/util/concurrent/atomic/AtomicIntegerFieldUpdater;

    return-void
.end method

.method public constructor <init>(Llf3;I)V
    .locals 0

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Lif3;->f:Llf3;
    ...
    iput-object p1, p0, Lif3;->d:Ljava/util/concurrent/atomic/AtomicReferenceArray;

    new-instance p1, Ljava/util/concurrent/atomic/AtomicReferenceArray;

    invoke-direct {p1, p2}, Ljava/util/concurrent/atomic/AtomicReferenceArray;-><init>(I)V

    iput-object p1, p0, Lif3;->e:Ljava/util/concurrent/atomic/AtomicReferenceArray;
...
# virtual methods
.method public final a(Ljava/lang/Object;Ljava/lang/Object;Lqm6;)Ljava/lang/Object;
    .locals 8
    ...
    :goto_0
    iget-object v2, p0, Lif3;->d:Ljava/util/concurrent/atomic/AtomicReferenceArray;
    ...
    sget-object v4, Lif3;->g:Ljava/util/concurrent/atomic/AtomicIntegerFieldUpdater;
    ...
    new-instance p3, Lqm6;

    iget-object v1, p0, Lif3;->f:Llf3;

    iget-object v1, v1, Llf3;->a:Ljava/lang/ref/ReferenceQueue;
    ...
    :cond_8
    :goto_1
    iget-object v3, p0, Lif3;->e:Ljava/util/concurrent/atomic/AtomicReferenceArray;

    invoke-virtual {v3, v0}, Ljava/util/concurrent/atomic/AtomicReferenceArray;->get(I)Ljava/lang/Object;

    move-result-object v4

    instance-of p1, v4, Ll38;
...
.method public final b()Lif3;
    ...
    invoke-direct {v2, v0, v1}, Lif3;-><init>(Llf3;I)V
    ...
    :cond_3
    :goto_2
    iget-object v4, p0, Lif3;->e:Ljava/util/concurrent/atomic/AtomicReferenceArray;

    invoke-virtual {v4, v0}, Ljava/util/concurrent/atomic/AtomicReferenceArray;->get(I)Ljava/lang/Object;

    move-result-object v5

    instance-of v6, v5, Ll38;

    if-eqz v6, :cond_4

    check-cast v5, Ll38;

    iget-object v5, v5, Ll38;->a:Ljava/lang/Object;
    ...
    sget-object v6, Lmf3;->b:Ll38;

    goto :goto_3

    :cond_5
    sget-object v6, Lmf3;->a:Lkotlinx/coroutines/internal/Symbol;
    ...
    invoke-direct {v6, v5}, Ll38;-><init>(Ljava/lang/Object;)V
    ...
    invoke-virtual {v2, v3, v5, v1}, Lif3;->a(Ljava/lang/Object;Ljava/lang/Object;Lqm6;)Ljava/lang/Object;

    move-result-object v1

    sget-object v3, Lmf3;->a:Lkotlinx/coroutines/internal/Symbol;
...
.method public final c(I)V
    ...
    :goto_0
    iget-object v0, p0, Lif3;->e:Ljava/util/concurrent/atomic/AtomicReferenceArray;
