...
# direct methods
.method public synthetic constructor <init>(Lo65;JI)V
    .locals 0

    iput p4, p0, Ld65;->a:I

    iput-object p1, p0, Ld65;->b:Lo65;

    iput-wide p2, p0, Ld65;->c:J
...
.method public final run()V
    ...
    iget-object v0, p0, Ld65;->b:Lo65;

    iget-wide v1, p0, Ld65;->c:J
    ...
    invoke-virtual {v0, p0}, Lo65;->i(I)V

    goto/16 :goto_4

    :pswitch_2
    iput-object v6, v0, Lo65;->v:Ljava/lang/Long;

    iget-object p0, v0, Lo65;->n:Ljava/util/ArrayDeque;
    ...
    iget-object v8, v0, Lo65;->n:Ljava/util/ArrayDeque;
    ...
    invoke-static {v1, v2}, Lys9;->H(J)Ljava/lang/String;

    sub-long/2addr v1, v4

    invoke-static {v1, v2}, Lys9;->H(J)Ljava/lang/String;

    iget-boolean p0, v0, Lo65;->b:Z
    ...
    invoke-virtual {v1, p0}, Lmhd;->f(Ljava/lang/Class;)Ll2c;
    ...
    invoke-static {v6, p0}, Low7;->d(ILjava/lang/String;)Landroid/os/Bundle;

    move-result-object p0

    iget-object v1, v0, Lo65;->d:Landroid/media/MediaCodec;

    invoke-virtual {v1, p0}, Landroid/media/MediaCodec;->setParameters(Landroid/os/Bundle;)V

    iget-object p0, v0, Lo65;->e:Lv55;

    instance-of v1, p0, Lk65;

    if-eqz v1, :cond_3

    check-cast p0, Lk65;

    invoke-virtual {p0, v7}, Lk65;->a(Z)V
    ...
    invoke-virtual {v0}, Lo65;->g()V

    :cond_4
    invoke-virtual {v0, v3}, Lo65;->i(I)V
    ...
    :try_start_0
    iget-boolean p0, v0, Lo65;->y:Z

    if-eqz p0, :cond_5

    invoke-virtual {v0}, Lo65;->h()V
    ...
    iput-object p0, v0, Lo65;->s:Landroid/util/Range;

    iget-object p0, v0, Lo65;->d:Landroid/media/MediaCodec;
    ...
    invoke-virtual {v0, v7, v1, p0}, Lo65;->b(ILjava/lang/String;Ljava/lang/Throwable;)V
