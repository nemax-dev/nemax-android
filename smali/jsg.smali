...
.method public constructor <init>(Lhu0;Ljava/util/Random;ZZJ)V
    ...
    iput-object p1, p0, Ljsg;->Z:Lhu0;

    iput-object p2, p0, Ljsg;->r0:Ljava/util/Random;

    iput-boolean p3, p0, Ljsg;->s0:Z

    iput-boolean p4, p0, Ljsg;->t0:Z

    iput-wide p5, p0, Ljsg;->u0:J

    new-instance p2, Let0;

    invoke-direct {p2}, Ljava/lang/Object;-><init>()V

    iput-object p2, p0, Ljsg;->a:Let0;

    invoke-interface {p1}, Lhu0;->getBuffer()Let0;

    move-result-object p1

    iput-object p1, p0, Ljsg;->b:Let0;

    const/4 p1, 0x4

    new-array p1, p1, [B

    iput-object p1, p0, Ljsg;->X:[B

    new-instance p1, Lws0;

    invoke-direct {p1}, Lws0;-><init>()V

    iput-object p1, p0, Ljsg;->Y:Lws0;
...
# virtual methods
.method public final c(ILew0;)V
    .locals 5

    iget-boolean v0, p0, Ljsg;->c:Z

    if-nez v0, :cond_2

    invoke-virtual {p2}, Lew0;->c()I
    ...
    iget-object p1, p0, Ljsg;->r0:Ljava/util/Random;

    iget-object v2, p0, Ljsg;->X:[B
    ...
    invoke-virtual {p2, v1, p1}, Lew0;->k(Let0;I)V

    iget-object p1, p0, Ljsg;->Y:Lws0;

    invoke-virtual {v1, p1}, Let0;->q0(Lws0;)V

    invoke-virtual {p1, v3, v4}, Lws0;->d(J)I

    invoke-static {p1, v2}, Lvzg;->D(Lws0;[B)V

    invoke-virtual {p1}, Lws0;->close()V

    :cond_0
    iget-object p0, p0, Ljsg;->Z:Lhu0;
...
.method public final d(Lew0;)V
    ...
    iget-object v3, v0, Ljsg;->a:Let0;

    invoke-virtual {v1, v3, v2}, Lew0;->k(Let0;I)V

    iget-boolean v2, v0, Ljsg;->s0:Z

    const-wide/16 v4, 0x0

    if-eqz v2, :cond_7

    iget-object v1, v1, Lew0;->c:[B

    array-length v1, v1

    int-to-long v1, v1

    iget-wide v6, v0, Ljsg;->u0:J

    cmp-long v1, v1, v6

    if-ltz v1, :cond_7

    iget-object v1, v0, Ljsg;->o:Lm09;
    ...
    iget-boolean v2, v0, Ljsg;->t0:Z

    const/4 v6, 0x0

    invoke-direct {v1, v2, v6}, Lm09;-><init>(ZI)V

    iput-object v1, v0, Ljsg;->o:Lm09;

    :goto_0
    iget-object v2, v1, Lm09;->X:Ljava/io/Closeable;

    check-cast v2, Lfl4;

    iget-object v6, v1, Lm09;->b:Let0;
    ...
    iget-boolean v7, v1, Lm09;->c:Z

    if-eqz v7, :cond_1

    iget-object v1, v1, Lm09;->o:Ljava/lang/Object;
    ...
    invoke-virtual {v2, v3, v7, v8}, Lfl4;->R(Let0;J)V

    invoke-virtual {v2}, Lfl4;->flush()V

    sget-object v1, Ln09;->a:Lew0;

    iget-wide v7, v6, Let0;->b:J

    iget-object v2, v1, Lew0;->c:[B
    ...
    invoke-virtual {v2, v1}, Let0;->v0(I)Lafd;

    move-result-object v8

    iget-object v9, v8, Lafd;->a:[B

    iget v10, v8, Lafd;->c:I
    ...
    :goto_5
    iget-object v1, v0, Ljsg;->r0:Ljava/util/Random;

    iget-object v8, v0, Ljsg;->X:[B
