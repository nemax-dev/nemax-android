...
.method public synthetic constructor <init>(Lcom/google/firebase/iid/FirebaseInstanceIdReceiver;Landroid/content/Intent;Landroid/content/Context;ZLandroid/content/BroadcastReceiver$PendingResult;)V
    ...
    iput-object p3, p0, Lddf;->o:Ljava/lang/Object;

    iput-boolean p4, p0, Lddf;->b:Z

    iput-object p5, p0, Lddf;->X:Ljava/lang/Object;

    return-void
.end method

.method public constructor <init>(Ledf;ZLjava/io/File;Lkk5;)V
    .locals 1
    ...
    iput-object p1, p0, Lddf;->X:Ljava/lang/Object;

    iput-boolean p2, p0, Lddf;->b:Z

    iput-object p3, p0, Lddf;->c:Ljava/lang/Object;

    iput-object p4, p0, Lddf;->o:Ljava/lang/Object;
...
.method public final run()V
    ...
    iget-object v1, v0, Lddf;->c:Ljava/lang/Object;

    check-cast v1, Landroid/content/Intent;

    iget-object v2, v0, Lddf;->o:Ljava/lang/Object;

    check-cast v2, Landroid/content/Context;

    iget-boolean v3, v0, Lddf;->b:Z

    iget-object v0, v0, Lddf;->X:Ljava/lang/Object;
    ...
    invoke-direct {v0, v1}, La63;-><init>(Landroid/content/Intent;)V
    ...
    invoke-direct {v6, v10, v11}, Lko9;-><init>(Ljava/lang/String;I)V
    ...
    invoke-direct {v8, v2, v0, v7, v9}, Lmc3;-><init>(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;I)V
    ...
    invoke-virtual {v0, v1}, Lypc;->K(Landroid/content/Intent;)Lcyg;

    move-result-object v0

    invoke-static {v0}, Lxu7;->c(Lcom/google/android/gms/tasks/Task;)Ljava/lang/Object;
    ...
    :pswitch_0
    iget-object v1, v0, Lddf;->o:Ljava/lang/Object;

    check-cast v1, Lkk5;

    iget-boolean v2, v0, Lddf;->b:Z

    iget-object v3, v0, Lddf;->X:Ljava/lang/Object;

    check-cast v3, Ledf;

    iget-object v3, v3, Ldo4;->a:Ljava/io/File;

    if-eqz v2, :cond_8

    :try_start_8
    invoke-static {v3}, Llle;->c(Ljava/io/File;)V
    ...
    invoke-static {v0, v4, v2}, Ledf;->i(Ljava/io/File;BZ)V
    :try_end_8
    ...
    invoke-virtual {v1}, Lkk5;->close()V
