...
# static fields
.field public static final X:Lvs9;
...
.method public static final a(Lomc;)Lomc;
    .locals 2
    ...
    invoke-virtual {p0}, Lomc;->n()Lnmc;

    move-result-object p0

    iput-object v0, p0, Lnmc;->g:Lqmc;
...
.method public static b(Lcom/google/android/material/tabs/TabLayout;Landroid/view/View;)Landroid/graphics/RectF;
    ...
    :cond_0
    iget-boolean p0, p0, Lcom/google/android/material/tabs/TabLayout;->M0:Z

    if-nez p0, :cond_2

    instance-of p0, p1, Lene;

    if-eqz p0, :cond_2

    check-cast p1, Lene;

    invoke-virtual {p1}, Lene;->getContentWidth()I

    move-result p0

    invoke-virtual {p1}, Lene;->getContentHeight()I
...
.method public static c(Lx15;Lur7;)Lr11;
    .locals 3
...
.method public static declared-synchronized d()Lvs9;
    .locals 3
...
.method public i(Lcom/google/android/material/tabs/TabLayout;Landroid/view/View;Landroid/view/View;FLandroid/graphics/drawable/Drawable;)V
    ...
    invoke-static {p1, p2}, Lvs9;->b(Lcom/google/android/material/tabs/TabLayout;Landroid/view/View;)Landroid/graphics/RectF;

    move-result-object p0

    invoke-static {p1, p3}, Lvs9;->b(Lcom/google/android/material/tabs/TabLayout;Landroid/view/View;)Landroid/graphics/RectF;
    ...
    invoke-static {p2, p4, p3}, Lhg;->c(IFI)I
    ...
    invoke-static {p0, p4, p1}, Lhg;->c(IFI)I
...
.method public m(Ljava/lang/UnsatisfiedLinkError;[Lhyd;)Z
    ...
    invoke-virtual {v0}, Lhyd;->b()Ljava/lang/String;

    invoke-virtual {v1}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    new-instance v0, Ljava/io/File;

    iget-object v1, v1, Ldo4;->a:Ljava/io/File;
    ...
    :try_start_0
    invoke-static {v1, v0}, Llle;->d(Ljava/io/File;Ljava/io/File;)Lkk5;

    move-result-object v0

    invoke-virtual {v0}, Lkk5;->close()V
    :try_end_0
...
.method public u(Ltpd;Ljava/lang/Throwable;)V
    ...
    invoke-static {p1, p2, p0}, Lqd5;->j(Ljava/lang/Class;Ljava/lang/String;[Ljava/lang/Object;)V
...
.method public w(Lq09;)Lape;
    ...
    :try_start_4
    invoke-static {p1, v7, v8}, Lxu7;->j0(Lq09;J)J
    ...
    invoke-direct {v2, v6, v5}, Lic5;-><init>(Ljava/lang/String;Ljava/lang/Long;)V
    ...
    invoke-direct {p0, v2}, Ls41;-><init>(Ljava/lang/String;)V
