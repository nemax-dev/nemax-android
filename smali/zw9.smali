...
.method public constructor <init>(Ljava/util/concurrent/ThreadFactory;)V
    ...
    sget-boolean p1, Lv6d;->a:Z

    invoke-virtual {v0, p1}, Ljava/util/concurrent/ScheduledThreadPoolExecutor;->setRemoveOnCancelPolicy(Z)V

    iput-object v0, p0, Lzw9;->a:Ljava/util/concurrent/ScheduledThreadPoolExecutor;
...
.method public final b(Ljava/lang/Runnable;)Lvq4;
    ...
    invoke-virtual {p0, p1, v0, v1, v2}, Lzw9;->c(Ljava/lang/Runnable;JLjava/util/concurrent/TimeUnit;)Lvq4;
...
.method public final e(Ljava/lang/Runnable;JLjava/util/concurrent/TimeUnit;Lwq4;)Lq5d;
    .locals 3

    new-instance v0, Lq5d;

    invoke-direct {v0, p1, p5}, Lq5d;-><init>(Ljava/lang/Runnable;Lwq4;)V

    if-eqz p5, :cond_0

    invoke-interface {p5, v0}, Lwq4;->a(Lvq4;)Z
    ...
    :goto_0
    invoke-virtual {v0, p0}, Lq5d;->a(Ljava/util/concurrent/Future;)V
    :try_end_0
    ...
    invoke-interface {p5, v0}, Lwq4;->b(Lvq4;)Z
