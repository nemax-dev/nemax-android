...
.method public final a(Ls55;ILa1c;Ls17;)Ll63;
    ...
    iget-object p4, p4, Ls17;->a:Landroid/graphics/Bitmap$Config;

    invoke-interface {p0, p1, p4, p2, v3}, Lncb;->g(Ls55;Landroid/graphics/Bitmap$Config;ILandroid/graphics/ColorSpace;)Lo63;
    ...
    invoke-static {p0, p3, p2, p1}, Lcom/facebook/imagepipeline/image/CloseableStaticBitmap;->of(Lo63;La1c;II)Lcom/facebook/imagepipeline/image/CloseableStaticBitmap;
    ...
    :cond_1
    invoke-virtual {p0, p1, p4}, Lhg4;->b(Ls55;Ls17;)Lcom/facebook/imagepipeline/image/CloseableStaticBitmap;
    ...
    invoke-direct {p0, p2, p1}, Lcom/facebook/imagepipeline/decoder/DecodeException;-><init>(Ljava/lang/String;Ls55;)V

    throw p0

    :cond_3
    sget-object v1, Ljg4;->j:Lx17;

    if-ne v0, v1, :cond_5

    invoke-virtual {p4}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    iget-object v0, p0, Lhg4;->b:Lu17;
    ...
    sget-object p0, Laf;->a:Lcom/facebook/animated/gif/GifImage;
