...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lgjf;->p:Landroid/graphics/Matrix;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lgjf;->c:Landroid/graphics/Matrix;
    ...
    .line 8
    iput-object v0, p0, Lgjf;->m:Ljava/lang/String;

    .line 9
    iput-object v0, p0, Lgjf;->n:Ljava/lang/Boolean;
    ...
    iput-object v0, p0, Lgjf;->a:Landroid/graphics/Path;
    ...
    iput-object v0, p0, Lgjf;->b:Landroid/graphics/Path;
...
.method public constructor <init>(Lgjf;)V
    ...
    iget-object v2, p1, Lgjf;->g:Ldjf;

    invoke-direct {v1, v2, v0}, Ldjf;-><init>(Ldjf;Ljs;)V

    iput-object v1, p0, Lgjf;->g:Ldjf;

    .line 29
    new-instance v1, Landroid/graphics/Path;

    iget-object v2, p1, Lgjf;->a:Landroid/graphics/Path;

    invoke-direct {v1, v2}, Landroid/graphics/Path;-><init>(Landroid/graphics/Path;)V

    iput-object v1, p0, Lgjf;->a:Landroid/graphics/Path;

    .line 30
    new-instance v1, Landroid/graphics/Path;

    iget-object v2, p1, Lgjf;->b:Landroid/graphics/Path;

    invoke-direct {v1, v2}, Landroid/graphics/Path;-><init>(Landroid/graphics/Path;)V

    iput-object v1, p0, Lgjf;->b:Landroid/graphics/Path;
    ...
    .line 36
    iget-object v1, p1, Lgjf;->m:Ljava/lang/String;

    iput-object v1, p0, Lgjf;->m:Ljava/lang/String;
    ...
    .line 39
    :cond_0
    iget-object p1, p1, Lgjf;->n:Ljava/lang/Boolean;

    iput-object p1, p0, Lgjf;->n:Ljava/lang/Boolean;
...
# virtual methods
.method public final a(Ldjf;Landroid/graphics/Matrix;Landroid/graphics/Canvas;II)V
    .locals 20

    move-object/from16 v0, p1

    iget-object v1, v0, Ldjf;->a:Landroid/graphics/Matrix;

    iget-object v6, v0, Ldjf;->b:Ljava/util/ArrayList;

    move-object/from16 v2, p2

    invoke-virtual {v1, v2}, Landroid/graphics/Matrix;->set(Landroid/graphics/Matrix;)V

    iget-object v2, v0, Ldjf;->a:Landroid/graphics/Matrix;

    iget-object v0, v0, Ldjf;->j:Landroid/graphics/Matrix;
    ...
    invoke-virtual/range {v0 .. v5}, Lgjf;->a(Ldjf;Landroid/graphics/Matrix;Landroid/graphics/Canvas;II)V
    ...
    iget-object v12, v1, Lgjf;->c:Landroid/graphics/Matrix;
    ...
    iget-object v5, v1, Lgjf;->a:Landroid/graphics/Path;

    invoke-virtual {v5}, Landroid/graphics/Path;->reset()V

    iget-object v10, v0, Lfjf;->a:[Laua;

    if-eqz v10, :cond_3

    invoke-static {v10, v5}, Lis8;->A([Laua;Landroid/graphics/Path;)V

    :cond_3
    iget-object v10, v1, Lgjf;->b:Landroid/graphics/Path;

    invoke-virtual {v10}, Landroid/graphics/Path;->reset()V

    instance-of v11, v0, Lbjf;
    ...
    iget v15, v0, Lcjf;->j:F

    add-float/2addr v15, v13

    rem-float/2addr v15, v14

    iget-object v13, v1, Lgjf;->f:Landroid/graphics/PathMeasure;
    ...
    iput-object v13, v1, Lgjf;->f:Landroid/graphics/PathMeasure;
    ...
    iget-object v14, v1, Lgjf;->f:Landroid/graphics/PathMeasure;

    move/from16 v7, p2

    invoke-virtual {v14, v11, v13, v5, v7}, Landroid/graphics/PathMeasure;->getSegment(FFLandroid/graphics/Path;Z)Z

    iget-object v11, v1, Lgjf;->f:Landroid/graphics/PathMeasure;
    ...
    iget-object v5, v0, Lcjf;->f:Lb76;

    iget-object v7, v5, Lb76;->c:Ljava/lang/Object;
    ...
    :goto_5
    iget-object v7, v1, Lgjf;->e:Landroid/graphics/Paint;
    ...
    iput-object v7, v1, Lgjf;->e:Landroid/graphics/Paint;
    ...
    iget-object v11, v5, Lb76;->c:Ljava/lang/Object;
    ...
    iget v11, v0, Lcjf;->h:F

    sget-object v19, Ljjf;->p0:Landroid/graphics/PorterDuff$Mode;
    ...
    :goto_a
    iget-object v7, v1, Lgjf;->d:Landroid/graphics/Paint;
    ...
    iput-object v7, v1, Lgjf;->d:Landroid/graphics/Paint;
    ...
    iget-object v11, v0, Lcjf;->m:Landroid/graphics/Paint$Join;
    ...
    :cond_11
    iget-object v11, v0, Lcjf;->l:Landroid/graphics/Paint$Cap;
    ...
    iget v11, v0, Lcjf;->g:F

    sget-object v12, Ljjf;->p0:Landroid/graphics/PorterDuff$Mode;
...
.method public setAlpha(F)V
    ...
    invoke-virtual {p0, p1}, Lgjf;->setRootAlpha(I)V
