...
# direct methods
.method public constructor <init>(Landroid/content/Context;Lvl7;Lvl7;Lvl7;Lvl7;Lvl7;Lvl7;)V
    .locals 0
    ...
    iput-object p2, p0, Llla;->d:Lvl7;

    iput-object p3, p0, Llla;->b:Lvl7;

    iput-object p4, p0, Llla;->c:Lvl7;

    iput-object p5, p0, Llla;->e:Lvl7;

    iput-object p7, p0, Llla;->f:Lvl7;

    iput-object p6, p0, Llla;->g:Lvl7;

    invoke-virtual {p0}, Llla;->c()V

    const-string p1, "https"

    iput-object p1, p0, Llla;->j:Ljava/lang/String;

    const-string p1, "max.ru"

    iput-object p1, p0, Llla;->k:Ljava/lang/String;
...
.method public final a(I)V
    ...
    invoke-virtual {p0, p1, v0}, Llla;->b(ILjava/lang/String;)V
...
.method public final b(ILjava/lang/String;)V
    ...
    invoke-virtual {p0, p1, p2}, Lo2a;->a(ILjava/lang/String;)V
...
.method public final d(Lnn2;II)Lj30;
    .locals 8

    iget-wide v0, p1, Lnn2;->a:J

    iget-object v2, p1, Lnn2;->b:Ljava/lang/String;

    iget-wide v3, p1, Lnn2;->c:J

    iget-wide v5, p1, Lnn2;->l:J
    ...
    iget-object p0, p0, Llla;->a:Landroid/content/Context;
    ...
    invoke-static {p1, v0}, Lxu0;->M(Landroid/content/Intent;I)I
    ...
    invoke-direct/range {v0 .. v7}, Ltrc;-><init>(Ljava/lang/String;Ljava/lang/CharSequence;[Ljava/lang/CharSequence;ZILandroid/os/Bundle;Ljava/util/HashSet;)V

    new-instance p2, Lj30;

    sget v1, Lbdc;->tt_reply:I
...
.method public final e(Z)Landroid/content/Intent;
    ...
    invoke-static {v0, p1}, Lg48;->X0(Ljava/lang/String;Z)Lcb4;

    move-result-object v0

    invoke-virtual {p0, v0}, Llla;->j(Lcb4;)Landroid/content/Intent;
...
.method public final f(Lnn2;I)Lj30;
    .locals 11

    sget v0, Lt1d;->b:I

    iget-wide v1, p1, Lnn2;->a:J

    iget-object v3, p1, Lnn2;->b:Ljava/lang/String;

    iget-wide v4, p1, Lnn2;->c:J

    iget-wide v6, p1, Lnn2;->m:J

    iget-wide v8, p1, Lnn2;->l:J
    ...
    invoke-static {v1}, Lxu0;->g(I)I

    move-result v1

    invoke-static {p1, v1}, Lxu0;->M(Landroid/content/Intent;I)I
    ...
    sget v1, Lbdc;->tt_mark_as_read:I
...
.method public final g(Ljava/lang/String;ZZ)La1a;
    .locals 9
    ...
    invoke-direct {v0, v1, p1}, La1a;-><init>(Landroid/content/Context;Ljava/lang/String;)V

    iget-object v1, p0, Llla;->d:Lvl7;
    ...
    sget v2, Lu5c;->ic_notification:I

    iget-object v3, v0, La1a;->F:Landroid/app/Notification;
    ...
    invoke-virtual {v0, v2, v3}, La1a;->e(IZ)V
    ...
    iget-object v2, v2, Lela;->a:Landroid/content/Context;

    sget v4, Lvac;->oneme_app_name:I

    invoke-virtual {v2, v4}, Landroid/content/Context;->getString(I)Ljava/lang/String;

    move-result-object v2

    invoke-static {v2}, La1a;->b(Ljava/lang/CharSequence;)Ljava/lang/CharSequence;

    move-result-object v2

    iput-object v2, v0, La1a;->e:Ljava/lang/CharSequence;

    iput-object p1, v0, La1a;->z:Ljava/lang/String;

    iget-object p1, p0, Llla;->b:Lvl7;
    ...
    iget-object v6, p1, Li3;->g:Lyl7;

    invoke-virtual {v6, v2, v3}, Lyl7;->getBoolean(Ljava/lang/String;Z)Z

    move-result v2

    const-string v6, "app.notification.in.app.sound"

    iget-object v7, p1, Li3;->g:Lyl7;

    invoke-virtual {v7, v6, v3}, Lyl7;->getBoolean(Ljava/lang/String;Z)Z

    move-result v6

    if-eqz v6, :cond_0

    invoke-virtual {p1, v5}, Lip;->w(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {p1, v8, v6}, Lyl7;->getInt(Ljava/lang/String;I)I
    ...
    iget-object v2, v0, La1a;->F:Landroid/app/Notification;
    ...
    :goto_3
    invoke-virtual {v0, p2}, La1a;->g(Landroid/net/Uri;)V

    goto :goto_5

    :cond_6
    :goto_4
    invoke-virtual {v0, v4}, La1a;->g(Landroid/net/Uri;)V

    :goto_5
    invoke-virtual {v0, v7}, La1a;->d(I)V

    :cond_7
    if-eqz p1, :cond_8

    iget-object p2, v0, La1a;->F:Landroid/app/Notification;
...
.method public final h()Landroid/app/NotificationManager;
    ...
    iget-object v0, p0, Llla;->i:Landroid/app/NotificationManager;
    ...
    iput-object v0, p0, Llla;->i:Landroid/app/NotificationManager;

    invoke-virtual {p0}, Llla;->c()V

    :cond_0
    iget-object p0, p0, Llla;->i:Landroid/app/NotificationManager;

    return-object p0
.end method

.method public final i(Z)Lo2a;
    .locals 2

    iget-object v0, p0, Llla;->h:Lo2a;
    ...
    invoke-direct {v0, v1}, Lo2a;-><init>(Landroid/content/Context;)V

    iput-object v0, p0, Llla;->h:Lo2a;
    ...
    :cond_1
    iget-object p0, p0, Llla;->h:Lo2a;

    return-object p0
.end method

.method public final j(Lcb4;)Landroid/content/Intent;
    .locals 2
    ...
    iget-object v1, p0, Llla;->j:Ljava/lang/String;

    iget-object p0, p0, Llla;->k:Ljava/lang/String;

    invoke-static {p1, v0, v1, p0}, Lg48;->Z0(Lcb4;Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)Landroid/content/Intent;
...
.method public final k(La1a;Landroid/content/Intent;Landroid/content/Intent;ILjava/lang/String;)V
    .locals 1

    iget-object v0, p0, Llla;->a:Landroid/content/Context;

    invoke-static {v0, p4, p2}, Lxu0;->o(Landroid/content/Context;ILandroid/content/Intent;)Landroid/app/PendingIntent;

    move-result-object p2

    iput-object p2, p1, La1a;->g:Landroid/app/PendingIntent;

    if-eqz p3, :cond_0

    const/high16 p2, 0x8000000

    invoke-static {p2}, Lxu0;->g(I)I

    move-result p2

    invoke-static {p3, p2}, Lxu0;->M(Landroid/content/Intent;I)I
    ...
    iget-object p3, p1, La1a;->F:Landroid/app/Notification;

    iput-object p2, p3, Landroid/app/Notification;->deleteIntent:Landroid/app/PendingIntent;

    :cond_0
    invoke-virtual {p1}, La1a;->a()Landroid/app/Notification;

    move-result-object p1

    iget-object p2, p0, Llla;->d:Lvl7;
    ...
    invoke-virtual {p2}, Lela;->e()I

    const/4 p2, 0x1

    invoke-virtual {p0, p2}, Llla;->i(Z)Lo2a;

    move-result-object p0

    invoke-virtual {p0, p5, p4, p1}, Lo2a;->b(Ljava/lang/String;ILandroid/app/Notification;)V
    ...
    invoke-static {p1, p2, p0}, Lkug;->P(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
...
.method public final l()V
    ...
    iget-object v1, p0, Ll0a;->c:Ljd4;

    invoke-virtual {v1}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    const-string v1, "ru.oneme.app.new.activeCalls"

    invoke-virtual {p0, v1}, Ll0a;->g(Ljava/lang/String;)Landroid/app/NotificationChannel;

    move-result-object v2

    invoke-virtual {p0}, Ll0a;->a()Lk0a;

    move-result-object v3

    if-nez v2, :cond_0

    invoke-virtual {p0, v3}, Ll0a;->e(Lk0a;)V
    ...
    :cond_1
    invoke-virtual {p0}, Ll0a;->i()Landroid/app/NotificationManager;
