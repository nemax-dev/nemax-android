...
# direct methods
.method public constructor <init>(Landroid/content/Context;Lyw2;)V
    .locals 7
    ...
    invoke-direct {v1, p2, v2, v3}, Lf16;-><init>(Ljava/lang/Object;Ljava/util/concurrent/ExecutorService;I)V

    iput-object v1, p0, Lckc;->U1:Lf16;
    ...
    iput-object p2, p0, Lckc;->V1:Landroid/graphics/drawable/GradientDrawable;
    ...
    invoke-virtual {p0, v0}, Landroidx/recyclerview/widget/RecyclerView;->setItemAnimator(Lzoc;)V
    ...
    invoke-virtual {p0, v1}, Landroidx/recyclerview/widget/RecyclerView;->j(Lbpc;)V

    new-instance v1, Lgr4;

    invoke-direct {v1, p1}, Lgr4;-><init>(Landroid/content/Context;)V

    iput-object p2, v1, Lgr4;->c:Ljava/lang/Object;
    ...
    invoke-direct {p1, p2, v0, v1}, Lv9b;-><init>(ILkotlin/coroutines/Continuation;I)V
...
.method public final setContacts(Ljava/util/List;)V
    ...
    iget-object p0, p0, Lckc;->U1:Lf16;
