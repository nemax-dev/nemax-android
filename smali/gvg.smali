...
.method public constructor <init>(Lpxg;Landroid/os/IBinder;)V
    ...
    iput-object p1, p0, Lgvg;->o:Ljava/lang/Object;
...
.method public constructor <init>(Lxvg;Ljre;Ljre;)V
    .locals 1
...
.method public final a()V
    ...
    iget-object v0, p0, Lgvg;->o:Ljava/lang/Object;
    ...
    iget-object p0, p0, Lgvg;->c:Ljava/lang/Object;
    ...
    invoke-direct {v2, p0}, Ldug;-><init>(Landroid/os/IBinder;)V

    :goto_0
    iput-object v2, v0, Luxg;->m:Lhvg;

    iget-object p0, v0, Luxg;->b:Ldde;

    const-string v2, "linkToDeath"

    new-array v4, v3, [Ljava/lang/Object;

    invoke-virtual {p0, v2, v4}, Ldde;->c(Ljava/lang/String;[Ljava/lang/Object;)V

    :try_start_0
    iget-object v2, v0, Luxg;->m:Lhvg;

    invoke-interface {v2}, Landroid/os/IInterface;->asBinder()Landroid/os/IBinder;

    move-result-object v2

    iget-object v4, v0, Luxg;->j:Lkwg;
    ...
    invoke-static {p0, v4, v2}, Ldde;->e(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/String;
    ...
    :goto_1
    iput-boolean v3, v0, Luxg;->g:Z

    iget-object p0, v0, Luxg;->d:Ljava/util/ArrayList;
    ...
    iget-object v4, v0, Lxvg;->a:Luxg;

    iget-object v4, v4, Luxg;->m:Lhvg;

    iget-object v0, v0, Lxvg;->b:Ljava/lang/String;

    new-instance v5, Landroid/os/Bundle;

    invoke-direct {v5}, Landroid/os/Bundle;-><init>()V

    sget-object v6, Lcwg;->a:Ljava/util/HashMap;
    ...
    :try_start_2
    sget-object v7, Lcwg;->a:Ljava/util/HashMap;
    ...
    iget-object v7, p0, Lgvg;->o:Ljava/lang/Object;

    check-cast v7, Lxvg;

    iget-object v8, p0, Lgvg;->c:Ljava/lang/Object;

    check-cast v8, Ljre;

    iget-object v9, v7, Lxvg;->b:Ljava/lang/String;

    invoke-direct {v6, v7, v8}, Ltvg;-><init>(Lxvg;Ljre;)V
    ...
    :try_start_4
    iget-object v3, v4, Ldug;->c:Landroid/os/IBinder;
    ...
    :goto_4
    iget-object v2, p0, Lgvg;->o:Ljava/lang/Object;

    check-cast v2, Lxvg;

    sget-object v3, Lxvg;->c:Ldde;

    iget-object v2, v2, Lxvg;->b:Ljava/lang/String;
    ...
    iget-object v1, v3, Ldde;->a:Ljava/lang/Object;

    check-cast v1, Ljava/lang/String;

    invoke-static {v1, v4, v2}, Ldde;->e(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/String;
    ...
    invoke-virtual {p0, v1}, Ljre;->c(Ljava/lang/Exception;)V
