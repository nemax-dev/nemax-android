...
.method public final invoke()Ljava/lang/Object;
    ...
    iget-object p0, p0, Lee;->b:Ljava/lang/Object;

    check-cast p0, Lgr1;

    iget-object v3, p0, Lgr1;->e:Lwo0;

    monitor-enter v3

    :try_start_0
    iget-wide v4, v3, Lwo0;->c:J
    :try_end_0
    ...
    invoke-static {v6, v0}, Lwr;->J([Ljava/lang/Object;Ljava/lang/Object;)Z
    ...
    invoke-static {v2, p0, v0}, Ly30;->i(III)I
    ...
    invoke-static {v3, p0, v4, v2, v5}, Ls8e;->t(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/StringBuilder;
    ...
    invoke-direct {v1, v2, v0, p0}, Lgy6;-><init>(ILandroid/content/Context;Ljava/lang/String;)V
    ...
    invoke-direct {v0, p0}, Ltbf;-><init>(Lacf;)V
    ...
    :try_start_8
    invoke-static {v5, p0}, Lmu0;->e(Ljava/io/Closeable;Ljava/lang/Throwable;)V
    ...
    iget-object p0, p0, Lynd;->a:Landroid/content/Context;
    ...
    invoke-static {v0, v3, v4, v2}, Lkne;->Y(Ljava/lang/String;CCZ)Ljava/lang/String;
    ...
    invoke-static {v1}, Lpod;->E(Ljava/io/File;)V

    const-string p0, "session.data"

    invoke-static {v1, p0}, Llp5;->R(Ljava/io/File;Ljava/lang/String;)Ljava/io/File;
    ...
    invoke-virtual {p0}, Lee;->invoke()Ljava/lang/Object;
    ...
    invoke-static {p0}, Lh3e;->m(Lh9g;)Landroidx/lifecycle/SavedStateHandlesVM;
    ...
    iget-object v4, p0, Lra6;->c:Lqdf;

    iget-object v0, p0, Lra6;->b:Ljava/lang/String;

    const/16 v1, 0x12

    if-eqz v0, :cond_e

    iget-boolean v2, p0, Lra6;->o:Z

    if-eqz v2, :cond_e

    new-instance v2, Ljava/io/File;

    iget-object v3, p0, Lra6;->a:Landroid/content/Context;
    ...
    iget-object v1, p0, Lra6;->a:Landroid/content/Context;
    ...
    invoke-direct {v3, v5}, Lhm6;-><init>(I)V

    iget-boolean v5, p0, Lra6;->X:Z

    invoke-direct/range {v0 .. v5}, Lqa6;-><init>(Landroid/content/Context;Ljava/lang/String;Lhm6;Lqdf;Z)V
    ...
    iget-object v2, p0, Lra6;->b:Ljava/lang/String;
