...
.method public final i(Lyf5;)Z
    ...
    invoke-direct {p0, v0}, Lvya;-><init>(I)V
    ...
    invoke-interface {p1, v1, v3, v0}, Lyf5;->i(I[BI)V
    ...
    :cond_0
    invoke-interface {p1, v4}, Lyf5;->p(I)V
    ...
    invoke-static {v7, v6}, Loe0;->x(II)I
    ...
    invoke-interface {p1, v8}, Lyf5;->p(I)V

    goto :goto_1

    :cond_6
    invoke-virtual {p0, v5}, Lvya;->H(I)V

    invoke-virtual {p0}, Lvya;->t()I
...
.method public final n(Lag5;)V
    ...
    invoke-virtual {p0, p1, v0}, Lx3;->j(Lag5;Ltgf;)V
...
.method public final o(Lyf5;Li7;)I
    ...
    iget-object p2, p0, Lv3;->b:Lvya;

    iget-object v0, p2, Lvya;->a:[B

    const/16 v1, 0xae2

    const/4 v2, 0x0

    invoke-interface {p1, v0, v2, v1}, Lf74;->read([BII)I
    ...
    :cond_0
    invoke-virtual {p2, v2}, Lvya;->G(I)V

    invoke-virtual {p2, p1}, Lvya;->F(I)V
    ...
    :cond_1
    invoke-virtual {v0, p2}, Lx3;->e(Lvya;)V
