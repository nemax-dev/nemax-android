...
.method static constructor <clinit>()V
    ...
    sput-object v1, Lone/me/appearancesettings/multitheme/AppearanceSettingsMultiThemeScreen;->n0:[Lof7;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lone/me/appearancesettings/multitheme/AppearanceSettingsMultiThemeScreen;->a:Lhs7;
    ...
    iput-object v0, p0, Lone/me/appearancesettings/multitheme/AppearanceSettingsMultiThemeScreen;->b:Lth7;
    ...
    iput-object v0, p0, Lone/me/appearancesettings/multitheme/AppearanceSettingsMultiThemeScreen;->c:Ldbc;
    ...
    iput-object v0, p0, Lone/me/appearancesettings/multitheme/AppearanceSettingsMultiThemeScreen;->o:Ldbc;
    ...
    iput-object v0, p0, Lone/me/appearancesettings/multitheme/AppearanceSettingsMultiThemeScreen;->X:Ldbc;
    ...
    iput-object v0, p0, Lone/me/appearancesettings/multitheme/AppearanceSettingsMultiThemeScreen;->Y:Lth7;
    ...
    invoke-direct {v0, v3, v1, v2}, Lqy5;-><init>(Ljava/lang/Object;Ljava/util/concurrent/ExecutorService;I)V

    iput-object v0, p0, Lone/me/appearancesettings/multitheme/AppearanceSettingsMultiThemeScreen;->Z:Lqy5;
...
.method public final getScreenDelegate()Lxyc;
    ...
    iget-object p0, p0, Lone/me/appearancesettings/multitheme/AppearanceSettingsMultiThemeScreen;->a:Lhs7;
...
.method public final onCreateView(Landroid/view/LayoutInflater;Landroid/view/ViewGroup;Landroid/os/Bundle;)Landroid/view/View;
    ...
    invoke-direct {v0, v1, v3}, Lkna;-><init>(Landroid/content/Context;I)V
    ...
    invoke-direct {v4, v2, v5}, Lfq;-><init>(Lone/me/appearancesettings/multitheme/AppearanceSettingsMultiThemeScreen;I)V

    invoke-direct {v1, v4}, Lsma;-><init>(Lf96;)V
    ...
    sget-object v4, Lxbf;->v:Leue;

    invoke-static {v4, v1}, Leue;->d(Leue;Landroid/widget/TextView;)V
    ...
    invoke-static {v7, v6}, Lr7;->E(Landroid/content/Context;I)Ljava/lang/String;
    ...
    invoke-virtual {v4, v6}, Lqs9;->c(Landroid/content/Context;)Lzs4;
    ...
    invoke-static {v7, v6}, Lz8c;->M(Landroid/graphics/drawable/Drawable;I)V
    ...
    invoke-direct {v6, v10}, Lwja;-><init>(Landroid/content/Context;)V
    ...
    invoke-virtual {v6, v10}, Lwja;->setValueFrom(F)V

    const/high16 v11, 0x40a00000    # 5.0f

    invoke-virtual {v6, v11}, Lwja;->setValueTo(F)V

    const/high16 v11, 0x3f800000    # 1.0f

    invoke-virtual {v6, v11}, Lwja;->setStepSize(F)V

    iget-object v12, v2, Lone/me/appearancesettings/multitheme/AppearanceSettingsMultiThemeScreen;->Y:Lth7;
    ...
    invoke-virtual {v12, v13, v14}, Lwh7;->getInt(Ljava/lang/String;I)I

    move-result v12

    int-to-float v12, v12

    invoke-virtual {v6, v12}, Lwja;->setValue(F)V
    ...
    sget-object v13, Lxbf;->F:Leue;

    invoke-static {v13, v12, v4, v12}, Ldw1;->f(Leue;Landroid/widget/TextView;Lqs9;Landroid/widget/TextView;)Lqse;

    move-result-object v13

    iget v13, v13, Lqse;->g:I
    ...
    invoke-static {v15, v13}, Lr7;->E(Landroid/content/Context;I)Ljava/lang/String;
    ...
    invoke-direct {v13, v6, v12, v15}, Lgq;-><init>(Lwja;Landroid/widget/TextView;I)V

    invoke-static {v12, v13}, Laug;->y(Landroid/view/View;Landroid/view/View$OnClickListener;)V

    new-instance v13, Ljq;

    invoke-direct {v13, v12, v2, v15}, Ljq;-><init>(Landroid/widget/TextView;Lone/me/sdk/arch/Widget;I)V

    iget-object v15, v6, Lwja;->w0:Ljava/util/ArrayList;
    ...
    invoke-direct {v13, v15}, Lxn2;-><init>(Landroid/content/Context;)V
    ...
    invoke-direct {v3, v13, v2, v9}, Lmq;-><init>(Lxn2;Lone/me/appearancesettings/multitheme/AppearanceSettingsMultiThemeScreen;Lkotlin/coroutines/Continuation;)V

    const/4 v11, 0x3

    invoke-static {v15, v9, v9, v3, v11}, Lyr3;->Y(Lp04;Lh04;Ls04;Lt96;I)Lt1e;
    ...
    sget-object v15, Lxbf;->k:Leue;

    invoke-static {v15, v3, v4, v3}, Ldw1;->f(Leue;Landroid/widget/TextView;Lqs9;Landroid/widget/TextView;)Lqse;

    move-result-object v15

    iget v15, v15, Lqse;->e:I
    ...
    invoke-direct {v11, v5, v8}, Lll3;-><init>(II)V

    invoke-virtual {v15, v11}, Landroid/view/View;->setLayoutParams(Landroid/view/ViewGroup$LayoutParams;)V

    iget-object v11, v2, Lone/me/appearancesettings/multitheme/AppearanceSettingsMultiThemeScreen;->Z:Lqy5;

    invoke-virtual {v15, v11}, Landroidx/recyclerview/widget/RecyclerView;->setAdapter(Lygc;)V

    invoke-virtual {v15, v9}, Landroidx/recyclerview/widget/RecyclerView;->setItemAnimator(Ldhc;)V
    ...
    invoke-virtual {v15, v11}, Landroidx/recyclerview/widget/RecyclerView;->j(Lehc;)V
    ...
    invoke-direct {v10, v2, v8}, Lfq;-><init>(Lone/me/appearancesettings/multitheme/AppearanceSettingsMultiThemeScreen;I)V

    invoke-direct {v14, v11, v10}, Lpz5;-><init>(Landroid/content/Context;Lfq;)V

    invoke-virtual {v15, v14}, Landroidx/recyclerview/widget/RecyclerView;->j(Lehc;)V
    ...
    invoke-static {v10, v4}, Lr7;->E(Landroid/content/Context;I)Ljava/lang/String;
    ...
    invoke-direct {v10, v11, v14}, Lll3;-><init>(II)V
    ...
    invoke-direct {v10, v2}, Lhq;-><init>(Lone/me/appearancesettings/multitheme/AppearanceSettingsMultiThemeScreen;)V
    ...
    sget v5, Lw5c;->Theme_MaterialComponents_DayNight:I

    invoke-direct {v10, v14, v5}, Lww3;-><init>(Landroid/content/Context;I)V

    invoke-virtual {v2}, Lone/me/appearancesettings/multitheme/AppearanceSettingsMultiThemeScreen;->x0()Lzq;

    move-result-object v5

    iget-object v5, v5, Lzq;->w0:Ljava/util/ArrayList;
    ...
    invoke-virtual {v14}, Lwp;->getItemId()J
    ...
    sget-object v9, Lxbf;->E:Leue;

    invoke-static {v9, v11}, Leue;->d(Leue;Landroid/widget/TextView;)V
    ...
    invoke-direct {v10, v14, v5, v9}, Liq;-><init>(ILkotlin/coroutines/Continuation;I)V

    invoke-static {v10, v11}, Lu77;->J(Lv96;Landroid/view/View;)V
    ...
    iget-object v7, v7, Lqca;->a:Ljbc;

    new-instance v9, Ltb;

    const/4 v10, 0x1

    invoke-direct {v9, v7, v2, v10}, Ltb;-><init>(Lbq5;Ljava/lang/Object;I)V
    ...
    invoke-static {v9, v0}, Lfog;->y(Lbq5;Lh04;)Lbq5;
    ...
    invoke-direct {v7, v13, v9}, Lnq;-><init>(Lxn2;Lkotlin/coroutines/Continuation;)V

    new-instance v9, Lgs5;

    invoke-direct {v9, v0, v7, v10}, Lgs5;-><init>(Lbq5;Lt96;I)V

    invoke-virtual {v2}, Lone/me/sdk/arch/Widget;->getViewLifecycleScope()Lfk7;

    move-result-object v0

    invoke-static {v9, v0}, Lfog;->G(Lbq5;Lp04;)Lt1e;
    ...
    invoke-static {v5}, Lcp;->o(Landroidx/constraintlayout/widget/ConstraintLayout;)Lul3;
    ...
    invoke-virtual {v0, v7, v9, v10, v9}, Lul3;->d(IIII)V
    ...
    invoke-direct {v11, v0, v9, v7, v10}, Le4a;-><init>(Ljava/lang/Object;III)V
    ...
    invoke-virtual {v11, v7}, Le4a;->e(I)V
    ...
    invoke-direct {v10, v0, v9, v7, v11}, Le4a;-><init>(Ljava/lang/Object;III)V
    ...
    invoke-virtual {v10, v7}, Le4a;->e(I)V
    ...
    invoke-virtual {v0, v7, v9, v10, v11}, Lul3;->d(IIII)V
    ...
    invoke-virtual {v0, v7, v11, v10, v11}, Lul3;->d(IIII)V
    ...
    invoke-virtual {v0, v7, v10, v6, v11}, Lul3;->d(IIII)V

    new-instance v6, Le4a;

    const/4 v11, 0x5

    invoke-direct {v6, v0, v10, v7, v11}, Le4a;-><init>(Ljava/lang/Object;III)V
    ...
    invoke-static {v14, v10, v6}, Ldw1;->q(FFLe4a;)V
    ...
    invoke-direct {v6, v0, v11, v7, v10}, Le4a;-><init>(Ljava/lang/Object;III)V
    ...
    invoke-virtual {v6, v7}, Le4a;->e(I)V
    ...
    invoke-virtual {v0, v6, v10, v7, v11}, Lul3;->d(IIII)V

    new-instance v7, Le4a;

    const/4 v11, 0x5

    invoke-direct {v7, v0, v10, v6, v11}, Le4a;-><init>(Ljava/lang/Object;III)V
    ...
    invoke-static {v9, v11, v7}, Ldw1;->q(FFLe4a;)V

    const/4 v7, 0x0

    const/4 v11, 0x6

    invoke-virtual {v0, v6, v11, v7, v11}, Lul3;->d(IIII)V
    ...
    invoke-virtual {v0, v6, v10, v4, v11}, Lul3;->d(IIII)V

    new-instance v4, Le4a;

    const/4 v9, 0x5

    invoke-direct {v4, v0, v10, v6, v9}, Le4a;-><init>(Ljava/lang/Object;III)V
    ...
    invoke-static {v14, v9, v4}, Ldw1;->q(FFLe4a;)V
    ...
    invoke-virtual {v0, v4, v10, v6, v11}, Lul3;->d(IIII)V

    new-instance v6, Le4a;

    const/4 v9, 0x5

    invoke-direct {v6, v0, v10, v4, v9}, Le4a;-><init>(Ljava/lang/Object;III)V
    ...
    invoke-static {v14, v9, v6}, Ldw1;->q(FFLe4a;)V

    const/4 v11, 0x6

    invoke-virtual {v0, v4, v11, v7, v11}, Lul3;->d(IIII)V
    ...
    invoke-virtual {v0, v4, v10, v3, v11}, Lul3;->d(IIII)V

    new-instance v3, Le4a;

    const/4 v6, 0x5

    invoke-direct {v3, v0, v10, v4, v6}, Le4a;-><init>(Ljava/lang/Object;III)V
    ...
    invoke-static {v14, v6, v3}, Ldw1;->q(FFLe4a;)V
    ...
    invoke-virtual {v0, v5}, Lul3;->a(Landroidx/constraintlayout/widget/ConstraintLayout;)V
...
.method public final onViewCreated(Landroid/view/View;)V
    ...
    invoke-direct {v0, v2, p0}, Lpq;-><init>(Lkotlin/coroutines/Continuation;Lone/me/appearancesettings/multitheme/AppearanceSettingsMultiThemeScreen;)V
...
.method public final x0()Lzq;
    .locals 0

    iget-object p0, p0, Lone/me/appearancesettings/multitheme/AppearanceSettingsMultiThemeScreen;->b:Lth7;
