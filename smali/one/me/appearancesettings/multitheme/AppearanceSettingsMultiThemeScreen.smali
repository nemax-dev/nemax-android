...
.method static constructor <clinit>()V
    ...
    sput-object v1, Lone/me/appearancesettings/multitheme/AppearanceSettingsMultiThemeScreen;->r0:[Lqj7;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lone/me/appearancesettings/multitheme/AppearanceSettingsMultiThemeScreen;->a:Lcub;
    ...
    iput-object v0, p0, Lone/me/appearancesettings/multitheme/AppearanceSettingsMultiThemeScreen;->b:Lvl7;
    ...
    iput-object v0, p0, Lone/me/appearancesettings/multitheme/AppearanceSettingsMultiThemeScreen;->c:Luic;
    ...
    iput-object v0, p0, Lone/me/appearancesettings/multitheme/AppearanceSettingsMultiThemeScreen;->o:Luic;
    ...
    iput-object v0, p0, Lone/me/appearancesettings/multitheme/AppearanceSettingsMultiThemeScreen;->X:Luic;
    ...
    iput-object v0, p0, Lone/me/appearancesettings/multitheme/AppearanceSettingsMultiThemeScreen;->Y:Lvl7;
    ...
    invoke-direct {v3, v2}, Loq;-><init>(Lwq;)V
    ...
    invoke-direct {v0, v3, v1, v2}, Lf16;-><init>(Ljava/lang/Object;Ljava/util/concurrent/ExecutorService;I)V

    iput-object v0, p0, Lone/me/appearancesettings/multitheme/AppearanceSettingsMultiThemeScreen;->Z:Lf16;
...
.method public final getScreenDelegate()Lq7d;
    ...
    iget-object p0, p0, Lone/me/appearancesettings/multitheme/AppearanceSettingsMultiThemeScreen;->a:Lcub;
...
.method public final onCreateView(Landroid/view/LayoutInflater;Landroid/view/ViewGroup;Landroid/os/Bundle;)Landroid/view/View;
    ...
    invoke-direct {v0, v1, v3}, Lusa;-><init>(Landroid/content/Context;I)V
    ...
    invoke-direct {v4, v2, v5}, Ldq;-><init>(Lone/me/appearancesettings/multitheme/AppearanceSettingsMultiThemeScreen;I)V

    invoke-direct {v1, v4}, Lcsa;-><init>(Lmc6;)V
    ...
    sget-object v4, Lbmf;->v:Ls3f;

    invoke-static {v4, v1}, Ls3f;->d(Ls3f;Landroid/widget/TextView;)V
    ...
    invoke-static {v7, v6}, Lv7;->v(Landroid/content/Context;I)Ljava/lang/String;
    ...
    invoke-virtual {v4, v6}, Lrx9;->l(Landroid/content/Context;)Lfv4;
    ...
    invoke-interface {v6}, Lvra;->b()Lhe0;

    move-result-object v6

    iget v6, v6, Lhe0;->h:I

    invoke-static {v7, v6}, Lv7;->M(Landroid/graphics/drawable/Drawable;I)V
    ...
    invoke-direct {v6, v10}, Ldpa;-><init>(Landroid/content/Context;)V
    ...
    invoke-virtual {v6, v10}, Ldpa;->setValueFrom(F)V

    const/high16 v11, 0x40a00000    # 5.0f

    invoke-virtual {v6, v11}, Ldpa;->setValueTo(F)V

    const/high16 v11, 0x3f800000    # 1.0f

    invoke-virtual {v6, v11}, Ldpa;->setStepSize(F)V

    iget-object v12, v2, Lone/me/appearancesettings/multitheme/AppearanceSettingsMultiThemeScreen;->Y:Lvl7;
    ...
    invoke-virtual {v12, v13, v14}, Lyl7;->getInt(Ljava/lang/String;I)I

    move-result v12

    int-to-float v12, v12

    invoke-virtual {v6, v12}, Ldpa;->setValue(F)V
    ...
    sget-object v13, Lbmf;->F:Ls3f;

    invoke-static {v13, v12}, Ls3f;->d(Ls3f;Landroid/widget/TextView;)V

    invoke-virtual {v4, v12}, Lrx9;->n(Landroid/view/View;)Lvra;
    ...
    invoke-static {v15, v13}, Lv7;->v(Landroid/content/Context;I)Ljava/lang/String;
    ...
    invoke-direct {v13, v6, v15, v12}, Lpb;-><init>(Ljava/lang/Object;ILjava/lang/Object;)V

    invoke-static {v12, v13}, Lo58;->M(Landroid/view/View;Landroid/view/View$OnClickListener;)V

    new-instance v13, Lgq;

    invoke-direct {v13, v12, v2}, Lgq;-><init>(Landroid/widget/TextView;Lone/me/appearancesettings/multitheme/AppearanceSettingsMultiThemeScreen;)V

    iget-object v15, v6, Ldpa;->A0:Ljava/util/ArrayList;
    ...
    invoke-direct {v13, v15}, Lmo2;-><init>(Landroid/content/Context;)V
    ...
    invoke-direct {v3, v13, v2, v9}, Ljq;-><init>(Lmo2;Lone/me/appearancesettings/multitheme/AppearanceSettingsMultiThemeScreen;Lkotlin/coroutines/Continuation;)V

    const/4 v11, 0x3

    invoke-static {v15, v9, v9, v3, v11}, Lvzg;->s(Lf14;Lx04;Li14;Lad6;I)Lwae;
    ...
    sget-object v15, Lbmf;->k:Ls3f;

    invoke-static {v15, v3}, Ls3f;->d(Ls3f;Landroid/widget/TextView;)V

    invoke-virtual {v4, v3}, Lrx9;->n(Landroid/view/View;)Lvra;

    move-result-object v15

    invoke-interface {v15}, Lvra;->getText()Le2f;

    move-result-object v15

    iget v15, v15, Le2f;->e:I
    ...
    invoke-direct {v11, v5, v8}, Lam3;-><init>(II)V

    invoke-virtual {v15, v11}, Landroid/view/View;->setLayoutParams(Landroid/view/ViewGroup$LayoutParams;)V

    iget-object v11, v2, Lone/me/appearancesettings/multitheme/AppearanceSettingsMultiThemeScreen;->Z:Lf16;

    invoke-virtual {v15, v11}, Landroidx/recyclerview/widget/RecyclerView;->setAdapter(Luoc;)V

    invoke-virtual {v15, v9}, Landroidx/recyclerview/widget/RecyclerView;->setItemAnimator(Lzoc;)V
    ...
    new-instance v11, Lg61;

    const/16 v14, 0xb

    invoke-direct {v11, v14}, Lg61;-><init>(I)V

    invoke-virtual {v15, v11}, Landroidx/recyclerview/widget/RecyclerView;->j(Lbpc;)V

    invoke-virtual {v15}, Landroid/view/View;->getContext()Landroid/content/Context;

    move-result-object v11

    new-instance v14, Le26;

    new-instance v10, Ldq;

    const/4 v8, 0x1

    invoke-direct {v10, v2, v8}, Ldq;-><init>(Lone/me/appearancesettings/multitheme/AppearanceSettingsMultiThemeScreen;I)V

    invoke-direct {v14, v11, v10}, Le26;-><init>(Landroid/content/Context;Ldq;)V

    invoke-virtual {v15, v14}, Landroidx/recyclerview/widget/RecyclerView;->j(Lbpc;)V
    ...
    invoke-static {v10, v4}, Lv7;->v(Landroid/content/Context;I)Ljava/lang/String;
    ...
    invoke-direct {v10, v11, v14}, Lam3;-><init>(II)V
    ...
    sget v5, Lldc;->Theme_MaterialComponents_DayNight:I

    invoke-direct {v10, v14, v5}, Lmx3;-><init>(Landroid/content/Context;I)V

    invoke-virtual {v2}, Lone/me/appearancesettings/multitheme/AppearanceSettingsMultiThemeScreen;->y0()Lwq;

    move-result-object v5

    iget-object v5, v5, Lwq;->C0:Ljava/util/ArrayList;
    ...
    invoke-virtual {v14}, Laq;->getItemId()J
    ...
    sget-object v9, Lbmf;->E:Ls3f;

    invoke-static {v9, v11}, Ls3f;->d(Ls3f;Landroid/widget/TextView;)V
    ...
    invoke-direct {v10, v14, v5, v9}, Lfq;-><init>(ILkotlin/coroutines/Continuation;I)V

    invoke-static {v10, v11}, Lsya;->s(Lcd6;Landroid/view/View;)V
    ...
    invoke-virtual {v7, v9}, Ly4;->c(Ljava/lang/Class;)Ljava/lang/Object;

    move-result-object v7

    check-cast v7, Lsha;

    iget-object v7, v7, Lsha;->a:Lajc;

    new-instance v9, Lwb;

    const/4 v10, 0x1

    invoke-direct {v9, v7, v2, v10}, Lwb;-><init>(Lss5;Ljava/lang/Object;I)V
    ...
    invoke-static {v9, v0}, Lha7;->D(Lss5;Lx04;)Lss5;
    ...
    invoke-direct {v7, v13, v9}, Lkq;-><init>(Lmo2;Lkotlin/coroutines/Continuation;)V

    new-instance v9, Lxu5;

    invoke-direct {v9, v0, v7, v10}, Lxu5;-><init>(Lss5;Lad6;I)V

    invoke-virtual {v2}, Lone/me/sdk/arch/Widget;->getViewLifecycleScope()Lfo7;

    move-result-object v0

    invoke-static {v9, v0}, Lha7;->N(Lss5;Lf14;)Lwae;
    ...
    invoke-static {v5}, Lys9;->h(Landroidx/constraintlayout/widget/ConstraintLayout;)Lkm3;
    ...
    invoke-virtual {v0, v7, v9, v10, v9}, Lkm3;->d(IIII)V
    ...
    invoke-direct {v11, v0, v9, v7, v10}, Lc9a;-><init>(Ljava/lang/Object;III)V
    ...
    invoke-virtual {v11, v7}, Lc9a;->e(I)V
    ...
    invoke-direct {v10, v0, v9, v7, v11}, Lc9a;-><init>(Ljava/lang/Object;III)V
    ...
    invoke-virtual {v10, v7}, Lc9a;->e(I)V
    ...
    invoke-virtual {v0, v7, v9, v10, v11}, Lkm3;->d(IIII)V
    ...
    invoke-virtual {v0, v7, v11, v10, v11}, Lkm3;->d(IIII)V
    ...
    invoke-virtual {v0, v7, v10, v6, v11}, Lkm3;->d(IIII)V

    new-instance v6, Lc9a;

    const/4 v11, 0x5

    invoke-direct {v6, v0, v10, v7, v11}, Lc9a;-><init>(Ljava/lang/Object;III)V
    ...
    invoke-static {v14, v10, v6}, Lmw1;->q(FFLc9a;)V
    ...
    invoke-direct {v6, v0, v11, v7, v10}, Lc9a;-><init>(Ljava/lang/Object;III)V
    ...
    invoke-virtual {v6, v7}, Lc9a;->e(I)V
    ...
    invoke-virtual {v0, v6, v10, v7, v11}, Lkm3;->d(IIII)V

    new-instance v7, Lc9a;

    const/4 v11, 0x5

    invoke-direct {v7, v0, v10, v6, v11}, Lc9a;-><init>(Ljava/lang/Object;III)V
    ...
    invoke-static {v9, v11, v7}, Lmw1;->q(FFLc9a;)V

    const/4 v7, 0x0

    const/4 v11, 0x6

    invoke-virtual {v0, v6, v11, v7, v11}, Lkm3;->d(IIII)V
    ...
    invoke-virtual {v0, v6, v10, v4, v11}, Lkm3;->d(IIII)V

    new-instance v4, Lc9a;

    const/4 v9, 0x5

    invoke-direct {v4, v0, v10, v6, v9}, Lc9a;-><init>(Ljava/lang/Object;III)V
    ...
    invoke-static {v14, v9, v4}, Lmw1;->q(FFLc9a;)V
    ...
    invoke-virtual {v0, v4, v10, v6, v11}, Lkm3;->d(IIII)V

    new-instance v6, Lc9a;

    const/4 v9, 0x5

    invoke-direct {v6, v0, v10, v4, v9}, Lc9a;-><init>(Ljava/lang/Object;III)V
    ...
    invoke-static {v14, v9, v6}, Lmw1;->q(FFLc9a;)V

    const/4 v11, 0x6

    invoke-virtual {v0, v4, v11, v7, v11}, Lkm3;->d(IIII)V
    ...
    invoke-virtual {v0, v4, v10, v3, v11}, Lkm3;->d(IIII)V

    new-instance v3, Lc9a;

    const/4 v6, 0x5

    invoke-direct {v3, v0, v10, v4, v6}, Lc9a;-><init>(Ljava/lang/Object;III)V
    ...
    invoke-static {v14, v6, v3}, Lmw1;->q(FFLc9a;)V
    ...
    invoke-virtual {v0, v5}, Lkm3;->a(Landroidx/constraintlayout/widget/ConstraintLayout;)V
    ...
    invoke-static {v9}, Lh3e;->f(Landroid/view/View;)V
    ...
    invoke-static {v0, v9}, Lsya;->s(Lcd6;Landroid/view/View;)V
...
.method public final onViewCreated(Landroid/view/View;)V
    ...
    invoke-direct {v0, v2, p0}, Lmq;-><init>(Lkotlin/coroutines/Continuation;Lone/me/appearancesettings/multitheme/AppearanceSettingsMultiThemeScreen;)V
...
.method public final y0()Lwq;
    .locals 0

    iget-object p0, p0, Lone/me/appearancesettings/multitheme/AppearanceSettingsMultiThemeScreen;->b:Lvl7;
