...
# direct methods
.method public constructor <init>(Landroid/content/Context;Lth7;Lth7;Lth7;Lth7;Lth7;Lth7;)V
    .locals 0
    ...
    iput-object p2, p0, Lega;->d:Lth7;

    iput-object p3, p0, Lega;->b:Lth7;

    iput-object p4, p0, Lega;->c:Lth7;

    iput-object p5, p0, Lega;->e:Lth7;

    iput-object p7, p0, Lega;->f:Lth7;

    iput-object p6, p0, Lega;->g:Lth7;

    invoke-virtual {p0}, Lega;->c()V

    const-string p1, "https"

    iput-object p1, p0, Lega;->j:Ljava/lang/String;

    const-string p1, "max.ru"

    iput-object p1, p0, Lega;->k:Ljava/lang/String;
...
.method public final a(I)V
    ...
    invoke-virtual {p0, p1, v0}, Lega;->b(ILjava/lang/String;)V
...
.method public final b(ILjava/lang/String;)V
    ...
    iget-object p0, p0, Ltx9;->b:Landroid/app/NotificationManager;
...
.method public final d(Lwm2;II)Lh40;
    .locals 8

    iget-wide v0, p1, Lwm2;->a:J

    iget-object v2, p1, Lwm2;->b:Ljava/lang/String;

    iget-wide v3, p1, Lwm2;->c:J

    iget-wide v5, p1, Lwm2;->l:J
    ...
    iget-object p0, p0, Lega;->a:Landroid/content/Context;
    ...
    invoke-static {p1, v0}, Lpo9;->Y(Landroid/content/Intent;I)I
    ...
    invoke-direct/range {v0 .. v7}, Lkjc;-><init>(Ljava/lang/String;Ljava/lang/CharSequence;[Ljava/lang/CharSequence;ZILandroid/os/Bundle;Ljava/util/HashSet;)V

    new-instance p2, Lh40;

    sget v1, Lm5c;->tt_reply:I

    invoke-virtual {p0, v1}, Landroid/content/Context;->getString(I)Ljava/lang/String;

    move-result-object p0

    invoke-direct {p2, p3, p0, p1}, Lh40;-><init>(ILjava/lang/String;Landroid/app/PendingIntent;)V

    new-instance p0, Ljava/util/ArrayList;

    invoke-direct {p0}, Ljava/util/ArrayList;-><init>()V

    iput-object p0, p2, Lh40;->d:Ljava/lang/Object;

    iget-object p0, p2, Lh40;->d:Ljava/lang/Object;
...
.method public final e(Z)Landroid/content/Intent;
    ...
    invoke-static {v0, p1}, Lg08;->x0(Ljava/lang/String;Z)Ly94;

    move-result-object v0

    invoke-virtual {p0, v0}, Lega;->j(Ly94;)Landroid/content/Intent;
...
.method public final f(Lwm2;I)Lh40;
    .locals 11
    ...
    iget-object v3, p1, Lwm2;->b:Ljava/lang/String;

    iget-wide v4, p1, Lwm2;->c:J

    iget-wide v6, p1, Lwm2;->m:J

    iget-wide v8, p1, Lwm2;->l:J
    ...
    invoke-static {v1}, Lpo9;->j(I)I

    move-result v1

    invoke-static {p1, v1}, Lpo9;->Y(Landroid/content/Intent;I)I
    ...
    sget v1, Lm5c;->tt_mark_as_read:I

    invoke-virtual {p0, v1}, Landroid/content/Context;->getString(I)Ljava/lang/String;

    move-result-object p0

    invoke-direct {p2, v0, p0, p1}, Lh40;-><init>(ILjava/lang/String;Landroid/app/PendingIntent;)V
...
.method public final g(Ljava/lang/String;ZZ)Lfw9;
    .locals 9
    ...
    invoke-direct {v0, v1, p1}, Lfw9;-><init>(Landroid/content/Context;Ljava/lang/String;)V

    iget-object v1, p0, Lega;->d:Lth7;
    ...
    sget v2, Lcyb;->ic_notification:I

    iget-object v3, v0, Lfw9;->F:Landroid/app/Notification;
    ...
    invoke-virtual {v0, v2, v3}, Lfw9;->e(IZ)V
    ...
    iget-object v2, v2, Lxfa;->a:Landroid/content/Context;

    sget v4, Lg3c;->oneme_app_name:I

    invoke-virtual {v2, v4}, Landroid/content/Context;->getString(I)Ljava/lang/String;

    move-result-object v2

    invoke-static {v2}, Lfw9;->b(Ljava/lang/CharSequence;)Ljava/lang/CharSequence;

    move-result-object v2

    iput-object v2, v0, Lfw9;->e:Ljava/lang/CharSequence;

    iput-object p1, v0, Lfw9;->z:Ljava/lang/String;

    iget-object p1, p0, Lega;->b:Lth7;
    ...
    iget-object v6, p1, Ld3;->g:Lwh7;

    invoke-virtual {v6, v2, v3}, Lwh7;->getBoolean(Ljava/lang/String;Z)Z

    move-result v2

    const-string v6, "app.notification.in.app.sound"

    iget-object v7, p1, Ld3;->g:Lwh7;

    invoke-virtual {v7, v6, v3}, Lwh7;->getBoolean(Ljava/lang/String;Z)Z

    move-result v6

    if-eqz v6, :cond_0

    invoke-virtual {p1, v5}, Lbp;->v(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {p1, v8, v6}, Lwh7;->getInt(Ljava/lang/String;I)I
    ...
    iget-object v2, v0, Lfw9;->F:Landroid/app/Notification;
    ...
    :cond_6
    :goto_4
    invoke-virtual {v0, v4}, Lfw9;->g(Landroid/net/Uri;)V

    :goto_5
    invoke-virtual {v0, v7}, Lfw9;->d(I)V

    :cond_7
    if-eqz p1, :cond_8

    iget-object p2, v0, Lfw9;->F:Landroid/app/Notification;
...
.method public final h()Landroid/app/NotificationManager;
    ...
    iget-object v0, p0, Lega;->i:Landroid/app/NotificationManager;
    ...
    iput-object v0, p0, Lega;->i:Landroid/app/NotificationManager;

    invoke-virtual {p0}, Lega;->c()V

    :cond_0
    iget-object p0, p0, Lega;->i:Landroid/app/NotificationManager;

    return-object p0
.end method

.method public final i(Z)Ltx9;
    .locals 2

    iget-object v0, p0, Lega;->h:Ltx9;
    ...
    invoke-direct {v0, v1}, Ltx9;-><init>(Landroid/content/Context;)V

    iput-object v0, p0, Lega;->h:Ltx9;
    ...
    :cond_1
    iget-object p0, p0, Lega;->h:Ltx9;

    return-object p0
.end method

.method public final j(Ly94;)Landroid/content/Intent;
    .locals 3
    ...
    iget-object v2, p0, Lega;->a:Landroid/content/Context;
    ...
    iget-object v2, p0, Lega;->j:Ljava/lang/String;
    ...
    iget-object p0, p0, Lega;->k:Ljava/lang/String;
...
.method public final k(Lfw9;Landroid/content/Intent;Landroid/content/Intent;ILjava/lang/String;)V
    .locals 1

    iget-object v0, p0, Lega;->a:Landroid/content/Context;

    invoke-static {v0, p4, p2}, Lpo9;->l(Landroid/content/Context;ILandroid/content/Intent;)Landroid/app/PendingIntent;

    move-result-object p2

    iput-object p2, p1, Lfw9;->g:Landroid/app/PendingIntent;

    if-eqz p3, :cond_0

    const/high16 p2, 0x8000000

    invoke-static {p2}, Lpo9;->j(I)I

    move-result p2

    invoke-static {p3, p2}, Lpo9;->Y(Landroid/content/Intent;I)I
    ...
    iget-object p3, p1, Lfw9;->F:Landroid/app/Notification;

    iput-object p2, p3, Landroid/app/Notification;->deleteIntent:Landroid/app/PendingIntent;

    :cond_0
    invoke-virtual {p1}, Lfw9;->a()Landroid/app/Notification;

    move-result-object p1

    iget-object p2, p0, Lega;->d:Lth7;
    ...
    invoke-virtual {p2}, Lxfa;->e()I

    const/4 p2, 0x1

    invoke-virtual {p0, p2}, Lega;->i(Z)Ltx9;

    move-result-object p0

    invoke-virtual {p0, p5, p4, p1}, Ltx9;->a(Ljava/lang/String;ILandroid/app/Notification;)V
    ...
    invoke-static {p1, p2, p0}, Lz76;->H(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
...
.method public final l()V
    ...
    iget-object v1, p0, Lqv9;->c:Lkc4;

    invoke-virtual {v1}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    const-string v1, "ru.oneme.app.new.activeCalls"

    invoke-virtual {p0, v1}, Lqv9;->g(Ljava/lang/String;)Landroid/app/NotificationChannel;

    move-result-object v2

    invoke-virtual {p0}, Lqv9;->a()Lpv9;

    move-result-object v3

    if-nez v2, :cond_0

    invoke-virtual {p0, v3}, Lqv9;->e(Lpv9;)V
    ...
    :cond_1
    invoke-virtual {p0}, Lqv9;->i()Landroid/app/NotificationManager;
