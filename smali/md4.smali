...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lmd4;->d:Ljava/lang/String;
    ...
    sput-object v0, Lmd4;->e:[Ljava/lang/String;
...
.method public static a(Ljava/lang/String;)Ljava/util/ArrayList;
    ...
    invoke-direct {v6, v7, v8, v5}, Lxce;-><init>(III)V
...
.method public static e(Landroid/database/Cursor;)Loq4;
    .locals 23
    ...
    invoke-static {v3}, Lmd4;->a(Ljava/lang/String;)Ljava/util/ArrayList;
    ...
    invoke-direct/range {v3 .. v10}, Lgs4;-><init>(Ljava/lang/String;Landroid/net/Uri;Ljava/lang/String;Ljava/util/List;[BLjava/lang/String;[B)V
...
.method public static f(Landroid/database/Cursor;)Loq4;
    .locals 23
    ...
    invoke-static {v2}, Lmd4;->a(Ljava/lang/String;)Ljava/util/ArrayList;
    ...
    invoke-direct/range {v2 .. v9}, Lgs4;-><init>(Ljava/lang/String;Landroid/net/Uri;Ljava/lang/String;Ljava/util/List;[BLjava/lang/String;[B)V
...
.method public static h(Landroid/database/sqlite/SQLiteDatabase;)Ljava/util/ArrayList;
    ...
    invoke-static {v2, v1}, Lfif;->c0(Landroid/database/sqlite/SQLiteDatabase;Ljava/lang/String;)Z
    ...
    invoke-static {v1}, Lmd4;->f(Landroid/database/Cursor;)Loq4;
...
.method public final b()V
    ...
    :cond_0
    :try_start_1
    iget-object v1, p0, Lmd4;->a:La74;

    invoke-interface {v1}, La74;->getReadableDatabase()Landroid/database/sqlite/SQLiteDatabase;
    ...
    invoke-static {v1, v3, v2}, Lakf;->a(Landroid/database/sqlite/SQLiteDatabase;ILjava/lang/String;)I
    ...
    invoke-static {v4, v3, v5, v2}, Lakf;->b(Landroid/database/sqlite/SQLiteDatabase;ILjava/lang/String;I)V

    const/4 v2, 0x2

    if-ne v1, v2, :cond_1

    invoke-static {v4}, Lmd4;->h(Landroid/database/sqlite/SQLiteDatabase;)Ljava/util/ArrayList;
    ...
    invoke-virtual {p0, v2, v4}, Lmd4;->j(Loq4;Landroid/database/sqlite/SQLiteDatabase;)V
...
.method public final c(Ljava/lang/String;[Ljava/lang/String;)Landroid/database/Cursor;
    ...
    iget-object p0, p0, Lmd4;->a:La74;

    invoke-interface {p0}, La74;->getReadableDatabase()Landroid/database/sqlite/SQLiteDatabase;

    move-result-object v0

    const-string v1, "ExoPlayerDownloads"

    sget-object v2, Lmd4;->e:[Ljava/lang/String;
...
.method public final d(Ljava/lang/String;)Loq4;
    .locals 1

    invoke-virtual {p0}, Lmd4;->b()V
    ...
    invoke-virtual {p0, v0, p1}, Lmd4;->c(Ljava/lang/String;[Ljava/lang/String;)Landroid/database/Cursor;
    ...
    invoke-static {p0}, Lmd4;->e(Landroid/database/Cursor;)Loq4;
...
.method public final i(Loq4;)V
    .locals 1

    invoke-virtual {p0}, Lmd4;->b()V

    :try_start_0
    iget-object v0, p0, Lmd4;->a:La74;

    invoke-interface {v0}, La74;->getWritableDatabase()Landroid/database/sqlite/SQLiteDatabase;

    move-result-object v0

    invoke-virtual {p0, p1, v0}, Lmd4;->j(Loq4;Landroid/database/sqlite/SQLiteDatabase;)V
    :try_end_0
    .catch Landroid/database/sqlite/SQLiteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public final j(Loq4;Landroid/database/sqlite/SQLiteDatabase;)V
    .locals 7

    iget-object p0, p1, Loq4;->a:Lgs4;

    iget-object p0, p0, Lgs4;->X:[B
    ...
    iget-object v1, v1, Lgs4;->c:Ljava/lang/String;
    ...
    iget-object v1, v1, Lgs4;->b:Landroid/net/Uri;
    ...
    iget-object v1, v1, Lgs4;->o:Ljava/util/List;
    ...
    iget-object p1, p1, Loq4;->h:Lfs4;

    iget-wide v1, p1, Lfs4;->a:J
...
.method public final k()V
    ...
    invoke-interface {p0}, La74;->getWritableDatabase()Landroid/database/sqlite/SQLiteDatabase;
...
.method public final m(ILjava/lang/String;)V
    ...
    sget-object v3, Lmd4;->d:Ljava/lang/String;
