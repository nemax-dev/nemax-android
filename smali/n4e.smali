...
.method static constructor <clinit>()V
    ...
    sput-object v0, Ln4e;->e:Ljava/util/concurrent/ScheduledExecutorService;
    ...
    invoke-direct {v2, v3, v0, v1}, Lj2d;-><init>(Ljava/lang/String;IZ)V

    sput-object v2, Ln4e;->d:Lj2d;
...
.method public final a()Lm6d;
    ...
    iget-object p0, p0, Ln4e;->c:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    invoke-direct {v0, p0}, Lm4e;-><init>(Ljava/util/concurrent/ScheduledExecutorService;)V
...
.method public final d(Ljava/lang/Runnable;JJLjava/util/concurrent/TimeUnit;)Lvq4;
    ...
    sget-object v7, Ls45;->a:Ls45;

    iget-object v6, p0, Ln4e;->c:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    new-instance v6, Lia7;

    invoke-direct {v6, p1, v1}, Lia7;-><init>(Ljava/lang/Runnable;Ljava/util/concurrent/ScheduledExecutorService;)V
    ...
    :goto_0
    invoke-virtual {v6, v0}, Lia7;->a(Ljava/util/concurrent/Future;)V
    :try_end_0
    .catch Ljava/util/concurrent/RejectedExecutionException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    invoke-direct {v1, p1, v5}, Li0;-><init>(Ljava/lang/Runnable;Z)V
    ...
    invoke-virtual {v1, v0}, Li0;->a(Ljava/util/concurrent/Future;)V
    :try_end_1
