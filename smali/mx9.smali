...
# static fields
.field public static final X:Lgf1;

.field public static final Y:Lmx9;

.field public static final Z:Lmx9;

.field public static b:Lmx9;

.field public static final c:Lmx9;

.field public static final synthetic o:Lmx9;

.field public static final r0:Lmx9;

.field public static final s0:Lmx9;
...
.method public static c([BLes8;I)Lxtc;
    .locals 10
    ...
    invoke-direct {v0, p0, p1, p2}, Lxtc;-><init>([BLes8;I)V
...
.method public static e(Lnve;)Lby6;
    .locals 7
    ...
    invoke-virtual {v1}, Lxr;->iterator()Ljava/util/Iterator;
    ...
    iget-object v3, v2, Lvx6;->a:Ljava/lang/String;
    ...
    :cond_0
    iget-object v1, p0, Lnve;->X:Ljava/lang/Object;
    ...
    :cond_1
    :goto_1
    invoke-static {v0}, Lmx9;->a(Ljava/net/HttpURLConnection;)V
    ...
    iget-object v4, v1, Lt9h;->c:Ljava/lang/Object;

    check-cast v4, Lxk;

    iget-object v5, v1, Lt9h;->o:Ljava/lang/Object;

    check-cast v5, Ltkd;

    iget-object v5, v5, Ltkd;->b:Ljava/lang/Object;

    check-cast v5, Lrw3;

    iget-object v1, v1, Lt9h;->b:Ljava/lang/Object;
    ...
    invoke-virtual {v5, v6, v1, v4, v3}, Lrw3;->g(Ljava/io/OutputStream;Lgl;Lxk;I)V

    invoke-virtual {v6}, Ljava/util/zip/DeflaterOutputStream;->finish()V

    invoke-virtual {v6}, Lgx6;->m()V

    goto :goto_2

    :cond_2
    invoke-virtual {v5, v2, v1, v4, v3}, Lrw3;->g(Ljava/io/OutputStream;Lgl;Lxk;I)V
    :try_end_1
    ...
    invoke-direct {v6, v4, v5}, Lvx6;-><init>(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-direct {v5, v1, p0}, Lxr;-><init>(ILjava/lang/Object;)V

    const/4 p0, 0x1

    invoke-direct {v4, v2, v5, v3, p0}, Lby6;-><init>(ILjava/lang/Object;Ljava/io/Closeable;I)V
...
.method public static g(I)La25;
    .locals 3

    sget-object v0, La25;->s0:Lg85;
...
.method public D(Lj49;)Lpye;
    ...
    :cond_9
    :try_start_2
    invoke-static {v1, v10, v11}, Lye5;->K(Lj49;J)J
    ...
    :cond_d
    :try_start_3
    invoke-static {v1}, Lye5;->F(Lj49;)B
    ...
    invoke-static {v1, v0}, Lye5;->a0(Lj49;Lol9;)Ljava/util/Set;
    ...
    :cond_25
    new-instance v13, Lkz9;

    invoke-direct/range {v13 .. v20}, Lkz9;-><init>(JJILoy8;Ljava/util/Set;)V
    ...
    :goto_1b
    new-instance v14, Lyo9;

    invoke-direct {v14, v13}, Lyo9;-><init>(I)V
    :try_end_d
    ...
    invoke-virtual {v14, v0}, Lyo9;->b(Ljava/lang/Object;)V
    ...
    :try_start_11
    invoke-static {v1, v12, v13}, Lye5;->K(Lj49;J)J
    ...
    :cond_4a
    invoke-direct {v7, v9, v0, v1, v11}, Lr36;-><init>(Ljd2;JLyo9;)V
    ...
    invoke-direct {v4, v10, v11}, Lb70;-><init>(J)V
...
.method public d(Lvcf;[ILdg0;Le47;)Lx8;
    .locals 11
...
.method public h(Lrh8;F)V
    .locals 4

    iget-object p0, p1, Lrh8;->b:Ljava/lang/Object;
    ...
    iget-boolean v3, p0, Lvzc;->f:Z

    if-ne v3, v1, :cond_0

    iget-boolean v3, p0, Lvzc;->g:Z
    ...
    iput-boolean v1, p0, Lvzc;->f:Z

    iput-boolean v2, p0, Lvzc;->g:Z

    const/4 p2, 0x0

    invoke-virtual {p0, p2}, Lvzc;->b(Landroid/graphics/Rect;)V
    ...
    invoke-virtual {p1, p0, p0, p0, p0}, Lrh8;->j(IIII)V
    ...
    invoke-static {p2, p0, v1}, Lwzc;->a(FFZ)F
    ...
    invoke-static {p2, p0, v0}, Lwzc;->b(FFZ)F
    ...
    invoke-virtual {p1, v1, p0, v1, p0}, Lrh8;->j(IIII)V
