...
.method public final onTransact(ILandroid/os/Parcel;Landroid/os/Parcel;I)Z
    ...
    :cond_1
    invoke-virtual {p0, p1, p2, p3}, Larg;->Z(ILandroid/os/Parcel;Landroid/os/Parcel;)Z
    ...
    :cond_3
    invoke-virtual {p0, p2, p1}, Larg;->Y(Landroid/os/Parcel;I)Z
    ...
    :cond_5
    invoke-virtual {p0, p1, p2, p3}, Larg;->X(ILandroid/os/Parcel;Landroid/os/Parcel;)Z
    ...
    iget-object p1, p0, Ltvg;->f:Lxvg;

    iget-object p1, p1, Lxvg;->a:Luxg;

    if-eqz p1, :cond_9

    iget-object p2, p0, Ltvg;->e:Ljre;

    iget-object p3, p1, Luxg;->f:Ljava/lang/Object;

    monitor-enter p3

    :try_start_0
    iget-object p4, p1, Luxg;->e:Ljava/util/HashSet;
    ...
    invoke-direct {p2, v3, p1}, Luwg;-><init>(ILjava/lang/Object;)V

    invoke-virtual {p1}, Luxg;->a()Landroid/os/Handler;
    ...
    :cond_9
    :goto_6
    iget-object p1, p0, Ltvg;->d:Ldde;

    const-string p2, "onGetLaunchReviewFlowInfo"

    new-array p3, v3, [Ljava/lang/Object;

    invoke-virtual {p1, p2, p3}, Ldde;->c(Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    invoke-direct {p3, p1, p2}, Lnsg;-><init>(Landroid/app/PendingIntent;Z)V

    iget-object p0, p0, Ltvg;->e:Ljre;

    invoke-virtual {p0, p3}, Ljre;->d(Ljava/lang/Object;)V
    ...
    iget-object p1, p0, Lixg;->f:Lnxg;

    iget-object p1, p1, Lnxg;->a:Lgyg;

    iget-object p2, p0, Lixg;->e:Ljre;

    invoke-virtual {p1, p2}, Lgyg;->c(Ljre;)V

    iget-object p0, p0, Lixg;->d:Lpie;

    const-string p1, "onCompleteUpdate"

    new-array p2, v3, [Ljava/lang/Object;

    invoke-virtual {p0, p1, p2}, Lpie;->e(Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    invoke-static {p1, v6}, Lw68;->h(ILjava/lang/String;)Ljava/lang/String;
    ...
    iget-object p1, p0, Lixg;->d:Lpie;

    const-string p3, "onRequestInfo"

    new-array p4, v3, [Ljava/lang/Object;

    invoke-virtual {p1, p3, p4}, Lpie;->e(Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    invoke-virtual {p2, p0}, Ljre;->c(Ljava/lang/Exception;)V

    goto/16 :goto_8

    :cond_13
    iget-object p0, p0, Lixg;->g:Lnxg;
    ...
    iget-object p0, p0, Lnxg;->d:Lsxg;

    invoke-virtual {p0}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    new-instance v2, Ljava/io/File;

    iget-object p0, p0, Lsxg;->a:Landroid/content/Context;
    ...
    invoke-static {v2}, Lsxg;->a(Ljava/io/File;)J
    ...
    invoke-direct {p0, v5}, Lkp;-><init>(I)V

    invoke-virtual {p2, p0}, Ljre;->d(Ljava/lang/Object;)V
    ...
    :cond_1d
    invoke-virtual {p0, p1, p2, p3}, Larg;->W(ILandroid/os/Parcel;Landroid/os/Parcel;)Z
