...
.field public final r0:Lxwg;

.field public final s0:Lxwg;
...
# direct methods
.method public constructor <init>(Ljava/lang/String;IILxwg;)V
    .locals 1
    ...
    iput-object p1, p0, Lgg4;->Z:Ljava/lang/String;

    iput p2, p0, Lgg4;->X:I

    iput p3, p0, Lgg4;->Y:I

    iput-object p4, p0, Lgg4;->r0:Lxwg;
    ...
    iput-object p1, p0, Lgg4;->s0:Lxwg;
...
.method public final G(Lu74;)J
    ...
    iput-object v0, v1, Lgg4;->t0:Lu74;

    const-wide/16 v12, 0x0

    iput-wide v12, v1, Lgg4;->z0:J

    iput-wide v12, v1, Lgg4;->y0:J

    invoke-virtual/range {p0 .. p1}, Lii0;->c(Lu74;)V
    ...
    iget-object v3, v0, Lu74;->a:Landroid/net/Uri;
    ...
    iget-object v4, v0, Lu74;->d:[B

    iget-wide v5, v0, Lu74;->f:J

    iget-wide v7, v0, Lu74;->g:J
    ...
    :goto_0
    iget-object v11, v0, Lu74;->e:Ljava/util/Map;

    const/4 v10, 0x1

    invoke-virtual/range {v1 .. v11}, Lgg4;->g(Ljava/net/URL;I[BJJZZLjava/util/Map;)Ljava/net/HttpURLConnection;

    move-result-object v2

    iget-wide v3, v0, Lu74;->f:J

    iget-wide v5, v0, Lu74;->g:J

    iput-object v2, v1, Lgg4;->u0:Ljava/net/HttpURLConnection;

    invoke-virtual {v2}, Ljava/net/HttpURLConnection;->getResponseCode()I

    move-result v7

    iput v7, v1, Lgg4;->x0:I
    ...
    sget-object v8, Lly6;->a:Ljava/util/regex/Pattern;
    ...
    invoke-static {v9}, Loe0;->n(Ljava/lang/String;)V
    ...
    sget-object v11, Lly6;->a:Ljava/util/regex/Pattern;
    ...
    iput-object v2, v1, Lgg4;->v0:Ljava/io/InputStream;

    if-eqz v7, :cond_9

    new-instance v2, Ljava/util/zip/GZIPInputStream;

    iget-object v6, v1, Lgg4;->v0:Ljava/io/InputStream;
    ...
    :cond_9
    :goto_7
    iput-boolean v14, v1, Lgg4;->w0:Z

    invoke-virtual/range {p0 .. p1}, Lii0;->e(Lu74;)V

    :try_start_4
    invoke-virtual {v1, v3, v4}, Lgg4;->h(J)V
    :try_end_4
    .catch Ljava/io/IOException; {:try_start_4 .. :try_end_4} :catch_3

    iget-wide v0, v1, Lgg4;->y0:J
    ...
    :cond_d
    sget-object v8, Lly6;->b:Ljava/util/regex/Pattern;
...
.method public final close()V
    ...
    :try_start_0
    iget-object v2, p0, Lgg4;->v0:Ljava/io/InputStream;
    :try_end_0
    ...
    :cond_0
    :goto_0
    iput-object v1, p0, Lgg4;->v0:Ljava/io/InputStream;

    invoke-virtual {p0}, Lgg4;->f()V

    iget-boolean v2, p0, Lgg4;->w0:Z

    if-eqz v2, :cond_1

    iput-boolean v0, p0, Lgg4;->w0:Z

    invoke-virtual {p0}, Lii0;->b()V

    :cond_1
    iput-object v1, p0, Lgg4;->u0:Ljava/net/HttpURLConnection;

    iput-object v1, p0, Lgg4;->t0:Lu74;
...
.method public final f()V
    ...
    iget-object p0, p0, Lgg4;->u0:Ljava/net/HttpURLConnection;
...
.method public final g(Ljava/net/URL;I[BJJZZLjava/util/Map;)Ljava/net/HttpURLConnection;
    ...
    iget-object v1, p0, Lgg4;->r0:Lxwg;

    if-eqz v1, :cond_0

    invoke-virtual {v1}, Lxwg;->y()Ljava/util/Map;
    ...
    :cond_0
    iget-object v1, p0, Lgg4;->s0:Lxwg;
    ...
    :cond_1
    sget-object p10, Lly6;->a:Ljava/util/regex/Pattern;
    ...
    :cond_4
    iget-object p0, p0, Lgg4;->Z:Ljava/lang/String;
    ...
    invoke-static {p2}, Lu74;->b(I)Ljava/lang/String;
...
.method public final getUri()Landroid/net/Uri;
    ...
    iget-object v0, p0, Lgg4;->u0:Ljava/net/HttpURLConnection;
    ...
    :cond_0
    iget-object p0, p0, Lgg4;->t0:Lu74;

    if-eqz p0, :cond_1

    iget-object p0, p0, Lu74;->a:Landroid/net/Uri;
...
.method public final h(J)V
    ...
    iget-object v5, p0, Lgg4;->v0:Ljava/io/InputStream;
...
.method public final read([BII)I
    ...
    :cond_2
    iget-object v0, p0, Lgg4;->v0:Ljava/io/InputStream;
    ...
    :cond_3
    iget-wide p2, p0, Lgg4;->z0:J

    int-to-long v0, p1

    add-long/2addr p2, v0

    iput-wide p2, p0, Lgg4;->z0:J
