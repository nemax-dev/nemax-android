...
.method public constructor <init>(Ljx4;)V
    ...
    iput-object v0, p0, Lth4;->X:Ljava/util/concurrent/atomic/AtomicBoolean;

    const/16 v0, 0x10

    new-array v2, v0, [F

    iput-object v2, p0, Lth4;->Y:[F

    new-array v0, v0, [F

    iput-object v0, p0, Lth4;->Z:[F

    new-instance v0, Ljava/util/LinkedHashMap;

    invoke-direct {v0}, Ljava/util/LinkedHashMap;-><init>()V

    iput-object v0, p0, Lth4;->n0:Ljava/util/LinkedHashMap;

    iput v1, p0, Lth4;->o0:I

    iput-boolean v1, p0, Lth4;->p0:Z

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, Lth4;->q0:Ljava/util/ArrayList;
    ...
    iput-object v0, p0, Lth4;->b:Landroid/os/HandlerThread;
    ...
    iput-object v1, p0, Lth4;->o:Landroid/os/Handler;

    new-instance v0, Lwl6;

    invoke-direct {v0, v1}, Lwl6;-><init>(Landroid/os/Handler;)V

    iput-object v0, p0, Lth4;->c:Lwl6;

    new-instance v0, Lkq4;

    invoke-direct {v0}, Lkq4;-><init>()V

    iput-object v0, p0, Lth4;->a:Lkq4;

    :try_start_0
    new-instance v0, Lza4;

    invoke-direct {v0, p0, p1}, Lza4;-><init>(Lth4;Ljx4;)V
    ...
    :try_start_1
    invoke-virtual {p1}, Lms1;->get()Ljava/lang/Object;
    :try_end_1
    ...
    invoke-virtual {p0}, Lth4;->release()V
...
.method public final a(Lsie;)V
    ...
    iget-object v0, p0, Lth4;->X:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    invoke-direct {v1, p1, v2}, Lrh4;-><init>(Lsie;I)V

    invoke-virtual {p0, v0, v1}, Lth4;->c(Ljava/lang/Runnable;Ljava/lang/Runnable;)V
...
.method public final b()V
    ...
    iget-boolean v0, p0, Lth4;->p0:Z

    if-eqz v0, :cond_2

    iget v0, p0, Lth4;->o0:I

    if-nez v0, :cond_2

    iget-object v0, p0, Lth4;->n0:Ljava/util/LinkedHashMap;
    ...
    invoke-virtual {v2}, Lkie;->close()V

    goto :goto_0

    :cond_0
    iget-object v1, p0, Lth4;->q0:Ljava/util/ArrayList;
    ...
    invoke-virtual {v2, v3}, Ljs1;->d(Ljava/lang/Throwable;)Z
    ...
    iget-object v0, p0, Lth4;->a:Lkq4;

    invoke-virtual {v0}, Lkq4;->q()V

    iget-object p0, p0, Lth4;->b:Landroid/os/HandlerThread;
...
.method public final d(Ljava/lang/Exception;)V
    ...
    iget-object p0, p0, Lth4;->q0:Ljava/util/ArrayList;
...
.method public final e(II)Lyp7;
    .locals 1

    new-instance v0, Lwa4;

    invoke-direct {v0, p1, p2, p0}, Lwa4;-><init>(IILjava/lang/Object;)V
...
.method public final f(Lkie;)V
    ...
    invoke-direct {v1, v2, p1}, Lsd4;-><init>(ILjava/lang/Object;)V
...
.method public final g(Landroid/util/Size;[FI)Landroid/graphics/Bitmap;
    ...
    invoke-static {v1, v2}, Lcp;->P([FF)V

    invoke-static {v1}, Lcp;->Q([F)V
    ...
    invoke-static {v5, v4}, Lcr0;->e(Ljava/lang/String;Z)V
    ...
    invoke-static {v5}, Lhb6;->b(Ljava/lang/String;)V
    ...
    invoke-static {v14}, Lhb6;->b(Ljava/lang/String;)V
    ...
    invoke-static {v15}, Lhb6;->b(Ljava/lang/String;)V
    ...
    invoke-static {v6}, Lhb6;->b(Ljava/lang/String;)V
    ...
    invoke-static {v7}, Lhb6;->b(Ljava/lang/String;)V
    ...
    invoke-static {v8}, Lhb6;->b(Ljava/lang/String;)V
    ...
    iput-object v5, v2, Lkq4;->k:Ljava/lang/Object;
    ...
    iget-object v5, v2, Lkq4;->m:Ljava/lang/Object;

    check-cast v5, Lfb6;

    invoke-virtual {v5}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    instance-of v9, v5, Lgb6;
    ...
    invoke-static {v1}, Lhb6;->b(Ljava/lang/String;)V
    ...
    invoke-static {v3}, Lhb6;->b(Ljava/lang/String;)V
...
.method public final h(Lj6f;)V
    .locals 11

    iget-object v0, p0, Lth4;->q0:Ljava/util/ArrayList;
    ...
    invoke-virtual {p0, p1}, Lth4;->d(Ljava/lang/Exception;)V
    ...
    :cond_3
    :goto_1
    iget-object v4, p1, Lj6f;->b:Ljava/lang/Object;

    check-cast v4, Landroid/util/Size;

    iget-object v5, p1, Lj6f;->c:Ljava/lang/Object;

    check-cast v5, [F

    invoke-virtual {p0, v4, v5, v9}, Lth4;->g(Landroid/util/Size;[FI)Landroid/graphics/Bitmap;
    ...
    :cond_5
    iget-object v9, p1, Lj6f;->a:Ljava/lang/Object;
    ...
    iget-object v8, v8, Lba0;->c:Ljs1;

    invoke-virtual {v8, v3}, Ljs1;->b(Ljava/lang/Object;)Z
...
.method public final onFrameAvailable(Landroid/graphics/SurfaceTexture;)V
    ...
    iget-object v0, p0, Lth4;->Y:[F

    invoke-virtual {p1, v0}, Landroid/graphics/SurfaceTexture;->getTransformMatrix([F)V

    iget-object v1, p0, Lth4;->n0:Ljava/util/LinkedHashMap;
    ...
    iget-object v5, p0, Lth4;->Z:[F

    invoke-virtual {v3, v5, v0}, Lkie;->n([F[F)V
    ...
    :try_start_0
    iget-object v3, p0, Lth4;->a:Lkq4;

    invoke-virtual {p1}, Landroid/graphics/SurfaceTexture;->getTimestamp()J

    move-result-wide v6

    invoke-virtual {v3, v6, v7, v5, v4}, Lkq4;->t(J[FLandroid/view/Surface;)V
    :try_end_0
    ...
    invoke-static {v6, v7}, Lcr0;->j(Ljava/lang/String;Z)V
    ...
    invoke-static {v2, v8}, Lcr0;->j(Ljava/lang/String;Z)V

    new-instance v2, Lj6f;

    iget-object v3, v3, Lkie;->o:Landroid/util/Size;
    ...
    invoke-direct {v2, v4, v3, v5}, Lj6f;-><init>(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;)V

    goto :goto_0

    :cond_4
    :try_start_1
    invoke-virtual {p0, v2}, Lth4;->h(Lj6f;)V
    :try_end_1
    .catch Ljava/lang/RuntimeException; {:try_start_1 .. :try_end_1} :catch_1
