...
.method public static b(Landroid/view/View;Lpkg;Landroid/graphics/Rect;)Lpkg;
    .locals 1
...
.method public static j(Landroid/view/View;)Lpkg;
    .locals 7

    sget-boolean v0, Ldkg;->d:Z
    ...
    :try_start_0
    sget-object v2, Ldkg;->a:Ljava/lang/reflect/Field;
    ...
    sget-object v2, Ldkg;->b:Ljava/lang/reflect/Field;
    ...
    sget-object v3, Ldkg;->c:Ljava/lang/reflect/Field;
    ...
    invoke-static {v4, v5, v6, v2}, La67;->b(IIII)La67;

    move-result-object v2

    invoke-virtual {v3, v2}, Lekg;->i(La67;)V
    ...
    invoke-static {v2, v4, v5, v0}, La67;->b(IIII)La67;

    move-result-object v0

    invoke-virtual {v3, v0}, Lekg;->f(La67;)V

    invoke-virtual {v3}, Lekg;->b()Lpkg;

    move-result-object v0

    iget-object v2, v0, Lpkg;->a:Lnkg;

    invoke-virtual {v2, v0}, Lnkg;->q(Lpkg;)V
    ...
    invoke-virtual {v2, p0}, Lnkg;->d(Landroid/view/View;)V
    :try_end_0
...
.method public static u(Landroid/view/View;Lr4a;)V
    .locals 2
    ...
    invoke-direct {v0, p0, p1}, Lwwf;-><init>(Landroid/view/View;Lr4a;)V
