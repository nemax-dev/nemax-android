...
.method public b(Z)V
    .locals 0
    # Imeni🖤: Выполняем внутренний вызов a(z) с оригинальным значением.
    invoke-direct {p0, p1}, Lcom/my/tracker/obfuscated/z0;->a(Z)V
    # Imeni🖤: Принудительно отключаем трекинг покупок.
    const/4 p1, 0x0
...
.method public c(Z)V
    .locals 0
    # Imeni🖤: Принудительно отключаем трекинг местоположения.
    const/4 p1, 0x0
...
.method public d(Z)V
    .locals 0
    # Imeni🖤: Принудительно отключаем трекинг запусков приложения.
    const/4 p1, 0x0
...
.method public e(Z)V
    .locals 0
    # Imeni🖤: Принудительно отключаем трекинг атрибуции.
    const/4 p1, 0x0
