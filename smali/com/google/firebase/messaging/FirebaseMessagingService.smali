...
.method public final b(Landroid/content/Intent;)V
    ...
    invoke-static {v3}, Lr8;->d0(Landroid/os/Bundle;)Z
    ...
    invoke-direct {v4, v3}, Lr8;-><init>(Landroid/os/Bundle;)V

    new-instance v7, Lko9;

    const-string v8, "Firebase-Messaging-Network-Io"

    invoke-direct {v7, v8, v6}, Lko9;-><init>(Ljava/lang/String;I)V
    ...
    invoke-direct {v8, v6, p0, v4, v7}, Ltz4;-><init>(ZLjava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;)V

    :try_start_0
    invoke-virtual {v8}, Ltz4;->d()Z
    ...
    invoke-static {p1}, Lnoa;->K(Landroid/content/Intent;)Z
    ...
    invoke-static {v4, v7}, Lnoa;->z(Ljava/lang/String;Landroid/os/Bundle;)V
    ...
    invoke-direct {v4, v3}, Lljc;-><init>(Landroid/os/Bundle;)V

    invoke-virtual {p0, v4}, Lcom/google/firebase/messaging/FirebaseMessagingService;->d(Lljc;)V
    ...
    :goto_4
    iget-object v3, p0, Lcom/google/firebase/messaging/FirebaseMessagingService;->Y:Lxrc;
    ...
    invoke-direct {v3, v4}, Lxrc;-><init>(Landroid/content/Context;)V

    iput-object v3, p0, Lcom/google/firebase/messaging/FirebaseMessagingService;->Y:Lxrc;

    :cond_10
    iget-object p0, p0, Lcom/google/firebase/messaging/FirebaseMessagingService;->Y:Lxrc;
    ...
    invoke-direct {p1, v0, v5, v3, v6}, Lkxg;-><init>(IILandroid/os/Bundle;I)V

    invoke-virtual {p0, p1}, Lxxg;->i(Lkxg;)Lcyg;
