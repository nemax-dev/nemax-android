...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    .line 5
    invoke-direct {p0, v0}, Lkyf;-><init>(I)V
    ...
    .line 9
    sget-object v1, Lj6c;->ScrollingViewBehavior_Layout:[I
    ...
    .line 11
    sget p2, Lj6c;->ScrollingViewBehavior_Layout_behavior_overlapTop:I
...
.method public static A(Ljava/util/List;)Lyl;
    .locals 4
...
.method public final B(Landroid/view/View;)I
    ...
    invoke-static {p1, v1, p0}, Lr7;->q(III)I
...
.method public h(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Landroid/view/View;Landroid/view/View;)Z
    ...
    :cond_0
    instance-of p0, p3, Lyl;

    if-eqz p0, :cond_1

    check-cast p3, Lyl;

    iget-boolean p0, p3, Lyl;->u0:Z

    if-eqz p0, :cond_1

    invoke-virtual {p3, p2}, Lyl;->h(Landroid/view/View;)Z

    move-result p0

    invoke-virtual {p3, p0}, Lyl;->g(Z)Z
...
.method public final i(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Landroid/view/View;)V
    ...
    invoke-static {p1, p0}, Lixf;->j(Landroid/view/View;Ly3;)V
...
.method public final m(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Landroid/view/View;III)Z
    ...
    invoke-static {v2}, Lcom/google/android/material/appbar/AppBarLayout$ScrollingViewBehavior;->A(Ljava/util/List;)Lyl;
    ...
    invoke-virtual {p1}, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->getLastWindowInsets()Lpkg;
    ...
    :cond_2
    :goto_0
    invoke-virtual {v2}, Lyl;->getTotalScrollRange()I
...
.method public final q(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Landroid/view/View;Landroid/graphics/Rect;Z)Z
    ...
    invoke-static {v0}, Lcom/google/android/material/appbar/AppBarLayout$ScrollingViewBehavior;->A(Ljava/util/List;)Lyl;
    ...
    invoke-virtual {v0, v1, p1, p0}, Lyl;->f(ZZZ)V
