...
# direct methods
.method public constructor <init>(Landroid/view/ContextThemeWrapper;Liy0;Llm;)V
    .locals 4

    invoke-direct {p0}, Lygc;-><init>()V

    iget-object v0, p2, Liy0;->a:Lte9;

    iget-object v1, p2, Liy0;->b:Lte9;

    iget-object v2, p2, Liy0;->o:Lte9;

    iget-object v0, v0, Lte9;->a:Ljava/util/Calendar;

    iget-object v3, v2, Lte9;->a:Ljava/util/Calendar;
    ...
    iget-object v0, v2, Lte9;->a:Ljava/util/Calendar;

    iget-object v1, v1, Lte9;->a:Ljava/util/Calendar;
    ...
    sget v2, Lrwb;->mtrl_calendar_day_height:I
    ...
    iput-object p3, p0, Lcom/google/android/material/datepicker/c;->X:Llm;
...
.method public final k(I)J
    ...
    iget-object p0, p0, Liy0;->a:Lte9;

    iget-object p0, p0, Lte9;->a:Ljava/util/Calendar;

    invoke-static {p0}, Lzhf;->a(Ljava/util/Calendar;)Ljava/util/Calendar;
...
.method public final r(Luhc;I)V
    ...
    invoke-direct {p2, v0}, Lte9;-><init>(Ljava/util/Calendar;)V

    iget-object v0, p1, Lcom/google/android/material/datepicker/b;->A0:Landroid/widget/TextView;

    invoke-virtual {p2}, Lte9;->c()Ljava/lang/String;
    ...
    iget-object v0, v0, Lue9;->a:Lte9;

    invoke-virtual {p2, v0}, Lte9;->equals(Ljava/lang/Object;)Z
    ...
    invoke-direct {p1, p2, p0}, Lue9;-><init>(Lte9;Liy0;)V
...
.method public final t(Landroid/view/ViewGroup;I)Luhc;
    ...
    invoke-direct {p1, v0, p0}, Lghc;-><init>(II)V
