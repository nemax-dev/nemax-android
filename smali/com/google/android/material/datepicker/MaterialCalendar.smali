...
.field public j1:Lte9;

.field public k1:I

.field public l1:Lwd8;
...
.method public final S0(Lte9;)V
    ...
    iget-object v1, v1, Liy0;->a:Lte9;

    invoke-virtual {v1, p1}, Lte9;->d(Lte9;)I

    move-result v1

    iget-object v2, p0, Lcom/google/android/material/datepicker/MaterialCalendar;->j1:Lte9;

    iget-object v0, v0, Lcom/google/android/material/datepicker/c;->o:Liy0;

    iget-object v0, v0, Liy0;->a:Lte9;

    invoke-virtual {v0, v2}, Lte9;->d(Lte9;)I
    ...
    :cond_1
    iput-object p1, p0, Lcom/google/android/material/datepicker/MaterialCalendar;->j1:Lte9;
...
.method public final T0(I)V
    ...
    iget-object v3, p0, Lcom/google/android/material/datepicker/MaterialCalendar;->j1:Lte9;
    ...
    iget-object p1, p0, Lcom/google/android/material/datepicker/MaterialCalendar;->j1:Lte9;

    invoke-virtual {p0, p1}, Lcom/google/android/material/datepicker/MaterialCalendar;->S0(Lte9;)V
...
.method public final m0(Landroid/view/LayoutInflater;Landroid/view/ViewGroup;Landroid/os/Bundle;)Landroid/view/View;
    ...
    invoke-direct {v0, p3, v1}, Lwd8;-><init>(Landroid/content/Context;I)V

    iput-object v0, p0, Lcom/google/android/material/datepicker/MaterialCalendar;->l1:Lwd8;
    ...
    sget v2, La2c;->mtrl_calendar_vertical:I
    ...
    :cond_0
    sget v2, La2c;->mtrl_calendar_horizontal:I
    ...
    sget v2, Lrwb;->mtrl_calendar_navigation_height:I

    invoke-virtual {p2, v2}, Landroid/content/res/Resources;->getDimensionPixelSize(I)I

    move-result v2

    sget v6, Lrwb;->mtrl_calendar_navigation_top_padding:I
    ...
    sget v2, Lrwb;->mtrl_calendar_navigation_bottom_padding:I
    ...
    sget v6, Lrwb;->mtrl_calendar_days_of_week_height:I
    ...
    sget v8, Lrwb;->mtrl_calendar_day_height:I
    ...
    sget v9, Lrwb;->mtrl_calendar_month_vertical_padding:I
    ...
    sget v7, Lrwb;->mtrl_calendar_bottom_padding:I
    ...
    sget p2, Lkyb;->mtrl_calendar_days_of_week:I
    ...
    invoke-direct {v2, v6}, Lr48;-><init>(I)V

    invoke-static {p2, v2}, Lixf;->j(Landroid/view/View;Ly3;)V
    ...
    invoke-direct {v6, v2}, Lx74;-><init>(I)V

    goto :goto_1

    :cond_1
    invoke-direct {v6}, Lx74;-><init>()V
    ...
    sget p2, Lkyb;->mtrl_calendar_months:I
    ...
    invoke-direct {p2, p0, v5, v5}, Ls48;-><init>(Lcom/google/android/material/datepicker/MaterialCalendar;II)V
    ...
    invoke-direct {v2, v5, p0}, Llm;-><init>(ILjava/lang/Object;)V

    invoke-direct {p2, p3, v0, v2}, Lcom/google/android/material/datepicker/c;-><init>(Landroid/view/ContextThemeWrapper;Liy0;Llm;)V

    iget-object v0, p0, Lcom/google/android/material/datepicker/MaterialCalendar;->n1:Landroidx/recyclerview/widget/RecyclerView;

    invoke-virtual {v0, p2}, Landroidx/recyclerview/widget/RecyclerView;->setAdapter(Lygc;)V

    invoke-virtual {p3}, Landroid/view/ContextThemeWrapper;->getResources()Landroid/content/res/Resources;

    move-result-object v0

    sget v2, Lo1c;->mtrl_calendar_year_selector_span:I

    invoke-virtual {v0, v2}, Landroid/content/res/Resources;->getInteger(I)I

    move-result v0

    sget v2, Lkyb;->mtrl_calendar_year_selector_frame:I
    ...
    invoke-direct {v2, p0}, Lcq;-><init>(Lcom/google/android/material/datepicker/MaterialCalendar;)V

    invoke-virtual {v0, v2}, Landroidx/recyclerview/widget/RecyclerView;->j(Lehc;)V

    :cond_2
    sget v0, Lkyb;->month_navigation_fragment_toggle:I
    ...
    sget v2, Lkyb;->month_navigation_previous:I
    ...
    sget v2, Lkyb;->month_navigation_next:I
    ...
    sget v2, Lkyb;->mtrl_calendar_day_selector_frame:I
    ...
    invoke-virtual {v2}, Lte9;->c()Ljava/lang/String;
    ...
    invoke-direct {v3, p0, p2, v0}, Lt48;-><init>(Lcom/google/android/material/datepicker/MaterialCalendar;Lcom/google/android/material/datepicker/c;Lcom/google/android/material/button/MaterialButton;)V

    invoke-virtual {v2, v3}, Landroidx/recyclerview/widget/RecyclerView;->m(Lkhc;)V

    new-instance v2, La4d;

    const/4 v3, 0x5

    invoke-direct {v2, v3, p0}, La4d;-><init>(ILjava/lang/Object;)V
    ...
    invoke-direct {v2, p0, p2, v3}, Lq48;-><init>(Lcom/google/android/material/datepicker/MaterialCalendar;Lcom/google/android/material/datepicker/c;I)V
    ...
    new-instance p3, Lb74;

    const/4 v0, 0x1

    invoke-direct {p3, v0}, Lb74;-><init>(I)V

    iget-object v0, p0, Lcom/google/android/material/datepicker/MaterialCalendar;->n1:Landroidx/recyclerview/widget/RecyclerView;

    invoke-virtual {p3, v0}, Lb74;->a(Landroidx/recyclerview/widget/RecyclerView;)V

    :cond_4
    iget-object p3, p0, Lcom/google/android/material/datepicker/MaterialCalendar;->n1:Landroidx/recyclerview/widget/RecyclerView;

    iget-object v0, p0, Lcom/google/android/material/datepicker/MaterialCalendar;->j1:Lte9;

    iget-object p2, p2, Lcom/google/android/material/datepicker/c;->o:Liy0;

    iget-object p2, p2, Liy0;->a:Lte9;

    invoke-virtual {p2, v0}, Lte9;->d(Lte9;)I
    ...
    invoke-direct {p2, p3}, Lr48;-><init>(I)V

    invoke-static {p0, p2}, Lixf;->j(Landroid/view/View;Ly3;)V
...
.method public final z0(Landroid/os/Bundle;)V
    ...
    iget-object p0, p0, Lcom/google/android/material/datepicker/MaterialCalendar;->j1:Lte9;
