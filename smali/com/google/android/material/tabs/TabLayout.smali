...
.field public static final f1:Lg8b;
...
.field public Y0:Le44;

.field public Z0:Ldne;

.field public a:I

.field public a1:Lyme;
...
.field public final d1:Lf8b;

.field public final n0:I

.field public final o:Lbne;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/google/android/material/tabs/TabLayout;->f1:Lg8b;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    sget v3, Lsvb;->tabStyle:I

    sget v4, Lcom/google/android/material/tabs/TabLayout;->e1:I

    invoke-static {p1, p2, v3, v4}, Li58;->a(Landroid/content/Context;Landroid/util/AttributeSet;II)Landroid/content/Context;
    ...
    iput-object v0, p0, Lcom/google/android/material/tabs/TabLayout;->d1:Lf8b;
    ...
    invoke-direct {v7, p0, v0}, Lbne;-><init>(Lcom/google/android/material/tabs/TabLayout;Landroid/content/Context;)V

    iput-object v7, p0, Lcom/google/android/material/tabs/TabLayout;->o:Lbne;
    ...
    sget-object v2, Lj6c;->TabLayout:[I

    sget v1, Lj6c;->TabLayout_tabTextAppearance:I
    ...
    invoke-static/range {v0 .. v5}, Love;->d(Landroid/content/Context;Landroid/util/AttributeSet;[III[I)Landroid/content/res/TypedArray;
    ...
    invoke-static {v1}, Lcsa;->j(Landroid/graphics/drawable/Drawable;)Landroid/content/res/ColorStateList;
    ...
    invoke-virtual {v2, v1}, La58;->k(Landroid/content/res/ColorStateList;)V

    invoke-virtual {v2, v0}, La58;->i(Landroid/content/Context;)V

    sget-object v1, Lixf;->a:Ljava/util/WeakHashMap;

    invoke-static {p0}, Lxwf;->i(Landroid/view/View;)F

    move-result v1

    invoke-virtual {v2, v1}, La58;->j(F)V

    invoke-virtual {p0, v2}, Landroid/view/View;->setBackground(Landroid/graphics/drawable/Drawable;)V

    :cond_0
    sget v1, Lj6c;->TabLayout_tabIndicator:I

    invoke-static {v0, p2, v1}, Lfog;->D(Landroid/content/Context;Landroid/content/res/TypedArray;I)Landroid/graphics/drawable/Drawable;
    ...
    sget v1, Lj6c;->TabLayout_tabIndicatorColor:I
    ...
    sget v1, Lj6c;->TabLayout_tabIndicatorHeight:I

    invoke-virtual {p2, v1, p1}, Landroid/content/res/TypedArray;->getDimensionPixelSize(II)I

    move-result v1

    invoke-virtual {v7, v1}, Lbne;->b(I)V

    sget v1, Lj6c;->TabLayout_tabIndicatorGravity:I
    ...
    sget v1, Lj6c;->TabLayout_tabIndicatorAnimationMode:I
    ...
    sget v1, Lj6c;->TabLayout_tabIndicatorFullWidth:I
    ...
    sget v1, Lj6c;->TabLayout_tabPadding:I
    ...
    sget v3, Lj6c;->TabLayout_tabPaddingStart:I
    ...
    sget v3, Lj6c;->TabLayout_tabPaddingTop:I
    ...
    sget v3, Lj6c;->TabLayout_tabPaddingEnd:I
    ...
    sget v3, Lj6c;->TabLayout_tabPaddingBottom:I
    ...
    sget v1, Lsvb;->isMaterial3Theme:I

    invoke-static {v1, v0, v6}, Lqbf;->C(ILandroid/content/Context;Z)Z

    move-result v1

    if-eqz v1, :cond_1

    sget v1, Lsvb;->textAppearanceTitleSmall:I
    ...
    :cond_1
    sget v1, Lsvb;->textAppearanceButton:I
    ...
    sget v3, Lw5c;->TextAppearance_Design_Tab:I
    ...
    sget-object v3, Lz6c;->TextAppearance:[I
    ...
    :try_start_0
    sget v4, Lz6c;->TextAppearance_android_textSize:I
    ...
    sget v5, Lz6c;->TextAppearance_android_textColor:I

    invoke-static {v0, v3, v5}, Lfog;->B(Landroid/content/Context;Landroid/content/res/TypedArray;I)Landroid/content/res/ColorStateList;
    ...
    sget v3, Lj6c;->TabLayout_tabSelectedTextAppearance:I
    ...
    :try_start_1
    sget v3, Lz6c;->TextAppearance_android_textSize:I

    float-to-int v4, v4

    invoke-virtual {v1, v3, v4}, Landroid/content/res/TypedArray;->getDimensionPixelSize(II)I

    sget v3, Lz6c;->TextAppearance_android_textColor:I

    invoke-static {v0, v1, v3}, Lfog;->B(Landroid/content/Context;Landroid/content/res/TypedArray;I)Landroid/content/res/ColorStateList;
    ...
    :cond_4
    :goto_3
    sget v1, Lj6c;->TabLayout_tabTextColor:I
    ...
    invoke-static {v0, p2, v1}, Lfog;->B(Landroid/content/Context;Landroid/content/res/TypedArray;I)Landroid/content/res/ColorStateList;
    ...
    :cond_5
    sget v1, Lj6c;->TabLayout_tabSelectedTextColor:I
    ...
    :cond_6
    sget v1, Lj6c;->TabLayout_tabIconTint:I
    ...
    sget v1, Lj6c;->TabLayout_tabIconTintMode:I
    ...
    invoke-static {v1, v3}, Ll18;->D(ILandroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuff$Mode;

    sget v1, Lj6c;->TabLayout_tabRippleColor:I
    ...
    sget v1, Lj6c;->TabLayout_tabIndicatorAnimationDuration:I
    ...
    sget v1, Lsvb;->motionEasingEmphasizedInterpolator:I

    sget-object v3, Lhg;->b:Lue5;

    invoke-static {v0, v1, v3}, Lj5e;->w(Landroid/content/Context;ILandroid/animation/TimeInterpolator;)Landroid/animation/TimeInterpolator;
    ...
    sget p1, Lj6c;->TabLayout_tabBackground:I
    ...
    sget p1, Lj6c;->TabLayout_tabContentStart:I
    ...
    sget p1, Lj6c;->TabLayout_tabMode:I
    ...
    sget p1, Lj6c;->TabLayout_tabGravity:I
    ...
    sget p1, Lj6c;->TabLayout_tabInlineLabel:I
    ...
    sget p1, Lj6c;->TabLayout_tabUnboundedRipple:I
    ...
    sget p2, Lrwb;->design_tab_text_size_2line:I
    ...
    sget p2, Lrwb;->design_tab_scrollable_min_width:I
...
.method private getTabScrollRange()I
    ...
    iget-object v0, p0, Lcom/google/android/material/tabs/TabLayout;->o:Lbne;
...
.method private setSelectedTabView(I)V
    ...
    iget-object p0, p0, Lcom/google/android/material/tabs/TabLayout;->o:Lbne;
    ...
    instance-of v4, v3, Lene;

    if-eqz v4, :cond_7

    check-cast v3, Lene;

    invoke-virtual {v3}, Lene;->f()V
...
.method public final b(Lcne;IZ)V
    .locals 7

    iget-object v0, p1, Lcne;->c:Lcom/google/android/material/tabs/TabLayout;
    ...
    iget-object p2, p1, Lcne;->d:Lene;

    const/4 v0, 0x0

    invoke-virtual {p2, v0}, Lene;->setSelected(Z)V
    ...
    iget-object p0, p1, Lcne;->c:Lcom/google/android/material/tabs/TabLayout;

    if-eqz p0, :cond_3

    invoke-virtual {p0, p1, v2}, Lcom/google/android/material/tabs/TabLayout;->o(Lcne;Z)V
...
.method public final c(I)V
    ...
    :cond_3
    iget-object v1, v0, Lbne;->a:Landroid/animation/ValueAnimator;
    ...
    iget-object v1, v0, Lbne;->b:Lcom/google/android/material/tabs/TabLayout;
    ...
    invoke-virtual {v0, p1, p0, v1}, Lbne;->d(IIZ)V
...
.method public final d()V
    ...
    iget-object v3, p0, Lcom/google/android/material/tabs/TabLayout;->o:Lbne;
...
.method public getSelectedTabPosition()I
    ...
    iget-object p0, p0, Lcom/google/android/material/tabs/TabLayout;->c:Lcne;
...
.method public final i()Lcne;
    .locals 4

    sget-object v0, Lcom/google/android/material/tabs/TabLayout;->f1:Lg8b;

    invoke-virtual {v0}, Lg8b;->g()Ljava/lang/Object;
    ...
    :cond_0
    iput-object p0, v0, Lcne;->c:Lcom/google/android/material/tabs/TabLayout;

    const/4 v1, 0x0

    iget-object v2, p0, Lcom/google/android/material/tabs/TabLayout;->d1:Lf8b;

    if-eqz v2, :cond_1

    invoke-virtual {v2}, Lf8b;->g()Ljava/lang/Object;
    ...
    invoke-direct {v2, p0, v3}, Lene;-><init>(Lcom/google/android/material/tabs/TabLayout;Landroid/content/Context;)V

    :cond_2
    invoke-virtual {v2, v0}, Lene;->setTab(Lcne;)V
...
.method public final j()V
    ...
    iget-object v0, p0, Lcom/google/android/material/tabs/TabLayout;->X0:Lpra;

    if-eqz v0, :cond_3

    invoke-virtual {v0}, Lpra;->b()I
    ...
    iget-object v4, p0, Lcom/google/android/material/tabs/TabLayout;->X0:Lpra;
    ...
    iget-object v5, v3, Lcne;->d:Lene;

    invoke-virtual {v5, v4}, Landroid/view/View;->setContentDescription(Ljava/lang/CharSequence;)V

    :cond_0
    iget-object v4, v3, Lcne;->d:Lene;

    if-eqz v4, :cond_1

    invoke-virtual {v4}, Lene;->d()V
    ...
    invoke-virtual {p0, v3, v4, v1}, Lcom/google/android/material/tabs/TabLayout;->b(Lcne;IZ)V
    ...
    invoke-virtual {p0, v0}, Lcom/google/android/material/tabs/TabLayout;->h(I)Lcne;

    move-result-object v0

    const/4 v1, 0x1

    invoke-virtual {p0, v0, v1}, Lcom/google/android/material/tabs/TabLayout;->o(Lcne;Z)V
...
.method public final k()V
    ...
    iput-object v2, v1, Lcne;->c:Lcom/google/android/material/tabs/TabLayout;

    iput-object v2, v1, Lcne;->d:Lene;

    const/4 v3, -0x1

    iput v3, v1, Lcne;->a:I

    iput-object v2, v1, Lcne;->b:Landroid/view/View;

    sget-object v2, Lcom/google/android/material/tabs/TabLayout;->f1:Lg8b;

    invoke-virtual {v2, v1}, Lg8b;->f(Ljava/lang/Object;)Z

    goto :goto_1

    :cond_1
    iput-object v2, p0, Lcom/google/android/material/tabs/TabLayout;->c:Lcne;

    return-void
.end method

.method public final l(Lzme;)V
    .locals 0
...
.method public final m(I)V
    ...
    iget-object v0, p0, Lcom/google/android/material/tabs/TabLayout;->c:Lcne;
    ...
    iput-object v5, v3, Lcne;->c:Lcom/google/android/material/tabs/TabLayout;

    iput-object v5, v3, Lcne;->d:Lene;

    iput v4, v3, Lcne;->a:I

    iput-object v5, v3, Lcne;->b:Landroid/view/View;

    sget-object v6, Lcom/google/android/material/tabs/TabLayout;->f1:Lg8b;

    invoke-virtual {v6, v3}, Lg8b;->f(Ljava/lang/Object;)Z
    ...
    :goto_2
    invoke-virtual {p0, v5, v3}, Lcom/google/android/material/tabs/TabLayout;->o(Lcne;Z)V
...
.method public final n(I)V
    ...
    invoke-virtual {v1, p1}, Lene;->setTab(Lcne;)V

    const/4 p1, 0x0

    invoke-virtual {v1, p1}, Lene;->setSelected(Z)V

    iget-object p1, p0, Lcom/google/android/material/tabs/TabLayout;->d1:Lf8b;

    invoke-virtual {p1, v1}, Lf8b;->f(Ljava/lang/Object;)Z
...
.method public final o(Lcne;Z)V
    .locals 10
    ...
    :cond_6
    :goto_5
    iput-object p1, v4, Lcom/google/android/material/tabs/TabLayout;->c:Lcne;

    if-eqz v0, :cond_7

    iget-object p0, v0, Lcne;->c:Lcom/google/android/material/tabs/TabLayout;
    ...
    invoke-interface {p2, p1}, Lzme;->a(Lcne;)V
...
.method public final onDraw(Landroid/graphics/Canvas;)V
    ...
    :goto_0
    iget-object v1, p0, Lcom/google/android/material/tabs/TabLayout;->o:Lbne;
    ...
    iget-object v2, v1, Lene;->r0:Landroid/graphics/drawable/Drawable;
    ...
    iget-object v1, v1, Lene;->r0:Landroid/graphics/drawable/Drawable;
...
.method public final onInitializeAccessibilityNodeInfo(Landroid/view/accessibility/AccessibilityNodeInfo;)V
    ...
    invoke-static {v0, p0, v0}, Lu8d;->s(III)Lu8d;
...
.method public final onMeasure(II)V
    ...
    invoke-static {v0, v1}, Ll18;->i(Landroid/content/Context;I)F
    ...
    invoke-static {v1, v2}, Ll18;->i(Landroid/content/Context;I)F
...
.method public final p(Lpra;Z)V
    .locals 2
    ...
    iget-object v1, p0, Lcom/google/android/material/tabs/TabLayout;->Y0:Le44;

    if-eqz v1, :cond_0

    iget-object v0, v0, Lpra;->a:Landroid/database/DataSetObservable;

    invoke-virtual {v0, v1}, Landroid/database/Observable;->unregisterObserver(Ljava/lang/Object;)V

    :cond_0
    iput-object p1, p0, Lcom/google/android/material/tabs/TabLayout;->X0:Lpra;

    if-eqz p2, :cond_2

    if-eqz p1, :cond_2

    iget-object p2, p0, Lcom/google/android/material/tabs/TabLayout;->Y0:Le44;
    ...
    invoke-direct {p2, v0, p0}, Le44;-><init>(ILjava/lang/Object;)V

    iput-object p2, p0, Lcom/google/android/material/tabs/TabLayout;->Y0:Le44;

    :cond_1
    iget-object p2, p0, Lcom/google/android/material/tabs/TabLayout;->Y0:Le44;

    iget-object p1, p1, Lpra;->a:Landroid/database/DataSetObservable;
...
.method public final q(IFZZZ)V
    ...
    iget-object v2, p0, Lcom/google/android/material/tabs/TabLayout;->o:Lbne;
    ...
    iget-object p4, v2, Lbne;->b:Lcom/google/android/material/tabs/TabLayout;
    ...
    iget-object p4, v2, Lbne;->a:Landroid/animation/ValueAnimator;
    ...
    invoke-virtual {v2, p4, v0, p2}, Lbne;->c(Landroid/view/View;Landroid/view/View;F)V
...
.method public final r(Landroidx/viewpager/widget/ViewPager;Z)V
    ...
    iget-object v1, p0, Lcom/google/android/material/tabs/TabLayout;->Z0:Ldne;
    ...
    :cond_0
    iget-object v0, p0, Lcom/google/android/material/tabs/TabLayout;->a1:Lyme;
    ...
    :cond_1
    iget-object v0, p0, Lcom/google/android/material/tabs/TabLayout;->U0:Lz06;

    const/4 v1, 0x0

    if-eqz v0, :cond_2

    invoke-virtual {p0, v0}, Lcom/google/android/material/tabs/TabLayout;->l(Lzme;)V

    iput-object v1, p0, Lcom/google/android/material/tabs/TabLayout;->U0:Lz06;
    ...
    invoke-direct {v1, p0}, Ldne;-><init>(Lcom/google/android/material/tabs/TabLayout;)V

    iput-object v1, p0, Lcom/google/android/material/tabs/TabLayout;->Z0:Ldne;
    ...
    invoke-virtual {p1, v1}, Landroidx/viewpager/widget/ViewPager;->b(Lryf;)V
    ...
    iput-object v0, p0, Lcom/google/android/material/tabs/TabLayout;->U0:Lz06;

    invoke-virtual {p0, v0}, Lcom/google/android/material/tabs/TabLayout;->a(Lzme;)V

    invoke-virtual {p1}, Landroidx/viewpager/widget/ViewPager;->getAdapter()Lpra;
    ...
    invoke-virtual {p0, v0, v1}, Lcom/google/android/material/tabs/TabLayout;->p(Lpra;Z)V
    ...
    invoke-direct {v0, p0}, Lyme;-><init>(Lcom/google/android/material/tabs/TabLayout;)V

    iput-object v0, p0, Lcom/google/android/material/tabs/TabLayout;->a1:Lyme;

    :cond_5
    iget-object v0, p0, Lcom/google/android/material/tabs/TabLayout;->a1:Lyme;

    iput-boolean v1, v0, Lyme;->a:Z
    ...
    invoke-virtual {v2, v1, v0}, Lcom/google/android/material/tabs/TabLayout;->p(Lpra;Z)V
...
.method public setInlineLabel(Z)V
    ...
    iget-object v2, v1, Lene;->t0:Lcom/google/android/material/tabs/TabLayout;
    ...
    iget-object v2, v1, Lene;->p0:Landroid/widget/TextView;

    if-nez v2, :cond_1

    iget-object v4, v1, Lene;->q0:Landroid/widget/ImageView;
    ...
    iget-object v4, v1, Lene;->c:Landroid/widget/ImageView;

    invoke-virtual {v1, v2, v4, v3}, Lene;->g(Landroid/widget/TextView;Landroid/widget/ImageView;Z)V

    goto :goto_2

    :cond_1
    :goto_1
    iget-object v3, v1, Lene;->q0:Landroid/widget/ImageView;

    invoke-virtual {v1, v2, v3, p1}, Lene;->g(Landroid/widget/TextView;Landroid/widget/ImageView;Z)V
...
.method public setOnTabSelectedListener(Lane;)V
    .locals 0
    .annotation runtime Ljava/lang/Deprecated;
    .end annotation

    .line 1
    invoke-virtual {p0, p1}, Lcom/google/android/material/tabs/TabLayout;->setOnTabSelectedListener(Lzme;)V

    return-void
.end method

.method public setOnTabSelectedListener(Lzme;)V
    .locals 1
    .annotation runtime Ljava/lang/Deprecated;
    .end annotation

    .line 2
    iget-object v0, p0, Lcom/google/android/material/tabs/TabLayout;->S0:Lzme;
    ...
    .line 4
    :cond_0
    iput-object p1, p0, Lcom/google/android/material/tabs/TabLayout;->S0:Lzme;

    if-eqz p1, :cond_1

    .line 5
    invoke-virtual {p0, p1}, Lcom/google/android/material/tabs/TabLayout;->a(Lzme;)V
...
.method public setSelectedTabIndicator(Landroid/graphics/drawable/Drawable;)V
    ...
    .line 4
    invoke-static {p1, v0}, Ljt4;->g(Landroid/graphics/drawable/Drawable;I)V
    ...
    .line 5
    invoke-static {p1, v0}, Ljt4;->h(Landroid/graphics/drawable/Drawable;Landroid/content/res/ColorStateList;)V
    ...
    invoke-virtual {p0, p1}, Lbne;->b(I)V
...
.method public setSelectedTabIndicatorColor(I)V
    ...
    invoke-static {v0, p1}, Ljt4;->g(Landroid/graphics/drawable/Drawable;I)V
...
.method public setTabIconTint(Landroid/content/res/ColorStateList;)V
    ...
    iget-object v1, v1, Lcne;->d:Lene;

    if-eqz v1, :cond_0

    invoke-virtual {v1}, Lene;->d()V
...
.method public setTabIndicatorAnimationMode(I)V
    ...
    invoke-direct {p1, v0}, Lgz4;-><init>(I)V

    iput-object p1, p0, Lcom/google/android/material/tabs/TabLayout;->Q0:Lvs9;
...
.method public setTabIndicatorFullWidth(Z)V
    ...
    iget-object p1, p0, Lbne;->b:Lcom/google/android/material/tabs/TabLayout;

    invoke-virtual {p1}, Lcom/google/android/material/tabs/TabLayout;->getSelectedTabPosition()I

    move-result p1

    invoke-virtual {p0, p1}, Lbne;->a(I)V
...
.method public setTabRippleColor(Landroid/content/res/ColorStateList;)V
    ...
    invoke-virtual {v0, v1}, Lene;->e(Landroid/content/Context;)V
...
.method public setTabsFromPagerAdapter(Lpra;)V
    .locals 1
    .annotation runtime Ljava/lang/Deprecated;
    .end annotation
    ...
    invoke-virtual {p0, p1, v0}, Lcom/google/android/material/tabs/TabLayout;->p(Lpra;Z)V
