...
.method static constructor <clinit>()V
    ...
    sput-object v0, Ljv5;->v:[Landroid/hardware/camera2/params/MeteringRectangle;

    return-void
.end method

.method public constructor <init>(Luv1;Lwl6;Load;Lu8d;)V
    .locals 4
    ...
    iput-boolean v0, p0, Ljv5;->d:Z

    const/4 v1, 0x0

    iput-object v1, p0, Ljv5;->e:Landroid/util/Rational;

    iput-boolean v0, p0, Ljv5;->g:Z

    invoke-static {v0}, Ljava/lang/Integer;->valueOf(I)Ljava/lang/Integer;

    move-result-object v2

    iput-object v2, p0, Ljv5;->h:Ljava/lang/Integer;

    const-wide/16 v2, 0x0

    iput-wide v2, p0, Ljv5;->k:J

    iput-boolean v0, p0, Ljv5;->l:Z
    ...
    iput-object v1, p0, Ljv5;->o:Lfv5;

    sget-object v2, Ljv5;->v:[Landroid/hardware/camera2/params/MeteringRectangle;

    iput-object v2, p0, Ljv5;->p:[Landroid/hardware/camera2/params/MeteringRectangle;

    iput-object v2, p0, Ljv5;->q:[Landroid/hardware/camera2/params/MeteringRectangle;

    iput-object v2, p0, Ljv5;->r:[Landroid/hardware/camera2/params/MeteringRectangle;

    iput-object v1, p0, Ljv5;->s:Ljs1;

    iput-boolean v0, p0, Ljv5;->t:Z

    iput-object v1, p0, Ljv5;->u:Liv5;

    iput-object p1, p0, Ljv5;->a:Luv1;

    iput-object p3, p0, Ljv5;->b:Load;

    iput-object p2, p0, Ljv5;->c:Lwl6;

    new-instance p1, Lf02;

    const/16 p2, 0x15

    invoke-direct {p1, p2, p4}, Lf02;-><init>(ILjava/lang/Object;)V

    iput-object p1, p0, Ljv5;->f:Lf02;
...
.method public final a(ZZ)V
    ...
    invoke-virtual {v2, p1, v0}, Ltk9;->l(Lz90;Ljava/lang/Object;)V
    ...
    invoke-direct {p1, v0, p2}, Lr8;-><init>(ILjava/lang/Object;)V

    invoke-virtual {v1, p1}, Lh40;->c(Lpf3;)V

    iget-object p0, p0, Ljv5;->a:Luv1;

    invoke-virtual {v1}, Lh40;->d()Ll12;
...
.method public final b()V
    ...
    iget-object v0, p0, Ljv5;->a:Luv1;

    iget-object v1, v0, Luv1;->b:Lsv1;
    ...
    iget-object v1, p0, Ljv5;->o:Lfv5;

    iget-object v2, v0, Luv1;->b:Lsv1;
    ...
    invoke-virtual {v1, v3}, Ljs1;->d(Ljava/lang/Throwable;)Z

    iput-object v2, p0, Ljv5;->s:Ljs1;

    :cond_0
    iget-object v1, p0, Ljv5;->i:Ljava/util/concurrent/ScheduledFuture;
    ...
    iput-object v2, p0, Ljv5;->i:Ljava/util/concurrent/ScheduledFuture;
    ...
    :cond_2
    iget-object v1, p0, Ljv5;->p:[Landroid/hardware/camera2/params/MeteringRectangle;
    ...
    invoke-virtual {p0, v3, v2}, Ljv5;->a(ZZ)V

    :cond_3
    sget-object v1, Ljv5;->v:[Landroid/hardware/camera2/params/MeteringRectangle;

    iput-object v1, p0, Ljv5;->p:[Landroid/hardware/camera2/params/MeteringRectangle;

    iput-object v1, p0, Ljv5;->q:[Landroid/hardware/camera2/params/MeteringRectangle;

    iput-object v1, p0, Ljv5;->r:[Landroid/hardware/camera2/params/MeteringRectangle;

    iput-boolean v2, p0, Ljv5;->g:Z
...
.method public final c(Ljava/util/List;ILandroid/util/Rational;Landroid/graphics/Rect;I)Ljava/util/List;
    ...
    iget-object v5, v5, Lfc9;->d:Landroid/util/Rational;
    ...
    iget-object v12, v8, Ljv5;->f:Lf02;

    iget-object v12, v12, Lf02;->b:Ljava/lang/Object;

    check-cast v12, Lu8d;

    const-class v13, Landroidx/camera/camera2/internal/compat/quirk/AfRegionFlipHorizontallyQuirk;

    invoke-virtual {v12, v13}, Lu8d;->a(Ljava/lang/Class;)Z
...
.method public final d(Ljs1;)V
    .locals 4

    iget-boolean v0, p0, Ljv5;->d:Z
    ...
    invoke-static {v3}, Lex1;->k0(Landroid/hardware/camera2/CaptureRequest$Key;)Lz90;

    move-result-object v3

    invoke-virtual {v2, v3, v1}, Ltk9;->l(Lz90;Ljava/lang/Object;)V
    ...
    invoke-direct {v1, v3, v2}, Lr8;-><init>(ILjava/lang/Object;)V

    invoke-virtual {v0, v1}, Lh40;->c(Lpf3;)V

    new-instance v1, Lsw1;

    const/4 v2, 0x1

    invoke-direct {v1, p1, v2}, Lsw1;-><init>(Ljs1;I)V

    invoke-virtual {v0, v1}, Lh40;->b(Lkx1;)V

    iget-object p0, p0, Ljv5;->a:Luv1;

    invoke-virtual {v0}, Lh40;->d()Ll12;
...
.method public final e(Z)V
    ...
    invoke-virtual {v2, v3, v4}, Ltk9;->l(Lz90;Ljava/lang/Object;)V

    if-eqz p1, :cond_1

    sget-object p1, Landroid/hardware/camera2/CaptureRequest;->CONTROL_AE_MODE:Landroid/hardware/camera2/CaptureRequest$Key;

    iget-object v3, p0, Ljv5;->a:Luv1;

    iget-object v3, v3, Luv1;->e:Lzx1;

    invoke-static {v3, v1}, Luv1;->t(Lzx1;I)I
    ...
    sget-object v3, Lof3;->b:Lof3;

    invoke-static {p1}, Lex1;->k0(Landroid/hardware/camera2/CaptureRequest$Key;)Lz90;

    move-result-object p1

    invoke-virtual {v2, p1, v3, v1}, Ltk9;->g(Lz90;Lof3;Ljava/lang/Object;)V
    ...
    invoke-direct {p1, v2, v1}, Lr8;-><init>(ILjava/lang/Object;)V

    invoke-virtual {v0, p1}, Lh40;->c(Lpf3;)V

    new-instance p1, Lq12;

    const/4 v1, 0x1

    invoke-direct {p1, v1}, Lq12;-><init>(I)V

    invoke-virtual {v0, p1}, Lh40;->b(Lkx1;)V
