...
.method public constructor <init>(Lth7;Lth7;Lth7;)V
    ...
    iput-object p3, p0, Lmta;->a:Lth7;

    iput-object p1, p0, Lmta;->b:Lth7;

    iput-object p2, p0, Lmta;->c:Lth7;
    ...
    iput-object p1, p0, Lmta;->o:Lru/ok/android/externcalls/sdk/video/VideoRender;

    invoke-static {}, Ljava/util/concurrent/ConcurrentHashMap;->newKeySet()Ljava/util/concurrent/ConcurrentHashMap$KeySetView;

    move-result-object p1

    iput-object p1, p0, Lmta;->X:Ljava/util/concurrent/ConcurrentHashMap$KeySetView;
...
.method public final clear()V
    ...
    iget-object v0, p0, Lmta;->X:Ljava/util/concurrent/ConcurrentHashMap$KeySetView;
    ...
    iput-object v3, v2, Lhr1;->o0:Lxhf;
    ...
    :cond_0
    iget-object p0, p0, Lmta;->o:Lru/ok/android/externcalls/sdk/video/VideoRender;
...
.method public final createVideoViewInstance(Landroid/content/Context;)Lru/ok/android/externcalls/sdk/ui/RendererView;
    ...
    invoke-direct/range {v0 .. v5}, Lru/ok/android/externcalls/sdk/ui/TextureViewRenderer;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;IILuc4;)V
...
.method public final d(Lru/ok/android/externcalls/sdk/layout/ConversationVideoTrackParticipantKey;Lru/ok/android/externcalls/sdk/ui/TextureViewRenderer;)V
    ...
    invoke-virtual {p0}, Lmta;->c()Lru/ok/android/externcalls/sdk/Conversation;
...
.method public final onCameraChanged()V
    ...
    iget-object v3, v1, Lhr1;->q0:Lsvf;

    if-eqz v3, :cond_0

    iget-boolean v3, v3, Lsvf;->c:Z
...
.method public final rebindParticipantViews()V
    ...
    iget-object v5, p0, Lmta;->o:Lru/ok/android/externcalls/sdk/video/VideoRender;
...
.method public final removeOwnVideoParticipantView(Lru/ok/android/externcalls/sdk/ui/RendererView;)V
    ...
    invoke-virtual {v0}, Ljta;->c()Lnsa;

    move-result-object v0

    iget-object v0, v0, Lnsa;->a:Ldh1;

    invoke-interface {v0}, Ldh1;->s()Lsvf;

    move-result-object v0

    iget-object v0, v0, Lsvf;->b:Lru/ok/android/externcalls/sdk/layout/ConversationVideoTrackParticipantKey;

    invoke-virtual {p0, v0, p1}, Lmta;->d(Lru/ok/android/externcalls/sdk/layout/ConversationVideoTrackParticipantKey;Lru/ok/android/externcalls/sdk/ui/TextureViewRenderer;)V
...
.method public final bridge synthetic removeParticipantView(Lru/ok/android/externcalls/sdk/layout/ConversationVideoTrackParticipantKey;Lru/ok/android/externcalls/sdk/ui/RendererView;)V
    ...
    invoke-virtual {p0, p1, p2}, Lmta;->d(Lru/ok/android/externcalls/sdk/layout/ConversationVideoTrackParticipantKey;Lru/ok/android/externcalls/sdk/ui/TextureViewRenderer;)V
...
.method public final setOwnVideoParticipantView(Lru/ok/android/externcalls/sdk/ui/RendererView;Lru/ok/android/externcalls/sdk/ui/FrameDecorator;)V
    ...
    invoke-virtual {p2}, Ljta;->c()Lnsa;

    move-result-object p2

    iget-object p2, p2, Lnsa;->a:Ldh1;

    invoke-interface {p2}, Ldh1;->s()Lsvf;

    move-result-object p2

    iget-object p2, p2, Lsvf;->b:Lru/ok/android/externcalls/sdk/layout/ConversationVideoTrackParticipantKey;
...
.method public final setParticipantView(Lru/ok/android/externcalls/sdk/layout/ConversationVideoTrackParticipantKey;Lru/ok/android/externcalls/sdk/ui/RendererView;Lru/ok/android/externcalls/sdk/ui/FrameDecorator;)V
    ...
    iget-object p3, p0, Lmta;->o:Lru/ok/android/externcalls/sdk/video/VideoRender;
    ...
    invoke-virtual {p1}, Lru/ok/android/externcalls/sdk/layout/ConversationVideoTrackParticipantKey;->getType()Lvvf;
