...
# direct methods
.method public constructor <init>(Landroid/content/Context;Landroid/net/Uri;Landroid/net/Uri;IILdde;)V
    .locals 0
...
.method public final a(Landroid/net/Uri;Landroid/net/Uri;)V
    ...
    :cond_0
    invoke-static {v2}, Lcr0;->l(Ljava/io/Closeable;)V

    invoke-static {p1}, Lcr0;->l(Ljava/io/Closeable;)V
    ...
    :goto_1
    invoke-static {v1}, Lcr0;->l(Ljava/io/Closeable;)V
...
.method public final b()Ljava/lang/String;
    ...
    invoke-static {v1, v0}, Lr7;->o(Landroid/content/Context;Ljava/lang/String;)I
    ...
    invoke-static {v1, p0, v2, v2}, Lx28;->k(Landroid/content/Context;Landroid/net/Uri;Ljava/lang/String;[Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v1, v2, v0, p0}, Lx28;->k(Landroid/content/Context;Landroid/net/Uri;Ljava/lang/String;[Ljava/lang/String;)Ljava/lang/String;
...
.method public final c()Lpo0;
    ...
    invoke-direct {v2, v1}, Lcy6;-><init>(Ljava/io/InputStream;)V

    invoke-virtual {v2}, Lcy6;->a()I
    ...
    :catch_3
    :cond_b
    invoke-direct {v2, v11, v0}, Lpo0;-><init>(Landroid/graphics/Bitmap;Lv85;)V
    ...
    invoke-direct {v1, v11, v0}, Lpo0;-><init>(Landroid/graphics/Bitmap;Lv85;)V
...
.method public final d()V
    ...
    invoke-direct {v6}, Law5;-><init>()V

    invoke-virtual {v0}, Landroid/net/Uri;->toString()Ljava/lang/String;

    move-result-object v0

    invoke-virtual {v6, v0}, Law5;->i(Ljava/lang/String;)V

    invoke-virtual {v6}, Law5;->b()Lalc;

    move-result-object v0

    invoke-virtual {v1, v0}, Ln4a;->b(Lalc;)Lobc;
    ...
    :try_start_5
    iget-object v1, v0, Lomc;->Z:Lqmc;

    invoke-virtual {v1}, Lqmc;->W()Luu0;
    ...
    sget-object v7, Lq4a;->a:Ljava/util/logging/Logger;
    ...
    invoke-direct {v7, v2, v9, v8}, Ljx;-><init>(Ljava/lang/Object;ILjava/lang/Object;)V
    :try_end_6
    .catchall {:try_start_6 .. :try_end_6} :catchall_3

    :try_start_7
    invoke-interface {v6, v7}, Luu0;->N(Ljx;)J
    :try_end_7
    .catchall {:try_start_7 .. :try_end_7} :catchall_2

    invoke-static {v6}, Lcr0;->l(Ljava/io/Closeable;)V

    invoke-static {v7}, Lcr0;->l(Ljava/io/Closeable;)V

    invoke-static {v1}, Lcr0;->l(Ljava/io/Closeable;)V

    invoke-virtual {v4}, Lz5e;->a()V
    ...
    :goto_6
    invoke-static {v5}, Lcr0;->l(Ljava/io/Closeable;)V
    ...
    invoke-static {v0}, Lcr0;->l(Ljava/io/Closeable;)V
...
.method public final onPostExecute(Ljava/lang/Object;)V
    ...
    :goto_0
    iget-object v0, v1, Ldde;->a:Ljava/lang/Object;

    check-cast v0, Lo4f;

    invoke-virtual {v0}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    iput-object p0, v0, Lo4f;->v0:Ljava/lang/String;

    const/4 p0, 0x1

    iput-boolean p0, v0, Lo4f;->s0:Z

    invoke-virtual {v0, p1}, Lo4f;->setImageBitmap(Landroid/graphics/Bitmap;)V

    return-void

    :cond_1
    iget-object p0, v1, Ldde;->a:Ljava/lang/Object;
