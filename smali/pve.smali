...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lpve;->X:Ljava/lang/String;

    return-void
.end method

.method public constructor <init>(Landroid/content/Context;Lrwg;)V
    .locals 2
    ...
    invoke-direct {v1, p1}, Love;-><init>(Landroid/content/Context;)V

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Lpve;->a:Landroid/content/Context;

    iput-object p2, p0, Lpve;->c:Lrwg;

    iput-object v0, p0, Lpve;->b:Landroid/app/job/JobScheduler;

    iput-object v1, p0, Lpve;->o:Love;
...
.method public static a(Landroid/app/job/JobScheduler;I)V
    ...
    sget-object v1, Lpve;->X:Ljava/lang/String;

    invoke-virtual {v0, v1, p1, p0}, Lmq0;->s(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method public static d(Landroid/content/Context;Landroid/app/job/JobScheduler;)Ljava/util/ArrayList;
    ...
    sget-object v2, Lpve;->X:Ljava/lang/String;

    const-string v3, "getAllPendingJobs() is not reliable on this device."

    invoke-virtual {v1, v2, v3, p1}, Lmq0;->s(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method public static f(Landroid/app/job/JobInfo;)Lkwg;
    .locals 3
    ...
    invoke-direct {v2, p0, v1}, Lkwg;-><init>(Ljava/lang/String;I)V
    :try_end_0
...
.method public final c(Ljava/lang/String;)V
    ...
    iget-object v0, p0, Lpve;->a:Landroid/content/Context;

    iget-object v1, p0, Lpve;->b:Landroid/app/job/JobScheduler;

    invoke-static {v0, v1}, Lpve;->d(Landroid/content/Context;Landroid/app/job/JobScheduler;)Ljava/util/ArrayList;
    ...
    invoke-static {v3}, Lpve;->f(Landroid/app/job/JobInfo;)Lkwg;
    ...
    invoke-static {v1, v2}, Lpve;->a(Landroid/app/job/JobScheduler;I)V

    goto :goto_2

    :cond_3
    iget-object p0, p0, Lpve;->c:Lrwg;

    iget-object p0, p0, Lrwg;->c:Landroidx/work/impl/WorkDatabase;

    invoke-virtual {p0}, Landroidx/work/impl/WorkDatabase;->u()Lnve;
...
.method public final varargs e([Lgxg;)V
    .locals 11

    iget-object v0, p0, Lpve;->c:Lrwg;
    ...
    iget-object v7, v5, Lgxg;->a:Ljava/lang/String;

    invoke-virtual {v6, v7}, Lixg;->o(Ljava/lang/String;)Lgxg;
    ...
    sget-object v9, Lpve;->X:Ljava/lang/String;
    ...
    invoke-virtual {v5, v9, v6}, Lmq0;->a0(Ljava/lang/String;Ljava/lang/String;)V
    ...
    :cond_1
    invoke-static {v5}, Lmq0;->u(Lgxg;)Lkwg;

    move-result-object v6

    invoke-virtual {v1}, Landroidx/work/impl/WorkDatabase;->u()Lnve;

    move-result-object v7

    invoke-virtual {v7, v6}, Lnve;->n(Lkwg;)Lmve;
    ...
    iget-object v9, v2, Lgzc;->b:Ljava/lang/Object;

    check-cast v9, Landroidx/work/impl/WorkDatabase;

    new-instance v10, Ln07;

    invoke-direct {v10, v2, v8}, Ln07;-><init>(Lgzc;I)V

    invoke-virtual {v9, v10}, Lxxc;->o(Ljava/util/concurrent/Callable;)Ljava/lang/Object;
    ...
    iget-object v9, v6, Lkwg;->a:Ljava/lang/String;

    iget v6, v6, Lkwg;->b:I

    invoke-direct {v7, v9, v6, v8}, Lmve;-><init>(Ljava/lang/String;II)V

    iget-object v6, v0, Lrwg;->c:Landroidx/work/impl/WorkDatabase;

    invoke-virtual {v6}, Landroidx/work/impl/WorkDatabase;->u()Lnve;

    move-result-object v6

    invoke-virtual {v6, v7}, Lnve;->q(Lmve;)V

    :cond_3
    invoke-virtual {p0, v5, v8}, Lpve;->g(Lgxg;I)V
...
.method public final g(Lgxg;I)V
    .locals 13

    iget-object v0, p0, Lpve;->b:Landroid/app/job/JobScheduler;

    iget-object v1, p0, Lpve;->o:Love;

    invoke-virtual {v1}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    iget-object v2, p1, Lgxg;->j:Lrm3;

    new-instance v3, Landroid/os/PersistableBundle;

    invoke-direct {v3}, Landroid/os/PersistableBundle;-><init>()V

    iget-object v4, p1, Lgxg;->a:Ljava/lang/String;
    ...
    sget-object v8, Love;->b:Ljava/lang/String;

    invoke-static {v3}, Lqg9;->r(I)Ljava/lang/String;
    ...
    invoke-virtual {v7, v8, v3}, Lmq0;->n(Ljava/lang/String;Ljava/lang/String;)V
    ...
    iget-boolean v7, v6, Lqm3;->b:Z

    new-instance v8, Landroid/app/job/JobInfo$TriggerContentUri;

    iget-object v6, v6, Lqm3;->a:Landroid/net/Uri;
    ...
    invoke-static {v1}, Lfk8;->o(Landroid/app/job/JobInfo$Builder;)V
    ...
    sget-object v5, Lpve;->X:Ljava/lang/String;

    invoke-virtual {v2, v5, v3}, Lmq0;->n(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {v1, v5, v2}, Lmq0;->a0(Ljava/lang/String;Ljava/lang/String;)V

    iget-boolean v1, p1, Lgxg;->q:Z

    if-eqz v1, :cond_d

    iget-object v1, p1, Lgxg;->r:Lhwa;

    sget-object v2, Lhwa;->a:Lhwa;

    if-ne v1, v2, :cond_d

    iput-boolean v9, p1, Lgxg;->q:Z
    ...
    invoke-virtual {v2, v5, v1}, Lmq0;->n(Ljava/lang/String;Ljava/lang/String;)V

    invoke-virtual {p0, p1, p2}, Lpve;->g(Lgxg;I)V
    :try_end_0
    ...
    invoke-virtual {p2, v5, p1, p0}, Lmq0;->s(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V

    return-void

    :goto_8
    iget-object p2, p0, Lpve;->a:Landroid/content/Context;

    invoke-static {p2, v0}, Lpve;->d(Landroid/content/Context;Landroid/app/job/JobScheduler;)Ljava/util/ArrayList;
    ...
    iget-object v1, p0, Lrwg;->c:Landroidx/work/impl/WorkDatabase;

    invoke-virtual {v1}, Landroidx/work/impl/WorkDatabase;->x()Lixg;

    move-result-object v1

    invoke-virtual {v1}, Lixg;->l()Ljava/util/ArrayList;
    ...
    invoke-virtual {v0, v5, p2}, Lmq0;->r(Ljava/lang/String;Ljava/lang/String;)V

    new-instance v0, Ljava/lang/IllegalStateException;

    invoke-direct {v0, p2, p1}, Ljava/lang/IllegalStateException;-><init>(Ljava/lang/String;Ljava/lang/Throwable;)V

    iget-object p0, p0, Lrwg;->b:Lvh3;
