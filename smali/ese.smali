...
.method public constructor <init>(Lp64;Lax0;)V
    ...
    iput-object p1, p0, Lese;->a:Lp64;

    invoke-virtual {p2}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    iput-object p2, p0, Lese;->b:Lax0;
...
.method public final F(Lw64;)J
    ...
    iget-object v0, p0, Lese;->a:Lp64;

    invoke-interface {v0, p1}, Lp64;->F(Lw64;)J

    move-result-wide v0

    iput-wide v0, p0, Lese;->o:J
    ...
    invoke-virtual {p1, v2, v3, v0, v1}, Lw64;->c(JJ)Lw64;
    ...
    iput-boolean v1, p0, Lese;->c:Z

    iget-object v1, p0, Lese;->b:Lax0;

    invoke-virtual {v1}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    iget-object v4, p1, Lw64;->h:Ljava/lang/String;
    ...
    :try_start_0
    invoke-virtual {v1, p1}, Lax0;->c(Lw64;)V
    :try_end_0
    .catch Ljava/io/IOException; {:try_start_0 .. :try_end_0} :catch_0

    :goto_1
    iget-wide p0, p0, Lese;->o:J
...
.method public final close()V
    ...
    iget-object v0, p0, Lese;->b:Lax0;

    const/4 v1, 0x0

    :try_start_0
    iget-object v2, p0, Lese;->a:Lp64;

    invoke-interface {v2}, Lp64;->close()V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    iget-boolean v2, p0, Lese;->c:Z
...
.method public final read([BII)I
    ...
    invoke-interface {v0, p1, p2, p3}, Li64;->read([BII)I
    ...
    invoke-virtual {v0, v1}, Lax0;->c(Lw64;)V
