...
.method public static e(Ljava/util/ArrayList;I)Lm0a;
    .locals 18
    ...
    invoke-static {v0}, Ln0a;->g(Landroid/app/Notification$Action;)[Landroid/app/RemoteInput;
    ...
    invoke-static {v6}, Ln0a;->h(Landroid/app/RemoteInput;)Ljava/lang/String;

    move-result-object v8

    invoke-static {v6}, Ln0a;->f(Landroid/app/RemoteInput;)Ljava/lang/CharSequence;

    move-result-object v9

    invoke-static {v6}, Ln0a;->b(Landroid/app/RemoteInput;)[Ljava/lang/CharSequence;

    move-result-object v10

    invoke-static {v6}, Ln0a;->a(Landroid/app/RemoteInput;)Z

    move-result v11

    invoke-static {v6}, Ls0a;->c(Landroid/app/RemoteInput;)I

    move-result v12

    invoke-static {v6}, Ln0a;->d(Landroid/app/RemoteInput;)Landroid/os/Bundle;

    move-result-object v13

    const/4 v14, 0x0

    invoke-direct/range {v7 .. v14}, Ltrc;-><init>(Ljava/lang/String;Ljava/lang/CharSequence;[Ljava/lang/CharSequence;ZILandroid/os/Bundle;Ljava/util/HashSet;)V
    ...
    invoke-static {v0}, Ln0a;->c(Landroid/app/Notification$Action;)Landroid/os/Bundle;
    ...
    invoke-static {v0}, Lq0a;->a(Landroid/app/Notification$Action;)Z
    ...
    invoke-static {v0}, Lr0a;->a(Landroid/app/Notification$Action;)I

    move-result v14

    invoke-static {v0}, Ls0a;->e(Landroid/app/Notification$Action;)Z
    ...
    invoke-static {v0}, Lt0a;->a(Landroid/app/Notification$Action;)Z
    ...
    invoke-static {v0}, Lp0a;->a(Landroid/app/Notification$Action;)Landroid/graphics/drawable/Icon;
    ...
    invoke-direct/range {v6 .. v17}, Lm0a;-><init>(Landroidx/core/graphics/drawable/IconCompat;Ljava/lang/CharSequence;Landroid/app/PendingIntent;Landroid/os/Bundle;[Ltrc;[Ltrc;ZIZZZ)V
    ...
    invoke-static {v1}, Lmz6;->c(Ljava/lang/Object;)I
    ...
    invoke-static {v1}, Lmz6;->a(Ljava/lang/Object;)I
    ...
    :cond_8
    invoke-static {v1}, Lkz6;->a(Landroid/graphics/drawable/Icon;)Landroidx/core/graphics/drawable/IconCompat;
