...
.method public final o(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    iget-object v0, p0, Lone/me/calllist/ui/CallHistoryScreen;->r0:Ldbc;

    iget-object v1, p0, Lone/me/calllist/ui/CallHistoryScreen;->o0:Ldbc;
    ...
    iget-boolean v3, p1, Llu1;->b:Z

    iget-object v4, p1, Llu1;->a:Ljava/util/List;
    ...
    iget-object v1, p0, Lone/me/calllist/ui/CallHistoryScreen;->p0:Ldbc;
    ...
    iput-object v4, v1, Lp1e;->a:Ljava/lang/Object;
    ...
    invoke-virtual {v7, v9, v1}, Lygc;->p(II)V
    ...
    :goto_3
    iget-object v1, p0, Lone/me/calllist/ui/CallHistoryScreen;->Z:Ldbc;

    const/4 v6, 0x2

    aget-object v7, v2, v6

    invoke-interface {v1, p0, v7}, Ldbc;->t(Ljava/lang/Object;Lof7;)Ljava/lang/Object;
    ...
    sget v7, Lryb;->call_history_empty:I
    ...
    iget-object v1, p0, Lone/me/calllist/ui/CallHistoryScreen;->X:Ldbc;
    ...
    invoke-direct {v4, v10, v11}, Lrca;-><init>(Landroid/content/Context;I)V

    sget v10, Lryb;->call_history_empty:I

    invoke-virtual {v4, v10}, Landroidx/constraintlayout/widget/ConstraintLayout;->setId(I)V

    new-instance v10, Lnz3;

    const/4 v12, -0x1

    invoke-direct {v10, v12, v12}, Lnz3;-><init>(II)V
    ...
    invoke-virtual {v10, v12}, Lnz3;->b(Lkz3;)V

    invoke-virtual {v4, v10}, Landroid/view/View;->setLayoutParams(Landroid/view/ViewGroup$LayoutParams;)V

    sget v10, Losc;->f0:I

    invoke-virtual {v4, v10}, Lrca;->setIcon(I)V

    sget v10, Lk3c;->call_history_call_history_empty_title:I

    new-instance v12, Lyte;

    invoke-direct {v12, v10}, Lyte;-><init>(I)V

    invoke-virtual {v4, v12}, Lrca;->setTitle(Ldue;)V

    sget v10, Lk3c;->call_history_call_history_empty_subtitle:I

    new-instance v12, Lyte;

    invoke-direct {v12, v10}, Lyte;-><init>(I)V

    invoke-virtual {v4, v12}, Lrca;->setSubtitle(Ldue;)V
    ...
    sget v12, Lk3c;->call_history_call_contact_action:I
    ...
    invoke-direct {v12, v13}, Lk20;-><init>(I)V

    invoke-virtual {v4, v10, v12}, Lrca;->v(Ljava/lang/String;Landroid/view/View$OnClickListener;)V

    :cond_8
    new-instance v10, Lc67;

    new-instance v12, Lqr0;

    invoke-direct {v12, v3, v6, v7}, Lqr0;-><init>(IIZ)V

    invoke-direct {v10, v11, v12, v7}, Lc67;-><init>(ILqr0;I)V

    const/4 v3, 0x0

    invoke-static {v4, v10, v3}, Liwd;->f(Landroid/view/View;Lc67;Lf96;)V

    invoke-virtual {v4, v5}, Lrca;->setVisibility(I)V

    invoke-static {v4, v1}, Lyr3;->e(Landroid/view/View;Landroid/view/ViewGroup;)V
    ...
    invoke-virtual {v0, v9}, Lrca;->setVisibility(I)V
    ...
    invoke-virtual {v0, v5}, Lrca;->setVisibility(I)V

    :cond_b
    :goto_7
    iget-object v0, p0, Lone/me/calllist/ui/CallHistoryScreen;->q0:Ldbc;
