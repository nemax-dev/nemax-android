...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    invoke-direct {v0, p1, p0, v1}, Lrve;-><init>(Ljava/lang/Object;Lsve;I)V

    iput-object v0, p0, Lsve;->a:Lrve;
    ...
    invoke-direct {p0}, Lsve;->getTheme()Lnma;
    ...
    iput-object p1, p0, Lsve;->b:Landroid/graphics/drawable/GradientDrawable;
    ...
    invoke-interface {v2}, Lnma;->i()Lhee;

    move-result-object v2

    iget-object v2, v2, Lhee;->b:Lmee;

    iget v2, v2, Lmee;->b:I

    invoke-virtual {v0, v2}, Landroid/graphics/Paint;->setColor(I)V

    iput-object v0, p0, Lsve;->o:Landroid/graphics/Paint;

    new-instance v0, Landroid/graphics/Paint;

    invoke-direct {v0, v1}, Landroid/graphics/Paint;-><init>(I)V

    iput-object v0, p0, Lsve;->n0:Landroid/graphics/Paint;

    new-instance v0, Landroid/graphics/RectF;

    invoke-direct {v0}, Landroid/graphics/RectF;-><init>()V

    iput-object v0, p0, Lsve;->o0:Landroid/graphics/RectF;

    new-instance v0, Landroid/graphics/RectF;

    invoke-direct {v0}, Landroid/graphics/RectF;-><init>()V

    iput-object v0, p0, Lsve;->p0:Landroid/graphics/RectF;
...
.method public static final synthetic a(Lsve;)Lnma;
    .locals 0
...
.method private final getTheme()Lnma;
    .locals 3
    ...
    invoke-virtual {p0}, Lsve;->getThemeName()Ljava/lang/String;
    ...
    invoke-virtual {v0, v2}, Lnd;->i(Ljava/lang/String;)Lyda;
...
.method public final b()V
    ...
    invoke-virtual {v0}, Lsve;->getIncomingColors()[I
    ...
    iput-object v3, v0, Lsve;->q0:Landroid/graphics/LinearGradient;
    ...
    invoke-virtual {v0}, Lsve;->getOutgoingColors()[I
    ...
    iput-object v12, v0, Lsve;->r0:Landroid/graphics/LinearGradient;
...
.method public final getPatternDrawable()Landroid/graphics/drawable/Drawable;
    ...
    sget-object v0, Lsve;->s0:[Lof7;

    const/4 v1, 0x1

    aget-object v0, v0, v1

    iget-object p0, p0, Lsve;->c:Lrve;
...
.method public final onDraw(Landroid/graphics/Canvas;)V
    ...
    iget-object v9, p0, Lsve;->o:Landroid/graphics/Paint;
    ...
    iget-object v4, p0, Lsve;->o0:Landroid/graphics/RectF;

    invoke-virtual {v4, p1, v1, v5, v7}, Landroid/graphics/RectF;->set(FFFF)V

    iget-object p1, p0, Lsve;->q0:Landroid/graphics/LinearGradient;

    iget-object v1, p0, Lsve;->n0:Landroid/graphics/Paint;
    ...
    iget-object v3, p0, Lsve;->p0:Landroid/graphics/RectF;

    invoke-virtual {v3, p1, v7, v5, v4}, Landroid/graphics/RectF;->set(FFFF)V

    iget-object p0, p0, Lsve;->r0:Landroid/graphics/LinearGradient;
...
.method public final onThemeChanged(Lnma;)V
    ...
    iget-object v0, p0, Lsve;->o:Landroid/graphics/Paint;
    ...
    iget-object v0, p0, Lsve;->b:Landroid/graphics/drawable/GradientDrawable;
