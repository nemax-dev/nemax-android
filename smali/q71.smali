...
.field public O0:Lyyf;

.field public P0:Lbz3;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    invoke-direct {v3, v4, p0}, Lgzc;-><init>(ILjava/lang/Object;)V

    new-instance v4, Lr02;

    const/4 v5, 0x5

    invoke-direct {v4, v5, p0}, Lr02;-><init>(ILjava/lang/Object;)V
    ...
    invoke-direct {v5, v3, v4, v6, v7}, Ly71;-><init>(Lgzc;Lr02;Lo71;Lo71;)V

    invoke-virtual {v0, v5}, Landroidx/viewpager2/widget/ViewPager2;->setAdapter(Luoc;)V

    iput-object v5, p0, Lq71;->K0:Ly71;

    new-instance v3, Lho6;

    invoke-direct {v3, p1}, Lho6;-><init>(Landroid/content/Context;)V

    sget p1, Ll6c;->call_users_speakers_view_tab_layout:I
    ...
    iput-object v3, p0, Lq71;->J0:Lho6;

    invoke-direct {p0}, Lq71;->getScreenInfo()Lx7d;

    move-result-object v5

    iget-boolean v5, v5, Lx7d;->g:Z
    ...
    invoke-virtual {v5, v7, v9, v8, v1}, Lkm3;->d(IIII)V

    new-instance v8, Lc9a;

    const/4 v10, 0x5

    invoke-direct {v8, v5, v9, v7, v10}, Lc9a;-><init>(Ljava/lang/Object;III)V
    ...
    invoke-static {v11, v12, v8}, Lmw1;->q(FFLc9a;)V

    invoke-virtual {v5, v7, v10, p1, v10}, Lkm3;->d(IIII)V

    const/4 v8, 0x7

    invoke-virtual {v5, v7, v8, p1, v8}, Lkm3;->d(IIII)V

    invoke-virtual {v5, v7, v1, p1, v1}, Lkm3;->d(IIII)V

    invoke-virtual {v3}, Landroid/view/View;->getId()I

    move-result v7

    invoke-virtual {v5, v7, v9, p1, v9}, Lkm3;->d(IIII)V

    new-instance v11, Lc9a;

    const/4 v12, 0x5

    invoke-direct {v11, v5, v9, v7, v12}, Lc9a;-><init>(Ljava/lang/Object;III)V
    ...
    invoke-static {v4, v12, v11}, Lmw1;->q(FFLc9a;)V
    ...
    invoke-virtual {v5, p1, v10, v0, v10}, Lkm3;->d(IIII)V

    new-instance v0, Lc9a;

    const/4 v2, 0x5

    invoke-direct {v0, v5, v10, p1, v2}, Lc9a;-><init>(Ljava/lang/Object;III)V
    ...
    invoke-virtual {v5, p1, v9, v0, v9}, Lkm3;->d(IIII)V

    invoke-virtual {v3}, Landroid/view/View;->getId()I

    move-result v0

    invoke-virtual {v5, p1, v1, v0, v1}, Lkm3;->d(IIII)V

    invoke-virtual {v3}, Landroid/view/View;->getId()I

    move-result v0

    invoke-virtual {v5, p1, v8, v0, v10}, Lkm3;->d(IIII)V

    invoke-virtual {v5, p1}, Lkm3;->g(I)Lfm3;
    ...
    invoke-virtual {v5, p0}, Lkm3;->a(Landroidx/constraintlayout/widget/ConstraintLayout;)V

    return-void
.end method

.method private final getMediator()Ldo6;
    .locals 0
...
.method public static final v(Lq71;I)V
    ...
    invoke-static {v0, p1, v1}, Ls53;->G(Landroid/view/ViewStub;Landroid/view/View;Lkc6;)V
...
.method public final A(Lzy3;)V
    ...
    invoke-static {p0, p1}, Ln8g;->A(Landroid/view/View;I)V
...
.method public final I(Lzy3;)V
    ...
    invoke-static {p0, p1}, Ln8g;->B(Landroid/view/View;I)V
...
.method public final onAttachedToWindow()V
    ...
    invoke-direct {p0}, Lq71;->getMediator()Ldo6;

    move-result-object v0

    iget-object v1, v0, Ldo6;->a:Landroidx/viewpager2/widget/ViewPager2;

    iget-boolean v2, v0, Ldo6;->c:Z
    ...
    invoke-direct {v3, v4, v0}, La55;-><init>(ILjava/lang/Object;)V

    iput-object v3, v0, Ldo6;->f:La55;

    invoke-virtual {v2, v3}, Luoc;->z(Lwoc;)V

    new-instance v2, Lco6;

    iget-object v3, v0, Ldo6;->b:Lho6;

    invoke-direct {v2, v3}, Lco6;-><init>(Lho6;)V

    iput-object v2, v0, Ldo6;->e:Lco6;

    invoke-virtual {v1, v2}, Landroidx/viewpager2/widget/ViewPager2;->b(Lw9g;)V

    invoke-virtual {v0}, Ldo6;->a()V
    ...
    invoke-virtual {v0, p0}, Landroidx/viewpager2/widget/ViewPager2;->b(Lw9g;)V
...
.method public final onDetachedFromWindow()V
    ...
    iput-boolean v1, v0, Ldo6;->c:Z

    iget-object v1, v0, Ldo6;->f:La55;

    if-eqz v1, :cond_1

    iget-object v2, v0, Ldo6;->d:Luoc;

    if-eqz v2, :cond_1

    invoke-virtual {v2, v1}, Luoc;->B(Lwoc;)V

    :cond_1
    const/4 v1, 0x0

    iput-object v1, v0, Ldo6;->f:La55;

    iput-object v1, v0, Ldo6;->d:Luoc;

    iget-object v2, v0, Ldo6;->e:Lco6;

    if-eqz v2, :cond_2

    iget-object v3, v0, Ldo6;->a:Landroidx/viewpager2/widget/ViewPager2;

    invoke-virtual {v3, v2}, Landroidx/viewpager2/widget/ViewPager2;->g(Lw9g;)V

    :cond_2
    iput-object v1, v0, Ldo6;->e:Lco6;
...
.method public final setControlsMediator(Lbz3;)V
    ...
    iput-object p1, p0, Lq71;->P0:Lbz3;
...
.method public final setOpponents(Ljava/util/List;)V
    ...
    :goto_1
    iget-object v0, p0, Lq71;->J0:Lho6;
    ...
    invoke-virtual {v0, v1, p1}, Lho6;->b(II)V

    iget-object p1, p0, Lq71;->P0:Lbz3;

    if-eqz p1, :cond_2

    check-cast p1, Lfz3;

    iget-object v0, p1, Lfz3;->j:Lzy3;

    invoke-virtual {p0, v0}, Lq71;->I(Lzy3;)V

    iget-object p1, p1, Lfz3;->k:Lzy3;

    invoke-virtual {p0, p1}, Lq71;->A(Lzy3;)V
...
.method public final setVideoLayoutUpdatesController(Lyyf;)V
    ...
    iput-object p1, p0, Lq71;->O0:Lyyf;
