...
# virtual methods
.method public final a(Lcpc;Li9d;)V
    .locals 5

    iget-object v0, p0, Lun0;->a:Lm56;
    ...
    invoke-direct {v2, p0}, Lxe0;-><init>(Landroidx/fragment/app/c;)V

    const/4 v3, 0x0

    const/4 v4, 0x1

    invoke-virtual {v2, v3, v1, v0, v4}, Lxe0;->f(ILandroidx/fragment/app/a;Ljava/lang/String;I)V

    invoke-virtual {v2, v4}, Lxe0;->d(Z)I
    ...
    iput-object p1, p0, Landroidx/biometric/BiometricViewModel;->c:Lcpc;
    ...
    iput-object p1, p0, Landroidx/biometric/BiometricViewModel;->d:Li9d;

    goto :goto_1

    :cond_4
    iput-object p2, p0, Landroidx/biometric/BiometricViewModel;->d:Li9d;
