...
.method public final a()V
    ...
    iget-object v0, v0, Lcy0;->e:Lwc4;

    invoke-static {v0}, Luv3;->a(Luv3;)J
    ...
    :try_start_4
    iget-object v9, v8, Lptd;->d:Lr9b;

    iget-wide v10, p0, Ltx0;->c:J

    iget-wide v13, p0, Ltx0;->Y:J

    invoke-virtual/range {v9 .. v14}, Lr9b;->K(JLjava/lang/String;J)V
    :try_end_4
    ...
    :cond_5
    :goto_1
    invoke-virtual {v8, p0}, Lptd;->b(Lstd;)V
    :try_end_5
    .catchall {:try_start_5 .. :try_end_5} :catchall_0

    :try_start_6
    iget-object p0, v8, Lptd;->c:Lnx5;

    invoke-virtual {p0}, Lnx5;->i()V
    :try_end_6
    ...
    :cond_8
    :try_start_c
    iget-object p0, v4, Lotd;->c:Lsh5;

    invoke-static {v0, v2, v3, p0}, Lrtd;->b(Ljava/io/File;JLsh5;)Lrtd;

    move-result-object p0

    invoke-virtual {p0}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    iget-object v0, v4, Lotd;->c:Lsh5;
    ...
    iget-object v0, v0, Lby0;->e:Lvc4;

    invoke-static {v0}, Ltv3;->a(Ltv3;)J
    ...
    :cond_a
    invoke-virtual {v4, p0}, Lotd;->b(Lrtd;)V
    :try_end_c
    ...
    invoke-static {v2}, Ldif;->g(Ljava/io/Closeable;)V
...
.method public b(Lv64;)V
    ...
    iget-object v7, v1, Lv64;->h:Ljava/lang/String;

    sget v8, Ldif;->a:I

    iget-wide v8, v1, Lv64;->f:J
    ...
    :try_start_0
    invoke-virtual {v6}, Lotd;->d()V

    iget-object v1, v6, Lotd;->c:Lsh5;

    invoke-virtual {v1, v7}, Lsh5;->d(Ljava/lang/String;)Lby0;
    ...
    iget-object v7, v6, Lotd;->a:Ljava/io/File;
    ...
    invoke-static {v7}, Lotd;->e(Ljava/io/File;)V

    invoke-virtual {v6}, Lotd;->k()V
    ...
    :cond_1
    :goto_1
    iget-object v7, v6, Lotd;->b:Lei7;

    cmp-long v4, v2, v4

    if-eqz v4, :cond_2

    invoke-virtual {v7, v6, v2, v3}, Lei7;->a(Lxw0;J)V
    ...
    iget-object v2, v6, Lotd;->a:Ljava/io/File;

    iget-object v3, v6, Lotd;->e:Ljava/util/Random;
    ...
    invoke-static {v12}, Lotd;->e(Ljava/io/File;)V
    ...
    invoke-static/range {v12 .. v17}, Lrtd;->c(Ljava/io/File;IJJ)Ljava/io/File;
    ...
    invoke-direct {v2, v1, v3, v4}, Lunc;-><init>(Ljava/io/OutputStream;II)V
    ...
    :cond_4
    invoke-virtual {v2, v1}, Lunc;->c(Ljava/io/OutputStream;)V
...
.method public c(Lw64;)V
    ...
    iget-object v8, v1, Lw64;->h:Ljava/lang/String;

    sget v3, Lfif;->a:I

    iget-wide v3, v1, Lw64;->f:J
    ...
    :try_start_0
    invoke-virtual {v7}, Lptd;->d()V

    iget-object v1, v7, Lptd;->c:Lnx5;

    invoke-virtual {v1, v8}, Lnx5;->d(Ljava/lang/String;)Lcy0;
    ...
    iget-object v2, v7, Lptd;->a:Ljava/io/File;
    ...
    iget-object v3, v7, Lptd;->f:Ljava/util/Random;
    ...
    invoke-static {v13}, Lptd;->e(Ljava/io/File;)V
    ...
    invoke-static/range {v13 .. v18}, Lstd;->c(Ljava/io/File;IJJ)Ljava/io/File;
